# Documentation: ts/src/pro/whitebit.ts

## File Metadata

- **Path**: `ts/src/pro/whitebit.ts`
- **Size**: 40,276 bytes
- **Lines**: 992
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/whitebit.ts`.
...
```bash
ts-node ts/src/pro/whitebit.ts
```
