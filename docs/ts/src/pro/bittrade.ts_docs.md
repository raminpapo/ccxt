# Documentation: ts/src/pro/bittrade.ts

## File Metadata

- **Path**: `ts/src/pro/bittrade.ts`
- **Size**: 25,179 bytes
- **Lines**: 625
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/bittrade.ts`.
...
```bash
ts-node ts/src/pro/bittrade.ts
```
