# Documentation: ts/src/pro/toobit.ts

## File Metadata

- **Path**: `ts/src/pro/toobit.ts`
- **Size**: 50,869 bytes
- **Lines**: 1,204
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/toobit.ts`.
...
- `wss://stream.toobit.com` (referenced)
- `../base/errors.js` (referenced)
- `../toobit.js` (referenced)
