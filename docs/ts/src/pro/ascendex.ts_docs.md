# Documentation: ts/src/pro/ascendex.ts

## File Metadata

- **Path**: `ts/src/pro/ascendex.ts`
- **Size**: 40,454 bytes
- **Lines**: 1,032
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/ascendex.ts`.
...
```bash
ts-node ts/src/pro/ascendex.ts
```
