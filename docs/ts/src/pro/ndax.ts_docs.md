# Documentation: ts/src/pro/ndax.ts

## File Metadata

- **Path**: `ts/src/pro/ndax.ts`
- **Size**: 24,872 bytes
- **Lines**: 552
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/ndax.ts`.

**Classes defined**: ndax

**Functions defined**: name, being
