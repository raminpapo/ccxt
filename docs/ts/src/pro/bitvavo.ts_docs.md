# Documentation: ts/src/pro/bitvavo.ts

## File Metadata

- **Path**: `ts/src/pro/bitvavo.ts`
- **Size**: 65,109 bytes
- **Lines**: 1,510
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/bitvavo.ts`.
