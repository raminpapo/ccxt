# Documentation: ts/src/pro/test/Exchange/test.watchOrderBook.ts

## File Metadata

- **Path**: `ts/src/pro/test/Exchange/test.watchOrderBook.ts`
- **Size**: 2,733 bytes
- **Lines**: 58
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/test/Exchange/test.watchOrderBook.ts`.
...
**To run this test:**
```bash
npm test ts/src/pro/test/Exchange/test.watchOrderBook.ts
```
