# Documentation: ts/src/pro/test/Exchange/test.unWatchPositions.ts

## File Metadata

- **Path**: `ts/src/pro/test/Exchange/test.unWatchPositions.ts`
- **Size**: 3,199 bytes
- **Lines**: 78
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/test/Exchange/test.unWatchPositions.ts`.
...
**To run this test:**
```bash
npm test ts/src/pro/test/Exchange/test.unWatchPositions.ts
```
