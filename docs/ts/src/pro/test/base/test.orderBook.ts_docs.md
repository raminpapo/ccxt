# Documentation: ts/src/pro/test/base/test.orderBook.ts

## File Metadata

- **Path**: `ts/src/pro/test/base/test.orderBook.ts`
- **Size**: 18,126 bytes
- **Lines**: 402
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/test/base/test.orderBook.ts`.
...
**To run this test:**
```bash
npm test ts/src/pro/test/base/test.orderBook.ts
```
