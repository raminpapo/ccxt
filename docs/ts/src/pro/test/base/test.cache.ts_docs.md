# Documentation: ts/src/pro/test/base/test.cache.ts

## File Metadata

- **Path**: `ts/src/pro/test/base/test.cache.ts`
- **Size**: 17,616 bytes
- **Lines**: 432
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/test/base/test.cache.ts`.

**Functions defined**: equals, testWsCache
...
**To run this test:**
```bash
npm test ts/src/pro/test/base/test.cache.ts
```
