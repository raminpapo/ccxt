# Documentation: ts/src/pro/test/custom/server.ts

## File Metadata

- **Path**: `ts/src/pro/test/custom/server.ts`
- **Size**: 4,559 bytes
- **Lines**: 135
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/test/custom/server.ts`.
...
**To run this test:**
```bash
npm test ts/src/pro/test/custom/server.ts
```
