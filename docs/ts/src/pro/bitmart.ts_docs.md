# Documentation: ts/src/pro/bitmart.ts

## File Metadata

- **Path**: `ts/src/pro/bitmart.ts`
- **Size**: 72,934 bytes
- **Lines**: 1,708
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/bitmart.ts`.

**Classes defined**: bitmart
...
- `../base/ws/OrderBookSide.js` (imported)
...
- `../base/ws/OrderBookSide.js` (referenced)
- `../base/errors.js` (referenced)
- `../bitmart.js` (referenced)
