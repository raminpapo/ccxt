# Documentation: ts/src/pro/blockchaincom.ts

## File Metadata

- **Path**: `ts/src/pro/blockchaincom.ts`
- **Size**: 31,815 bytes
- **Lines**: 791
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/blockchaincom.ts`.
...
- `../blockchaincom.js` (imported)
- `../base/ws/Cache.js` (imported)
- `../base/ws/Client.js` (imported)
- `../base/types.js` (imported)
- `https://exchange.blockchain.com` (referenced)
- `../base/errors.js` (referenced)
- `../blockchaincom.js` (referenced)
...
```bash
ts-node ts/src/pro/blockchaincom.ts
```
