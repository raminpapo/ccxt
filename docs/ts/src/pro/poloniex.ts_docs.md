# Documentation: ts/src/pro/poloniex.ts

## File Metadata

- **Path**: `ts/src/pro/poloniex.ts`
- **Size**: 58,080 bytes
- **Lines**: 1,343
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/poloniex.ts`.
...
```bash
ts-node ts/src/pro/poloniex.ts
```
