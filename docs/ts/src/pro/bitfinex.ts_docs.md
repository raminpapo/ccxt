# Documentation: ts/src/pro/bitfinex.ts

## File Metadata

- **Path**: `ts/src/pro/bitfinex.ts`
- **Size**: 53,654 bytes
- **Lines**: 1,327
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/bitfinex.ts`.

**Classes defined**: bitfinex
...
```bash
ts-node ts/src/pro/bitfinex.ts
```
