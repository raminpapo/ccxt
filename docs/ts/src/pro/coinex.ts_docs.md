# Documentation: ts/src/pro/coinex.ts

## File Metadata

- **Path**: `ts/src/pro/coinex.ts`
- **Size**: 60,860 bytes
- **Lines**: 1,446
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/coinex.ts`.
