# Documentation: ts/src/pro/coincheck.ts

## File Metadata

- **Path**: `ts/src/pro/coincheck.ts`
- **Size**: 8,392 bytes
- **Lines**: 215
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/coincheck.ts`.
...
```bash
ts-node ts/src/pro/coincheck.ts
```
