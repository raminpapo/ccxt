# Documentation: ts/src/pro/kucoinfutures.ts

## File Metadata

- **Path**: `ts/src/pro/kucoinfutures.ts`
- **Size**: 60,805 bytes
- **Lines**: 1,338
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/kucoinfutures.ts`.
...
```bash
ts-node ts/src/pro/kucoinfutures.ts
```
