# Documentation: ts/src/pro/xt.ts

## File Metadata

- **Path**: `ts/src/pro/xt.ts`
- **Size**: 68,217 bytes
- **Lines**: 1,472
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/xt.ts`.

**Classes defined**: xt, method
