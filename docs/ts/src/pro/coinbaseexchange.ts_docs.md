# Documentation: ts/src/pro/coinbaseexchange.ts

## File Metadata

- **Path**: `ts/src/pro/coinbaseexchange.ts`
- **Size**: 42,601 bytes
- **Lines**: 989
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/coinbaseexchange.ts`.

**Classes defined**: coinbaseexchange
...
- `wss://ws-feed-public.sandbox.exchange.coinbase.com` (referenced)
- `wss://ws-feed.exchange.coinbase.com` (referenced)
- `../coinbaseexchange.js` (referenced)
...
```bash
ts-node ts/src/pro/coinbaseexchange.ts
```
