# Documentation: ts/src/pro/bitget.ts

## File Metadata

- **Path**: `ts/src/pro/bitget.ts`
- **Size**: 127,658 bytes
- **Lines**: 2,907
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/bitget.ts`.
