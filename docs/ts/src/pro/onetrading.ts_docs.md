# Documentation: ts/src/pro/onetrading.ts

## File Metadata

- **Path**: `ts/src/pro/onetrading.ts`
- **Size**: 58,171 bytes
- **Lines**: 1,368
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/onetrading.ts`.
...
```bash
ts-node ts/src/pro/onetrading.ts
```
