# Documentation: ts/src/pro/bitrue.ts

## File Metadata

- **Path**: `ts/src/pro/bitrue.ts`
- **Size**: 17,299 bytes
- **Lines**: 473
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/bitrue.ts`.
...
- `wss://wsapi.bitrue.com` (referenced)
- `../bitrue.js` (referenced)
- `https://open.bitrue.com` (referenced)
