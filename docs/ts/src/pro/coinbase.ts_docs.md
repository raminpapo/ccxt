# Documentation: ts/src/pro/coinbase.ts

## File Metadata

- **Path**: `ts/src/pro/coinbase.ts`
- **Size**: 44,190 bytes
- **Lines**: 988
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/coinbase.ts`.
...
- `wss://advanced-trade-ws.coinbase.com` (referenced)
...
```bash
ts-node ts/src/pro/coinbase.ts
```
