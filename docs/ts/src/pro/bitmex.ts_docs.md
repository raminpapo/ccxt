# Documentation: ts/src/pro/bitmex.ts

## File Metadata

- **Path**: `ts/src/pro/bitmex.ts`
- **Size**: 79,657 bytes
- **Lines**: 1,780
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/bitmex.ts`.
