# Documentation: ts/src/pro/probit.ts

## File Metadata

- **Path**: `ts/src/pro/probit.ts`
- **Size**: 25,165 bytes
- **Lines**: 614
- **Type**: TypeScript
- **Extension**: .ts
...
export default class probit extends probitRest {
    ...
    async subscribePublic (methodName: string, symbol: string, dataType, filter, params = {}) {
        await this.loadMarkets ();
...
This is a TypeScript file located at `ts/src/pro/probit.ts`.
