# Documentation: ts/src/pro/gemini.ts

## File Metadata

- **Path**: `ts/src/pro/gemini.ts`
- **Size**: 40,227 bytes
- **Lines**: 953
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/gemini.ts`.
...
- `../gemini.js` (referenced)
- `../base/errors.js` (referenced)
- `wss://api.gemini.com` (referenced)
- `../base/Precise.js` (referenced)
- `wss://api.sandbox.gemini.com` (referenced)
