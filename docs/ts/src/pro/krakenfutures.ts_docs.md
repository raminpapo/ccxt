# Documentation: ts/src/pro/krakenfutures.ts

## File Metadata

- **Path**: `ts/src/pro/krakenfutures.ts`
- **Size**: 68,858 bytes
- **Lines**: 1,617
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/krakenfutures.ts`.
...
```bash
ts-node ts/src/pro/krakenfutures.ts
```
