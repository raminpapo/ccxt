# Documentation: ts/src/pro/cryptocom.ts

## File Metadata

- **Path**: `ts/src/pro/cryptocom.ts`
- **Size**: 66,997 bytes
- **Lines**: 1,463
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/cryptocom.ts`.
...
```bash
ts-node ts/src/pro/cryptocom.ts
```
