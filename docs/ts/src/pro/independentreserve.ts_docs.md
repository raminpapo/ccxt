# Documentation: ts/src/pro/independentreserve.ts

## File Metadata

- **Path**: `ts/src/pro/independentreserve.ts`
- **Size**: 12,261 bytes
- **Lines**: 300
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/independentreserve.ts`.
...
- `wss://websockets.independentreserve.com` (referenced)
...
```bash
ts-node ts/src/pro/independentreserve.ts
```
