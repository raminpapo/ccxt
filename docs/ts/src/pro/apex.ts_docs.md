# Documentation: ts/src/pro/apex.ts

## File Metadata

- **Path**: `ts/src/pro/apex.ts`
- **Size**: 46,776 bytes
- **Lines**: 1,094
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/apex.ts`.
...
- `https://omni.apex.exchange/assets/logo_content-CY9uyFbz.svg` (referenced)
- `../apex.js` (referenced)
