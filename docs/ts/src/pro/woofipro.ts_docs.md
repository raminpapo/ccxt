# Documentation: ts/src/pro/woofipro.ts

## File Metadata

- **Path**: `ts/src/pro/woofipro.ts`
- **Size**: 56,117 bytes
- **Lines**: 1,368
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/woofipro.ts`.
...
```bash
ts-node ts/src/pro/woofipro.ts
```
