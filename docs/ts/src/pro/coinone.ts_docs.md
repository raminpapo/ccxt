# Documentation: ts/src/pro/coinone.ts

## File Metadata

- **Path**: `ts/src/pro/coinone.ts`
- **Size**: 16,804 bytes
- **Lines**: 426
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/coinone.ts`.
...
- `wss://stream.coinone.co.kr` (referenced)
