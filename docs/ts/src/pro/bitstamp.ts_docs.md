# Documentation: ts/src/pro/bitstamp.ts

## File Metadata

- **Path**: `ts/src/pro/bitstamp.ts`
- **Size**: 24,058 bytes
- **Lines**: 599
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/bitstamp.ts`.
...
- `wss://ws.bitstamp.net` (referenced)
...
```bash
ts-node ts/src/pro/bitstamp.ts
```
