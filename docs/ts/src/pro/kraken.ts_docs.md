# Documentation: ts/src/pro/kraken.ts

## File Metadata

- **Path**: `ts/src/pro/kraken.ts`
- **Size**: 74,564 bytes
- **Lines**: 1,635
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/kraken.ts`.
...
- `../kraken.js` (referenced)
- `wss://beta-ws.kraken.com` (referenced)
- `wss://beta-ws-auth.kraken.com` (referenced)
- `../base/errors.js` (referenced)
- `../base/Precise.js` (referenced)
- `wss://ws.kraken.com` (referenced)
- `wss://ws-auth.kraken.com` (referenced)
