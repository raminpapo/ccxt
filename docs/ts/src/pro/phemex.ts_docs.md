# Documentation: ts/src/pro/phemex.ts

## File Metadata

- **Path**: `ts/src/pro/phemex.ts`
- **Size**: 68,087 bytes
- **Lines**: 1,593
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/phemex.ts`.
