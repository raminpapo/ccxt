# Documentation: ts/src/pro/coinbaseinternational.ts

## File Metadata

- **Path**: `ts/src/pro/coinbaseinternational.ts`
- **Size**: 34,691 bytes
- **Lines**: 826
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/coinbaseinternational.ts`.

**Classes defined**: coinbaseinternational
...
- `../coinbaseinternational.js` (imported)
- `../base/ws/Cache.js` (imported)
- `../base/ws/Client.js` (imported)
- `../base/types.js` (imported)
- `../static_dependencies/noble-hashes/sha256.js` (imported)
- `../base/errors.js` (referenced)
- `../coinbaseinternational.js` (referenced)
- `wss://ws-md.n5e2.coinbase.com` (referenced)
- `wss://ws-md.international.coinbase.com` (referenced)
- `../base/ws/Cache.js` (referenced)
...
```bash
ts-node ts/src/pro/coinbaseinternational.ts
```
