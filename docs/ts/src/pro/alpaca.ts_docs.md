# Documentation: ts/src/pro/alpaca.ts

## File Metadata

- **Path**: `ts/src/pro/alpaca.ts`
- **Size**: 30,345 bytes
- **Lines**: 766
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/pro/alpaca.ts`.
