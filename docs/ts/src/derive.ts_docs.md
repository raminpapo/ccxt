# Documentation: ts/src/derive.ts

## File Metadata

- **Path**: `ts/src/derive.ts`
- **Size**: 129,595 bytes
- **Lines**: 2,691
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/derive.ts`.

**Classes defined**: derive

**Functions defined**: param, name, params
