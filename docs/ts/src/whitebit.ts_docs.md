# Documentation: ts/src/whitebit.ts

## File Metadata

- **Path**: `ts/src/whitebit.ts`
- **Size**: 190,268 bytes
- **Lines**: 4,025
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/whitebit.ts`.

**Classes defined**: whitebit
...
- `./abstract/whitebit.js` (imported)
- `./base/types.js` (imported)
- `./static_dependencies/noble-hashes/sha512.js` (imported)
- `./base/functions/number.js` (imported)
- `./base/errors.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/66732963-8eb7dd00-ee66-11e9-849b-10d9282bb9e0.jpg` (referenced)
- `./base/Precise.js` (referenced)
- `./abstract/whitebit.js` (referenced)
- `./base/types.js` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://someaddress.com` (referenced)
- `https://www.whitebit.com` (referenced)
