# Documentation: ts/src/wavesexchange.ts

## File Metadata

- **Path**: `ts/src/wavesexchange.ts`
- **Size**: 129,848 bytes
- **Lines**: 2,800
- **Type**: TypeScript
- **Extension**: .ts
    ...
    async createOrder (symbol: string, type: OrderType, side: OrderSide, amount: number, price: Num = undefined, params = {}) {
        ...
        if (matcherFeeAssetId === undefined) {
            ...
            if ((baseFeeAsset in balances) && (balances[baseFeeAsset]['free'] as any >= parseFloat (floatBaseMatcherFee))) {
                ...
                if ((discountFeeAsset in balances) && (balances[discountFeeAsset]['free'] as any >= parseFloat (floatDiscountMatcherFee))) {
...
This is a TypeScript file located at `ts/src/wavesexchange.ts`.

**Classes defined**: wavesexchange
...
- `./abstract/wavesexchange.js` (imported)
- `./base/types.js` (imported)
- `./base/functions/number.js` (imported)
- `./static_dependencies/noble-curves/ed25519.js` (imported)
- `./base/errors.js` (referenced)
- `https://nodes-testnet.wavesnodes.com` (referenced)
- `https://docs.waves.tech` (referenced)
- `./base/Precise.js` (referenced)
- `./abstract/wavesexchange.js` (referenced)
- `./base/types.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/84547058-5fb27d80-ad0b-11ea-8711-78ac8b3c7f31.jpg` (referenced)
- `https://nodes.wavesnodes.com/api-docs/index.html` (referenced)
...
```bash
ts-node ts/src/wavesexchange.ts
```
