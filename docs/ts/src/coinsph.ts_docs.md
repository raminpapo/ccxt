# Documentation: ts/src/coinsph.ts

## File Metadata

- **Path**: `ts/src/coinsph.ts`
- **Size**: 106,809 bytes
- **Lines**: 2,224
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coinsph.ts`.

**Classes defined**: coinsph
...
- `-1007` (imported)
- `./abstract/coinsph.js` (imported)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `./base/errors.js` (referenced)
- `https://api.pro.coins.ph` (referenced)
- `https://user-images.githubusercontent.com/1294454/225719995-48ab2026-4ddb-496c-9da7-0d7566617c9b.jpg` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/number.js` (referenced)
- `./abstract/coinsph.js` (referenced)
