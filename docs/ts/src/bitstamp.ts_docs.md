# Documentation: ts/src/bitstamp.ts

## File Metadata

- **Path**: `ts/src/bitstamp.ts`
- **Size**: 104,455 bytes
- **Lines**: 2,464
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitstamp.ts`.
...
- `./abstract/bitstamp.js` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `https://www.bitstamp.net` (referenced)
