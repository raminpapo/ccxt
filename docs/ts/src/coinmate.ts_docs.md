# Documentation: ts/src/coinmate.ts

## File Metadata

- **Path**: `ts/src/coinmate.ts`
- **Size**: 53,665 bytes
- **Lines**: 1,238
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coinmate.ts`.

**Classes defined**: coinmate
...
- `./abstract/coinmate.js` (referenced)
- `https://coinmate.docs.apiary.io` (referenced)
...
- `https://coinmate.io` (referenced)
- `https://user-images.githubusercontent.com/51840849/87460806-1c9f3f00-c616-11ea-8c46-a77018a8f3f4.jpg` (referenced)
