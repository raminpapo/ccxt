# Documentation: ts/src/coinmetro.ts

## File Metadata

- **Path**: `ts/src/coinmetro.ts`
- **Size**: 91,000 bytes
- **Lines**: 2,053
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coinmetro.ts`.

**Classes defined**: coinmetro
...
- `./abstract/coinmetro.js` (imported)
- `./base/Precise.js` (imported)
- `./base/types.js` (imported)
- `./base/functions/number.js` (imported)
- `status` (imported)
- `./base/errors.js` (referenced)
- `./abstract/coinmetro.js` (referenced)
- `https://api.coinmetro.com` (referenced)
