# Documentation: ts/src/protobuf/mexc/compiled.cjs

## File Metadata

- **Path**: `ts/src/protobuf/mexc/compiled.cjs`
- **Size**: 320,164 bytes
- **Lines**: 7,620
- **Type**: Unknown
- **Extension**: .cjs
...
This is a Unknown file located at `ts/src/protobuf/mexc/compiled.cjs`.

**Functions defined**: encode, decodeDelimited, decode, encodeDelimited, create, PrivateAccountV3Api
