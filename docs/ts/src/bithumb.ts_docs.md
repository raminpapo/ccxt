# Documentation: ts/src/bithumb.ts

## File Metadata

- **Path**: `ts/src/bithumb.ts`
- **Size**: 55,528 bytes
- **Lines**: 1,286
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bithumb.ts`.

**Classes defined**: bithumb
