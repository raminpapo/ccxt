# Documentation: ts/src/coincatch.ts

## File Metadata

- **Path**: `ts/src/coincatch.ts`
- **Size**: 262,961 bytes
- **Lines**: 5,496
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coincatch.ts`.

**Classes defined**: coincatch
...
- `./abstract/coincatch.js` (imported)
...
- `./abstract/coincatch.js` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://api.coincatch.com` (referenced)
