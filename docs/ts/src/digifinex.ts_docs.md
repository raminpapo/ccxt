# Documentation: ts/src/digifinex.ts

## File Metadata

- **Path**: `ts/src/digifinex.ts`
- **Size**: 189,066 bytes
- **Lines**: 4,439
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/digifinex.ts`.

**Classes defined**: digifinex
...
- `./abstract/digifinex.js` (imported)
- `./base/functions/number.js` (imported)
- `https://openapi.digifinex.com` (referenced)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `./base/errors.js` (referenced)
- `./base/Precise.js` (referenced)
- `https://www.digifinex.com` (referenced)
- `./base/types.js` (referenced)
- `https://docs.digifinex.com` (referenced)
- `./abstract/digifinex.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://user-images.githubusercontent.com/51840849/87443315-01283a00-c5fe-11ea-8628-c2a0feaf07ac.jpg` (referenced)
