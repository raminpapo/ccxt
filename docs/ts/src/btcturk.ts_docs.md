# Documentation: ts/src/btcturk.ts

## File Metadata

- **Path**: `ts/src/btcturk.ts`
- **Size**: 44,048 bytes
- **Lines**: 1,078
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/btcturk.ts`.
...
- `./abstract/btcturk.js` (referenced)
- `./base/types.js` (referenced)
- `https://www.btcturk.com` (referenced)
