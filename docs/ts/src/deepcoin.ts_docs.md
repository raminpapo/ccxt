# Documentation: ts/src/deepcoin.ts

## File Metadata

- **Path**: `ts/src/deepcoin.ts`
- **Size**: 139,627 bytes
- **Lines**: 3,063
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/deepcoin.ts`.

**Classes defined**: deepcoin
