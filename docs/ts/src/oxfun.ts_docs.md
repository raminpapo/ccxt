# Documentation: ts/src/oxfun.ts

## File Metadata

- **Path**: `ts/src/oxfun.ts`
- **Size**: 132,714 bytes
- **Lines**: 2,978
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/oxfun.ts`.
