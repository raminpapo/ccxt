# Documentation: ts/src/independentreserve.ts

## File Metadata

- **Path**: `ts/src/independentreserve.ts`
- **Size**: 48,470 bytes
- **Lines**: 1,132
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/independentreserve.ts`.
...
- `./abstract/independentreserve.js` (imported)
...
- `./abstract/independentreserve.js` (referenced)
...
- `https://www.independentreserve.com` (referenced)
- `https://user-images.githubusercontent.com/51840849/87182090-1e9e9080-c2ec-11ea-8e49-563db9a38f37.jpg` (referenced)
...
```bash
ts-node ts/src/independentreserve.ts
```
