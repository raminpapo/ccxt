# Documentation: ts/src/test/base/test.precise.ts

## File Metadata

- **Path**: `ts/src/test/base/test.precise.ts`
- **Size**: 5,540 bytes
- **Lines**: 126
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/base/test.precise.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/base/test.precise.ts
```
