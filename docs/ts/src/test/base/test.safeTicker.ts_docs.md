# Documentation: ts/src/test/base/test.safeTicker.ts

## File Metadata

- **Path**: `ts/src/test/base/test.safeTicker.ts`
- **Size**: 5,238 bytes
- **Lines**: 143
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/base/test.safeTicker.ts`.

**Functions defined**: preciseEqualStr, testSafeTicker
...
**To run this test:**
```bash
npm test ts/src/test/base/test.safeTicker.ts
```
