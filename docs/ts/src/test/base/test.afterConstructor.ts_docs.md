# Documentation: ts/src/test/base/test.afterConstructor.ts

## File Metadata

- **Path**: `ts/src/test/base/test.afterConstructor.ts`
- **Size**: 3,738 bytes
- **Lines**: 107
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/base/test.afterConstructor.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/base/test.afterConstructor.ts
```
