# Documentation: ts/src/test/base/test.safeMethods.ts

## File Metadata

- **Path**: `ts/src/test/base/test.safeMethods.ts`
- **Size**: 15,118 bytes
- **Lines**: 321
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/base/test.safeMethods.ts`.

**Functions defined**: equals, testSafeMethods
...
**To run this test:**
```bash
npm test ts/src/test/base/test.safeMethods.ts
```
