# Documentation: ts/src/test/base/test.decimalToPrecision.ts

## File Metadata

- **Path**: `ts/src/test/base/test.decimalToPrecision.ts`
- **Size**: 27,114 bytes
- **Lines**: 402
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/base/test.decimalToPrecision.ts`.

**Functions defined**: testDecimalToPrecision
...
**To run this test:**
```bash
npm test ts/src/test/base/test.decimalToPrecision.ts
```
