# Documentation: ts/src/test/base/test.datetime.ts

## File Metadata

- **Path**: `ts/src/test/base/test.datetime.ts`
- **Size**: 5,934 bytes
- **Lines**: 102
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/base/test.datetime.ts`.

**Functions defined**: testDatetime
...
**To run this test:**
```bash
npm test ts/src/test/base/test.datetime.ts
```
