# Documentation: ts/src/test/base/language_specific/test.camelcase.ts

## File Metadata

- **Path**: `ts/src/test/base/language_specific/test.camelcase.ts`
- **Size**: 6,094 bytes
- **Lines**: 60
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/base/language_specific/test.camelcase.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/base/language_specific/test.camelcase.ts
```
