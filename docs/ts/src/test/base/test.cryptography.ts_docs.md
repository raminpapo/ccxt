# Documentation: ts/src/test/base/test.cryptography.ts

## File Metadata

- **Path**: `ts/src/test/base/test.cryptography.ts`
- **Size**: 8,460 bytes
- **Lines**: 127
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/base/test.cryptography.ts`.

**Functions defined**: equals, testCryptography
...
- `../../static_dependencies/noble-curves/secp256k1.js` (imported)
- `../../base/functions/encode.js` (imported)
...
- `../../static_dependencies/noble-curves/secp256k1.js` (referenced)
- `../../base/functions/encode.js` (referenced)
...
**To run this test:**
```bash
npm test ts/src/test/base/test.cryptography.ts
```
