# Documentation: ts/src/test/base/errors/test.InvalidNonce.ts

## File Metadata

- **Path**: `ts/src/test/base/errors/test.InvalidNonce.ts`
- **Size**: 2,014 bytes
- **Lines**: 47
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/base/errors/test.InvalidNonce.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/base/errors/test.InvalidNonce.ts
```
