# Documentation: ts/src/test/static/request/delta.json

## File Metadata

- **Path**: `ts/src/test/static/request/delta.json`
- **Size**: 8,930 bytes
- **Lines**: 272
- **Type**: JSON
- **Extension**: .json
        ...
        "fetchOrder": [
            {
                ...
                "method": "fetchOrder",
                "url": "https://api.delta.exchange/v2/orders/123",
                "input": [
                    "123",
                    "BTC/USDT"
                ]
            ...
            {
                "description": "Fetch Order by clientOrderId",
                "method": "fetchOrder",
                "url": "https://api.delta.exchange/v2/orders/client_order_id/123",
                "input": [
                    "123",
                    "BTC/USDT",
                    {
...
This is a JSON file located at `ts/src/test/static/request/delta.json`.
