# Documentation: ts/src/test/static/request/bybit.json

## File Metadata

- **Path**: `ts/src/test/static/request/bybit.json`
- **Size**: 73,430 bytes
- **Lines**: 1,837
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        ...
        "createOrder": [
            ...
            {
                "description": "Swap market sell with stopLossPrice(Type2) and tpslMode full",
                "method": "createOrder",
                "url": "https://api-testnet.bybit.com/v5/position/trading-stop",
                "input": [
                  "ETH/USDT:USDT",
                ...
                "output": "{\"symbol\":\"ETHUSDT\",\"stopLoss\":\"3999\",\"tpslMode\":\"Full\",\"category\":\"linear\"}"
            },
            {
                "description": "Swap market sell with takeProfitPrice(Type2) and tpslMode full",
                "method": "createOrder",
                "url": "https://api-testnet.bybit.com/v5/position/trading-stop",
                "input": [
                  "ETH/USDT:USDT",
                ...
                "output": "{\"symbol\":\"ETHUSDT\",\"takeProfit\":\"4000\",\"tpslMode\":\"Full\",\"category\":\"linear\"}"
            },
            {
                "description": "Swap market sell with stopLossPrice(Type2) and tpslMode partial",
                "method": "createOrder",
                "url": "https://api-testnet.bybit.com/v5/position/trading-stop",
                "input": [
                  "LTC/USDT:USDT",
                ...
                "output": "{\"symbol\":\"LTCUSDT\",\"stopLoss\":\"3.9\",\"tpslMode\":\"Partial\",\"slSize\":\"1\",\"category\":\"linear\"}"
            },
            {
                "description": "Swap market sell with takeProfitPrice(Type2) and tpslMode partial",
                "method": "createOrder",
                "url": "https://api-testnet.bybit.com/v5/position/trading-stop",
                "input": [
                  "LTC/USDT:USDT",
                ...
                "output": "{\"symbol\":\"LTCUSDT\",\"takeProfit\":\"2.2\",\"tpslMode\":\"Partial\",\"tpSize\":\"1\",\"category\":\"linear\"}"
            },
            {
        ...
        "editOrders": [
            {
                "description": "Spot edit orders",
                "method": "editOrders",
                "url": "https://api-testnet.bybit.com/v5/order/amend-batch",
                "input": [
                    [
                        {
                            "id":"2e472521-031f-40f5-a8cb-bc3efb86ce0f",
                            "symbol": "LTC/USDT",
                            "amount": 0.1,
                            "side": "buy",
                            "type": "limit",
                        ...
                        {
                            "id":"3e472521-031f-40f5-a8cb-bc3efb86ce0f",
                            "symbol": "LTC/USDT",
                            "amount": 0.11,
                            "side": "sell",
                            "type": "limit",
        ...
        "fetchPositions": [
            {
                ...
                "url": "https://api-testnet.bybit.com/v5/position/list?settleCoin=USDT&category=linear&limit=200",
                "input": []
            }
        ],
        "fetchPosition": [
        ...
        "fetchBalance": [
            ...
            {
                "description": "inverse balance should use unified when account is > UTA 1.0",
                "method": "fetchBalance",
                "options": {
        ...
        "fetchLedger": [
            {
                "description": "fetchLedger using uta 1.0",
                "options": {
            ...
            {
                "description": "fetchLedger (inverse) using uta 2.0",
                "method": "fetchLedger",
        ...
        "fetchTickers": [
            {
                "description": "fetch options tickers",
                "method": "fetchTickers",
            ...
            {
                "description": "Fetch option tickers with the code parameter set to BTC",
                "method": "fetchTickers",
                "url": "https://api.bybit.com/v5/market/tickers?category=option&baseCoin=BTC&code=BTC",
                "input": [
                  null,
                  {
                    "type": "option",
            ...
            {
                "description": "Fetch option tickers with the code parameter set to SOL",
                "method": "fetchTickers",
                "url": "https://api.bybit.com/v5/market/tickers?category=option&baseCoin=SOL&code=SOL",
                "input": [
                  null,
                  {
                    "type": "option",
            ...
            {
                "description": "Fetch tickers for a BTC option",
                "method": "fetchTickers",
                "url": "https://api.bybit.com/v5/market/tickers?category=option&baseCoin=BTC",
                "input": [
                  [
            ...
            {
                "description": "Fetch tickers for an ETH option",
                "method": "fetchTickers",
                "url": "https://api.bybit.com/v5/market/tickers?category=option&baseCoin=ETH",
                "input": [
                  [
                    "ETH/USDT:USDT-250530-1700-P"
                  ]
                ]
            },
            {
                "description": "Fetch tickers for a SOL option",
                "method": "fetchTickers",
                "url": "https://api.bybit.com/v5/market/tickers?category=option&baseCoin=SOL",
                "input": [
                  [
                    "SOL/USDT:USDT-250530-90-P"
                  ]
                ]
            },
            {
            ...
            {
                "description": "Fetch tickers of multiple spot symbols",
                "method": "fetchTickers",
                "url": "https://api.bybit.com/v5/market/tickers?category=spot",
                "input": [
                  [
            ...
            {
                "description": "Fetch tickers of multiple linear swap symbols",
                "method": "fetchTickers",
                "url": "https://api.bybit.com/v5/market/tickers?category=linear",
                "input": [
                  [
        ...
        "withdraw": [
            {
                "description": "withdraw  using UTA account",
                "method": "withdraw",
                "url": "https://api.bybit.com/v5/asset/withdraw/create",
                "input": [
                    "USDT",
                    4.34,
                    "TCb3SXELLBn81JWPNhTbGBEoXHtCX62eU6",
                    null,
                    {
                        "network": "TRC20"
                    }
            ...
            },
            {
                ...
                "input": [
                  "USDT",
                  10,
                  "TFC#SYyBLBnF1JWPAhTbGBEoXHtDX6rYT6",
                  null,
                  {
                    "network": "TRC20"
                  }
        ...
        "fetchOpenInterest": [
            {
                "description": "linear swap fetchOpenInterest",
                "method": "fetchOpenInterest",
                "url": "https://api-testnet.bybit.com/v5/market/open-interest?symbol=BTCUSDT&intervalTime=1h&category=linear",
                "input": [
                  "BTC/USDT:USDT"
                ]
            },
            {
                "description": "inverse swap fetchOpenInterest",
                "method": "fetchOpenInterest",
                "url": "https://api-testnet.bybit.com/v5/market/open-interest?symbol=BTCUSD&intervalTime=1h&category=inverse",
                "input": [
                  "BTC/USD:BTC"
                ]
            }
        ...
        "fetchAllGreeks": [
            {
                ...
                "url": "https://api-testnet.bybit.com/v5/market/tickers?category=option&baseCoin=BTC&symbol=BTC-30MAY25-70000-C-USDT",
                "input": [
                    [
                        "BTC/USDT:USDT-250530-70000-C"
                    ],
...
This is a JSON file located at `ts/src/test/static/request/bybit.json`.
