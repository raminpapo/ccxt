# Documentation: ts/src/test/static/request/cryptocom.json

## File Metadata

- **Path**: `ts/src/test/static/request/cryptocom.json`
- **Size**: 17,963 bytes
- **Lines**: 360
- **Type**: JSON
- **Extension**: .json
        ...
        "fetchFundingRate": [
            {
                ...
                "url": "https://api.crypto.com/exchange/v1/public/get-valuations?instrument_name=BTCUSD-PERP&valuation_type=estimated_funding_rate&count=1",
                "input": [
                    "BTC/USD:USD"
                ],
                "output": null
        ...
        "fetchOrderBook": [
            {
                ...
                "url": "https://api.crypto.com/exchange/v1/public/get-book?instrument_name=BTC_USDT&depth=50",
                "input": [
                    "BTC/USDT",
                    150
                ],
            ...
            },
            {
                ...
                "method": "fetchOrderBook",
                "url": "https://api.crypto.com/exchange/v1/public/get-book?instrument_name=BTC_USDT&depth=40",
                "input": [
                    "BTC/USDT",
                    40
                ],
...
This is a JSON file located at `ts/src/test/static/request/cryptocom.json`.
