# Documentation: ts/src/test/static/request/paradex.json

## File Metadata

- **Path**: `ts/src/test/static/request/paradex.json`
- **Size**: 18,886 bytes
- **Lines**: 438
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/paradex.json`.
