# Documentation: ts/src/test/static/request/probit.json

## File Metadata

- **Path**: `ts/src/test/static/request/probit.json`
- **Size**: 11,008 bytes
- **Lines**: 277
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/probit.json`.
