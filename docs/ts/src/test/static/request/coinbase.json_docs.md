# Documentation: ts/src/test/static/request/coinbase.json

## File Metadata

- **Path**: `ts/src/test/static/request/coinbase.json`
- **Size**: 25,072 bytes
- **Lines**: 643
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/coinbase.json`.
