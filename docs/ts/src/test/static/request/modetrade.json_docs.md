# Documentation: ts/src/test/static/request/modetrade.json

## File Metadata

- **Path**: `ts/src/test/static/request/modetrade.json`
- **Size**: 20,511 bytes
- **Lines**: 567
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/modetrade.json`.
