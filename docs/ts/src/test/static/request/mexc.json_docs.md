# Documentation: ts/src/test/static/request/mexc.json

## File Metadata

- **Path**: `ts/src/test/static/request/mexc.json`
- **Size**: 33,825 bytes
- **Lines**: 858
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        "transfer": [
            {
                ...
                "method": "transfer",
                "url": "https://api.mexc.com/api/v3/capital/transfer?asset=USDT&amount=1&fromAccountType=FUTURES&toAccountType=SPOT&timestamp=1759328309546&recvWindow=5000&signature=c46acee7a5dfdc9bb370eaa01de579597cfcece73c9e52e0d11fe2b6b2342305",
                "input": [
                    "USDT",
                    1,
                    "swap",
            ...
            },
            {
                ...
                "method": "transfer",
                "url": "https://api.mexc.com/api/v3/capital/transfer?asset=USDT&amount=1&fromAccountType=SPOT&toAccountType=FUTURES&timestamp=1759328120276&recvWindow=5000&signature=dfad4e88d4960b6573e3104e7fd5099ad9ef9283f228745c9177a00d37b471fe",
                "input": [
                    "USDT",
                    1,
                    "spot",
        ...
        "fetchTransfers": [
            {
                "description": "fetch futures - spot transfers",
                "method": "fetchTransfers",
                "url": "https://api.mexc.com/api/v3/capital/transfer?fromAccountType=FUTURES&toAccountType=SPOT&timestamp=1759327539901&recvWindow=5000&signature=12fec501599abd41bfcfa71dea40330e97b80a01d9a3d7e56876885c718ff43c",
                "input": [
                    null,
                    null,
                    null,
        ...
        "withdraw": [
            {
                ...
                "method": "withdraw",
                "url": "https://api.mexc.com/api/v3/capital/transfer/internal?asset=USDT&amount=0.1&toAccount=to_someone%40gmail.com&toAccountType=EMAIL&timestamp=1756409115448&recvWindow=5000&signature=4a16eb036f895b590d5a69ffa3e1d81015d9bf87a057f7361796f3e3853ec073",
                "input": [
                    "USDT",
                    0.1,
...
This is a JSON file located at `ts/src/test/static/request/mexc.json`.
