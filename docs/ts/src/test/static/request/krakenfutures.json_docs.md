# Documentation: ts/src/test/static/request/krakenfutures.json

## File Metadata

- **Path**: `ts/src/test/static/request/krakenfutures.json`
- **Size**: 11,999 bytes
- **Lines**: 328
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/krakenfutures.json`.
