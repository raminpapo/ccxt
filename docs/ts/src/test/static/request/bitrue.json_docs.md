# Documentation: ts/src/test/static/request/bitrue.json

## File Metadata

- **Path**: `ts/src/test/static/request/bitrue.json`
- **Size**: 14,026 bytes
- **Lines**: 362
- **Type**: JSON
- **Extension**: .json
        ...
        "fetchTrades": [
            {
                ...
                "method": "fetchTrades",
                "url": "https://www.bitrue.com/api/v1/trades?symbol=BTCUSDT",
                "input": [
                    "BTC/USDT"
                ]
            }
        ...
        "fetchOrderBook": [
            {
                ...
                "url": "https://www.bitrue.com/api/v1/depth?symbol=BTCUSDT",
                "input": [
                    "BTC/USDT"
                ]
            },
            {
                ...
                "method": "fetchOrderBook",
                "url": "https://fapi.bitrue.com/fapi/v1/depth?contractName=E-BTC-USDT",
                "input": [
                    "BTC/USDT:USDT"
                ]
            }
        ...
        "fetchTicker": [
            {
                ...
                "method": "fetchTicker",
                "url": "https://fapi.bitrue.com/fapi/v1/ticker?contractName=E-BTC-USDT",
                "input": [
                    "BTC/USDT:USDT"
                ]
            },
            {
                ...
                "method": "fetchTicker",
                "url": "https://www.bitrue.com/api/v1/ticker/24hr?symbol=BTCUSDT",
                "input": [
                    "BTC/USDT"
                ]
            }
        ...
        "fetchBidsAsks": [
            {
                ...
                "url": "https://www.bitrue.com/api/v1/ticker/bookTicker?symbol=BTCUSDT",
                "input": [
                    [
                        "BTC/USDT",
                        "ETH/USDT"
        ...
        "fetchOHLCV": [
            {
                ...
                "method": "fetchOHLCV",
                "url": "https://www.bitrue.com/api/v1/market/kline?symbol=BTCUSDT&scale=1m",
                "input": [
                    "BTC/USDT"
                ]
            },
            {
                ...
                "method": "fetchOHLCV",
                "url": "https://fapi.bitrue.com/fapi/v1/klines?contractName=E-BTC-USDT&interval=1min",
                "input": [
                    "BTC/USDT:USDT"
                ]
            }
...
This is a JSON file located at `ts/src/test/static/request/bitrue.json`.
