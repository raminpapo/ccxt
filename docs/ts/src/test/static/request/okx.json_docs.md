# Documentation: ts/src/test/static/request/okx.json

## File Metadata

- **Path**: `ts/src/test/static/request/okx.json`
- **Size**: 76,574 bytes
- **Lines**: 1,872
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        ...
        "fetchOpenInterests": [
            ...
            {
                "description": "fetch open interests for swap",
                "method": "fetchOpenInterests",
                "url": "https://www.okx.com/api/v5/public/open-interest?instType=SWAP",
                "input": [],
                "output": null
            ...
            {
                "description": "fetch open interests for future",
                "method": "fetchOpenInterests",
                "url": "https://www.okx.com/api/v5/public/open-interest?instType=FUTURES",
                "input": [
                    null,
                    { "instType": "FUTURES" }
                ],
            ...
            {
                "description": "fetch open interests for option",
                "method": "fetchOpenInterests",
                "url": "https://www.okx.com/api/v5/public/open-interest?instType=OPTION&instFamily=BTC-USD",
                "input": [
                    null,
        ...
        "fetchOHLCV": [
            {
                "description": "market history should use limit=300",
                "method": "fetchOHLCV",
                "url": "https://www.okx.com/api/v5/market/history-candles?instId=BTC-USDT-SWAP&bar=1H&limit=300",
                "input": [
                    "BTC/USDT:USDT",
                    "1h",
                    null,
        ...
        "createOrderWithTakeProfitAndStopLoss": [
            {
                "description": "createOrder with tp+sl using the new api",
        ...
        "transfer": [
            {
                "description": "transfer spot to funding",
                "method": "transfer",
        ...
        "fetchMarkPrice": [
            {
                ...
                "url": "https://www.okx.com/api/v5/public/mark-price?instId=ETH-USDT-SWAP",
                "input": [
                    "ETH/USDT:USDT"
                ]
              }
        ...
        "fetchMarginAdjustmentHistory": [
            ...
            },
            {
                ...
                "disabled": true,
                "method": "fetchMarginAdjustmentHistory",
                "url": "https://www.okx.com/api/v5/account/bills-archive?subType=160&mgnMode=isolated&startTime=1717162769000&limit=3",
                "input": [
                  null,
                  "add",
                  1717162769000,
        ...
        "fetchPositionsHistory": [
            {
                ...
                "url": "https://www.okx.com/api/v5/account/positions-history?limit=100",
                "input": []
            },
            {
                "description": "Fill this with a description of the method call",
                "method": "fetchPositionsHistory",
                "url": "https://www.okx.com/api/v5/account/positions-history?limit=1&instId=XRP-USDT-SWAP",
                "input": [
                  [
                    "XRP/USDT:USDT"
                  ],
        ...
        "fetchLongShortRatioHistory": [
            {
                ...
                "url": "https://www.okx.com/api/v5/rubik/stat/contracts/long-short-account-ratio-contract?instId=BTC-USDT-SWAP",
                "input": [
                  "BTC/USDT:USDT"
                ]
            }
        ...
        "fetchAllGreeks": [
            {
                "description": "fetchAllGreeks with one symbol and a uly parameter",
                "method": "fetchAllGreeks",
                "url": "https://www.okx.com/api/v5/public/opt-summary?uly=BTC-USD&instFamily=BTC-USD&expTime=241227",
                "input": [
                    [
                        "BTC/USD:BTC-241227-60000-P"
                    ],
...
This is a JSON file located at `ts/src/test/static/request/okx.json`.
