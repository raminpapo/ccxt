# Documentation: ts/src/test/static/request/bitfinex.json

## File Metadata

- **Path**: `ts/src/test/static/request/bitfinex.json`
- **Size**: 33,073 bytes
- **Lines**: 896
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/bitfinex.json`.
