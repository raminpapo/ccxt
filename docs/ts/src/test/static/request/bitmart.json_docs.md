# Documentation: ts/src/test/static/request/bitmart.json

## File Metadata

- **Path**: `ts/src/test/static/request/bitmart.json`
- **Size**: 35,666 bytes
- **Lines**: 939
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/bitmart.json`.
