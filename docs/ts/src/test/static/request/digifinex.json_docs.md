# Documentation: ts/src/test/static/request/digifinex.json

## File Metadata

- **Path**: `ts/src/test/static/request/digifinex.json`
- **Size**: 30,455 bytes
- **Lines**: 835
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/digifinex.json`.
