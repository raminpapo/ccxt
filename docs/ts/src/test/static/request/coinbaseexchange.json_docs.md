# Documentation: ts/src/test/static/request/coinbaseexchange.json

## File Metadata

- **Path**: `ts/src/test/static/request/coinbaseexchange.json`
- **Size**: 7,944 bytes
- **Lines**: 238
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/coinbaseexchange.json`.
