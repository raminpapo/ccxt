# Documentation: ts/src/test/static/request/woofipro.json

## File Metadata

- **Path**: `ts/src/test/static/request/woofipro.json`
- **Size**: 20,549 bytes
- **Lines**: 569
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        ...
        "fetchCurrencies": [
            {
                "disabled": true,
                "disableReason": "multi request method",
...
This is a JSON file located at `ts/src/test/static/request/woofipro.json`.
