# Documentation: ts/src/test/static/request/upbit.json

## File Metadata

- **Path**: `ts/src/test/static/request/upbit.json`
- **Size**: 21,663 bytes
- **Lines**: 556
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/upbit.json`.
