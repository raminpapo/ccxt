# Documentation: ts/src/test/static/request/foxbit.json

## File Metadata

- **Path**: `ts/src/test/static/request/foxbit.json`
- **Size**: 28,399 bytes
- **Lines**: 753
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/foxbit.json`.
