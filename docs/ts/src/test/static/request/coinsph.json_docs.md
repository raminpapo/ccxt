# Documentation: ts/src/test/static/request/coinsph.json

## File Metadata

- **Path**: `ts/src/test/static/request/coinsph.json`
- **Size**: 12,676 bytes
- **Lines**: 319
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/coinsph.json`.
