# Documentation: ts/src/test/static/request/lbank.json

## File Metadata

- **Path**: `ts/src/test/static/request/lbank.json`
- **Size**: 13,223 bytes
- **Lines**: 309
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/lbank.json`.
...
- `https://api.lbank.info/v2/withdrawConfigs.do` (referenced)
- `https://api.lbank.info/v2/supplement/user_info.do` (referenced)
- `https://api.lbank.info/v2/supplement/create_order.do` (referenced)
