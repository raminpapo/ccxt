# Documentation: ts/src/test/static/request/bitstamp.json

## File Metadata

- **Path**: `ts/src/test/static/request/bitstamp.json`
- **Size**: 8,078 bytes
- **Lines**: 249
- **Type**: JSON
- **Extension**: .json
        ...
        "fetchTransactionFees": [
            {
                ...
                "url": "https://www.bitstamp.net/api/v2/fees/withdrawal/",
                "input": [],
                "output": "foo=bar"
            }
        ],
...
This is a JSON file located at `ts/src/test/static/request/bitstamp.json`.
