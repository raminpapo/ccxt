# Documentation: ts/src/test/static/request/whitebit.json

## File Metadata

- **Path**: `ts/src/test/static/request/whitebit.json`
- **Size**: 21,228 bytes
- **Lines**: 536
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/whitebit.json`.
