# Documentation: ts/src/test/static/request/phemex.json

## File Metadata

- **Path**: `ts/src/test/static/request/phemex.json`
- **Size**: 40,197 bytes
- **Lines**: 969
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        ...
        "fetchMyTrades": [
            {
                "description": "by default uses spot",
                "method": "fetchMyTrades",
                "url": "https://api.phemex.com/exchange/spot/order/trades",
                "input": [],
                "output": null
            },
            {
            ...
            },
            {
                ...
                "method": "fetchMyTrades",
                "url": "https://api.phemex.com/exchange/order/trade?limit=5&symbol=BTCUSD&start=1699457638000&tradeType=Trade",
                "input": [
                    "BTC/USD:BTC",
                    1699457638000,
                    5
    ...
    "fetchPositions": [
            {
                ...
                "url": "https://api.phemex.com/g-accounts/positions?currency=USDT",
                "input": [
                    [
                        "XRP/USDT:USDT"
                    ],
...
This is a JSON file located at `ts/src/test/static/request/phemex.json`.
