# Documentation: ts/src/test/static/request/hollaex.json

## File Metadata

- **Path**: `ts/src/test/static/request/hollaex.json`
- **Size**: 5,930 bytes
- **Lines**: 180
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/hollaex.json`.
