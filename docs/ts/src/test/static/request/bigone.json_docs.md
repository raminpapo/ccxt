# Documentation: ts/src/test/static/request/bigone.json

## File Metadata

- **Path**: `ts/src/test/static/request/bigone.json`
- **Size**: 15,033 bytes
- **Lines**: 441
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/bigone.json`.
