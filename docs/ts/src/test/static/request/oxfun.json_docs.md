# Documentation: ts/src/test/static/request/oxfun.json

## File Metadata

- **Path**: `ts/src/test/static/request/oxfun.json`
- **Size**: 13,905 bytes
- **Lines**: 388
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/oxfun.json`.
