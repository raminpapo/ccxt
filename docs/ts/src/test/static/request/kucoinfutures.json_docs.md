# Documentation: ts/src/test/static/request/kucoinfutures.json

## File Metadata

- **Path**: `ts/src/test/static/request/kucoinfutures.json`
- **Size**: 31,683 bytes
- **Lines**: 846
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        ...
        "fetchTicker": [
            {
                "description": "fetch ticker of a market with expiry",
                "method": "fetchTicker",
                "url": "https://api-futures.kucoin.com/api/v1/ticker?symbol=OMNIUSDTM",
                "input": [
                    "OMNI/USDT:USDT"
                ],
                "output": null
...
This is a JSON file located at `ts/src/test/static/request/kucoinfutures.json`.
