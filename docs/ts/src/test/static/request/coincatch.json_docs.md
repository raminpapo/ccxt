# Documentation: ts/src/test/static/request/coincatch.json

## File Metadata

- **Path**: `ts/src/test/static/request/coincatch.json`
- **Size**: 23,887 bytes
- **Lines**: 610
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        ...
        "createOrder": [
            {
                "description": "Swap market sell for hedged with exchange-specific side",
                "method": "createOrder",
                ...
                "output": "{\"symbol\":\"BTCUSDT_UMCBL\",\"marginCoin\":\"USDT\",\"size\":\"0.0001\",\"orderType\":\"market\",\"side\":\"close_long\"}"
            },
            {
                "description": "Swap market buy for hedged",
                "method": "createOrder",
                "url": "https://api.coincatch.com/api/mix/v1/order/placeOrder",
                "input": [
                    "BTC/USDT:USDT",
                ...
                "output": "{\"symbol\":\"BTCUSDT_UMCBL\",\"marginCoin\":\"USDT\",\"size\":\"0.0001\",\"orderType\":\"market\",\"side\":\"open_long\"}"
            },
            {
                "description": "Swap market sell for non-hedged with exchange-specific side and reduceOnly",
                "method": "createOrder",
                "url": "https://api.coincatch.com/api/mix/v1/order/placeOrder",
                "input": [
                    "BTC/USDT:USDT",
                ...
                "output": "{\"symbol\":\"BTCUSDT_UMCBL\",\"marginCoin\":\"USDT\",\"size\":\"0.0001\",\"orderType\":\"market\",\"side\":\"sell_single\",\"reduceOnly\":true}"
            },
            {
                "description": "Swap limit sell for non-hedged with postOnly and reduceOnly",
                "method": "createOrder",
                "url": "https://api.coincatch.com/api/mix/v1/order/placeOrder",
                "input": [
                    "BTC/USDT:USDT",
                ...
                "output": "{\"symbol\":\"BTCUSDT_UMCBL\",\"marginCoin\":\"USDT\",\"size\":\"0.0001\",\"timeInForceValue\":\"post_only\",\"price\":\"140000\",\"orderType\":\"limit\",\"side\":\"sell_single\",\"reduceOnly\":true}"
            },
            {
                "description": "Swap limit buy for non-hedged with exchange-specific side",
                "method": "createOrder",
                "url": "https://api.coincatch.com/api/mix/v1/order/placeOrder",
                "input": [
                    "BTC/USDT:USDT",
                ...
                "output": "{\"symbol\":\"BTCUSDT_UMCBL\",\"marginCoin\":\"USDT\",\"size\":\"0.0001\",\"orderType\":\"market\",\"side\":\"buy_single\"}"
            },
            {
                "description": "Swap limit buy for non-hedged with postOnly",
                "method": "createOrder",
                "url": "https://api.coincatch.com/api/mix/v1/order/placeOrder",
                "input": [
                    "BTC/USDT:USDT",
                ...
                "output": "{\"symbol\":\"BTCUSDT_UMCBL\",\"marginCoin\":\"USDT\",\"size\":\"0.0001\",\"timeInForceValue\":\"post_only\",\"price\":\"50000\",\"orderType\":\"limit\",\"side\":\"buy_single\"}"
            },
            {
...
This is a JSON file located at `ts/src/test/static/request/coincatch.json`.
