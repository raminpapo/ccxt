# Documentation: ts/src/test/static/request/ascendex.json

## File Metadata

- **Path**: `ts/src/test/static/request/ascendex.json`
- **Size**: 27,371 bytes
- **Lines**: 742
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/ascendex.json`.
