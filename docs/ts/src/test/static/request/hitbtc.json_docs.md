# Documentation: ts/src/test/static/request/hitbtc.json

## File Metadata

- **Path**: `ts/src/test/static/request/hitbtc.json`
- **Size**: 30,871 bytes
- **Lines**: 867
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/hitbtc.json`.
