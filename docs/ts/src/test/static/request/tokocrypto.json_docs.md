# Documentation: ts/src/test/static/request/tokocrypto.json

## File Metadata

- **Path**: `ts/src/test/static/request/tokocrypto.json`
- **Size**: 10,722 bytes
- **Lines**: 269
- **Type**: JSON
- **Extension**: .json
        ...
        "fetchTime": [
            {
                ...
                "method": "fetchTime",
                "url": "https://www.tokocrypto.com/open/v1/common/time",
                "input": []
            }
        ],
        "fetchOrderBook": [
...
This is a JSON file located at `ts/src/test/static/request/tokocrypto.json`.
