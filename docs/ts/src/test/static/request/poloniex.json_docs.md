# Documentation: ts/src/test/static/request/poloniex.json

## File Metadata

- **Path**: `ts/src/test/static/request/poloniex.json`
- **Size**: 19,641 bytes
- **Lines**: 582
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        ...
        "fetchOHLCV": [
            {
                "description": "non ascii symbol test",
                "disabledCS": true,
                "disabledGO": true,
                "method": "fetchOHLCV",
                "url": "https://api.poloniex.com/markets/%E7%B4%A2%E6%8B%89%E6%8B%89_USDT/candles?interval=HOUR_1",
                "input": [
                    "索拉拉/USDT",
                    "1h"
                ],
...
This is a JSON file located at `ts/src/test/static/request/poloniex.json`.
