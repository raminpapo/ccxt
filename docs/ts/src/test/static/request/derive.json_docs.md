# Documentation: ts/src/test/static/request/derive.json

## File Metadata

- **Path**: `ts/src/test/static/request/derive.json`
- **Size**: 16,003 bytes
- **Lines**: 413
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/derive.json`.
