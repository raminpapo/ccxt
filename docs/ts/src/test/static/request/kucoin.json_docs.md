# Documentation: ts/src/test/static/request/kucoin.json

## File Metadata

- **Path**: `ts/src/test/static/request/kucoin.json`
- **Size**: 34,305 bytes
- **Lines**: 974
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        ...
        "fetchTicker": [
            ...
            {
                "description": "uta spot fetch ticker",
                "method": "fetchTicker",
                "url": "https://api.kucoin.com/api/ua/v1/market/ticker?symbol=BTC-USDT&tradeType=SPOT",
                "input": [
                    "BTC/USDT",
                    {
                        "uta": true,
        ...
        "fetchTrades": [
            ...
            {
                "description": "uta fetch trades",
                "method": "fetchTrades",
                "url": "https://api.kucoin.com/api/ua/v1/market/trade?symbol=BTC-USDT&tradeType=SPOT",
                "input": [
                    "BTC/USDT",
                    null,
                    3,
        ...
        "fetchOrderBook": [
            ...
            },
            {
                ...
                "method": "fetchOrderBook",
                "url": "https://api.kucoin.com/api/ua/v1/market/orderbook?symbol=BTC-USDT&tradeType=SPOT&limit=20",
                "input": [
                    "BTC/USDT",
                    20,
                    {
        ...
        "fetchOHLCV": [
            ...
            {
                "description": "uta spot ohlcv",
                "method": "fetchOHLCV",
                "url": "https://api.kucoin.com/api/ua/v1/market/kline?symbol=BTC-USDT&startAt=1762240065&endAt=1762240245&tradeType=SPOT&interval=1min",
                "input": [
                    "BTC/USDT",
                    "1m",
                    null,
        ...
        "fetchStatus": [
            ...
            {
                "description": "uta fetch status",
                "method": "fetchStatus",
                "url": "https://api.kucoin.com/api/ua/v1/server/status?tradeType=SPOT",
                "input": [
                    {
                        "uta": true,
                        "tradeType": "SPOT"
...
This is a JSON file located at `ts/src/test/static/request/kucoin.json`.
