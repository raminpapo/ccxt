# Documentation: ts/src/test/static/request/coinbaseinternational.json

## File Metadata

- **Path**: `ts/src/test/static/request/coinbaseinternational.json`
- **Size**: 8,357 bytes
- **Lines**: 249
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/coinbaseinternational.json`.
