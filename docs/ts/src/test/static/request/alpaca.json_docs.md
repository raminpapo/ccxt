# Documentation: ts/src/test/static/request/alpaca.json

## File Metadata

- **Path**: `ts/src/test/static/request/alpaca.json`
- **Size**: 12,412 bytes
- **Lines**: 344
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/alpaca.json`.
