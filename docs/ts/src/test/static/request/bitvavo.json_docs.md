# Documentation: ts/src/test/static/request/bitvavo.json

## File Metadata

- **Path**: `ts/src/test/static/request/bitvavo.json`
- **Size**: 9,630 bytes
- **Lines**: 273
- **Type**: JSON
- **Extension**: .json
        ...
        "cancelAllOrders": [
            {
                ...
                "url": "https://api.bitvavo.com/v2/orders?operatorId=123456",
                "input": []
            }
        ],
        "fetchMyTrades": [
...
This is a JSON file located at `ts/src/test/static/request/bitvavo.json`.
