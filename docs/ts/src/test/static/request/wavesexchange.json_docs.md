# Documentation: ts/src/test/static/request/wavesexchange.json

## File Metadata

- **Path**: `ts/src/test/static/request/wavesexchange.json`
- **Size**: 7,394 bytes
- **Lines**: 175
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/wavesexchange.json`.
