# Documentation: ts/src/test/static/request/xt.json

## File Metadata

- **Path**: `ts/src/test/static/request/xt.json`
- **Size**: 11,850 bytes
- **Lines**: 327
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/xt.json`.
