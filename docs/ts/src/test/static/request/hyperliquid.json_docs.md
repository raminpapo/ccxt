# Documentation: ts/src/test/static/request/hyperliquid.json

## File Metadata

- **Path**: `ts/src/test/static/request/hyperliquid.json`
- **Size**: 70,470 bytes
- **Lines**: 1,335
- **Type**: JSON
- **Extension**: .json
...
```json
{
    ...
    "methods": {
        ...
        "cancelAllOrdersAfter": [
            {
                "description": "request with vaultAddress in options",
                "options": {
                    "vaultAddress": "0xcb4d9044aab9e5aa3965b470ebff554cc8820c7b"
                },
            ...
            },
            {
                ...
                "options": {
                    "subAccountAddress": "0xcb4d9044aab9e5aa3965b470ebff554cc8820c7b"
                },
                "method": "cancelAllOrdersAfter",
                "url": "https://api.hyperliquid.xyz/exchange",
                "input": [
        ...
        "fetchTickers": [
            {
                "description": "fetch spot tickers only",
                "method": "fetchTickers",
                "url": "https://api.hyperliquid.xyz/info",
                "input": [
                    null,
        ...
        "fetchOrderBook": [
            {
                "description": "fetch orderbook with kilo pair",
        ...
        "fetchFundingRateHistory": [
            {
                "description": "funding rate history with kilo pair",
        ...
        "fetchOrder": [
            ...
            },
            {
                ...
                "input": [
                    "0x1234567890abcdef1234567890abcded",
                    "SOL/USDC:USDC",
                    {
                        "user": "0x3B3741c0EFf9C6b556Ec813e70589161F416662A"
                    }
        ...
        "setMarginMode": [
            {
                "description": "set cross margin mode",
        ...
        "cancelOrdersForSymbols": [
            {
                "description": "cancel swap orders with different symbols",
            ...
            },
            {
                ...
                "input": [
                    [
                        {
                            "clientOrderId": "0x1234567890abcdef1234567890abcded",
                            "symbol": "SOL/USDC:USDC"
                        }
                    ]
                ],
...
This is a JSON file located at `ts/src/test/static/request/hyperliquid.json`.
