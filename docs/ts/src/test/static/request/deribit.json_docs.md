# Documentation: ts/src/test/static/request/deribit.json

## File Metadata

- **Path**: `ts/src/test/static/request/deribit.json`
- **Size**: 32,029 bytes
- **Lines**: 822
- **Type**: JSON
- **Extension**: .json
        ...
        "fetchClosedOrders": [
            {
                ...
                "url": "https://www.deribit.com/api/v2/private/get_order_history_by_currency?currency=BTC&count=1000",
                "input": []
            },
            {
                "description": "Spot fetch closed orders",
                "method": "fetchClosedOrders",
                "url": "https://www.deribit.com/api/v2/private/get_order_history_by_instrument?instrument_name=BTC_USDT&count=1000",
                "input": [
                    "BTC/USDT"
                ]
            },
            {
                ...
                "method": "fetchClosedOrders",
                "url": "https://test.deribit.com/api/v2/private/get_order_history_by_instrument?instrument_name=BTC_USDT-PERPETUAL&count=1000",
                "input": [
                    "BTC/USDT:USDT"
                ]
            },
            {
                ...
                "method": "fetchClosedOrders",
                "url": "https://test.deribit.com/api/v2/private/get_order_history_by_instrument?instrument_name=BTC-26JAN24-39000-C&count=1000",
                "input": [
                    "BTC/USD:BTC-240126-39000-C"
                ]
            }
...
This is a JSON file located at `ts/src/test/static/request/deribit.json`.
