# Documentation: ts/src/test/static/request/defx.json

## File Metadata

- **Path**: `ts/src/test/static/request/defx.json`
- **Size**: 13,854 bytes
- **Lines**: 403
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/defx.json`.
