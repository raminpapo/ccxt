# Documentation: ts/src/test/static/request/timex.json

## File Metadata

- **Path**: `ts/src/test/static/request/timex.json`
- **Size**: 9,381 bytes
- **Lines**: 258
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/timex.json`.
