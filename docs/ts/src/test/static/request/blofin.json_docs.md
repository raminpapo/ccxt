# Documentation: ts/src/test/static/request/blofin.json

## File Metadata

- **Path**: `ts/src/test/static/request/blofin.json`
- **Size**: 21,292 bytes
- **Lines**: 572
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/blofin.json`.
