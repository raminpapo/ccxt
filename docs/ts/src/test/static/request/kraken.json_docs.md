# Documentation: ts/src/test/static/request/kraken.json

## File Metadata

- **Path**: `ts/src/test/static/request/kraken.json`
- **Size**: 27,261 bytes
- **Lines**: 747
- **Type**: JSON
- **Extension**: .json
        ...
        "createOrders": [
            {
                ...
                "output": "{\"nonce\":\"1762290765599\",\"orders\":[{\"type\":\"sell\",\"ordertype\":\"limit\",\"volume\":\"6\",\"price\":\"0.4\"},{\"type\":\"sell\",\"ordertype\":\"limit\",\"volume\":\"6\",\"price\":\"0.4\"}],\"pair\":\"ADAUSDC\"}"
            }
        ],
        "fetchCurrencies": [
            {
...
This is a JSON file located at `ts/src/test/static/request/kraken.json`.
