# Documentation: ts/src/test/static/request/exmo.json

## File Metadata

- **Path**: `ts/src/test/static/request/exmo.json`
- **Size**: 12,741 bytes
- **Lines**: 372
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/request/exmo.json`.
