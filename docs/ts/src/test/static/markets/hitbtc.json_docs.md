# Documentation: ts/src/test/static/markets/hitbtc.json

## File Metadata

- **Path**: `ts/src/test/static/markets/hitbtc.json`
- **Size**: 49,660 bytes
- **Lines**: 2,087
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/markets/hitbtc.json`.
