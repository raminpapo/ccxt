# Documentation: ts/src/test/static/markets/kucoin.json

## File Metadata

- **Path**: `ts/src/test/static/markets/kucoin.json`
- **Size**: 34,776 bytes
- **Lines**: 1,395
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/markets/kucoin.json`.
