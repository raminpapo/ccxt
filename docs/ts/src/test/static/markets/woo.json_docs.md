# Documentation: ts/src/test/static/markets/woo.json

## File Metadata

- **Path**: `ts/src/test/static/markets/woo.json`
- **Size**: 38,518 bytes
- **Lines**: 1,385
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/markets/woo.json`.
