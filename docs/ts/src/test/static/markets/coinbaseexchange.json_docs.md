# Documentation: ts/src/test/static/markets/coinbaseexchange.json

## File Metadata

- **Path**: `ts/src/test/static/markets/coinbaseexchange.json`
- **Size**: 12,656 bytes
- **Lines**: 476
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/markets/coinbaseexchange.json`.
