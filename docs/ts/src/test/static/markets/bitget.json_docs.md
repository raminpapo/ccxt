# Documentation: ts/src/test/static/markets/bitget.json

## File Metadata

- **Path**: `ts/src/test/static/markets/bitget.json`
- **Size**: 36,629 bytes
- **Lines**: 1,345
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/markets/bitget.json`.
