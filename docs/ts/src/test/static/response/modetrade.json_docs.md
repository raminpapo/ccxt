# Documentation: ts/src/test/static/response/modetrade.json

## File Metadata

- **Path**: `ts/src/test/static/response/modetrade.json`
- **Size**: 27,559 bytes
- **Lines**: 702
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/response/modetrade.json`.
