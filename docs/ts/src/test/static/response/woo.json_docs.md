# Documentation: ts/src/test/static/response/woo.json

## File Metadata

- **Path**: `ts/src/test/static/response/woo.json`
- **Size**: 118,588 bytes
- **Lines**: 2,860
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/response/woo.json`.
