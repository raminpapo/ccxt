# Documentation: ts/src/test/static/response/kucoin.json

## File Metadata

- **Path**: `ts/src/test/static/response/kucoin.json`
- **Size**: 137,901 bytes
- **Lines**: 3,136
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/response/kucoin.json`.
