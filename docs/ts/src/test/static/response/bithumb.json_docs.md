# Documentation: ts/src/test/static/response/bithumb.json

## File Metadata

- **Path**: `ts/src/test/static/response/bithumb.json`
- **Size**: 19,723 bytes
- **Lines**: 488
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/response/bithumb.json`.
