# Documentation: ts/src/test/static/response/woofipro.json

## File Metadata

- **Path**: `ts/src/test/static/response/woofipro.json`
- **Size**: 27,558 bytes
- **Lines**: 702
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/response/woofipro.json`.
