# Documentation: ts/src/test/static/currencies/binanceus.json

## File Metadata

- **Path**: `ts/src/test/static/currencies/binanceus.json`
- **Size**: 54,104 bytes
- **Lines**: 1,440
- **Type**: JSON
- **Extension**: .json
            ...
            "networkList": [
                {
                    ...
                    "withdrawDesc": "Wallet Maintenance, Withdrawal Suspended",
                    "specialTips": "Both a MEMO and an Address are required to successfully deposit your XRP BEP2 tokens to Binance.",
                    "name": "BNB Beacon Chain (BEP2)",
                    "resetAddressStatus": false,
                    "addressRegex": "^(bnb1)[0-9a-z]{38}$",
                    "memoRegex": "^[0-9A-Za-z\\-_]{1,120}$",
...
This is a JSON file located at `ts/src/test/static/currencies/binanceus.json`.
