# Documentation: ts/src/test/static/currencies/mexc.json

## File Metadata

- **Path**: `ts/src/test/static/currencies/mexc.json`
- **Size**: 90,385 bytes
- **Lines**: 2,374
- **Type**: JSON
- **Extension**: .json
...
This is a JSON file located at `ts/src/test/static/currencies/mexc.json`.
