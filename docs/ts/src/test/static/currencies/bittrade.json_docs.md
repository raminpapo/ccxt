# Documentation: ts/src/test/static/currencies/bittrade.json

## File Metadata

- **Path**: `ts/src/test/static/currencies/bittrade.json`
- **Size**: 19,470 bytes
- **Lines**: 409
- **Type**: JSON
- **Extension**: .json
...
```json
{
    "BTC": {
        ...
        "info": {
            ...
            "show-precision": "8",
            "quote-currency": true,
            "deposit-min-amount": "0.0005",
            "withdraw-min-amount": "0.001",
            "otc-enable": "1",
            "visible": true,
            "white-enabled": false,
            ...
            "deposit-desc": "Please don’t deposit any other digital assets except BTC  to the above address. Otherwise, you may lose your assets permanently. !>_<!Depositing to the above address requires confirmations of the entire network. It will arrive after 1 confirmations, and it will be available to withdraw after 2 confirmations. !>_<!Minimum deposit amount:0.0005 BTC. Any deposits less than the minimum will not be credited or refunded.!>_<!Your deposit address won’t change often. If there are any changes, we will notify you via announcement or email.!>_<!Please make sure that your computer and browser are secure, and your information is protected from being tampered with or leaked.",
    ...
    "LTC": {
        ...
        "info": {
            ...
            "currency-type": "btc",
            "show-precision": "8",
            "quote-currency": false,
            "deposit-min-amount": "0.001",
            "withdraw-min-amount": "0.1",
            "otc-enable": "1",
            "visible": true,
            "white-enabled": false,
            "country-disabled": false,
    ...
    "ETH": {
        ...
        "info": {
            ...
            "withdraw-precision": "8",
            "weight": "5",
            "withdraw-enable-timestamp": "1567320000000",
            "deposit-enable-timestamp": "1598942400000",
            "currency-partition": "all",
            "visible-assets-timestamp": "1504248000000",
            "support-sites": [
                "MINEPOOL",
    ...
    "ADA": {
        ...
        "info": {
            ...
            "show-precision": "8",
            "quote-currency": false,
            "deposit-min-amount": "10",
            "withdraw-min-amount": "20",
            "otc-enable": "1",
            "visible": true,
            "white-enabled": false,
            "country-disabled": false,
            ...
            "withdraw-precision": "6",
            "weight": "9991",
            "withdraw-enable-timestamp": "1618813800000",
            "deposit-enable-timestamp": "1618554600000",
            "currency-partition": null,
            "visible-assets-timestamp": "1523860200000",
            "support-sites": [
                "MINEPOOL",
                "INSTITUTION",
                "OTC"
    ...
    "XRP": {
        ...
        "info": {
            "currency-addr-with-tag": true,
            "fast-confirms": "1",
            "safe-confirms": "1",
            "currency-type": "eth",
            "show-precision": "4",
            "quote-currency": false,
            "deposit-min-amount": "0.1",
            "withdraw-min-amount": "0.5",
            "otc-enable": "1",
            "visible": true,
            "white-enabled": false,
            "country-disabled": false,
            "deposit-enabled": true,
            "withdraw-enabled": true,
            "full-name": "Ripple XRP",
            "withdraw-precision": "4",
            "weight": "4",
            "withdraw-enable-timestamp": "1640386800000",
            "deposit-enable-timestamp": "1640386800000",
            "currency-partition": null,
            "visible-assets-timestamp": "1511416800000",
            "support-sites": [
                "INSTITUTION",
                "FUTURES",
                "OTC"
    ...
    "USDC": {
        ...
        "info": {
            ...
            "withdraw-precision": "6",
            "weight": "10001",
            "withdraw-enable-timestamp": "1672243200000",
            "deposit-enable-timestamp": "1678515866000",
            "currency-partition": "all",
            "visible-assets-timestamp": "1648738800000",
            "support-sites": [
                "INSTITUTION",
                "OTC"
            ],
...
This is a JSON file located at `ts/src/test/static/currencies/bittrade.json`.
