# Documentation: ts/src/test/tests.helpers.ts

## File Metadata

- **Path**: `ts/src/test/tests.helpers.ts`
- **Size**: 7,792 bytes
- **Lines**: 275
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/tests.helpers.ts`.

**Functions defined**: ioFileExists, jsonStringify, ioFileRead, getCliArgValue, jsonParse, getTestName, convertAscii, filterArgvs, selectArgv, dump
...
- `../base/functions/string.js` (imported)
- `../base/errorHierarchy.js` (imported)
- `assert` (imported)
- `url` (imported)
- `fs` (imported)
- `../../ccxt.js` (imported)
- `../base/types.js` (imported)
- `js/src/test/test.js` (referenced)
- `../base/functions/string.js` (referenced)
- `../base/errorHierarchy.js` (referenced)
- `../../ccxt.js` (referenced)
...
**To run this test:**
```bash
npm test ts/src/test/tests.helpers.ts
```
