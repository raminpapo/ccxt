# Documentation: ts/src/test/Exchange/base/test.sharedMethods.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/base/test.sharedMethods.ts`
- **Size**: 34,153 bytes
- **Lines**: 656
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/base/test.sharedMethods.ts`.

**Functions defined**: logTemplate, assertSymbol, assertCurrencyCode, assertType, assertTimestampAndDatetime, isTemporaryFailure, assertTimestamp, assertValidCurrencyIdAndCode, assertStructure, stringValue
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/base/test.sharedMethods.ts
```
