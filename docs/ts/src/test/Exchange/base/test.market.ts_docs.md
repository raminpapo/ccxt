# Documentation: ts/src/test/Exchange/base/test.market.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/base/test.market.ts`
- **Size**: 14,966 bytes
- **Lines**: 273
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/base/test.market.ts`.

**Functions defined**: testMarket
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/base/test.market.ts
```
