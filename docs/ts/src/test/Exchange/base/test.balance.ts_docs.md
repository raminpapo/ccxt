# Documentation: ts/src/test/Exchange/base/test.balance.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/base/test.balance.ts`
- **Size**: 2,693 bytes
- **Lines**: 49
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/base/test.balance.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/base/test.balance.ts
```
