# Documentation: ts/src/test/Exchange/base/test.ohlcv.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/base/test.ohlcv.ts`
- **Size**: 1,785 bytes
- **Lines**: 33
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/base/test.ohlcv.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/base/test.ohlcv.ts
```
