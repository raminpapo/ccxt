# Documentation: ts/src/test/Exchange/base/test.order.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/base/test.order.ts`
- **Size**: 3,711 bytes
- **Lines**: 59
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/base/test.order.ts`.

**Functions defined**: testOrder
...
- `../../../../ccxt` (imported)
- `./test.trade.js` (imported)
- `./test.trade.js` (referenced)
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/base/test.order.ts
```
