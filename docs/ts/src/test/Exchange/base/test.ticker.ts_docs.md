# Documentation: ts/src/test/Exchange/base/test.ticker.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/base/test.ticker.ts`
- **Size**: 12,500 bytes
- **Lines**: 188
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/base/test.ticker.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/base/test.ticker.ts
```
