# Documentation: ts/src/test/Exchange/base/test.currency.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/base/test.currency.ts`
- **Size**: 4,701 bytes
- **Lines**: 84
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/base/test.currency.ts`.

**Functions defined**: testCurrency
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/base/test.currency.ts
```
