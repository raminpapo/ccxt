# Documentation: ts/src/test/Exchange/test.createOrder.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/test.createOrder.ts`
- **Size**: 17,941 bytes
- **Lines**: 295
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/test.createOrder.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/test.createOrder.ts
```
