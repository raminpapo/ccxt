# Documentation: ts/src/test/Exchange/test.fetchClosedOrders.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/test.fetchClosedOrders.ts`
- **Size**: 945 bytes
- **Lines**: 21
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/test.fetchClosedOrders.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/test.fetchClosedOrders.ts
```
