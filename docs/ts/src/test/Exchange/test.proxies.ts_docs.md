# Documentation: ts/src/test/Exchange/test.proxies.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/test.proxies.ts`
- **Size**: 4,328 bytes
- **Lines**: 89
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/test.proxies.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/test.proxies.ts
```
