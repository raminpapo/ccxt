# Documentation: ts/src/test/Exchange/test.fetchOrderBooks.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/test.fetchOrderBooks.ts`
- **Size**: 891 bytes
- **Lines**: 20
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/test.fetchOrderBooks.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/test.fetchOrderBooks.ts
```
