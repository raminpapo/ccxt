# Documentation: ts/src/test/Exchange/test.loadMarkets.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/test.loadMarkets.ts`
- **Size**: 1,125 bytes
- **Lines**: 24
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/test.loadMarkets.ts`.
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/test.loadMarkets.ts
```
