# Documentation: ts/src/test/Exchange/test.fetchCurrencies.ts

## File Metadata

- **Path**: `ts/src/test/Exchange/test.fetchCurrencies.ts`
- **Size**: 4,046 bytes
- **Lines**: 72
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/test/Exchange/test.fetchCurrencies.ts`.

**Functions defined**: testFetchCurrencies, detectCurrencyConflicts
...
- `../../../ccxt` (imported)
- `./base/test.currency.js` (imported)
- `assert` (imported)
- `./base/test.currency.js` (referenced)
...
**To run this test:**
```bash
npm test ts/src/test/Exchange/test.fetchCurrencies.ts
```
