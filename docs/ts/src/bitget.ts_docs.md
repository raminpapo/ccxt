# Documentation: ts/src/bitget.ts

## File Metadata

- **Path**: `ts/src/bitget.ts`
- **Size**: 556,224 bytes
- **Lines**: 11,044
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitget.ts`.

**Classes defined**: bitget

**Functions defined**: suspended, is, cannot
...
- `./abstract/bitget.js` (referenced)
- `https://www.bitget.com` (referenced)
