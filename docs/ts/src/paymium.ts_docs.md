# Documentation: ts/src/paymium.ts

## File Metadata

- **Path**: `ts/src/paymium.ts`
- **Size**: 28,358 bytes
- **Lines**: 660
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/paymium.ts`.
...
- `https://user-images.githubusercontent.com/51840849/87153930-f0f02200-c2c0-11ea-9c0a-40337375ae89.jpg` (referenced)
- `https://www.paymium.com` (referenced)
- `./abstract/paymium.js` (referenced)
