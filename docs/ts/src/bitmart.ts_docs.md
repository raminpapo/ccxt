# Documentation: ts/src/bitmart.ts

## File Metadata

- **Path**: `ts/src/bitmart.ts`
- **Size**: 266,923 bytes
- **Lines**: 5,653
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitmart.ts`.
...
- `./abstract/bitmart.js` (referenced)
