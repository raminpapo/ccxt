# Documentation: ts/src/deribit.ts

## File Metadata

- **Path**: `ts/src/deribit.ts`
- **Size**: 178,620 bytes
- **Lines**: 3,831
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/deribit.ts`.

**Classes defined**: deribit
...
- `./base/functions/totp.js` (imported)
- `./abstract/deribit.js` (imported)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `./base/errors.js` (referenced)
- `https://test.deribit.com` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/41933112-9e2dd65a-798b-11e8-8440-5bab2959fcb8.jpg` (referenced)
- `./base/functions/number.js` (referenced)
- `./base/functions/totp.js` (referenced)
- `https://www.deribit.com` (referenced)
- `./abstract/deribit.js` (referenced)
