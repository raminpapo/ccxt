# Documentation: ts/src/modetrade.ts
...
This is a TypeScript file located at `ts/src/modetrade.ts`.

**Classes defined**: modetrade
...
- `./abstract/modetrade.js` (imported)
- `./base/errors.js` (referenced)
- `https://api-evm.orderly.org` (referenced)
...
- `./abstract/modetrade.js` (referenced)
