# Documentation: ts/src/tokocrypto.ts

## File Metadata

- **Path**: `ts/src/tokocrypto.ts`
- **Size**: 132,684 bytes
- **Lines**: 2,642
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/tokocrypto.ts`.

**Classes defined**: tokocrypto

**Functions defined**: is
...
- `./abstract/tokocrypto.js` (imported)
...
- `https://user-images.githubusercontent.com/1294454/183870484-d3398d0c-f6a1-4cce-91b8-d58792308716.jpg` (referenced)
- `./abstract/tokocrypto.js` (referenced)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `./base/errors.js` (referenced)
- `https://tokocrypto.com` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `https://www.tokocrypto.com` (referenced)
