# Documentation: ts/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.ts`
- **Size**: 36,841 bytes
- **Lines**: 1,331
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.ts`.

**Functions defined**: createBaseModeInfo_Multi, createBaseTx, createBaseSignerInfo, createBaseModeInfo, createBaseModeInfo_Single, createBaseTxRaw, createBaseAuthInfo, createBaseSignDocDirectAux, createBaseSignDoc, createBaseTxBody
...
- `../../crypto/multisig/v1beta1/multisig.js` (imported)
- `../../base/v1beta1/coin.js` (imported)
- `../signing/v1beta1/signing` (imported)
- `../../../google/protobuf/any.js` (imported)
- `../../../helpers.js` (imported)
- `protobufjs/minimal.js` (referenced)
- `../../crypto/multisig/v1beta1/multisig.js` (referenced)
- `../../base/v1beta1/coin.js` (referenced)
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.ts
```
