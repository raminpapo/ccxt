# Documentation: ts/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.ts`
- **Size**: 14,930 bytes
- **Lines**: 487
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.ts`.

**Functions defined**: signModeFromJSON, signModeToJSON, createBaseSignatureDescriptor, createBaseSignatureDescriptor_Data_Multi, createBaseSignatureDescriptor_Data, createBaseSignatureDescriptors, createBaseSignatureDescriptor_Data_Single
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.ts
```
