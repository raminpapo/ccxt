# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/sending/transfer.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/sending/transfer.ts`
- **Size**: 11,605 bytes
- **Lines**: 420
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/sending/transfer.ts`.

**Functions defined**: createBaseMsgDepositToSubaccount, createBaseTransfer, createBaseMsgWithdrawFromSubaccount, createBaseMsgSendFromModuleToAccount
...
**Functions** (4):
- `createBaseMsgDepositToSubaccount()`
- `createBaseMsgSendFromModuleToAccount()`
- `createBaseMsgWithdrawFromSubaccount()`
- `createBaseTransfer()`
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/sending/transfer.ts
```
