# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.ts`
- **Size**: 11,962 bytes
- **Lines**: 460
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.ts`.

**Functions defined**: createBaseMsgSetActiveStateResponse, createBaseMsgSetActiveState, createBaseMsgRemoveAuthenticatorResponse, createBaseTxExtension, createBaseMsgAddAuthenticatorResponse, createBaseMsgRemoveAuthenticator, createBaseMsgAddAuthenticator
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.ts
```
