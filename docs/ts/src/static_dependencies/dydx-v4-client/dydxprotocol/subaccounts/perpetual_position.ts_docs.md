# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/subaccounts/perpetual_position.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/subaccounts/perpetual_position.ts`
- **Size**: 2,892 bytes
- **Lines**: 109
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/subaccounts/perpetual_position.ts`.
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/subaccounts/perpetual_position.ts
```
