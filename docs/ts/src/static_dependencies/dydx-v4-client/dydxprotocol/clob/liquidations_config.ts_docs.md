# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations_config.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations_config.ts`
- **Size**: 11,636 bytes
- **Lines**: 358
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations_config.ts`.
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations_config.ts
```
