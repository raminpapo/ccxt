# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.ts`
- **Size**: 46,161 bytes
- **Lines**: 1,538
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.ts`.

**Functions defined**: createBaseOrderFillState, order_TimeInForceToJSON, order_SideFromJSON, order_ConditionTypeFromJSON, order_ConditionTypeToJSON, createBasePotentiallyPrunableOrders, createBaseOrdersFilledDuringLatestBlock, order_TimeInForceFromJSON, createBaseOrderId, order_SideToJSON
...
**Functions** (19):
- `createBaseBuilderCodeParameters()`
- `createBaseConditionalOrderPlacement()`
- `createBaseLongTermOrderPlacement()`
- `createBaseOrder()`
- `createBaseOrderFillState()`
- `createBaseOrderId()`
- `createBaseOrdersFilledDuringLatestBlock()`
- `createBasePotentiallyPrunableOrders()`
- `createBaseStatefulOrderTimeSliceValue()`
- `createBaseStreamLiquidationOrder()`
- `createBaseTransactionOrdering()`
- `createBaseTwapOrderPlacement()`
- `createBaseTwapParameters()`
- `order_ConditionTypeFromJSON()`
- `order_ConditionTypeToJSON()`
- `order_SideFromJSON()`
- `order_SideToJSON()`
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.ts
```
