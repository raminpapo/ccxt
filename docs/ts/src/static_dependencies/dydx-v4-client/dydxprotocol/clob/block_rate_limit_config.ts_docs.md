# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/block_rate_limit_config.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/block_rate_limit_config.ts`
- **Size**: 6,449 bytes
- **Lines**: 195
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/block_rate_limit_config.ts`.
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/block_rate_limit_config.ts
```
