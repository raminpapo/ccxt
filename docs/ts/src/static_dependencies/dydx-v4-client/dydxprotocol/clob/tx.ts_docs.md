# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.ts`
- **Size**: 38,278 bytes
- **Lines**: 1,286
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.ts`.

**Functions defined**: createBaseMsgBatchCancel, createBaseMsgCreateClobPair, createBaseMsgPlaceOrderResponse, createBaseOrderBatch, createBaseMsgProposedOperations, createBaseMsgProposedOperationsResponse, createBaseMsgCancelOrder, createBaseMsgPlaceOrder, createBaseMsgCreateClobPairResponse, createBaseMsgCancelOrderResponse
...
**Functions** (20):
- `createBaseMsgBatchCancel()`
- `createBaseMsgBatchCancelResponse()`
- `createBaseMsgCancelOrder()`
- `createBaseMsgCancelOrderResponse()`
- `createBaseMsgCreateClobPair()`
- `createBaseMsgCreateClobPairResponse()`
- `createBaseMsgPlaceOrder()`
- `createBaseMsgPlaceOrderResponse()`
- `createBaseMsgProposedOperations()`
- `createBaseMsgProposedOperationsResponse()`
- `createBaseMsgUpdateBlockRateLimitConfiguration()`
- `createBaseMsgUpdateBlockRateLimitConfigurationResponse()`
- `createBaseMsgUpdateClobPair()`
- `createBaseMsgUpdateClobPairResponse()`
- `createBaseMsgUpdateEquityTierLimitConfiguration()`
- `createBaseMsgUpdateEquityTierLimitConfigurationResponse()`
- `createBaseMsgUpdateLiquidationsConfig()`
- `createBaseMsgUpdateLiquidationsConfigResponse()`
- `createBaseOperationRaw()`
- `createBaseOrderBatch()`
...
- `./matches.js` (imported)
- `./block_rate_limit_config.js` (imported)
- `./order_removals.js` (imported)
- `./liquidations_config.js` (imported)
- `./equity_tier_limit_config.js` (imported)
- `../../helpers.js` (imported)
- `../subaccounts/subaccount.js` (imported)
- `protobufjs/minimal.js` (referenced)
- `./order.js` (referenced)
- `./clob_pair.js` (referenced)
- `./matches.js` (referenced)
- `./block_rate_limit_config.js` (referenced)
- `./order_removals.js` (referenced)
- `./liquidations_config.js` (referenced)
- `./equity_tier_limit_config.js` (referenced)
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.ts
```
