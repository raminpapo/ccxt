# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations.ts`
- **Size**: 8,571 bytes
- **Lines**: 284
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations.ts`.
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations.ts
```
