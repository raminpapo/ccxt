# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.ts`
- **Size**: 8,448 bytes
- **Lines**: 228
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.ts`.

**Functions defined**: orderRemoval_RemovalReasonToJSON, orderRemoval_RemovalReasonFromJSON, createBaseOrderRemoval
...
**Functions** (3):
- `createBaseOrderRemoval()`
- `orderRemoval_RemovalReasonFromJSON()`
- `orderRemoval_RemovalReasonToJSON()`

**Constants** (11):
- `REMOVAL_REASON_CONDITIONAL_FOK_COULD_NOT_BE_FULLY_FILLED`
- `REMOVAL_REASON_CONDITIONAL_IOC_WOULD_REST_ON_BOOK`
- `REMOVAL_REASON_FULLY_FILLED`
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.ts
```
