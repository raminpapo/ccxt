# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/equity_tier_limit_config.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/equity_tier_limit_config.ts`
- **Size**: 4,446 bytes
- **Lines**: 154
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/equity_tier_limit_config.ts`.
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/equity_tier_limit_config.ts
```
