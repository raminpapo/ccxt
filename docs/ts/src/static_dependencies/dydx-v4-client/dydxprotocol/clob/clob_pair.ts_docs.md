# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.ts`
- **Size**: 10,876 bytes
- **Lines**: 396
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.ts`.

**Functions defined**: createBasePerpetualClobMetadata, clobPair_StatusToJSON, createBaseSpotClobMetadata, clobPair_StatusFromJSON, createBaseClobPair
...
**Functions** (5):
- `clobPair_StatusFromJSON()`
- `clobPair_StatusToJSON()`
- `createBaseClobPair()`
- `createBasePerpetualClobMetadata()`
- `createBaseSpotClobMetadata()`
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.ts
```
