# Documentation: ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.ts`
- **Size**: 16,944 bytes
- **Lines**: 552
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.ts`.

**Functions defined**: createBaseMatchPerpetualDeleveraging_Fill, createBaseMatchPerpetualDeleveraging, createBaseMatchOrders, createBaseMakerFill, createBaseClobMatch, createBaseMatchPerpetualLiquidation
...
- `createBaseClobMatch()`
- `createBaseMakerFill()`
- `createBaseMatchOrders()`
- `createBaseMatchPerpetualDeleveraging()`
- `createBaseMatchPerpetualDeleveraging_Fill()`
- `createBaseMatchPerpetualLiquidation()`
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.ts
```
