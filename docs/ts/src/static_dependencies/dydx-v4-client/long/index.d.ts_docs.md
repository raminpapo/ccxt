# Documentation: ts/src/static_dependencies/dydx-v4-client/long/index.d.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/long/index.d.ts`
- **Size**: 10,112 bytes
- **Lines**: 477
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/long/index.d.ts`.

**Classes defined**: a, as, Long
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/long/index.d.ts
```
