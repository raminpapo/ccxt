# Documentation: ts/src/static_dependencies/dydx-v4-client/helpers.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/dydx-v4-client/helpers.ts`
- **Size**: 7,256 bytes
- **Lines**: 243
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/dydx-v4-client/helpers.ts`.
...
```bash
ts-node ts/src/static_dependencies/dydx-v4-client/helpers.ts
```
