# Documentation: ts/src/static_dependencies/proxies/https-proxy-agent/index.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/proxies/https-proxy-agent/index.ts`
- **Size**: 6,401 bytes
- **Lines**: 216
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/proxies/https-proxy-agent/index.ts`.

**Classes defined**: HttpsProxyAgent

**Functions defined**: isHTTPS, resume, omit
...
- `http` (imported)
- `debug` (imported)
- `./parse-proxy-response.js` (imported)
- `assert` (imported)
- `./../agent-base/index.js` (imported)
- `tls` (imported)
- `./../agent-base/index.js` (referenced)
- `./parse-proxy-response.js` (referenced)
...
```bash
ts-node ts/src/static_dependencies/proxies/https-proxy-agent/index.ts
```
