# Documentation: ts/src/static_dependencies/proxies/http-proxy-agent/index.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/proxies/http-proxy-agent/index.ts`
- **Size**: 5,244 bytes
- **Lines**: 181
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/proxies/http-proxy-agent/index.ts`.

**Classes defined**: HttpProxyAgent

**Functions defined**: throwing, isHTTPS, omit, throws
...
```bash
ts-node ts/src/static_dependencies/proxies/http-proxy-agent/index.ts
```
