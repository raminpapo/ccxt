# Documentation: ts/src/static_dependencies/watchable/src/unpromise.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/watchable/src/unpromise.ts`
- **Size**: 13,857 bytes
- **Lines**: 379
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/watchable/src/unpromise.ts`.

**Classes defined**: Unpromise

**Functions defined**: withResolvers, if, let, allowing, listWithoutMember, listWithMember, resolveSelfTuple, like, listWithoutIndex
...
```bash
ts-node ts/src/static_dependencies/watchable/src/unpromise.ts
```
