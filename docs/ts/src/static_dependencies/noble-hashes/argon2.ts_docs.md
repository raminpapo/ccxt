# Documentation: ts/src/static_dependencies/noble-hashes/argon2.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-hashes/argon2.ts`
- **Size**: 12,505 bytes
- **Lines**: 378
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-hashes/argon2.ts`.

**Functions defined**: mul2, indexAlpha, relPos, P, mul, block, blamka, can, G, Hp
...
```bash
ts-node ts/src/static_dependencies/noble-hashes/argon2.ts
```
