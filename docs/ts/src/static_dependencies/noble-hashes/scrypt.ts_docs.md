# Documentation: ts/src/static_dependencies/noble-hashes/scrypt.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-hashes/scrypt.ts`
- **Size**: 9,748 bytes
- **Lines**: 241
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-hashes/scrypt.ts`.

**Functions defined**: scrypt, BlockMix, were, scryptAsync, XorAndSalsa, can, scryptInit, that, scryptOutput
...
```bash
ts-node ts/src/static_dependencies/noble-hashes/scrypt.ts
```
