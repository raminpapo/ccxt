# Documentation: ts/src/static_dependencies/noble-hashes/blake2s.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-hashes/blake2s.ts`
- **Size**: 5,223 bytes
- **Lines**: 137
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-hashes/blake2s.ts`.

**Classes defined**: BLAKE2s

**Functions defined**: G, G1, compress, G2
...
```bash
ts-node ts/src/static_dependencies/noble-hashes/blake2s.ts
```
