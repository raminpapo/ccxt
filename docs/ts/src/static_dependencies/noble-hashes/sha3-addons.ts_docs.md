# Documentation: ts/src/static_dependencies/noble-hashes/sha3-addons.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-hashes/sha3-addons.ts`
- **Size**: 14,190 bytes
- **Lines**: 397
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-hashes/sha3-addons.ts`.

**Classes defined**: KangarooTwelve, TupleHash, ParallelHash, KMAC, KeccakPRG

**Functions defined**: rightEncodeK12, leftEncode, rightEncode, genParallel, genKmac, genTuple, chooseLen, cshakePers
...
```bash
ts-node ts/src/static_dependencies/noble-hashes/sha3-addons.ts
```
