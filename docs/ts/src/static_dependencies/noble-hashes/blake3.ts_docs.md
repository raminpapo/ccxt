# Documentation: ts/src/static_dependencies/noble-hashes/blake3.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-hashes/blake3.ts`
- **Size**: 8,988 bytes
- **Lines**: 247
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-hashes/blake3.ts`.

**Classes defined**: BLAKE3

**Functions defined**: uses
...
```bash
ts-node ts/src/static_dependencies/noble-hashes/blake3.ts
```
