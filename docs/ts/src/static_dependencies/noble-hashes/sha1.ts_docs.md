# Documentation: ts/src/static_dependencies/noble-hashes/sha1.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-hashes/sha1.ts`
- **Size**: 2,542 bytes
- **Lines**: 87
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-hashes/sha1.ts`.
...
```bash
ts-node ts/src/static_dependencies/noble-hashes/sha1.ts
```
