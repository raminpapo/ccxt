# Documentation: ts/src/static_dependencies/noble-hashes/blake2b.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-hashes/blake2b.ts`
- **Size**: 7,415 bytes
- **Lines**: 204
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-hashes/blake2b.ts`.

**Classes defined**: BLAKE2b

**Functions defined**: G, G1, G2
...
```bash
ts-node ts/src/static_dependencies/noble-hashes/blake2b.ts
```
