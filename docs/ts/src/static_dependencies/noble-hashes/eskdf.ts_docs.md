# Documentation: ts/src/static_dependencies/noble-hashes/eskdf.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-hashes/eskdf.ts`
- **Size**: 7,118 bytes
- **Lines**: 184
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-hashes/eskdf.ts`.

**Classes defined**: because

**Functions defined**: countBytes, modReduceKey, deriveMainSeed, scrypt, pbkdf2, getSaltInfo, xor32, eskdf, strHasLength, getKeyLength
...
- `./pbkdf2.js` (imported)
- `./utils.js` (imported)
- `./sha256.js` (referenced)
- `./_assert.js` (referenced)
- `./scrypt.js` (referenced)
- `./hkdf.js` (referenced)
- `./pbkdf2.js` (referenced)
- `./utils.js` (referenced)
...
```bash
ts-node ts/src/static_dependencies/noble-hashes/eskdf.ts
```
