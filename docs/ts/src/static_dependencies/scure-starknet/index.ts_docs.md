# Documentation: ts/src/static_dependencies/scure-starknet/index.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/scure-starknet/index.ts`
- **Size**: 14,533 bytes
- **Lines**: 383
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/scure-starknet/index.ts`.

**Functions defined**: ensureBytes, getSharedSecret, verify, sign, getPublicKey, normPrivKey, checkMessage, hex0xToBytes, bits2int, checkSignature
...
```bash
ts-node ts/src/static_dependencies/scure-starknet/index.ts
```
