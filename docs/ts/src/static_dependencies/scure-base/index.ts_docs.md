# Documentation: ts/src/static_dependencies/scure-base/index.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/scure-base/index.ts`
- **Size**: 19,129 bytes
- **Lines**: 503
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/scure-base/index.ts`.

**Functions defined**: join, convertRadix2, padding, for, convertRadix, assertNumber, chain, radix, normalize, alphabet
...
```bash
ts-node ts/src/static_dependencies/scure-base/index.ts
```
