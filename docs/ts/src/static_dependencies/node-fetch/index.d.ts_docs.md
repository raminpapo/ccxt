# Documentation: ts/src/static_dependencies/node-fetch/index.d.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/node-fetch/index.d.ts`
- **Size**: 6,644 bytes
- **Lines**: 222
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/node-fetch/index.d.ts`.

**Classes defined**: FetchError, Request, BodyMixin, Response, since, AbortError, Headers

**Functions defined**: fetch, isRedirect
...
```bash
ts-node ts/src/static_dependencies/node-fetch/index.d.ts
```
