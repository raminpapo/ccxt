# Documentation: ts/src/static_dependencies/scure-bip39/index.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/scure-bip39/index.ts`
- **Size**: 5,571 bytes
- **Lines**: 146
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/scure-bip39/index.ts`.

**Functions defined**: nfkd, mnemonicToEntropy, generateMnemonic, entropyToMnemonic, normalize, mnemonicToSeedSync, mnemonicToSeed, validateMnemonic, aentropy, getCoder
...
- `../noble-hashes/pbkdf2.js` (imported)
...
- `../noble-hashes/pbkdf2.js` (referenced)
...
```bash
ts-node ts/src/static_dependencies/scure-bip39/index.ts
```
