# Documentation: ts/src/static_dependencies/noble-curves/abstract/modular.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/abstract/modular.ts`
- **Size**: 15,135 bytes
- **Lines**: 419
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/abstract/modular.ts`.

**Functions defined**: tonelliFast, sqrt3mod4, invert, pow2, pow, mod, FpSqrt, tonelliShanks, tonelliSlow, sqrt5mod8
...
```bash
ts-node ts/src/static_dependencies/noble-curves/abstract/modular.ts
```
