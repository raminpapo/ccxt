# Documentation: ts/src/static_dependencies/noble-curves/abstract/weierstrass.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/abstract/weierstrass.ts`
- **Size**: 45,722 bytes
- **Lines**: 1,172
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/abstract/weierstrass.ts`.

**Classes defined**: DERErr, Point, Signature

**Functions defined**: weierstrass, weierstrassEquation, weierstrassPoints, validatePointOpts, isWithinCurveOrder, normPrivateKeyToScalar, validateOpts, assertGE, assertPrjPoint, call
...
```bash
ts-node ts/src/static_dependencies/noble-curves/abstract/weierstrass.ts
```
