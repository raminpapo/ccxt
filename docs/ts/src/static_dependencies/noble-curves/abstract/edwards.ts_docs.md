# Documentation: ts/src/static_dependencies/noble-curves/abstract/edwards.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/abstract/edwards.ts`
- **Size**: 20,483 bytes
- **Lines**: 500
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/abstract/edwards.ts`.

**Classes defined**: Point

**Functions defined**: getExtendedPublicKey, assertGE0, to, assertInRange, modN_LE, getPublicKey, isPoint, modN, validateOpts, twistedEdwards
...
```bash
ts-node ts/src/static_dependencies/noble-curves/abstract/edwards.ts
```
