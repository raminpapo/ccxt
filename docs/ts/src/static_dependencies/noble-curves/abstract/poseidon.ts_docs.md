# Documentation: ts/src/static_dependencies/noble-curves/abstract/poseidon.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/abstract/poseidon.ts`
- **Size**: 5,017 bytes
- **Lines**: 120
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/abstract/poseidon.ts`.

**Functions defined**: splitConstants, validateOpts, poseidon, poseidonHash
...
- `./test/poseidon.test.js` (referenced)
...
```bash
ts-node ts/src/static_dependencies/noble-curves/abstract/poseidon.ts
```
