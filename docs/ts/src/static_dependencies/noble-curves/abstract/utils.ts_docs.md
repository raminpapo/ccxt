# Documentation: ts/src/static_dependencies/noble-curves/abstract/utils.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/abstract/utils.ts`
- **Size**: 9,497 bytes
- **Lines**: 247
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/abstract/utils.ts`.
...
```bash
ts-node ts/src/static_dependencies/noble-curves/abstract/utils.ts
```
