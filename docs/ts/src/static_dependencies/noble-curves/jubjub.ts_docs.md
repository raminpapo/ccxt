# Documentation: ts/src/static_dependencies/noble-curves/jubjub.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/jubjub.ts`
- **Size**: 2,358 bytes
- **Lines**: 59
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/jubjub.ts`.
...
```bash
ts-node ts/src/static_dependencies/noble-curves/jubjub.ts
```
