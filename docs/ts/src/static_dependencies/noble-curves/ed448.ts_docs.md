# Documentation: ts/src/static_dependencies/noble-curves/ed448.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/ed448.ts`
- **Size**: 10,850 bytes
- **Lines**: 243
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/ed448.ts`.

**Functions defined**: map_to_curve_elligator2_curve448, ed448_pow_Pminus3div4, map_to_curve_elligator2_edwards448, adjustScalarBytes
...
- `map_to_curve_elligator2_edwards448()`
...
```bash
ts-node ts/src/static_dependencies/noble-curves/ed448.ts
```
