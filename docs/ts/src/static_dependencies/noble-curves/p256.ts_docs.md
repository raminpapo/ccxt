# Documentation: ts/src/static_dependencies/noble-curves/p256.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/p256.ts`
- **Size**: 1,767 bytes
- **Lines**: 54
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/p256.ts`.
...
```bash
ts-node ts/src/static_dependencies/noble-curves/p256.ts
```
