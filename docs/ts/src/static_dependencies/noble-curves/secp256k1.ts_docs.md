# Documentation: ts/src/static_dependencies/noble-curves/secp256k1.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/secp256k1.ts`
- **Size**: 11,646 bytes
- **Lines**: 271
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/secp256k1.ts`.

**Functions defined**: challenge, schnorrGetPublicKey, schnorrGetExtPubKey, sqrtMod, lift_x, taggedHash, schnorrSign, schnorrVerify
...
```bash
ts-node ts/src/static_dependencies/noble-curves/secp256k1.ts
```
