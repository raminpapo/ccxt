# Documentation: ts/src/static_dependencies/noble-curves/p521.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/p521.ts`
- **Size**: 2,276 bytes
- **Lines**: 58
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/p521.ts`.
...
```bash
ts-node ts/src/static_dependencies/noble-curves/p521.ts
```
