# Documentation: ts/src/static_dependencies/noble-curves/ed25519.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/noble-curves/ed25519.ts`
- **Size**: 18,609 bytes
- **Lines**: 446
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/noble-curves/ed25519.ts`.

**Classes defined**: RistrettoPoint

**Functions defined**: uvRatio, assertRstPoint, ed25519_domain, adjustScalarBytes, ed25519_pow_2_252_3, map_to_curve_elligator2_curve25519, map_to_curve_elligator2_edwards25519, calcElligatorRistrettoMap, like
...
- `./abstract/montgomery.js` (imported)
- `./abstract/utils.js` (imported)
- `../noble-hashes/sha512.js` (imported)
- `./abstract/curve.js` (imported)
...
```bash
ts-node ts/src/static_dependencies/noble-curves/ed25519.ts
```
