# Documentation: ts/src/static_dependencies/ethers/hash/typed-data.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/hash/typed-data.ts`
- **Size**: 21,199 bytes
- **Lines**: 607
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/hash/typed-data.ts`.

**Classes defined**: TypedDataEncoder

**Functions defined**: encodeType, checkString, checkCircular, getBaseEncoder, hexPadRight
...
```bash
ts-node ts/src/static_dependencies/ethers/hash/typed-data.ts
```
