# Documentation: ts/src/static_dependencies/ethers/coders/abstract-coder.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/coders/abstract-coder.ts`
- **Size**: 15,946 bytes
- **Lines**: 493
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/coders/abstract-coder.ts`.

**Classes defined**: Result, Reader, Coder, Array, of, Writer

**Functions defined**: checkResultErrors, throwError, getValue
...
```bash
ts-node ts/src/static_dependencies/ethers/coders/abstract-coder.ts
```
