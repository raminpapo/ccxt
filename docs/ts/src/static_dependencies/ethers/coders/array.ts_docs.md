# Documentation: ts/src/static_dependencies/ethers/coders/array.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/coders/array.ts`
- **Size**: 6,394 bytes
- **Lines**: 200
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/coders/array.ts`.
...
```bash
ts-node ts/src/static_dependencies/ethers/coders/array.ts
```
