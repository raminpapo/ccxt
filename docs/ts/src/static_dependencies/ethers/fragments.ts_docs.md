# Documentation: ts/src/static_dependencies/ethers/fragments.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/fragments.ts`
- **Size**: 52,446 bytes
- **Lines**: 1,615
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/fragments.ts`.

**Classes defined**: TokenString, to, ErrorFragment, ParamType, FallbackFragment, ConstructorFragment, Fragment, NamedFragment, EventFragment

**Functions defined**: consumeParams, lex, is, setify, allowSingle, consumeMutability, receive, consumeName, consumeKeywords
...
```bash
ts-node ts/src/static_dependencies/ethers/fragments.ts
```
