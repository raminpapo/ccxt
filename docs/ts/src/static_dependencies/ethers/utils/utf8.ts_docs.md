# Documentation: ts/src/static_dependencies/ethers/utils/utf8.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/utils/utf8.ts`
- **Size**: 10,670 bytes
- **Lines**: 325
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/utils/utf8.ts`.

**Functions defined**: getUtf8CodePoints, toUtf8CodePoints, toUtf8String, is, _toUtf8String, errorFunc, replaceFunc, should, ignoreFunc, toUtf8Bytes
...
```bash
ts-node ts/src/static_dependencies/ethers/utils/utf8.ts
```
