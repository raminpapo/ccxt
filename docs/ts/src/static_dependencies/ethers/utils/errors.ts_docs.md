# Documentation: ts/src/static_dependencies/ethers/utils/errors.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/utils/errors.ts`
- **Size**: 21,488 bytes
- **Lines**: 786
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/utils/errors.ts`.

**Functions defined**: or, isCallException, assertArgument, assertNormalize, makeError, assert, can, stringify, assertArgumentCount, isError
...
```bash
ts-node ts/src/static_dependencies/ethers/utils/errors.ts
```
