# Documentation: ts/src/static_dependencies/ethers/utils/units.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/utils/units.ts`
- **Size**: 3,002 bytes
- **Lines**: 92
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/utils/units.ts`.
...
```bash
ts-node ts/src/static_dependencies/ethers/utils/units.ts
```
