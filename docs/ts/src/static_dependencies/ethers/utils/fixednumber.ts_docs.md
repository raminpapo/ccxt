# Documentation: ts/src/static_dependencies/ethers/utils/fixednumber.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/utils/fixednumber.ts`
- **Size**: 22,063 bytes
- **Lines**: 644
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/utils/fixednumber.ts`.

**Classes defined**: FixedNumber, permits

**Functions defined**: getFormat, toString, getTens, checkValue
...
```bash
ts-node ts/src/static_dependencies/ethers/utils/fixednumber.ts
```
