# Documentation: ts/src/static_dependencies/ethers/utils/maths.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/utils/maths.ts`
- **Size**: 7,522 bytes
- **Lines**: 241
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/utils/maths.ts`.
...
```bash
ts-node ts/src/static_dependencies/ethers/utils/maths.ts
```
