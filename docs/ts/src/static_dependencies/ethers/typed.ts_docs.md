# Documentation: ts/src/static_dependencies/ethers/typed.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/typed.ts`
- **Size**: 20,479 bytes
- **Lines**: 796
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/typed.ts`.

**Classes defined**: Typed, to
...
```bash
ts-node ts/src/static_dependencies/ethers/typed.ts
```
