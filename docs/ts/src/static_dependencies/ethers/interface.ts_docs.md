# Documentation: ts/src/static_dependencies/ethers/interface.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/ethers/interface.ts`
- **Size**: 43,429 bytes
- **Lines**: 1,228
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/ethers/interface.ts`.

**Classes defined**: ErrorDescription, Interface, is, Indexed, that, TransactionDescription, LogDescription

**Functions defined**: selector, description, checkNames, balanceOf, for, wrapAccessError, name, definition, const
...
```bash
ts-node ts/src/static_dependencies/ethers/interface.ts
```
