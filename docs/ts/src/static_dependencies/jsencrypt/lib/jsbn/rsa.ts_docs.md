# Documentation: ts/src/static_dependencies/jsencrypt/lib/jsbn/rsa.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/jsencrypt/lib/jsbn/rsa.ts`
- **Size**: 12,972 bytes
- **Lines**: 407
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/jsencrypt/lib/jsbn/rsa.ts`.

**Classes defined**: RSAKey

**Functions defined**: byte2Hex, linebrk, pkcs1pad1, RSAEncryptB64, pkcs1unpad2, getDigestHeader, removeDigestHeader, pkcs1pad2
...
```bash
ts-node ts/src/static_dependencies/jsencrypt/lib/jsbn/rsa.ts
```
