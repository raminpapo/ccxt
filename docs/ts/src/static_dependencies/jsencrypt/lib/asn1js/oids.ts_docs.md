# Documentation: ts/src/static_dependencies/jsencrypt/lib/asn1js/oids.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/jsencrypt/lib/asn1js/oids.ts`
- **Size**: 185,081 bytes
- **Lines**: 1,962
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/jsencrypt/lib/asn1js/oids.ts`.
...
```bash
ts-node ts/src/static_dependencies/jsencrypt/lib/asn1js/oids.ts
```
