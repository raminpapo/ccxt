# Documentation: ts/src/static_dependencies/jsencrypt/JSEncrypt.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/jsencrypt/JSEncrypt.ts`
- **Size**: 7,549 bytes
- **Lines**: 221
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/jsencrypt/JSEncrypt.ts`.

**Classes defined**: JSEncrypt
...
- `./JSEncryptRSAKey.js` (imported)
- `./lib/jsbn/base64.js` (imported)
- `./JSEncryptRSAKey.js` (referenced)
...
```bash
ts-node ts/src/static_dependencies/jsencrypt/JSEncrypt.ts
```
