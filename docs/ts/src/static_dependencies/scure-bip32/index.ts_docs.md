# Documentation: ts/src/static_dependencies/scure-bip32/index.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/scure-bip32/index.ts`
- **Size**: 10,512 bytes
- **Lines**: 335
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/scure-bip32/index.ts`.

**Classes defined**: HDKey

**Functions defined**: numberToBytes, bytesToNumber
...
```bash
ts-node ts/src/static_dependencies/scure-bip32/index.ts
```
