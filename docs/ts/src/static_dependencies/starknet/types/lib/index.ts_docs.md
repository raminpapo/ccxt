# Documentation: ts/src/static_dependencies/starknet/types/lib/index.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/types/lib/index.ts`
- **Size**: 7,560 bytes
- **Lines**: 299
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/types/lib/index.ts`.
...
```bash
ts-node ts/src/static_dependencies/starknet/types/lib/index.ts
```
