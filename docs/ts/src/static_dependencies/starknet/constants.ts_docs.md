# Documentation: ts/src/static_dependencies/starknet/constants.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/constants.ts`
- **Size**: 2,489 bytes
- **Lines**: 77
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/constants.ts`.
...
```bash
ts-node ts/src/static_dependencies/starknet/constants.ts
```
