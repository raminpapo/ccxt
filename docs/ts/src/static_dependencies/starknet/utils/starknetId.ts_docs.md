# Documentation: ts/src/static_dependencies/starknet/utils/starknetId.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/starknetId.ts`
- **Size**: 11,837 bytes
- **Lines**: 327
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/starknetId.ts`.

**Functions defined**: execution, useDecoded, getStarknetIdPopContract, getStarknetIdVerifierContract, useEncoded, getStarknetIdIdentityContract, extractStars, getStarknetIdPfpContract, getStarknetIdMulticallContract, getStarknetIdContract
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/starknetId.ts
```
