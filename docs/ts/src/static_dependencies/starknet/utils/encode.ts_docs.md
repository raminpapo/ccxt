# Documentation: ts/src/static_dependencies/starknet/utils/encode.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/encode.ts`
- **Size**: 8,394 bytes
- **Lines**: 295
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/encode.ts`.

**Functions defined**: removeHexPrefix, padString, buf2hex, addHexPrefix, padLeft, utf8ToArray, btoaUniversal, atobUniversal, stringToArrayBuffer, arrayBufferToString
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/encode.ts
```
