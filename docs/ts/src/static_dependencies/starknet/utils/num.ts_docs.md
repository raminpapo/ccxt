# Documentation: ts/src/static_dependencies/starknet/utils/num.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/num.ts`
- **Size**: 7,508 bytes
- **Lines**: 273
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/num.ts`.

**Functions defined**: toBigInt, toStorageKey, assertInRange, bigNumberishArrayToDecimalStringArray, isBigInt, bigNumberishArrayToHexadecimalStringArray, getDecimalString, isHex, toHex, hexToDecimalString
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/num.ts
```
