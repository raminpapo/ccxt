# Documentation: ts/src/static_dependencies/starknet/utils/cairoDataTypes/uint256.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/cairoDataTypes/uint256.ts`
- **Size**: 3,832 bytes
- **Lines**: 137
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/cairoDataTypes/uint256.ts`.
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/cairoDataTypes/uint256.ts
```
