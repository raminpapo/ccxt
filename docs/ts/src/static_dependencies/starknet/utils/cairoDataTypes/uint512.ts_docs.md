# Documentation: ts/src/static_dependencies/starknet/utils/cairoDataTypes/uint512.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/cairoDataTypes/uint512.ts`
- **Size**: 4,749 bytes
- **Lines**: 177
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/cairoDataTypes/uint512.ts`.
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/cairoDataTypes/uint512.ts
```
