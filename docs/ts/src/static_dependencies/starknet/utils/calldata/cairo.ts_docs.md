# Documentation: ts/src/static_dependencies/starknet/utils/calldata/cairo.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/calldata/cairo.ts`
- **Size**: 8,385 bytes
- **Lines**: 251
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/calldata/cairo.ts`.

**Functions defined**: felt, with, isCairo1Abi, io, getAbiContractVersion
...
- `../cairoDataTypes/felt.js` (imported)
- `../cairoDataTypes/uint256.js` (referenced)
- `../cairoDataTypes/felt.js` (referenced)
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/calldata/cairo.ts
```
