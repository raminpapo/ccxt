# Documentation: ts/src/static_dependencies/starknet/utils/calldata/responseParser.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/calldata/responseParser.ts`
- **Size**: 9,131 bytes
- **Lines**: 274
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/calldata/responseParser.ts`.

**Functions defined**: parseResponseValue, parseBaseTypes, responseParser
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/calldata/responseParser.ts
```
