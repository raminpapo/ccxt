# Documentation: ts/src/static_dependencies/starknet/utils/calldata/propertyOrder.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/calldata/propertyOrder.ts`
- **Size**: 7,200 bytes
- **Lines**: 213
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/calldata/propertyOrder.ts`.
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/calldata/propertyOrder.ts
```
