# Documentation: ts/src/static_dependencies/starknet/utils/calldata/validate.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/calldata/validate.ts`
- **Size**: 10,692 bytes
- **Lines**: 328
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/calldata/validate.ts`.
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/calldata/validate.ts
```
