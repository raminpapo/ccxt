# Documentation: ts/src/static_dependencies/starknet/utils/calldata/index.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/calldata/index.ts`
- **Size**: 12,554 bytes
- **Lines**: 356
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/calldata/index.ts`.

**Classes defined**: CallData
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/calldata/index.ts
```
