# Documentation: ts/src/static_dependencies/starknet/utils/calldata/requestParser.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/calldata/requestParser.ts`
- **Size**: 10,428 bytes
- **Lines**: 323
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/calldata/requestParser.ts`.

**Functions defined**: parseBaseTypes, parseTuple, parseCalldataValue, parseCalldataField, parseByteArray
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/calldata/requestParser.ts
```
