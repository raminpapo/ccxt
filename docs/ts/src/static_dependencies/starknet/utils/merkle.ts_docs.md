# Documentation: ts/src/static_dependencies/starknet/utils/merkle.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/merkle.ts`
- **Size**: 3,150 bytes
- **Lines**: 108
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/merkle.ts`.
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/merkle.ts
```
