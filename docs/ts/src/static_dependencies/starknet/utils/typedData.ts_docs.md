# Documentation: ts/src/static_dependencies/starknet/utils/typedData.ts

## File Metadata

- **Path**: `ts/src/static_dependencies/starknet/utils/typedData.ts`
- **Size**: 13,641 bytes
- **Lines**: 441
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/static_dependencies/starknet/utils/typedData.ts`.

**Functions defined**: assertRange, getHex, encodeType, getDependencies, isMerkleTreeType, prepareSelector, getTypeHash, identifyRevision, validateTypedData, getMerkleTreeType
...
```bash
ts-node ts/src/static_dependencies/starknet/utils/typedData.ts
```
