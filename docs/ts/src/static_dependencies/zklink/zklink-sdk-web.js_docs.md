# Documentation: ts/src/static_dependencies/zklink/zklink-sdk-web.js

## File Metadata

- **Path**: `ts/src/static_dependencies/zklink/zklink-sdk-web.js`
- **Size**: 136,168 bytes
- **Lines**: 4,702
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `ts/src/static_dependencies/zklink/zklink-sdk-web.js`.
...
```bash
node ts/src/static_dependencies/zklink/zklink-sdk-web.js
```
