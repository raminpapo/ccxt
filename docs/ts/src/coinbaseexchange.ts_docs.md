# Documentation: ts/src/coinbaseexchange.ts

## File Metadata

- **Path**: `ts/src/coinbaseexchange.ts`
- **Size**: 97,217 bytes
- **Lines**: 2,165
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coinbaseexchange.ts`.
...
```bash
ts-node ts/src/coinbaseexchange.ts
```
