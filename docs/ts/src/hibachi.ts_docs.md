# Documentation: ts/src/hibachi.ts

## File Metadata

- **Path**: `ts/src/hibachi.ts`
- **Size**: 92,783 bytes
- **Lines**: 2,169
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/hibachi.ts`.
...
- `./abstract/hibachi.js` (referenced)
...
- `https://data-api.hibachi.xyz` (referenced)
- `./base/types.js` (referenced)
- `https://api.hibachi.xyz` (referenced)
