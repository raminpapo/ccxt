# Documentation: ts/src/bitopro.ts

## File Metadata

- **Path**: `ts/src/bitopro.ts`
- **Size**: 81,105 bytes
- **Lines**: 1,918
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitopro.ts`.
...
- `./abstract/bitopro.js` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://github.com/bitoex/bitopro-offical-api-docs/blob/master/v3-1/rest-1/rest.md` (referenced)
- `https://www.bitopro.com` (referenced)
