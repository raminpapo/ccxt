# Documentation: ts/src/base/functions/number.ts

## File Metadata

- **Path**: `ts/src/base/functions/number.ts`
- **Size**: 13,979 bytes
- **Lines**: 353
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/base/functions/number.ts`.
...
```bash
ts-node ts/src/base/functions/number.ts
```
