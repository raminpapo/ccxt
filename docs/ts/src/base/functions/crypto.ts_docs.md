# Documentation: ts/src/base/functions/crypto.ts

## File Metadata

- **Path**: `ts/src/base/functions/crypto.ts`
- **Size**: 7,872 bytes
- **Lines**: 151
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/base/functions/crypto.ts`.
...
- `../../static_dependencies/jsencrypt/lib/asn1js/base64.js` (imported)
...
- `../../static_dependencies/jsencrypt/lib/asn1js/asn1.js` (imported)
- `../../static_dependencies/noble-hashes/utils.js` (imported)
- `../../static_dependencies/noble-curves/abstract/utils.js` (imported)
- `../../static_dependencies/noble-hashes/hmac.js` (imported)
- `../../static_dependencies/jsencrypt/lib/asn1js/base64.js` (referenced)
...
```bash
ts-node ts/src/base/functions/crypto.ts
```
