# Documentation: ts/src/base/functions/generic.ts

## File Metadata

- **Path**: `ts/src/base/functions/generic.ts`
- **Size**: 7,207 bytes
- **Lines**: 266
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/base/functions/generic.ts`.

**Functions defined**: deepExtend, flatten
...
```bash
ts-node ts/src/base/functions/generic.ts
```
