# Documentation: ts/src/base/functions/time.ts

## File Metadata

- **Path**: `ts/src/base/functions/time.ts`
- **Size**: 6,251 bytes
- **Lines**: 183
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/base/functions/time.ts`.

**Classes defined**: TimedOut

**Functions defined**: was, can, clear
...
```bash
ts-node ts/src/base/functions/time.ts
```
