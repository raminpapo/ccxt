# Documentation: ts/src/base/functions/string.ts

## File Metadata

- **Path**: `ts/src/base/functions/string.ts`
- **Size**: 1,915 bytes
- **Lines**: 50
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/base/functions/string.ts`.
...
```bash
ts-node ts/src/base/functions/string.ts
```
