# Documentation: ts/src/base/Precise.ts

## File Metadata

- **Path**: `ts/src/base/Precise.ts`
- **Size**: 9,606 bytes
- **Lines**: 303
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/base/Precise.ts`.
...
```bash
ts-node ts/src/base/Precise.ts
```
