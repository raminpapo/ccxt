# Documentation: ts/src/base/ws/Client.ts

## File Metadata

- **Path**: `ts/src/base/ws/Client.ts`
- **Size**: 13,073 bytes
- **Lines**: 384
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/base/ws/Client.ts`.

**Classes defined**: Client

**Functions defined**: as, onSendComplete
...
```bash
ts-node ts/src/base/ws/Client.ts
```
