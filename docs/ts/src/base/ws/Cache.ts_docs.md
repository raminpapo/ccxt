# Documentation: ts/src/base/ws/Cache.ts

## File Metadata

- **Path**: `ts/src/base/ws/Cache.ts`
- **Size**: 8,894 bytes
- **Lines**: 279
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/base/ws/Cache.ts`.
...
```bash
ts-node ts/src/base/ws/Cache.ts
```
