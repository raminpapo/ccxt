# Documentation: ts/src/base/ws/OrderBookSide.ts

## File Metadata

- **Path**: `ts/src/base/ws/OrderBookSide.ts`
- **Size**: 10,880 bytes
- **Lines**: 298
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/base/ws/OrderBookSide.ts`.
...
```bash
ts-node ts/src/base/ws/OrderBookSide.ts
```
