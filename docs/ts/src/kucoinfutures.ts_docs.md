# Documentation: ts/src/kucoinfutures.ts

## File Metadata

- **Path**: `ts/src/kucoinfutures.ts`
- **Size**: 159,196 bytes
- **Lines**: 3,461
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/kucoinfutures.ts`.

**Classes defined**: kucoinfutures
...
- `./abstract/kucoinfutures.js` (imported)
- `./base/functions/number.js` (imported)
- `./base/errors.js` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `./abstract/kucoinfutures.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/147508995-9e35030a-d046-43a1-a006-6fabd981b554.jpg` (referenced)
- `./base/functions/number.js` (referenced)
- `https://docs.kucoin.com` (referenced)
- `https://openapi-v2.kucoin.com` (referenced)
...
```bash
ts-node ts/src/kucoinfutures.ts
```
