# Documentation: ts/src/binance.ts

## File Metadata

- **Path**: `ts/src/binance.ts`
- **Size**: 732,363 bytes
- **Lines**: 14,283
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/binance.ts`.

**Classes defined**: binance

**Functions defined**: to, is
...
- `accountSnapshot` (imported)
- `./static_dependencies/noble-curves/ed25519.js` (imported)
- `./abstract/binance.js` (referenced)
...
- `https://www.binance.com` (referenced)
