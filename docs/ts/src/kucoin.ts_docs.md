# Documentation: ts/src/kucoin.ts

## File Metadata

- **Path**: `ts/src/kucoin.ts`
- **Size**: 276,093 bytes
- **Lines**: 5,793
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/kucoin.ts`.

**Classes defined**: kucoin

**Functions defined**: has, of
...
- `./abstract/kucoin.js` (imported)
- `webApiRetries` (imported)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `./base/errors.js` (referenced)
- `./base/Precise.js` (referenced)
- `https://api.kucoin.com` (referenced)
- `https://user-images.githubusercontent.com/51840849/87295558-132aaf80-c50e-11ea-9801-a2fb0c57c799.jpg` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/number.js` (referenced)
- `./abstract/kucoin.js` (referenced)
- `https://api-futures.kucoin.com` (referenced)
