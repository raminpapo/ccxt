# Documentation: ts/src/hitbtc.ts

## File Metadata

- **Path**: `ts/src/hitbtc.ts`
- **Size**: 172,195 bytes
- **Lines**: 3,842
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/hitbtc.ts`.

**Classes defined**: hitbtc
...
- `https://api.hitbtc.com` (referenced)
- `./abstract/hitbtc.js` (referenced)
- `./base/Precise.js` (referenced)
- `https://github.com/hitbtc-com/hitbtc-api/blob/master/APIv2.md` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/27766555-8eaec20e-5edc-11e7-9c5b-6dc69fc42f5e.jpg` (referenced)
- `https://hitbtc.com` (referenced)
