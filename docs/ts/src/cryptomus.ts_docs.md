# Documentation: ts/src/cryptomus.ts

## File Metadata

- **Path**: `ts/src/cryptomus.ts`
- **Size**: 51,578 bytes
- **Lines**: 1,182
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/cryptomus.ts`.
...
- `./abstract/cryptomus.js` (imported)
...
- `https://cryptomus.com` (referenced)
- `https://api.cryptomus.com` (referenced)
- `./abstract/cryptomus.js` (referenced)
