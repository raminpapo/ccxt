# Documentation: ts/src/phemex.ts

## File Metadata

- **Path**: `ts/src/phemex.ts`
- **Size**: 260,349 bytes
- **Lines**: 5,332
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/phemex.ts`.
...
- `./abstract/phemex.js` (imported)
- `x-phemex-request-expiry` (imported)
...
- `https://user-images.githubusercontent.com/1294454/85225056-221eb600-b3d7-11ea-930d-564d2690e3f6.jpg` (referenced)
- `https://testnet-api.phemex.com` (referenced)
- `./abstract/phemex.js` (referenced)
