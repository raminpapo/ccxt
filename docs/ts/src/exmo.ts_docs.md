...
This is a TypeScript file located at `ts/src/exmo.ts`.

**Classes defined**: exmo

**Functions defined**: do
...
- `./abstract/exmo.js` (referenced)
- `https://exmo.me` (referenced)
- `https://api.exmo.com` (referenced)
- `./base/Precise.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/27766491-1b0ea956-5eda-11e7-9225-40d67b481b8d.jpg` (referenced)
