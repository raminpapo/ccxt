# Documentation: ts/src/probit.ts

## File Metadata

- **Path**: `ts/src/probit.ts`
- **Size**: 85,080 bytes
- **Lines**: 1,958
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/probit.ts`.
...
- `./abstract/probit.js` (imported)
- `./base/types.js` (imported)
- `./base/functions/number.js` (imported)
- `./base/errors.js` (referenced)
- `https://user-images.githubusercontent.com/51840849/79268032-c4379480-7ea2-11ea-80b3-dd96bb29fd0d.jpg` (referenced)
- `./base/Precise.js` (referenced)
- `./abstract/probit.js` (referenced)
- `./base/types.js` (referenced)
- `https://docs-ko.probit.com` (referenced)
- `./base/functions/number.js` (referenced)
- `https://www.probit.com` (referenced)
- `https://docs-en.probit.com` (referenced)
- `https://accounts.probit.com` (referenced)
