# Documentation: ts/src/delta.ts

## File Metadata

- **Path**: `ts/src/delta.ts`
- **Size**: 170,279 bytes
- **Lines**: 3,796
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/delta.ts`.

**Classes defined**: delta
...
- `./abstract/delta.js` (imported)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `./base/errors.js` (referenced)
- `./base/Precise.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/99450025-3be60a00-2931-11eb-9302-f4fd8d8589aa.jpg` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/number.js` (referenced)
- `./abstract/delta.js` (referenced)
