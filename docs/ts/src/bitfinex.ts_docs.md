# Documentation: ts/src/bitfinex.ts

## File Metadata

- **Path**: `ts/src/bitfinex.ts`
- **Size**: 180,693 bytes
- **Lines**: 3,985
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitfinex.ts`.

**Classes defined**: if, bitfinex
