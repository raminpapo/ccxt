# Documentation: ts/src/bit2c.ts

## File Metadata

- **Path**: `ts/src/bit2c.ts`
- **Size**: 44,097 bytes
- **Lines**: 1,036
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bit2c.ts`.
...
- `https://www.bit2c.co.il` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `https://bit2c.co.il` (referenced)
