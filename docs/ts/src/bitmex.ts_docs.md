# Documentation: ts/src/bitmex.ts

## File Metadata

- **Path**: `ts/src/bitmex.ts`
- **Size**: 141,202 bytes
- **Lines**: 3,117
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitmex.ts`.

**Classes defined**: bitmex
