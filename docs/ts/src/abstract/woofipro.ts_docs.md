# Documentation: ts/src/abstract/woofipro.ts

## File Metadata

- **Path**: `ts/src/abstract/woofipro.ts`
- **Size**: 9,419 bytes
- **Lines**: 131
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/woofipro.ts`.
...
```bash
ts-node ts/src/abstract/woofipro.ts
```
