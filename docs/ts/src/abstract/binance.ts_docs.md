# Documentation: ts/src/abstract/binance.ts

## File Metadata

- **Path**: `ts/src/abstract/binance.ts`
- **Size**: 59,183 bytes
- **Lines**: 783
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/binance.ts`.
...
```bash
ts-node ts/src/abstract/binance.ts
```
