# Documentation: ts/src/abstract/coinbaseadvanced.ts

## File Metadata

- **Path**: `ts/src/abstract/coinbaseadvanced.ts`
- **Size**: 8,392 bytes
- **Lines**: 107
- **Type**: TypeScript
- **Extension**: .ts
...
abstract class coinbase extends _coinbase {}
...
This is a TypeScript file located at `ts/src/abstract/coinbaseadvanced.ts`.
...
```bash
ts-node ts/src/abstract/coinbaseadvanced.ts
```
