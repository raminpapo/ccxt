# Documentation: ts/src/abstract/upbit.ts

## File Metadata

- **Path**: `ts/src/abstract/upbit.ts`
- **Size**: 4,302 bytes
- **Lines**: 68
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/upbit.ts`.
...
```bash
ts-node ts/src/abstract/upbit.ts
```
