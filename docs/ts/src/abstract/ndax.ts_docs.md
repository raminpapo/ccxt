# Documentation: ts/src/abstract/ndax.ts

## File Metadata

- **Path**: `ts/src/abstract/ndax.ts`
- **Size**: 7,701 bytes
- **Lines**: 109
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/ndax.ts`.
...
```bash
ts-node ts/src/abstract/ndax.ts
```
