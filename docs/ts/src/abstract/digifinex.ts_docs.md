# Documentation: ts/src/abstract/digifinex.ts

## File Metadata

- **Path**: `ts/src/abstract/digifinex.ts`
- **Size**: 7,394 bytes
- **Lines**: 104
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/digifinex.ts`.
...
```bash
ts-node ts/src/abstract/digifinex.ts
```
