# Documentation: ts/src/abstract/cryptocom.ts

## File Metadata

- **Path**: `ts/src/abstract/cryptocom.ts`
- **Size**: 10,791 bytes
- **Lines**: 135
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/cryptocom.ts`.
...
```bash
ts-node ts/src/abstract/cryptocom.ts
```
