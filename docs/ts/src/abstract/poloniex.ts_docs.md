# Documentation: ts/src/abstract/poloniex.ts

## File Metadata

- **Path**: `ts/src/abstract/poloniex.ts`
- **Size**: 8,326 bytes
- **Lines**: 117
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/poloniex.ts`.
...
```bash
ts-node ts/src/abstract/poloniex.ts
```
