# Documentation: ts/src/abstract/bequant.ts

## File Metadata

- **Path**: `ts/src/abstract/bequant.ts`
- **Size**: 9,304 bytes
- **Lines**: 127
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/bequant.ts`.
...
```bash
ts-node ts/src/abstract/bequant.ts
```
