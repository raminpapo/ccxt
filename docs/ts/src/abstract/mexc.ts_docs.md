# Documentation: ts/src/abstract/mexc.ts

## File Metadata

- **Path**: `ts/src/abstract/mexc.ts`
- **Size**: 14,912 bytes
- **Lines**: 193
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/mexc.ts`.
...
```bash
ts-node ts/src/abstract/mexc.ts
```
