# Documentation: ts/src/abstract/htx.ts

## File Metadata

- **Path**: `ts/src/abstract/htx.ts`
- **Size**: 49,855 bytes
- **Lines**: 560
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/htx.ts`.
...
```bash
ts-node ts/src/abstract/htx.ts
```
