# Documentation: ts/src/abstract/gateio.ts

## File Metadata

- **Path**: `ts/src/abstract/gateio.ts`
- **Size**: 26,870 bytes
- **Lines**: 340
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/gateio.ts`.
...
```bash
ts-node ts/src/abstract/gateio.ts
```
