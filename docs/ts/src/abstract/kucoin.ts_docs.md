# Documentation: ts/src/abstract/kucoin.ts

## File Metadata

- **Path**: `ts/src/abstract/kucoin.ts`
- **Size**: 20,001 bytes
- **Lines**: 266
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/kucoin.ts`.
...
```bash
ts-node ts/src/abstract/kucoin.ts
```
