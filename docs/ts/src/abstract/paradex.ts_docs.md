# Documentation: ts/src/abstract/paradex.ts

## File Metadata

- **Path**: `ts/src/abstract/paradex.ts`
- **Size**: 4,779 bytes
- **Lines**: 75
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/paradex.ts`.
...
```bash
ts-node ts/src/abstract/paradex.ts
```
