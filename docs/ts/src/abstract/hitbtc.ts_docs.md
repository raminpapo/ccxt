# Documentation: ts/src/abstract/hitbtc.ts

## File Metadata

- **Path**: `ts/src/abstract/hitbtc.ts`
- **Size**: 9,337 bytes
- **Lines**: 127
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/hitbtc.ts`.
...
```bash
ts-node ts/src/abstract/hitbtc.ts
```
