# Documentation: ts/src/abstract/binanceusdm.ts

## File Metadata

- **Path**: `ts/src/abstract/binanceusdm.ts`
- **Size**: 59,156 bytes
- **Lines**: 783
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/binanceusdm.ts`.
...
```bash
ts-node ts/src/abstract/binanceusdm.ts
```
