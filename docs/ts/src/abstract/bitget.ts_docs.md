# Documentation: ts/src/abstract/bitget.ts

## File Metadata

- **Path**: `ts/src/abstract/bitget.ts`
- **Size**: 51,228 bytes
- **Lines**: 588
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/bitget.ts`.
...
```bash
ts-node ts/src/abstract/bitget.ts
```
