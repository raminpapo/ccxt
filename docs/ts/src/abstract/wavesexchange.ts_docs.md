# Documentation: ts/src/abstract/wavesexchange.ts

## File Metadata

- **Path**: `ts/src/abstract/wavesexchange.ts`
- **Size**: 12,429 bytes
- **Lines**: 166
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/wavesexchange.ts`.
...
```bash
ts-node ts/src/abstract/wavesexchange.ts
```
