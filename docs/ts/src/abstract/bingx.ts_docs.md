# Documentation: ts/src/abstract/bingx.ts

## File Metadata

- **Path**: `ts/src/abstract/bingx.ts`
- **Size**: 14,990 bytes
- **Lines**: 191
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/bingx.ts`.
...
```bash
ts-node ts/src/abstract/bingx.ts
```
