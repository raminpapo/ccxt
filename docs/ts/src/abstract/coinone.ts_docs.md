# Documentation: ts/src/abstract/coinone.ts

## File Metadata

- **Path**: `ts/src/abstract/coinone.ts`
- **Size**: 5,557 bytes
- **Lines**: 79
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/coinone.ts`.
...
```bash
ts-node ts/src/abstract/coinone.ts
```
