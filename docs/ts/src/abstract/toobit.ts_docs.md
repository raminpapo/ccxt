# Documentation: ts/src/abstract/toobit.ts

## File Metadata

- **Path**: `ts/src/abstract/toobit.ts`
- **Size**: 5,193 bytes
- **Lines**: 75
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/toobit.ts`.
...
```bash
ts-node ts/src/abstract/toobit.ts
```
