# Documentation: ts/src/abstract/kucoinfutures.ts

## File Metadata

- **Path**: `ts/src/abstract/kucoinfutures.ts`
- **Size**: 22,277 bytes
- **Lines**: 294
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/kucoinfutures.ts`.
...
```bash
ts-node ts/src/abstract/kucoinfutures.ts
```
