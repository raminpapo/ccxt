# Documentation: ts/src/abstract/binancecoinm.ts

## File Metadata

- **Path**: `ts/src/abstract/binancecoinm.ts`
- **Size**: 59,156 bytes
- **Lines**: 783
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/binancecoinm.ts`.
...
```bash
ts-node ts/src/abstract/binancecoinm.ts
```
