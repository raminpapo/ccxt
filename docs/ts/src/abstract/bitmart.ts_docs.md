# Documentation: ts/src/abstract/bitmart.ts

## File Metadata

- **Path**: `ts/src/abstract/bitmart.ts`
- **Size**: 9,931 bytes
- **Lines**: 129
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/bitmart.ts`.
...
```bash
ts-node ts/src/abstract/bitmart.ts
```
