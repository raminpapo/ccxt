# Documentation: ts/src/abstract/coinex.ts

## File Metadata

- **Path**: `ts/src/abstract/coinex.ts`
- **Size**: 19,272 bytes
- **Lines**: 249
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/coinex.ts`.
...
```bash
ts-node ts/src/abstract/coinex.ts
```
