# Documentation: ts/src/abstract/huobi.ts

## File Metadata

- **Path**: `ts/src/abstract/huobi.ts`
- **Size**: 49,804 bytes
- **Lines**: 560
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/huobi.ts`.
...
```bash
ts-node ts/src/abstract/huobi.ts
```
