# Documentation: ts/src/abstract/bitmex.ts

## File Metadata

- **Path**: `ts/src/abstract/bitmex.ts`
- **Size**: 7,289 bytes
- **Lines**: 109
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/bitmex.ts`.
...
```bash
ts-node ts/src/abstract/bitmex.ts
```
