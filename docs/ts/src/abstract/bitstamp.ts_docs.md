# Documentation: ts/src/abstract/bitstamp.ts

## File Metadata

- **Path**: `ts/src/abstract/bitstamp.ts`
- **Size**: 19,034 bytes
- **Lines**: 271
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/bitstamp.ts`.
...
```bash
ts-node ts/src/abstract/bitstamp.ts
```
