# Documentation: ts/src/abstract/whitebit.ts

## File Metadata

- **Path**: `ts/src/abstract/whitebit.ts`
- **Size**: 9,125 bytes
- **Lines**: 126
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/whitebit.ts`.
...
```bash
ts-node ts/src/abstract/whitebit.ts
```
