# Documentation: ts/src/abstract/deribit.ts

## File Metadata

- **Path**: `ts/src/abstract/deribit.ts`
- **Size**: 9,778 bytes
- **Lines**: 138
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/deribit.ts`.
...
```bash
ts-node ts/src/abstract/deribit.ts
```
