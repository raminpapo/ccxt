# Documentation: ts/src/abstract/coinbaseinternational.ts

## File Metadata

- **Path**: `ts/src/abstract/coinbaseinternational.ts`
- **Size**: 3,330 bytes
- **Lines**: 51
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/coinbaseinternational.ts`.
...
```bash
ts-node ts/src/abstract/coinbaseinternational.ts
```
