# Documentation: ts/src/abstract/okxus.ts

## File Metadata

- **Path**: `ts/src/abstract/okxus.ts`
- **Size**: 29,067 bytes
- **Lines**: 363
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/okxus.ts`.
...
```bash
ts-node ts/src/abstract/okxus.ts
```
