# Documentation: ts/src/abstract/okx.ts

## File Metadata

- **Path**: `ts/src/abstract/okx.ts`
- **Size**: 29,118 bytes
- **Lines**: 363
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/okx.ts`.
...
```bash
ts-node ts/src/abstract/okx.ts
```
