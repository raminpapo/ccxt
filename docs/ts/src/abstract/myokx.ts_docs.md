# Documentation: ts/src/abstract/myokx.ts

## File Metadata

- **Path**: `ts/src/abstract/myokx.ts`
- **Size**: 29,067 bytes
- **Lines**: 363
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/myokx.ts`.
...
```bash
ts-node ts/src/abstract/myokx.ts
```
