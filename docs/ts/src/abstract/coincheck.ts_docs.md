# Documentation: ts/src/abstract/coincheck.ts

## File Metadata

- **Path**: `ts/src/abstract/coincheck.ts`
- **Size**: 2,717 bytes
- **Lines**: 45
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/coincheck.ts`.
...
```bash
ts-node ts/src/abstract/coincheck.ts
```
