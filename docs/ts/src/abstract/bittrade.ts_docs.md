# Documentation: ts/src/abstract/bittrade.ts

## File Metadata

- **Path**: `ts/src/abstract/bittrade.ts`
- **Size**: 8,956 bytes
- **Lines**: 126
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/bittrade.ts`.
...
```bash
ts-node ts/src/abstract/bittrade.ts
```
