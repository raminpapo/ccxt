# Documentation: ts/src/abstract/bitfinex.ts

## File Metadata

- **Path**: `ts/src/abstract/bitfinex.ts`
- **Size**: 11,211 bytes
- **Lines**: 152
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/bitfinex.ts`.
...
```bash
ts-node ts/src/abstract/bitfinex.ts
```
