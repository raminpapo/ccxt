# Documentation: ts/src/abstract/binanceus.ts

## File Metadata

- **Path**: `ts/src/abstract/binanceus.ts`
- **Size**: 63,147 bytes
- **Lines**: 835
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/binanceus.ts`.
...
```bash
ts-node ts/src/abstract/binanceus.ts
```
