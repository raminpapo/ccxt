# Documentation: ts/src/abstract/coinbase.ts

## File Metadata

- **Path**: `ts/src/abstract/coinbase.ts`
- **Size**: 8,413 bytes
- **Lines**: 107
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/abstract/coinbase.ts`.
...
```bash
ts-node ts/src/abstract/coinbase.ts
```
