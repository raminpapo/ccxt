# Documentation: ts/src/backpack.ts

## File Metadata

- **Path**: `ts/src/backpack.ts`
- **Size**: 104,299 bytes
- **Lines**: 2,344
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/backpack.ts`.

**Classes defined**: backpack
...
- `./abstract/backpack.js` (referenced)
