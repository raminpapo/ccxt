# Documentation: ts/src/coincheck.ts

## File Metadata

- **Path**: `ts/src/coincheck.ts`
- **Size**: 42,907 bytes
- **Lines**: 976
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coincheck.ts`.
...
- `./abstract/coincheck.js` (imported)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `./base/errors.js` (referenced)
- `./base/types.js` (referenced)
- `https://user-images.githubusercontent.com/51840849/87182088-1d6d6380-c2ec-11ea-9c64-8ab9f9b289f5.jpg` (referenced)
- `./base/functions/number.js` (referenced)
- `./abstract/coincheck.js` (referenced)
- `https://coincheck.com` (referenced)
