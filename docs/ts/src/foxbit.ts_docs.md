# Documentation: ts/src/foxbit.ts

## File Metadata

- **Path**: `ts/src/foxbit.ts`
- **Size**: 91,481 bytes
- **Lines**: 2,053
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/foxbit.ts`.
...
- `./abstract/foxbit.js` (imported)
- `broad` (imported)
- `./base/errors.js` (referenced)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `https://api.foxbit.com.br` (referenced)
- `./base/Precise.js` (referenced)
- `https://docs.foxbit.com.br` (referenced)
- `https://app.foxbit.com.br` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/number.js` (referenced)
- `./abstract/foxbit.js` (referenced)
