# Documentation: ts/src/latoken.ts

## File Metadata

- **Path**: `ts/src/latoken.ts`
- **Size**: 87,277 bytes
- **Lines**: 1,842
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/latoken.ts`.

**Classes defined**: latoken
...
- `TOO_MANY_REQUESTS` (imported)
- `./base/types.js` (imported)
- `./static_dependencies/noble-hashes/sha512.js` (imported)
- `./base/functions/number.js` (imported)
- `./abstract/latoken.js` (imported)
- `./base/errors.js` (referenced)
- `https://api.latoken.com` (referenced)
- `https://latoken.com` (referenced)
- `./base/types.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/61511972-24c39f00-aa01-11e9-9f7c-471f1d6e5214.jpg` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `./abstract/latoken.js` (referenced)
