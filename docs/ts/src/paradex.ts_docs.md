# Documentation: ts/src/paradex.ts

## File Metadata

- **Path**: `ts/src/paradex.ts`
- **Size**: 116,380 bytes
- **Lines**: 2,650
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/paradex.ts`.
...
- `./abstract/paradex.js` (referenced)
