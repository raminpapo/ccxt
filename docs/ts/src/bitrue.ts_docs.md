# Documentation: ts/src/bitrue.ts

## File Metadata

- **Path**: `ts/src/bitrue.ts`
- **Size**: 150,528 bytes
- **Lines**: 3,362
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitrue.ts`.
...
- `./abstract/bitrue.js` (referenced)
- `./base/types.js` (referenced)
- `https://www.bitrue.com` (referenced)
