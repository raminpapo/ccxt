# Documentation: ts/src/timex.ts

## File Metadata

- **Path**: `ts/src/timex.ts`
- **Size**: 81,286 bytes
- **Lines**: 1,814
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/timex.ts`.

**Classes defined**: timex
...
- `./abstract/timex.js` (imported)
- `./base/errors.js` (referenced)
- `./base/Precise.js` (referenced)
- `https://plasma-relay-backend.timex.io` (referenced)
- `./base/types.js` (referenced)
- `https://plasma-relay-backend.timex.io/swagger-ui/index.html` (referenced)
- `https://timex.io` (referenced)
- `./base/functions/number.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/70423869-6839ab00-1a7f-11ea-8f94-13ae72c31115.jpg` (referenced)
- `./abstract/timex.js` (referenced)
