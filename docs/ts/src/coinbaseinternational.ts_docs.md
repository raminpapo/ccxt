# Documentation: ts/src/coinbaseinternational.ts

## File Metadata

- **Path**: `ts/src/coinbaseinternational.ts`
- **Size**: 108,398 bytes
- **Lines**: 2,383
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coinbaseinternational.ts`.
...
```bash
ts-node ts/src/coinbaseinternational.ts
```
