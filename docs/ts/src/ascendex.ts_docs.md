# Documentation: ts/src/ascendex.ts

## File Metadata

- **Path**: `ts/src/ascendex.ts`
- **Size**: 169,945 bytes
- **Lines**: 3,729
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/ascendex.ts`.
...
- `https://api-test.ascendex-sandbox.com` (referenced)
- `./abstract/ascendex.js` (referenced)
- `./base/types.js` (referenced)
- `https://ascendex.com` (referenced)
