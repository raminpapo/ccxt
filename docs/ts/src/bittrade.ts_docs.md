# Documentation: ts/src/bittrade.ts

## File Metadata

- **Path**: `ts/src/bittrade.ts`
- **Size**: 98,880 bytes
- **Lines**: 2,078
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bittrade.ts`.

**Classes defined**: bittrade
...
- `./abstract/bittrade.js` (imported)
- `./base/types.js` (imported)
- `./base/functions/number.js` (imported)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `./base/errors.js` (referenced)
- `https://www.bittrade.co.jp` (referenced)
- `./base/Precise.js` (referenced)
- `./abstract/bittrade.js` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/85734211-85755480-b705-11ea-8b35-0b7f1db33a2f.jpg` (referenced)
- `https://api-doc.bittrade.co.jp` (referenced)
