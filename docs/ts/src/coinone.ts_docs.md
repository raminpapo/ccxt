# Documentation: ts/src/coinone.ts

## File Metadata

- **Path**: `ts/src/coinone.ts`
- **Size**: 54,241 bytes
- **Lines**: 1,293
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coinone.ts`.
...
- `./abstract/coinone.js` (imported)
- `./base/errors.js` (referenced)
- `https://doc.coinone.co.kr` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `./abstract/coinone.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/38003300-adc12fba-323f-11e8-8525-725f53c4a659.jpg` (referenced)
- `https://api.coinone.co.kr` (referenced)
- `https://coinone.co.kr` (referenced)
