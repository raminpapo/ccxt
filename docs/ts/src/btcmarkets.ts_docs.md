# Documentation: ts/src/btcmarkets.ts

## File Metadata

- **Path**: `ts/src/btcmarkets.ts`
- **Size**: 61,935 bytes
- **Lines**: 1,447
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/btcmarkets.ts`.

**Classes defined**: btcmarkets
...
- `./abstract/btcmarkets.js` (imported)
...
- `./abstract/btcmarkets.js` (referenced)
- `./base/errors.js` (referenced)
- `https://api.btcmarkets.net` (referenced)
- `https://btcmarkets.net` (referenced)
