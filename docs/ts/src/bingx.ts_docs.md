# Documentation: ts/src/bingx.ts

## File Metadata

- **Path**: `ts/src/bingx.ts`
- **Size**: 299,413 bytes
- **Lines**: 6,745
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bingx.ts`.

**Classes defined**: bingx
...
- `./abstract/bingx.js` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://github-production-user-asset-6210df.s3.amazonaws.com/1294454/253675376-6983b72e-4999-4549-b177-33b374c195e3.jpg` (referenced)
