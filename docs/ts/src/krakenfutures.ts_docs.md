# Documentation: ts/src/krakenfutures.ts

## File Metadata

- **Path**: `ts/src/krakenfutures.ts`
- **Size**: 133,017 bytes
- **Lines**: 2,935
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/krakenfutures.ts`.

**Classes defined**: krakenfutures
...
- ` + fromAccount + ` (imported)
- `./abstract/krakenfutures.js` (imported)
- `./base/types.js` (imported)
- `./static_dependencies/noble-hashes/sha512.js` (imported)
- `./base/functions/number.js` (imported)
- `./base/errors.js` (referenced)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `https://demo-futures.kraken.com` (referenced)
- `./base/Precise.js` (referenced)
- `./abstract/krakenfutures.js` (referenced)
- `./base/types.js` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://user-images.githubusercontent.com/24300605/81436764-b22fd580-9172-11ea-9703-742783e6376d.jpg` (referenced)
...
```bash
ts-node ts/src/krakenfutures.ts
```
