# Documentation: ts/src/bitbank.ts

## File Metadata

- **Path**: `ts/src/bitbank.ts`
- **Size**: 50,952 bytes
- **Lines**: 1,170
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitbank.ts`.

**Classes defined**: bitbank
