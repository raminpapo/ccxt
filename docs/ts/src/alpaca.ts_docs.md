# Documentation: ts/src/alpaca.ts

## File Metadata

- **Path**: `ts/src/alpaca.ts`
- **Size**: 85,939 bytes
- **Lines**: 1,937
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/alpaca.ts`.

**Classes defined**: alpaca
