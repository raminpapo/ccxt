# Documentation: ts/src/coinspot.ts

## File Metadata

- **Path**: `ts/src/coinspot.ts`
- **Size**: 29,549 bytes
- **Lines**: 662
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coinspot.ts`.

**Classes defined**: coinspot
...
- `./abstract/coinspot.js` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/28208429-3cacdf9a-6896-11e7-854e-4c79a772a30f.jpg` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://www.coinspot.com.au` (referenced)
