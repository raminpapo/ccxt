# Documentation: ts/src/btcbox.ts

## File Metadata

- **Path**: `ts/src/btcbox.ts`
- **Size**: 35,253 bytes
- **Lines**: 855
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/btcbox.ts`.
