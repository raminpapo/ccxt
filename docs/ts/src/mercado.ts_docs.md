# Documentation: ts/src/mercado.ts

## File Metadata

- **Path**: `ts/src/mercado.ts`
- **Size**: 43,280 bytes
- **Lines**: 1,029
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/mercado.ts`.
...
- `./abstract/mercado.js` (referenced)
...
- `https://www.mercadobitcoin.com.br` (referenced)
- `https://user-images.githubusercontent.com/1294454/27837060-e7c58714-60ea-11e7-9192-f05e86adb83f.jpg` (referenced)
