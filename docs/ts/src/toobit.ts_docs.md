# Documentation: ts/src/toobit.ts

## File Metadata

- **Path**: `ts/src/toobit.ts`
- **Size**: 137,840 bytes
- **Lines**: 3,030
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/toobit.ts`.

**Classes defined**: toobit
...
- `./abstract/toobit.js` (referenced)
- `https://api.toobit.com` (referenced)
