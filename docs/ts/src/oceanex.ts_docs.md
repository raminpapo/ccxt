# Documentation: ts/src/oceanex.ts

## File Metadata

- **Path**: `ts/src/oceanex.ts`
- **Size**: 48,279 bytes
- **Lines**: 1,151
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/oceanex.ts`.

**Classes defined**: oceanex
...
- `./abstract/oceanex.js` (referenced)
- `./base/errors.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/58385970-794e2d80-8001-11e9-889c-0567cd79b78e.jpg` (referenced)
- `https://www.oceanex.pro.com` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/rsa.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://api.oceanex.pro` (referenced)
