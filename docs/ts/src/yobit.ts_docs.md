# Documentation: ts/src/yobit.ts

## File Metadata

- **Path**: `ts/src/yobit.ts`
- **Size**: 62,542 bytes
- **Lines**: 1,480
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/yobit.ts`.
...
- `./abstract/yobit.js` (imported)
- `./base/errors.js` (referenced)
- `./base/Precise.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/27766910-cdcbfdae-5eea-11e7-9859-03fea873272d.jpg` (referenced)
- `./base/types.js` (referenced)
- `https://www.yobit.net` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `./abstract/yobit.js` (referenced)
