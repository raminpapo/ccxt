# Documentation: ts/src/hyperliquid.ts

## File Metadata

- **Path**: `ts/src/hyperliquid.ts`
- **Size**: 182,054 bytes
- **Lines**: 4,179
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/hyperliquid.ts`.
...
- `./static_dependencies/noble-hashes/sha3.js` (imported)
- `./static_dependencies/noble-curves/secp256k1.js` (imported)
- `./abstract/hyperliquid.js` (imported)
...
- `./static_dependencies/noble-hashes/sha3.js` (referenced)
- `./static_dependencies/noble-curves/secp256k1.js` (referenced)
- `https://api.hyperliquid-testnet.xyz` (referenced)
- `./abstract/hyperliquid.js` (referenced)
