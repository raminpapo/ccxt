# Documentation: ts/src/bitso.ts

## File Metadata

- **Path**: `ts/src/bitso.ts`
- **Size**: 81,421 bytes
- **Lines**: 1,909
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitso.ts`.

**Classes defined**: bitso
...
- `./abstract/bitso.js` (referenced)
- `https://bitso.com` (referenced)
