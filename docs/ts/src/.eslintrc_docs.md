# Documentation: ts/src/.eslintrc

## File Metadata

- **Path**: `ts/src/.eslintrc`
- **Size**: 4,835 bytes
- **Lines**: 123
- **Type**: Unknown
- **Extension**: none
...
```
{
  ...
  "extends": ["eslint:recommended", "airbnb-base", "plugin:import/typescript", "plugin:jsdoc/recommended-typescript-error"],
...
This is a Unknown file located at `ts/src/.eslintrc`.
