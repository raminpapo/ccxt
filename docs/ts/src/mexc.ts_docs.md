...
This is a TypeScript file located at `ts/src/mexc.ts`.

**Classes defined**: mexc
...
- `https://user-images.githubusercontent.com/1294454/137283979-8b2a818d-8633-461b-bfca-de89e8c446b2.jpg` (referenced)
- `./abstract/mexc.js` (referenced)
- `./base/Precise.js` (referenced)
- `./base/types.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://api.mexc.com` (referenced)
