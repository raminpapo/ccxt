# Documentation: ts/src/coinbase.ts

## File Metadata

- **Path**: `ts/src/coinbase.ts`
- **Size**: 256,410 bytes
- **Lines**: 5,271
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/coinbase.ts`.
