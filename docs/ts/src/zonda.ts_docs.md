# Documentation: ts/src/zonda.ts

## File Metadata

- **Path**: `ts/src/zonda.ts`
- **Size**: 90,411 bytes
- **Lines**: 2,013
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/zonda.ts`.

**Classes defined**: zonda
...
- `./abstract/zonda.js` (imported)
- `./base/types.js` (imported)
- `./static_dependencies/noble-hashes/sha512.js` (imported)
- `./base/functions/number.js` (imported)
- `./base/errors.js` (referenced)
- `https://zondaglobal.com` (referenced)
- `./base/Precise.js` (referenced)
- `./abstract/zonda.js` (referenced)
- `./base/types.js` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://{hostname}/API/Trading/tradingApi.php` (referenced)
- `https://user-images.githubusercontent.com/1294454/159202310-a0e38007-5e7c-4ba9-a32f-c8263a0291fe.jpg` (referenced)
