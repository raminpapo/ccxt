# Documentation: ts/src/bitvavo.ts

## File Metadata

- **Path**: `ts/src/bitvavo.ts`
- **Size**: 103,790 bytes
- **Lines**: 2,249
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitvavo.ts`.

**Classes defined**: bitvavo
...
- `./abstract/bitvavo.js` (referenced)
- `https://api.bitvavo.com` (referenced)
