# Documentation: ts/src/bitbns.ts

## File Metadata

- **Path**: `ts/src/bitbns.ts`
- **Size**: 54,640 bytes
- **Lines**: 1,305
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitbns.ts`.

**Classes defined**: bitbns
