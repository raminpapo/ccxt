# Documentation: ts/src/bitflyer.ts

## File Metadata

- **Path**: `ts/src/bitflyer.ts`
- **Size**: 51,292 bytes
- **Lines**: 1,237
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `ts/src/bitflyer.ts`.

**Classes defined**: bitflyer
...
- `./abstract/bitflyer.js` (referenced)
- `./base/Precise.js` (referenced)
- `https://bitflyer.com` (referenced)
