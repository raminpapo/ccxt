...
This is a TypeScript file located at `ts/src/p2b.ts`.
...
- `./abstract/p2b.js` (imported)
- `./static_dependencies/noble-hashes/sha512.js` (imported)
- `./base/functions/number.js` (imported)
- `./base/errors.js` (referenced)
- `https://github.com/P2B-team/p2b-api-docs/blob/master/api-doc.md` (referenced)
- `./base/types.js` (referenced)
- `./abstract/p2b.js` (referenced)
