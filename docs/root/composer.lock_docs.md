...
This is a Unknown file located at `composer.lock`.
...
- `https://github.com/php-fig/http-message-util.git` (referenced)
- `https://github.com/igorw/evenement.git` (referenced)
- `https://github.com/guzzle/psr7.git` (referenced)
