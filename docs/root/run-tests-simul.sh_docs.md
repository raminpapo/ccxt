# Documentation: run-tests-simul.sh

## File Metadata

- **Path**: `run-tests-simul.sh`
- **Size**: 2,118 bytes
- **Lines**: 94
- **Type**: Shell Script
- **Extension**: .sh
...
This is a Shell Script file located at `run-tests-simul.sh`.

**Functions defined**: run_specific_tests, run_all
