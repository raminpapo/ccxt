...
This is a Shell Script file located at `build.sh`.

**Functions defined**: run_tests
...
- `master` (imported)
- `python/ccxt/$exchange.py` (referenced)
- `python/ccxt/pro/$exchange.py` (referenced)
- `ts\/src\/test\/static\/response\/([A-Za-z0-9_-]+)\.json` (referenced)
- `ts\/src\/test\/static\/request\/([A-Za-z0-9_-]+)\.json` (referenced)
- `python/ccxt/async_support/$exchange.py` (referenced)
- `ts\/src\/pro\/([A-Za-z0-9_-]+)\.ts` (referenced)
- `ts/src/$exchange.ts` (referenced)
- `ts\/src\/([A-Za-z0-9_-]+).ts` (referenced)
- `ts/src/pro/$exchange.ts` (referenced)
