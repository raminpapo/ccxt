...
```json
{
  "compilerOptions": {
    ...
    "rootDir": "./ts",  // Add this line to specify the root directory
...
This is a JSON file located at `tsconfig.json`.

**Classes defined**: fields, properties

**Functions defined**: used, parameter
...
- `./ts/src/static_dependencies/**/*.cjs` (referenced)
