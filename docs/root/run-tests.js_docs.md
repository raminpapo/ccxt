...
This is a JavaScript file located at `run-tests.js`.

**Functions defined**: TaskPool, testAllExchanges
...
- `child_process` (imported)
- `fs` (imported)
- `ololog` (imported)
- `ansicolor` (imported)
- `./skip-tests.json` (referenced)
- `js/src/test/tests.init.js` (referenced)
- `./exchanges.json` (referenced)
- `ts/src/test/tests.init.ts` (referenced)
- `php/test/tests_init.php` (referenced)
- `python/ccxt/test/tests_init.py` (referenced)
