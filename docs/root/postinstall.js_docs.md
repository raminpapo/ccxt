...
This is a JavaScript file located at `postinstall.js`.

**Functions defined**: style, main, getData, pad
...
- `./js/src/static_dependencies/node-fetch/index.js` (imported)
- `https://opencollective.com/ccxt.json` (referenced)
- `./js/src/static_dependencies/node-fetch/index.js` (referenced)
