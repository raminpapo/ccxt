# Documentation: wiki/CONTRIBUTING.md

## File Metadata

- **Path**: `wiki/CONTRIBUTING.md`
- **Size**: 52,067 bytes
- **Lines**: 1,111
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/CONTRIBUTING.md`.

**Classes defined**: offers, methods, docstring, takes, requires

**Functions defined**: calls, is, takes, also, name
...
- `https://opencollective.com/ccxt/tiers/supporter/0/avatar.svg` (referenced)
- `https://www.example.com` (referenced)
- `https://opencollective.com/ccxt/tiers/supporter/7/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/supporter/3/avatar.svg` (referenced)
- `https://example.com/image.jpg` (referenced)
- `https://opencollective.com/ccxt/tiers/supporter/5/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/supporter/1/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/supporter/6/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/supporter/2/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/supporter/4/avatar.svg` (referenced)
