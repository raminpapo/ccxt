# Documentation: wiki/examples/ts/create-order-position-with-takeprofit-stoploss.md

## File Metadata

- **Path**: `wiki/examples/ts/create-order-position-with-takeprofit-stoploss.md`
- **Size**: 4,897 bytes
- **Lines**: 95
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/ts/create-order-position-with-takeprofit-stoploss.md`.
