# Documentation: wiki/examples/ts/fetch-first-ohlcv-timestamp.md

## File Metadata

- **Path**: `wiki/examples/ts/fetch-first-ohlcv-timestamp.md`
- **Size**: 4,047 bytes
- **Lines**: 94
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/ts/fetch-first-ohlcv-timestamp.md`.
