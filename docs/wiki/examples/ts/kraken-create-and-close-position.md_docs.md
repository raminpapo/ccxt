# Documentation: wiki/examples/ts/kraken-create-and-close-position.md

## File Metadata

- **Path**: `wiki/examples/ts/kraken-create-and-close-position.md`
- **Size**: 2,889 bytes
- **Lines**: 75
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/ts/kraken-create-and-close-position.md`.
