# Documentation: wiki/examples/ts/create-trailing-percent-order.md

## File Metadata

- **Path**: `wiki/examples/ts/create-trailing-percent-order.md`
- **Size**: 1,395 bytes
- **Lines**: 43
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/ts/create-trailing-percent-order.md`.
