# Documentation: wiki/examples/ts/phemex-create-order-position-with-takeprofit-stoploss.md

## File Metadata

- **Path**: `wiki/examples/ts/phemex-create-order-position-with-takeprofit-stoploss.md`
- **Size**: 2,321 bytes
- **Lines**: 68
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/ts/phemex-create-order-position-with-takeprofit-stoploss.md`.
