# Documentation: wiki/examples/js/create-trailing-percent-order.md

## File Metadata

- **Path**: `wiki/examples/js/create-trailing-percent-order.md`
- **Size**: 1,389 bytes
- **Lines**: 42
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/create-trailing-percent-order.md`.
