# Documentation: wiki/examples/js/custom-proxy-agent-for-js.md

## File Metadata

- **Path**: `wiki/examples/js/custom-proxy-agent-for-js.md`
- **Size**: 525 bytes
- **Lines**: 18
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/custom-proxy-agent-for-js.md`.
