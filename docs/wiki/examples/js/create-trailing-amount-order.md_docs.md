# Documentation: wiki/examples/js/create-trailing-amount-order.md

## File Metadata

- **Path**: `wiki/examples/js/create-trailing-amount-order.md`
- **Size**: 1,384 bytes
- **Lines**: 42
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/create-trailing-amount-order.md`.
