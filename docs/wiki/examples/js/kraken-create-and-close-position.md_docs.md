# Documentation: wiki/examples/js/kraken-create-and-close-position.md

## File Metadata

- **Path**: `wiki/examples/js/kraken-create-and-close-position.md`
- **Size**: 2,859 bytes
- **Lines**: 60
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/kraken-create-and-close-position.md`.
