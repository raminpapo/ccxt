# Documentation: wiki/examples/js/latoken-example.md

## File Metadata

- **Path**: `wiki/examples/js/latoken-example.md`
- **Size**: 4,050 bytes
- **Lines**: 113
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/latoken-example.md`.
