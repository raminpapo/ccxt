# Documentation: wiki/examples/js/hibachi-example.md

## File Metadata

- **Path**: `wiki/examples/js/hibachi-example.md`
- **Size**: 7,155 bytes
- **Lines**: 119
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/hibachi-example.md`.
