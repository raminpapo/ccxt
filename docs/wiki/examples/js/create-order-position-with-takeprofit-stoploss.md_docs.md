# Documentation: wiki/examples/js/create-order-position-with-takeprofit-stoploss.md

## File Metadata

- **Path**: `wiki/examples/js/create-order-position-with-takeprofit-stoploss.md`
- **Size**: 4,865 bytes
- **Lines**: 77
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/create-order-position-with-takeprofit-stoploss.md`.
