# Documentation: wiki/examples/js/exchange-capabilities.md

## File Metadata

- **Path**: `wiki/examples/js/exchange-capabilities.md`
- **Size**: 4,639 bytes
- **Lines**: 141
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/exchange-capabilities.md`.
