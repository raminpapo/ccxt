# Documentation: wiki/examples/js/bitstamp-private-api.md

## File Metadata

- **Path**: `wiki/examples/js/bitstamp-private-api.md`
- **Size**: 4,362 bytes
- **Lines**: 120
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/bitstamp-private-api.md`.
