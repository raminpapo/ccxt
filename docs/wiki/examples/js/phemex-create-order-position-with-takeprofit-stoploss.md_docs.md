# Documentation: wiki/examples/js/phemex-create-order-position-with-takeprofit-stoploss.md

## File Metadata

- **Path**: `wiki/examples/js/phemex-create-order-position-with-takeprofit-stoploss.md`
- **Size**: 2,265 bytes
- **Lines**: 55
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/phemex-create-order-position-with-takeprofit-stoploss.md`.
