# Documentation: wiki/examples/js/bitfinex-fetch-trades.md

## File Metadata

- **Path**: `wiki/examples/js/bitfinex-fetch-trades.md`
- **Size**: 1,146 bytes
- **Lines**: 40
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/js/bitfinex-fetch-trades.md`.
