# Documentation: wiki/examples/py/fetch-order-book-rtt.md

## File Metadata

- **Path**: `wiki/examples/py/fetch-order-book-rtt.md`
- **Size**: 1,598 bytes
- **Lines**: 60
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/fetch-order-book-rtt.md`.
