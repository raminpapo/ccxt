# Documentation: wiki/examples/py/create-order-position-with-takeprofit-stoploss.md

## File Metadata

- **Path**: `wiki/examples/py/create-order-position-with-takeprofit-stoploss.md`
- **Size**: 3,605 bytes
- **Lines**: 73
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/create-order-position-with-takeprofit-stoploss.md`.
