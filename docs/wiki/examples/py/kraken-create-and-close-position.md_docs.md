# Documentation: wiki/examples/py/kraken-create-and-close-position.md

## File Metadata

- **Path**: `wiki/examples/py/kraken-create-and-close-position.md`
- **Size**: 2,381 bytes
- **Lines**: 61
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/kraken-create-and-close-position.md`.
