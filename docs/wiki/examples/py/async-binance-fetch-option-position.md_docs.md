# Documentation: wiki/examples/py/async-binance-fetch-option-position.md

## File Metadata

- **Path**: `wiki/examples/py/async-binance-fetch-option-position.md`
- **Size**: 1,117 bytes
- **Lines**: 42
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/async-binance-fetch-option-position.md`.
