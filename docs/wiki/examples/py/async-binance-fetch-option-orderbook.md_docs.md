# Documentation: wiki/examples/py/async-binance-fetch-option-orderbook.md

## File Metadata

- **Path**: `wiki/examples/py/async-binance-fetch-option-orderbook.md`
- **Size**: 1,170 bytes
- **Lines**: 44
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/async-binance-fetch-option-orderbook.md`.
