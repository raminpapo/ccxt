# Documentation: wiki/examples/py/phemex-create-order-position-with-takeprofit-stoploss.md

## File Metadata

- **Path**: `wiki/examples/py/phemex-create-order-position-with-takeprofit-stoploss.md`
- **Size**: 2,024 bytes
- **Lines**: 56
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/phemex-create-order-position-with-takeprofit-stoploss.md`.
