# Documentation: wiki/examples/py/okx-position-takeprofit-stoploss.md

## File Metadata

- **Path**: `wiki/examples/py/okx-position-takeprofit-stoploss.md`
- **Size**: 4,322 bytes
- **Lines**: 112
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/okx-position-takeprofit-stoploss.md`.
