# Documentation: wiki/examples/py/fetch-create-deposit-address.md

## File Metadata

- **Path**: `wiki/examples/py/fetch-create-deposit-address.md`
- **Size**: 2,313 bytes
- **Lines**: 83
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/fetch-create-deposit-address.md`.
