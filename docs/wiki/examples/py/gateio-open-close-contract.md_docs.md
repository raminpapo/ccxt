# Documentation: wiki/examples/py/gateio-open-close-contract.md

## File Metadata

- **Path**: `wiki/examples/py/gateio-open-close-contract.md`
- **Size**: 1,248 bytes
- **Lines**: 59
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/gateio-open-close-contract.md`.
