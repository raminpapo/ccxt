# Documentation: wiki/examples/py/okx-transfer.md

## File Metadata

- **Path**: `wiki/examples/py/okx-transfer.md`
- **Size**: 1,636 bytes
- **Lines**: 44
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/py/okx-transfer.md`.
