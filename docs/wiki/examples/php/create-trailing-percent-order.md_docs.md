# Documentation: wiki/examples/php/create-trailing-percent-order.md

## File Metadata

- **Path**: `wiki/examples/php/create-trailing-percent-order.md`
- **Size**: 1,960 bytes
- **Lines**: 61
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/create-trailing-percent-order.md`.
