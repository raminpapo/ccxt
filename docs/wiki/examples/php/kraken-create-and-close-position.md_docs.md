# Documentation: wiki/examples/php/kraken-create-and-close-position.md

## File Metadata

- **Path**: `wiki/examples/php/kraken-create-and-close-position.md`
- **Size**: 3,148 bytes
- **Lines**: 77
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/kraken-create-and-close-position.md`.
