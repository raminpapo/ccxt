# Documentation: wiki/examples/php/shared-markets.md

## File Metadata

- **Path**: `wiki/examples/php/shared-markets.md`
- **Size**: 1,388 bytes
- **Lines**: 58
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/shared-markets.md`.
