# Documentation: wiki/examples/php/fetch-ticker.md

## File Metadata

- **Path**: `wiki/examples/php/fetch-ticker.md`
- **Size**: 1,381 bytes
- **Lines**: 45
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/fetch-ticker.md`.
