# Documentation: wiki/examples/php/margin-loan-borrow-buy-sell-repay.md

## File Metadata

- **Path**: `wiki/examples/php/margin-loan-borrow-buy-sell-repay.md`
- **Size**: 6,178 bytes
- **Lines**: 115
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/margin-loan-borrow-buy-sell-repay.md`.
