# Documentation: wiki/examples/php/method-overload-override.md

## File Metadata

- **Path**: `wiki/examples/php/method-overload-override.md`
- **Size**: 1,108 bytes
- **Lines**: 38
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/method-overload-override.md`.
