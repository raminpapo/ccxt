# Documentation: wiki/examples/php/latoken-example.md

## File Metadata

- **Path**: `wiki/examples/php/latoken-example.md`
- **Size**: 3,338 bytes
- **Lines**: 116
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/latoken-example.md`.
