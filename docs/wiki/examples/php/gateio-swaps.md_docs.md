# Documentation: wiki/examples/php/gateio-swaps.md

## File Metadata

- **Path**: `wiki/examples/php/gateio-swaps.md`
- **Size**: 2,262 bytes
- **Lines**: 91
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/gateio-swaps.md`.
