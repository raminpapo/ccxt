# Documentation: wiki/examples/php/create-order-position-with-takeprofit-stoploss.md

## File Metadata

- **Path**: `wiki/examples/php/create-order-position-with-takeprofit-stoploss.md`
- **Size**: 4,465 bytes
- **Lines**: 90
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/create-order-position-with-takeprofit-stoploss.md`.
