# Documentation: wiki/examples/php/create-trailing-amount-order.md

## File Metadata

- **Path**: `wiki/examples/php/create-trailing-amount-order.md`
- **Size**: 1,955 bytes
- **Lines**: 61
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/create-trailing-amount-order.md`.
