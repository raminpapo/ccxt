# Documentation: wiki/examples/php/create-order-ws-example.md

## File Metadata

- **Path**: `wiki/examples/php/create-order-ws-example.md`
- **Size**: 1,401 bytes
- **Lines**: 52
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/create-order-ws-example.md`.
