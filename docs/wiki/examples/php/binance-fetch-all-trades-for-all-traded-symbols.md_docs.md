# Documentation: wiki/examples/php/binance-fetch-all-trades-for-all-traded-symbols.md

## File Metadata

- **Path**: `wiki/examples/php/binance-fetch-all-trades-for-all-traded-symbols.md`
- **Size**: 3,375 bytes
- **Lines**: 113
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/examples/php/binance-fetch-all-trades-for-all-traded-symbols.md`.
