# Documentation: wiki/ccxt.pro.manual.md

## File Metadata

- **Path**: `wiki/ccxt.pro.manual.md`
- **Size**: 103,575 bytes
- **Lines**: 1,322
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/ccxt.pro.manual.md`.

**Classes defined**: my_exchange, myBinance, myExchange

**Functions defined**: main, myHandler, example, __construct, will, handle_message, loops
...
- `wss://socket.exchange.io` (referenced)
- `https://signalr.exchange.com` (referenced)
- `wss://ws.exchange.com` (referenced)
