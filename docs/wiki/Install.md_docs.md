# Documentation: wiki/Install.md

## File Metadata

- **Path**: `wiki/Install.md`
- **Size**: 7,873 bytes
- **Lines**: 235
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/Install.md`.

**Functions defined**: update
...
- `https://cdn.ccxt.com/3.0.35/ccxt.min.js` (referenced)
- `./js/ccxt.js` (referenced)
- `https://cdn.ccxt.com/latest/bybit.min.js` (referenced)
