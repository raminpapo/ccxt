# Documentation: wiki/exchanges/independentreserve.md

## File Metadata

- **Path**: `wiki/exchanges/independentreserve.md`
- **Size**: 13,245 bytes
- **Lines**: 366
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/exchanges/independentreserve.md`.
