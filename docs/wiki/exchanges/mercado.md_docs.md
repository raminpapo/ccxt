# Documentation: wiki/exchanges/mercado.md

## File Metadata

- **Path**: `wiki/exchanges/mercado.md`
- **Size**: 10,275 bytes
- **Lines**: 300
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `wiki/exchanges/mercado.md`.
