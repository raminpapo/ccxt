# Documentation: wiki/basePartials/params-table.hbs

## File Metadata

- **Path**: `wiki/basePartials/params-table.hbs`
- **Size**: 460 bytes
- **Lines**: 13
- **Type**: Unknown
- **Extension**: .hbs
...
This is a Unknown file located at `wiki/basePartials/params-table.hbs`.
