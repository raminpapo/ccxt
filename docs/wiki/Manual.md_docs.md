...
This is a Markdown file located at `wiki/Manual.md`.

**Classes defined**: or, has, implements, also, instantiation, contains, from, and

**Functions defined**: decimalToPrecision, amountToPrecision, priceToPrecision, before, decimal_to_precision, that, tick, my_overload
