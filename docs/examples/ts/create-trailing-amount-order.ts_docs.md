# Documentation: examples/ts/create-trailing-amount-order.ts

## File Metadata

- **Path**: `examples/ts/create-trailing-amount-order.ts`
- **Size**: 1,318 bytes
- **Lines**: 38
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/create-trailing-amount-order.ts`.
...
```bash
ts-node examples/ts/create-trailing-amount-order.ts
```
