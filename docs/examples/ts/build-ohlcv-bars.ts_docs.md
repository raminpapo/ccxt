# Documentation: examples/ts/build-ohlcv-bars.ts

## File Metadata

- **Path**: `examples/ts/build-ohlcv-bars.ts`
- **Size**: 3,336 bytes
- **Lines**: 54
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/build-ohlcv-bars.ts`.

**Functions defined**: example_with_fetch_trades, example_with_watch_trades
...
```bash
ts-node examples/ts/build-ohlcv-bars.ts
```
