# Documentation: examples/ts/fetch-ohlcv-many-exchanges-continuosly.ts

## File Metadata

- **Path**: `examples/ts/fetch-ohlcv-many-exchanges-continuosly.ts`
- **Size**: 1,261 bytes
- **Lines**: 45
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/fetch-ohlcv-many-exchanges-continuosly.ts`.
...
```bash
ts-node examples/ts/fetch-ohlcv-many-exchanges-continuosly.ts
```
