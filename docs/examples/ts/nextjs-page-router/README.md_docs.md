# Documentation: examples/ts/nextjs-page-router/README.md

## File Metadata

- **Path**: `examples/ts/nextjs-page-router/README.md`
- **Size**: 1,247 bytes
- **Lines**: 44
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `examples/ts/nextjs-page-router/README.md`.
