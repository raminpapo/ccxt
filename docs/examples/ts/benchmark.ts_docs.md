# Documentation: examples/ts/benchmark.ts

## File Metadata

- **Path**: `examples/ts/benchmark.ts`
- **Size**: 5,650 bytes
- **Lines**: 135
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/benchmark.ts`.

**Functions defined**: benchmark, runCommand
...
```bash
ts-node examples/ts/benchmark.ts
```
