# Documentation: examples/ts/margin-loan-borrow-buy-sell-repay.ts

## File Metadata

- **Path**: `examples/ts/margin-loan-borrow-buy-sell-repay.ts`
- **Size**: 5,016 bytes
- **Lines**: 73
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/margin-loan-borrow-buy-sell-repay.ts`.
...
```bash
ts-node examples/ts/margin-loan-borrow-buy-sell-repay.ts
```
