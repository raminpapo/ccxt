# Documentation: examples/ts/create-order-position-with-takeprofit-stoploss.ts

## File Metadata

- **Path**: `examples/ts/create-order-position-with-takeprofit-stoploss.ts`
- **Size**: 4,807 bytes
- **Lines**: 90
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/create-order-position-with-takeprofit-stoploss.ts`.
...
```bash
ts-node examples/ts/create-order-position-with-takeprofit-stoploss.ts
```
