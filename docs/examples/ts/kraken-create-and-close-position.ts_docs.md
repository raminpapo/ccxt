# Documentation: examples/ts/kraken-create-and-close-position.ts

## File Metadata

- **Path**: `examples/ts/kraken-create-and-close-position.ts`
- **Size**: 2,813 bytes
- **Lines**: 70
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/kraken-create-and-close-position.ts`.
...
```bash
ts-node examples/ts/kraken-create-and-close-position.ts
```
