# Documentation: examples/ts/fetch-first-ohlcv-timestamp.ts

## File Metadata

- **Path**: `examples/ts/fetch-first-ohlcv-timestamp.ts`
- **Size**: 3,976 bytes
- **Lines**: 89
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/fetch-first-ohlcv-timestamp.ts`.

**Functions defined**: fetchFirstBarTimestamp, tries
...
```bash
ts-node examples/ts/fetch-first-ohlcv-timestamp.ts
```
