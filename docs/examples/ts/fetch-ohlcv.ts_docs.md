# Documentation: examples/ts/fetch-ohlcv.ts

## File Metadata

- **Path**: `examples/ts/fetch-ohlcv.ts`
- **Size**: 593 bytes
- **Lines**: 18
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/fetch-ohlcv.ts`.
...
```bash
ts-node examples/ts/fetch-ohlcv.ts
```
