# Documentation: examples/ts/hibachi-example.ts

## File Metadata

- **Path**: `examples/ts/hibachi-example.ts`
- **Size**: 7,127 bytes
- **Lines**: 138
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `examples/ts/hibachi-example.ts`.
...
```bash
ts-node examples/ts/hibachi-example.ts
```
