# Documentation: examples/cs/examples/create-trailing-amount-order.cs

## File Metadata

- **Path**: `examples/cs/examples/create-trailing-amount-order.cs`
- **Size**: 1,538 bytes
- **Lines**: 45
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `examples/cs/examples/create-trailing-amount-order.cs`.
