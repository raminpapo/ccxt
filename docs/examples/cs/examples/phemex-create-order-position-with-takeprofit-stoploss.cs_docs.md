# Documentation: examples/cs/examples/phemex-create-order-position-with-takeprofit-stoploss.cs

## File Metadata

- **Path**: `examples/cs/examples/phemex-create-order-position-with-takeprofit-stoploss.cs`
- **Size**: 2,248 bytes
- **Lines**: 54
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `examples/cs/examples/phemex-create-order-position-with-takeprofit-stoploss.cs`.
