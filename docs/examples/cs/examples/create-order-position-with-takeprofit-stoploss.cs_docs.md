# Documentation: examples/cs/examples/create-order-position-with-takeprofit-stoploss.cs

## File Metadata

- **Path**: `examples/cs/examples/create-order-position-with-takeprofit-stoploss.cs`
- **Size**: 3,308 bytes
- **Lines**: 75
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `examples/cs/examples/create-order-position-with-takeprofit-stoploss.cs`.
