# Documentation: examples/cs/examples/SetMarketsFromExchange.cs

## File Metadata

- **Path**: `examples/cs/examples/SetMarketsFromExchange.cs`
- **Size**: 2,112 bytes
- **Lines**: 60
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `examples/cs/examples/SetMarketsFromExchange.cs`.
