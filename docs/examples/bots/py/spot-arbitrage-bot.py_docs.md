# Documentation: examples/bots/py/spot-arbitrage-bot.py

## File Metadata

- **Path**: `examples/bots/py/spot-arbitrage-bot.py`
- **Size**: 4,369 bytes
- **Lines**: 137
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/bots/py/spot-arbitrage-bot.py`.

**Functions defined**: bot, get_last_prices, check_requirements, main
...
```bash
python examples/bots/py/spot-arbitrage-bot.py
```
