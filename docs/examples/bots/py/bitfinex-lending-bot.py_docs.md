# Documentation: examples/bots/py/bitfinex-lending-bot.py

## File Metadata

- **Path**: `examples/bots/py/bitfinex-lending-bot.py`
- **Size**: 3,666 bytes
- **Lines**: 108
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/bots/py/bitfinex-lending-bot.py`.

**Functions defined**: bot, main, get_last_funding_infos, check_requirements
...
```bash
python examples/bots/py/bitfinex-lending-bot.py
```
