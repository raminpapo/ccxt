# Documentation: examples/ccxt.pro/py/binance-watch-ohlcv.py

## File Metadata

- **Path**: `examples/ccxt.pro/py/binance-watch-ohlcv.py`
- **Size**: 1,731 bytes
- **Lines**: 44
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/ccxt.pro/py/binance-watch-ohlcv.py`.
...
```bash
python examples/ccxt.pro/py/binance-watch-ohlcv.py
```
