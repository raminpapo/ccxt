# Documentation: examples/ccxt.pro/py/many-exchanges-many-orderbooks-throttled.py

## File Metadata

- **Path**: `examples/ccxt.pro/py/many-exchanges-many-orderbooks-throttled.py`
- **Size**: 1,665 bytes
- **Lines**: 57
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/ccxt.pro/py/many-exchanges-many-orderbooks-throttled.py`.

**Functions defined**: handling_loop, main, handle_all_orderbooks, exchange_loop, symbol_loop
...
```bash
python examples/ccxt.pro/py/many-exchanges-many-orderbooks-throttled.py
```
