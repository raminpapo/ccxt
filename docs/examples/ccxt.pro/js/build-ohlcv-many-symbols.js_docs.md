# Documentation: examples/ccxt.pro/js/build-ohlcv-many-symbols.js

## File Metadata

- **Path**: `examples/ccxt.pro/js/build-ohlcv-many-symbols.js`
- **Size**: 2,456 bytes
- **Lines**: 68
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/ccxt.pro/js/build-ohlcv-many-symbols.js`.
...
```bash
node examples/ccxt.pro/js/build-ohlcv-many-symbols.js
```
