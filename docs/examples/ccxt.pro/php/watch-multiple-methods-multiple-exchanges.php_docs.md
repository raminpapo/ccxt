# Documentation: examples/ccxt.pro/php/watch-multiple-methods-multiple-exchanges.php

## File Metadata

- **Path**: `examples/ccxt.pro/php/watch-multiple-methods-multiple-exchanges.php`
- **Size**: 1,615 bytes
- **Lines**: 42
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/ccxt.pro/php/watch-multiple-methods-multiple-exchanges.php`.

**Functions defined**: runAsync
...
```bash
php examples/ccxt.pro/php/watch-multiple-methods-multiple-exchanges.php
```
