# Documentation: examples/php/compare-two-exchanges-capabilities.php

## File Metadata

- **Path**: `examples/php/compare-two-exchanges-capabilities.php`
- **Size**: 2,287 bytes
- **Lines**: 56
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/compare-two-exchanges-capabilities.php`.
...
```bash
php examples/php/compare-two-exchanges-capabilities.php
```
