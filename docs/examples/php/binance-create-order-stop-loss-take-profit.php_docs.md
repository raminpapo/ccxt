# Documentation: examples/php/binance-create-order-stop-loss-take-profit.php

## File Metadata

- **Path**: `examples/php/binance-create-order-stop-loss-take-profit.php`
- **Size**: 1,533 bytes
- **Lines**: 52
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/binance-create-order-stop-loss-take-profit.php`.
...
```bash
php examples/php/binance-create-order-stop-loss-take-profit.php
```
