# Documentation: examples/php/build-ohlcv-bars.php

## File Metadata

- **Path**: `examples/php/build-ohlcv-bars.php`
- **Size**: 4,072 bytes
- **Lines**: 75
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/build-ohlcv-bars.php`.
...
```bash
php examples/php/build-ohlcv-bars.php
```
