# Documentation: examples/php/margin-loan-borrow-buy-sell-repay.php

## File Metadata

- **Path**: `examples/php/margin-loan-borrow-buy-sell-repay.php`
- **Size**: 6,107 bytes
- **Lines**: 110
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/margin-loan-borrow-buy-sell-repay.php`.
...
```bash
php examples/php/margin-loan-borrow-buy-sell-repay.php
```
