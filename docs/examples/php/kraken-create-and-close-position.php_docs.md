# Documentation: examples/php/kraken-create-and-close-position.php

## File Metadata

- **Path**: `examples/php/kraken-create-and-close-position.php`
- **Size**: 3,078 bytes
- **Lines**: 72
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/kraken-create-and-close-position.php`.
...
```bash
php examples/php/kraken-create-and-close-position.php
```
