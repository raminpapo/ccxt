# Documentation: examples/php/sample-local-proxy-server-with-cors.php

## File Metadata

- **Path**: `examples/php/sample-local-proxy-server-with-cors.php`
- **Size**: 2,816 bytes
- **Lines**: 72
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/sample-local-proxy-server-with-cors.php`.
...
```bash
php examples/php/sample-local-proxy-server-with-cors.php
```
