# Documentation: examples/php/fetch-first-ohlcv-timestamp.php

## File Metadata

- **Path**: `examples/php/fetch-first-ohlcv-timestamp.php`
- **Size**: 4,744 bytes
- **Lines**: 103
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/fetch-first-ohlcv-timestamp.php`.

**Functions defined**: fetch_first_bar_timestamp, tries
...
```bash
php examples/php/fetch-first-ohlcv-timestamp.php
```
