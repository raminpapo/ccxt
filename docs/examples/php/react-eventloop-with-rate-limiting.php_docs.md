# Documentation: examples/php/react-eventloop-with-rate-limiting.php

## File Metadata

- **Path**: `examples/php/react-eventloop-with-rate-limiting.php`
- **Size**: 991 bytes
- **Lines**: 29
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/react-eventloop-with-rate-limiting.php`.
...
```bash
php examples/php/react-eventloop-with-rate-limiting.php
```
