# Documentation: examples/php/cli.php

## File Metadata

- **Path**: `examples/php/cli.php`
- **Size**: 8,288 bytes
- **Lines**: 207
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/cli.php`.

**Functions defined**: teste
