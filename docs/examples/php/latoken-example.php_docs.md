# Documentation: examples/php/latoken-example.php

## File Metadata

- **Path**: `examples/php/latoken-example.php`
- **Size**: 3,338 bytes
- **Lines**: 113
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/latoken-example.php`.
...
```bash
php examples/php/latoken-example.php
```
