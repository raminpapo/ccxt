# Documentation: examples/php/create-order-position-with-takeprofit-stoploss.php

## File Metadata

- **Path**: `examples/php/create-order-position-with-takeprofit-stoploss.php`
- **Size**: 4,381 bytes
- **Lines**: 85
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/create-order-position-with-takeprofit-stoploss.php`.
...
```bash
php examples/php/create-order-position-with-takeprofit-stoploss.php
```
