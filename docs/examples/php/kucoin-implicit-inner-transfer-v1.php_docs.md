# Documentation: examples/php/kucoin-implicit-inner-transfer-v1.php

## File Metadata

- **Path**: `examples/php/kucoin-implicit-inner-transfer-v1.php`
- **Size**: 3,833 bytes
- **Lines**: 123
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/kucoin-implicit-inner-transfer-v1.php`.

**Functions defined**: get_account_id
...
```bash
php examples/php/kucoin-implicit-inner-transfer-v1.php
```
