# Documentation: examples/php/fetch-order.php

## File Metadata

- **Path**: `examples/php/fetch-order.php`
- **Size**: 3,077 bytes
- **Lines**: 92
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/fetch-order.php`.
...
```bash
php examples/php/fetch-order.php
```
