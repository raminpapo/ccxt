# Documentation: examples/php/fetch-ohlcv.php

## File Metadata

- **Path**: `examples/php/fetch-ohlcv.php`
- **Size**: 1,173 bytes
- **Lines**: 39
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/fetch-ohlcv.php`.
...
```bash
php examples/php/fetch-ohlcv.php
```
