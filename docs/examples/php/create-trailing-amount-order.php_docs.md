# Documentation: examples/php/create-trailing-amount-order.php

## File Metadata

- **Path**: `examples/php/create-trailing-amount-order.php`
- **Size**: 1,889 bytes
- **Lines**: 56
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/create-trailing-amount-order.php`.
...
```bash
php examples/php/create-trailing-amount-order.php
```
