# Documentation: examples/php/kucoin-fetch-all-deposit-addresses.php

## File Metadata

- **Path**: `examples/php/kucoin-fetch-all-deposit-addresses.php`
- **Size**: 3,129 bytes
- **Lines**: 90
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/kucoin-fetch-all-deposit-addresses.php`.

**Functions defined**: fetch_create_deposit_address, fetch_create_deposit_address_helper
...
**Functions** (2):
- `fetch_create_deposit_address()`
- `fetch_create_deposit_address_helper()`
...
```bash
php examples/php/kucoin-fetch-all-deposit-addresses.php
```
