# Documentation: examples/php/proxy-usage.php

## File Metadata

- **Path**: `examples/php/proxy-usage.php`
- **Size**: 2,657 bytes
- **Lines**: 72
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/proxy-usage.php`.
...
```bash
php examples/php/proxy-usage.php
```
