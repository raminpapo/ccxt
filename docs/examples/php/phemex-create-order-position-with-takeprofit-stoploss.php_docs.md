# Documentation: examples/php/phemex-create-order-position-with-takeprofit-stoploss.php

## File Metadata

- **Path**: `examples/php/phemex-create-order-position-with-takeprofit-stoploss.php`
- **Size**: 2,671 bytes
- **Lines**: 67
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/phemex-create-order-position-with-takeprofit-stoploss.php`.
...
```bash
php examples/php/phemex-create-order-position-with-takeprofit-stoploss.php
```
