# Documentation: examples/php/binance-fetch-all-trades-for-all-traded-symbols.php

## File Metadata

- **Path**: `examples/php/binance-fetch-all-trades-for-all-traded-symbols.php`
- **Size**: 3,343 bytes
- **Lines**: 110
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/binance-fetch-all-trades-for-all-traded-symbols.php`.

**Functions defined**: fetch_all_my_trades
...
```bash
php examples/php/binance-fetch-all-trades-for-all-traded-symbols.php
```
