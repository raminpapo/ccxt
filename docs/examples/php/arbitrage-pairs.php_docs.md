# Documentation: examples/php/arbitrage-pairs.php

## File Metadata

- **Path**: `examples/php/arbitrage-pairs.php`
- **Size**: 4,392 bytes
- **Lines**: 141
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `examples/php/arbitrage-pairs.php`.
...
```bash
php examples/php/arbitrage-pairs.php
```
