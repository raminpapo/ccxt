# Documentation: examples/py/phemex-create-order-position-with-takeprofit-stoploss.py

## File Metadata

- **Path**: `examples/py/phemex-create-order-position-with-takeprofit-stoploss.py`
- **Size**: 2,293 bytes
- **Lines**: 61
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/phemex-create-order-position-with-takeprofit-stoploss.py`.
...
```bash
python examples/py/phemex-create-order-position-with-takeprofit-stoploss.py
```
