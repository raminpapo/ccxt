# Documentation: examples/py/create-trailing-amount-order.py

## File Metadata

- **Path**: `examples/py/create-trailing-amount-order.py`
- **Size**: 1,597 bytes
- **Lines**: 50
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/create-trailing-amount-order.py`.
...
```bash
python examples/py/create-trailing-amount-order.py
```
