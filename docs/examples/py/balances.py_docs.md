# Documentation: examples/py/balances.py

## File Metadata

- **Path**: `examples/py/balances.py`
- **Size**: 1,945 bytes
- **Lines**: 84
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/balances.py`.
...
```bash
python examples/py/balances.py
```
