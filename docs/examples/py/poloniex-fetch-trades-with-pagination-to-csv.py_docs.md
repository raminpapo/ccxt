# Documentation: examples/py/poloniex-fetch-trades-with-pagination-to-csv.py

## File Metadata

- **Path**: `examples/py/poloniex-fetch-trades-with-pagination-to-csv.py`
- **Size**: 1,698 bytes
- **Lines**: 52
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/poloniex-fetch-trades-with-pagination-to-csv.py`.
...
```bash
python examples/py/poloniex-fetch-trades-with-pagination-to-csv.py
```
