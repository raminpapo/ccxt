# Documentation: examples/py/ws_test_load.py

## File Metadata

- **Path**: `examples/py/ws_test_load.py`
- **Size**: 3,975 bytes
- **Lines**: 117
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/ws_test_load.py`.

**Classes defined**: PerformanceMetrics

**Functions defined**: get_metrics, should_print_metrics, increment_error_count, __init__, increment_message_count, watch_orderbook, main
...
**To run this test:**
```bash
pytest examples/py/ws_test_load.py
```
