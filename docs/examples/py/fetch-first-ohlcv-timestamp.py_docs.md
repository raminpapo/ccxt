# Documentation: examples/py/fetch-first-ohlcv-timestamp.py

## File Metadata

- **Path**: `examples/py/fetch-first-ohlcv-timestamp.py`
- **Size**: 4,022 bytes
- **Lines**: 86
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/fetch-first-ohlcv-timestamp.py`.
...
```bash
python examples/py/fetch-first-ohlcv-timestamp.py
```
