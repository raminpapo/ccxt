# Documentation: examples/py/okx-transfer.py

## File Metadata

- **Path**: `examples/py/okx-transfer.py`
- **Size**: 1,584 bytes
- **Lines**: 39
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/okx-transfer.py`.
...
```bash
python examples/py/okx-transfer.py
```
