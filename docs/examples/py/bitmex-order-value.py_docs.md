# Documentation: examples/py/bitmex-order-value.py

## File Metadata

- **Path**: `examples/py/bitmex-order-value.py`
- **Size**: 1,467 bytes
- **Lines**: 45
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/bitmex-order-value.py`.
...
```bash
python examples/py/bitmex-order-value.py
```
