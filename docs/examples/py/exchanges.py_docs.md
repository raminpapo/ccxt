# Documentation: examples/py/exchanges.py

## File Metadata

- **Path**: `examples/py/exchanges.py`
- **Size**: 1,224 bytes
- **Lines**: 62
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/exchanges.py`.
...
```bash
python examples/py/exchanges.py
```
