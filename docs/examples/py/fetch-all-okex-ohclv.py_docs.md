# Documentation: examples/py/fetch-all-okex-ohclv.py

## File Metadata

- **Path**: `examples/py/fetch-all-okex-ohclv.py`
- **Size**: 3,018 bytes
- **Lines**: 80
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/fetch-all-okex-ohclv.py`.

**Classes defined**: my_okex, ohlcv, inheritance, is, and

**Functions defined**: fetch_all_ohlcvs
...
```bash
python examples/py/fetch-all-okex-ohclv.py
```
