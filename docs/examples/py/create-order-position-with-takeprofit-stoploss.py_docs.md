# Documentation: examples/py/create-order-position-with-takeprofit-stoploss.py

## File Metadata

- **Path**: `examples/py/create-order-position-with-takeprofit-stoploss.py`
- **Size**: 3,881 bytes
- **Lines**: 78
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/create-order-position-with-takeprofit-stoploss.py`.
...
```bash
python examples/py/create-order-position-with-takeprofit-stoploss.py
```
