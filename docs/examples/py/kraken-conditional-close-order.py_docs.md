# Documentation: examples/py/kraken-conditional-close-order.py

## File Metadata

- **Path**: `examples/py/kraken-conditional-close-order.py`
- **Size**: 938 bytes
- **Lines**: 45
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/kraken-conditional-close-order.py`.
...
```bash
python examples/py/kraken-conditional-close-order.py
```
