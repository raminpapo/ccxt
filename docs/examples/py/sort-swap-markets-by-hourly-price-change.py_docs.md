# Documentation: examples/py/sort-swap-markets-by-hourly-price-change.py

## File Metadata

- **Path**: `examples/py/sort-swap-markets-by-hourly-price-change.py`
- **Size**: 2,491 bytes
- **Lines**: 82
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/sort-swap-markets-by-hourly-price-change.py`.
...
```bash
python examples/py/sort-swap-markets-by-hourly-price-change.py
```
