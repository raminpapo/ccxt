# Documentation: examples/py/binance-futures-margin.py
...
This is a Python file located at `examples/py/binance-futures-margin.py`.
...
```bash
python examples/py/binance-futures-margin.py
```
