# Documentation: examples/py/gateio-swaps.py

## File Metadata

- **Path**: `examples/py/gateio-swaps.py`
- **Size**: 1,854 bytes
- **Lines**: 80
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/gateio-swaps.py`.
...
```bash
python examples/py/gateio-swaps.py
```
