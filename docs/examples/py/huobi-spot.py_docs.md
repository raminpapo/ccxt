# Documentation: examples/py/huobi-spot.py

## File Metadata

- **Path**: `examples/py/huobi-spot.py`
- **Size**: 1,865 bytes
- **Lines**: 83
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/huobi-spot.py`.
...
```bash
python examples/py/huobi-spot.py
```
