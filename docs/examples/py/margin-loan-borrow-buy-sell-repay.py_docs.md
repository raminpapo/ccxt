# Documentation: examples/py/margin-loan-borrow-buy-sell-repay.py

## File Metadata

- **Path**: `examples/py/margin-loan-borrow-buy-sell-repay.py`
- **Size**: 5,334 bytes
- **Lines**: 100
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/margin-loan-borrow-buy-sell-repay.py`.
...
```bash
python examples/py/margin-loan-borrow-buy-sell-repay.py
```
