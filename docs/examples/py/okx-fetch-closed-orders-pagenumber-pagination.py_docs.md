# Documentation: examples/py/okx-fetch-closed-orders-pagenumber-pagination.py

## File Metadata

- **Path**: `examples/py/okx-fetch-closed-orders-pagenumber-pagination.py`
- **Size**: 1,879 bytes
- **Lines**: 61
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/okx-fetch-closed-orders-pagenumber-pagination.py`.

**Functions defined**: get_all_closed_orders_since_to
...
**Functions** (1):
- `get_all_closed_orders_since_to()`
...
```bash
python examples/py/okx-fetch-closed-orders-pagenumber-pagination.py
```
