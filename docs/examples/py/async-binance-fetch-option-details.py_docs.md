# Documentation: examples/py/async-binance-fetch-option-details.py

## File Metadata

- **Path**: `examples/py/async-binance-fetch-option-details.py`
- **Size**: 1,028 bytes
- **Lines**: 36
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/async-binance-fetch-option-details.py`.
...
```bash
python examples/py/async-binance-fetch-option-details.py
```
