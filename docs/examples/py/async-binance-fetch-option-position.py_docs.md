# Documentation: examples/py/async-binance-fetch-option-position.py

## File Metadata

- **Path**: `examples/py/async-binance-fetch-option-position.py`
- **Size**: 1,160 bytes
- **Lines**: 39
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/async-binance-fetch-option-position.py`.
...
```bash
python examples/py/async-binance-fetch-option-position.py
```
