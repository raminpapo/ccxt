# Documentation: examples/py/binance-conditional-orders.py

## File Metadata

- **Path**: `examples/py/binance-conditional-orders.py`
- **Size**: 1,253 bytes
- **Lines**: 45
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/binance-conditional-orders.py`.
...
```bash
python examples/py/binance-conditional-orders.py
```
