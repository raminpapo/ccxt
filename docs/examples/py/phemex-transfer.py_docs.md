# Documentation: examples/py/phemex-transfer.py

## File Metadata

- **Path**: `examples/py/phemex-transfer.py`
- **Size**: 3,085 bytes
- **Lines**: 109
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/phemex-transfer.py`.
...
```bash
python examples/py/phemex-transfer.py
```
