# Documentation: examples/py/okx-fetch-all-my-trades.py

## File Metadata

- **Path**: `examples/py/okx-fetch-all-my-trades.py`
- **Size**: 1,653 bytes
- **Lines**: 64
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/okx-fetch-all-my-trades.py`.
...
```bash
python examples/py/okx-fetch-all-my-trades.py
```
