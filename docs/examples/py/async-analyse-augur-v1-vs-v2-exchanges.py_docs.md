# Documentation: examples/py/async-analyse-augur-v1-vs-v2-exchanges.py

## File Metadata

- **Path**: `examples/py/async-analyse-augur-v1-vs-v2-exchanges.py`
- **Size**: 2,769 bytes
- **Lines**: 89
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/async-analyse-augur-v1-vs-v2-exchanges.py`.
...
```bash
python examples/py/async-analyse-augur-v1-vs-v2-exchanges.py
```
