# Documentation: examples/py/phemex-open-cancel-close-positions.py

## File Metadata

- **Path**: `examples/py/phemex-open-cancel-close-positions.py`
- **Size**: 2,528 bytes
- **Lines**: 65
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/phemex-open-cancel-close-positions.py`.
...
```bash
python examples/py/phemex-open-cancel-close-positions.py
```
