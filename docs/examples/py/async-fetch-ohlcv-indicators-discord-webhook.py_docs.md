# Documentation: examples/py/async-fetch-ohlcv-indicators-discord-webhook.py

## File Metadata

- **Path**: `examples/py/async-fetch-ohlcv-indicators-discord-webhook.py`
- **Size**: 2,382 bytes
- **Lines**: 63
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/async-fetch-ohlcv-indicators-discord-webhook.py`.
...
```bash
python examples/py/async-fetch-ohlcv-indicators-discord-webhook.py
```
