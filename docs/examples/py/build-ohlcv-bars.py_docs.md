# Documentation: examples/py/build-ohlcv-bars.py

## File Metadata

- **Path**: `examples/py/build-ohlcv-bars.py`
- **Size**: 3,649 bytes
- **Lines**: 68
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/build-ohlcv-bars.py`.
...
```bash
python examples/py/build-ohlcv-bars.py
```
