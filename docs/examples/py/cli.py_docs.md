# Documentation: examples/py/cli.py

## File Metadata

- **Path**: `examples/py/cli.py`
- **Size**: 9,545 bytes
- **Lines**: 268
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/cli.py`.

**Classes defined**: Argv

**Functions defined**: print_usage, main, print_supported_exchanges, table
