# Documentation: examples/py/kraken-create-and-close-position.py

## File Metadata

- **Path**: `examples/py/kraken-create-and-close-position.py`
- **Size**: 2,671 bytes
- **Lines**: 66
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/kraken-create-and-close-position.py`.
...
```bash
python examples/py/kraken-create-and-close-position.py
```
