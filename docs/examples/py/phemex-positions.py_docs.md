# Documentation: examples/py/phemex-positions.py

## File Metadata

- **Path**: `examples/py/phemex-positions.py`
- **Size**: 1,484 bytes
- **Lines**: 55
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/phemex-positions.py`.
...
```bash
python examples/py/phemex-positions.py
```
