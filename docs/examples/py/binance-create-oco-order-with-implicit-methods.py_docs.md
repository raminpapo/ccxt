# Documentation: examples/py/binance-create-oco-order-with-implicit-methods.py

## File Metadata

- **Path**: `examples/py/binance-create-oco-order-with-implicit-methods.py`
- **Size**: 1,440 bytes
- **Lines**: 40
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/binance-create-oco-order-with-implicit-methods.py`.
...
```bash
python examples/py/binance-create-oco-order-with-implicit-methods.py
```
