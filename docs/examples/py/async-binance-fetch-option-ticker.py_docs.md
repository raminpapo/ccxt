# Documentation: examples/py/async-binance-fetch-option-ticker.py

## File Metadata

- **Path**: `examples/py/async-binance-fetch-option-ticker.py`
- **Size**: 1,153 bytes
- **Lines**: 39
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/async-binance-fetch-option-ticker.py`.
...
```bash
python examples/py/async-binance-fetch-option-ticker.py
```
