# Documentation: examples/py/huobi-open-close-position-bbo.py

## File Metadata

- **Path**: `examples/py/huobi-open-close-position-bbo.py`
- **Size**: 1,929 bytes
- **Lines**: 68
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/huobi-open-close-position-bbo.py`.
...
```bash
python examples/py/huobi-open-close-position-bbo.py
```
