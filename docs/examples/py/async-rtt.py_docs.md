# Documentation: examples/py/async-rtt.py

## File Metadata

- **Path**: `examples/py/async-rtt.py`
- **Size**: 2,370 bytes
- **Lines**: 77
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/async-rtt.py`.
...
```bash
python examples/py/async-rtt.py
```
