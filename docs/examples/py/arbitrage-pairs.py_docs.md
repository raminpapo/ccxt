# Documentation: examples/py/arbitrage-pairs.py

## File Metadata

- **Path**: `examples/py/arbitrage-pairs.py`
- **Size**: 3,562 bytes
- **Lines**: 133
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/arbitrage-pairs.py`.
...
```bash
python examples/py/arbitrage-pairs.py
```
