# Documentation: examples/py/binance-spot-trailing.py

## File Metadata

- **Path**: `examples/py/binance-spot-trailing.py`
- **Size**: 2,402 bytes
- **Lines**: 92
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/binance-spot-trailing.py`.
...
```bash
python examples/py/binance-spot-trailing.py
```
