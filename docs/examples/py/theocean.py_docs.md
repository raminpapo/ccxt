# Documentation: examples/py/theocean.py

## File Metadata

- **Path**: `examples/py/theocean.py`
- **Size**: 1,120 bytes
- **Lines**: 43
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/theocean.py`.
...
```bash
python examples/py/theocean.py
```
