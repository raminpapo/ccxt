# Documentation: examples/py/binance-fetch-ohlcv-to-csv.py

## File Metadata

- **Path**: `examples/py/binance-fetch-ohlcv-to-csv.py`
- **Size**: 2,963 bytes
- **Lines**: 71
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/binance-fetch-ohlcv-to-csv.py`.
...
```bash
python examples/py/binance-fetch-ohlcv-to-csv.py
```
