# Documentation: examples/py/gateio-fetch-ohlcv-pagination.py

## File Metadata

- **Path**: `examples/py/gateio-fetch-ohlcv-pagination.py`
- **Size**: 1,426 bytes
- **Lines**: 45
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/gateio-fetch-ohlcv-pagination.py`.
...
```bash
python examples/py/gateio-fetch-ohlcv-pagination.py
```
