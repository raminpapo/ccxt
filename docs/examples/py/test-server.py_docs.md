# Documentation: examples/py/test-server.py

## File Metadata

- **Path**: `examples/py/test-server.py`
- **Size**: 2,607 bytes
- **Lines**: 65
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/test-server.py`.

**Classes defined**: TestRequestHandler

**Functions defined**: test, do_GET
...
**To run this test:**
```bash
pytest examples/py/test-server.py
```
