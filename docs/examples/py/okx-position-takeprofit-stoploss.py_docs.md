# Documentation: examples/py/okx-position-takeprofit-stoploss.py

## File Metadata

- **Path**: `examples/py/okx-position-takeprofit-stoploss.py`
- **Size**: 4,700 bytes
- **Lines**: 121
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/okx-position-takeprofit-stoploss.py`.
...
```bash
python examples/py/okx-position-takeprofit-stoploss.py
```
