# Documentation: examples/py/measure-latency.py

## File Metadata

- **Path**: `examples/py/measure-latency.py`
- **Size**: 2,226 bytes
- **Lines**: 66
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/measure-latency.py`.
...
```bash
python examples/py/measure-latency.py
```
