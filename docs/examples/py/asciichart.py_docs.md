# Documentation: examples/py/asciichart.py

## File Metadata

- **Path**: `examples/py/asciichart.py`
- **Size**: 2,137 bytes
- **Lines**: 65
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `examples/py/asciichart.py`.

**Functions defined**: plot
...
```bash
python examples/py/asciichart.py
```
