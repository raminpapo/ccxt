# Documentation: examples/js/compare-two-exchanges-capabilities.js

## File Metadata

- **Path**: `examples/js/compare-two-exchanges-capabilities.js`
- **Size**: 1,574 bytes
- **Lines**: 37
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/compare-two-exchanges-capabilities.js`.
...
```bash
node examples/js/compare-two-exchanges-capabilities.js
```
