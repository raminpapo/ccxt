# Documentation: examples/js/live-orderbook.js

## File Metadata

- **Path**: `examples/js/live-orderbook.js`
- **Size**: 3,078 bytes
- **Lines**: 106
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/live-orderbook.js`.
...
```bash
node examples/js/live-orderbook.js
```
