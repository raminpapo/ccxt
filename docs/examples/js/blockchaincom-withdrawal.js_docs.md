# Documentation: examples/js/blockchaincom-withdrawal.js

## File Metadata

- **Path**: `examples/js/blockchaincom-withdrawal.js`
- **Size**: 1,875 bytes
- **Lines**: 60
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/blockchaincom-withdrawal.js`.
...
```bash
node examples/js/blockchaincom-withdrawal.js
```
