# Documentation: examples/js/build-ohlcv-bars.js

## File Metadata

- **Path**: `examples/js/build-ohlcv-bars.js`
- **Size**: 3,325 bytes
- **Lines**: 49
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/build-ohlcv-bars.js`.
...
```bash
node examples/js/build-ohlcv-bars.js
```
