# Documentation: examples/js/huobi-swaps.js

## File Metadata

- **Path**: `examples/js/huobi-swaps.js`
- **Size**: 1,938 bytes
- **Lines**: 71
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/huobi-swaps.js`.
...
```bash
node examples/js/huobi-swaps.js
```
