# Documentation: examples/js/gateio-swaps.js

## File Metadata

- **Path**: `examples/js/gateio-swaps.js`
- **Size**: 2,062 bytes
- **Lines**: 75
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/gateio-swaps.js`.
...
```bash
node examples/js/gateio-swaps.js
```
