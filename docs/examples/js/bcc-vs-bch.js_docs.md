# Documentation: examples/js/bcc-vs-bch.js

## File Metadata

- **Path**: `examples/js/bcc-vs-bch.js`
- **Size**: 3,603 bytes
- **Lines**: 116
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/bcc-vs-bch.js`.
...
```bash
node examples/js/bcc-vs-bch.js
```
