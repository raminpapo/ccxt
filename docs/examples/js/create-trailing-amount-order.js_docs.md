# Documentation: examples/js/create-trailing-amount-order.js

## File Metadata

- **Path**: `examples/js/create-trailing-amount-order.js`
- **Size**: 1,312 bytes
- **Lines**: 37
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/create-trailing-amount-order.js`.
...
```bash
node examples/js/create-trailing-amount-order.js
```
