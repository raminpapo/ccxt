# Documentation: examples/js/arbitrage-pairs.js

## File Metadata

- **Path**: `examples/js/arbitrage-pairs.js`
- **Size**: 4,630 bytes
- **Lines**: 130
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/arbitrage-pairs.js`.
...
```bash
node examples/js/arbitrage-pairs.js
```
