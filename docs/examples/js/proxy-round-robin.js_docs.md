# Documentation: examples/js/proxy-round-robin.js

## File Metadata

- **Path**: `examples/js/proxy-round-robin.js`
- **Size**: 3,423 bytes
- **Lines**: 99
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/proxy-round-robin.js`.
...
```bash
node examples/js/proxy-round-robin.js
```
