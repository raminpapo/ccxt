# Documentation: examples/js/aggregate-orderbook.js

## File Metadata

- **Path**: `examples/js/aggregate-orderbook.js`
- **Size**: 1,582 bytes
- **Lines**: 54
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/aggregate-orderbook.js`.
...
```bash
node examples/js/aggregate-orderbook.js
```
