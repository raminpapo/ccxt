# Documentation: examples/js/hitbtc2-withdraw.js

## File Metadata

- **Path**: `examples/js/hitbtc2-withdraw.js`
- **Size**: 2,020 bytes
- **Lines**: 61
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/hitbtc2-withdraw.js`.
...
```bash
node examples/js/hitbtc2-withdraw.js
```
