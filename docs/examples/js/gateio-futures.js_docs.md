# Documentation: examples/js/gateio-futures.js

## File Metadata

- **Path**: `examples/js/gateio-futures.js`
- **Size**: 1,289 bytes
- **Lines**: 50
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/gateio-futures.js`.
...
```bash
node examples/js/gateio-futures.js
```
