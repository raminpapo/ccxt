# Documentation: examples/js/bittrex-fetch-closed-orders-history.js

## File Metadata

- **Path**: `examples/js/bittrex-fetch-closed-orders-history.js`
- **Size**: 1,784 bytes
- **Lines**: 70
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/bittrex-fetch-closed-orders-history.js`.
...
```bash
node examples/js/bittrex-fetch-closed-orders-history.js
```
