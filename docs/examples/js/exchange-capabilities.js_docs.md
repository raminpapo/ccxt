# Documentation: examples/js/exchange-capabilities.js

## File Metadata

- **Path**: `examples/js/exchange-capabilities.js`
- **Size**: 4,574 bytes
- **Lines**: 136
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/exchange-capabilities.js`.
...
```bash
node examples/js/exchange-capabilities.js
```
