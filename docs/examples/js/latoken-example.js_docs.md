# Documentation: examples/js/latoken-example.js

## File Metadata

- **Path**: `examples/js/latoken-example.js`
- **Size**: 3,991 bytes
- **Lines**: 108
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/latoken-example.js`.
...
```bash
node examples/js/latoken-example.js
```
