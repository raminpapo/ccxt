# Documentation: examples/js/fetch-ohlcv-from-to-mark-index-premium.js

## File Metadata

- **Path**: `examples/js/fetch-ohlcv-from-to-mark-index-premium.js`
- **Size**: 2,579 bytes
- **Lines**: 73
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/fetch-ohlcv-from-to-mark-index-premium.js`.

**Functions defined**: checkAllSymbols, myDataFetch
...
```bash
node examples/js/fetch-ohlcv-from-to-mark-index-premium.js
```
