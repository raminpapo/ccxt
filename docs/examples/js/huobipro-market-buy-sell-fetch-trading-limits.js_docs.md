# Documentation: examples/js/huobipro-market-buy-sell-fetch-trading-limits.js

## File Metadata

- **Path**: `examples/js/huobipro-market-buy-sell-fetch-trading-limits.js`
- **Size**: 4,110 bytes
- **Lines**: 98
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/huobipro-market-buy-sell-fetch-trading-limits.js`.
...
```bash
node examples/js/huobipro-market-buy-sell-fetch-trading-limits.js
```
