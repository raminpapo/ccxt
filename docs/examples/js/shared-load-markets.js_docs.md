# Documentation: examples/js/shared-load-markets.js

## File Metadata

- **Path**: `examples/js/shared-load-markets.js`
- **Size**: 3,098 bytes
- **Lines**: 81
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/shared-load-markets.js`.
...
```bash
node examples/js/shared-load-markets.js
```
