# Documentation: examples/js/fetch-first-ohlcv-timestamp.js

## File Metadata

- **Path**: `examples/js/fetch-first-ohlcv-timestamp.js`
- **Size**: 3,927 bytes
- **Lines**: 80
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/fetch-first-ohlcv-timestamp.js`.
...
```bash
node examples/js/fetch-first-ohlcv-timestamp.js
```
