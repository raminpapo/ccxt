# Documentation: examples/js/huobi-open-close-contract.js

## File Metadata

- **Path**: `examples/js/huobi-open-close-contract.js`
- **Size**: 1,974 bytes
- **Lines**: 64
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/huobi-open-close-contract.js`.
...
```bash
node examples/js/huobi-open-close-contract.js
```
