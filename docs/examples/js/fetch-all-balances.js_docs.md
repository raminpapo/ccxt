# Documentation: examples/js/fetch-all-balances.js

## File Metadata

- **Path**: `examples/js/fetch-all-balances.js`
- **Size**: 6,729 bytes
- **Lines**: 220
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/fetch-all-balances.js`.

**Functions defined**: initializeAllExchanges
...
- `../../js/src/base/functions/number.js` (imported)
- `ansicolor` (imported)
- `fs` (imported)
- `ololog` (imported)
- `../../js/ccxt.js` (imported)
...
- `../../js/src/base/functions/number.js` (referenced)
...
```bash
node examples/js/fetch-all-balances.js
```
