# Documentation: examples/js/create-order-position-with-takeprofit-stoploss.js

## File Metadata

- **Path**: `examples/js/create-order-position-with-takeprofit-stoploss.js`
- **Size**: 4,775 bytes
- **Lines**: 72
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/create-order-position-with-takeprofit-stoploss.js`.
...
```bash
node examples/js/create-order-position-with-takeprofit-stoploss.js
```
