# Documentation: examples/js/fetch-all-tickers-to-files.js

## File Metadata

- **Path**: `examples/js/fetch-all-tickers-to-files.js`
- **Size**: 2,384 bytes
- **Lines**: 78
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/fetch-all-tickers-to-files.js`.
...
```bash
node examples/js/fetch-all-tickers-to-files.js
```
