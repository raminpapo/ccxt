# Documentation: examples/js/apex-example.js

## File Metadata

- **Path**: `examples/js/apex-example.js`
- **Size**: 4,178 bytes
- **Lines**: 98
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/apex-example.js`.
...
```bash
node examples/js/apex-example.js
```
