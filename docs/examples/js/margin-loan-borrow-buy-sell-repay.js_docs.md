# Documentation: examples/js/margin-loan-borrow-buy-sell-repay.js

## File Metadata

- **Path**: `examples/js/margin-loan-borrow-buy-sell-repay.js`
- **Size**: 4,982 bytes
- **Lines**: 71
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/margin-loan-borrow-buy-sell-repay.js`.
...
```bash
node examples/js/margin-loan-borrow-buy-sell-repay.js
```
