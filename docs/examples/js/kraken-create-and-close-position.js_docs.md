# Documentation: examples/js/kraken-create-and-close-position.js

## File Metadata

- **Path**: `examples/js/kraken-create-and-close-position.js`
- **Size**: 2,783 bytes
- **Lines**: 55
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/kraken-create-and-close-position.js`.
...
```bash
node examples/js/kraken-create-and-close-position.js
```
