# Documentation: examples/js/bitstamp-private-api.js

## File Metadata

- **Path**: `examples/js/bitstamp-private-api.js`
- **Size**: 4,298 bytes
- **Lines**: 115
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/bitstamp-private-api.js`.
...
```bash
node examples/js/bitstamp-private-api.js
```
