# Documentation: examples/js/search-all-exchanges.js

## File Metadata

- **Path**: `examples/js/search-all-exchanges.js`
- **Size**: 6,072 bytes
- **Lines**: 167
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/search-all-exchanges.js`.
...
```bash
node examples/js/search-all-exchanges.js
```
