# Documentation: examples/js/hibachi-example.js

## File Metadata

- **Path**: `examples/js/hibachi-example.js`
- **Size**: 7,096 bytes
- **Lines**: 114
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/hibachi-example.js`.
...
```bash
node examples/js/hibachi-example.js
```
