# Documentation: examples/js/create-order-with-retry.js

## File Metadata

- **Path**: `examples/js/create-order-with-retry.js`
- **Size**: 1,790 bytes
- **Lines**: 66
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/create-order-with-retry.js`.
...
```bash
node examples/js/create-order-with-retry.js
```
