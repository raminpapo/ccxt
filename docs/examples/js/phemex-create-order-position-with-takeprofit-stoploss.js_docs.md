# Documentation: examples/js/phemex-create-order-position-with-takeprofit-stoploss.js

## File Metadata

- **Path**: `examples/js/phemex-create-order-position-with-takeprofit-stoploss.js`
- **Size**: 2,168 bytes
- **Lines**: 50
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/phemex-create-order-position-with-takeprofit-stoploss.js`.
...
```bash
node examples/js/phemex-create-order-position-with-takeprofit-stoploss.js
```
