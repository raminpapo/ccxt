# Documentation: examples/js/benchmark.js

## File Metadata

- **Path**: `examples/js/benchmark.js`
- **Size**: 5,186 bytes
- **Lines**: 105
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/benchmark.js`.
