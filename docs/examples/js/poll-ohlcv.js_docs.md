# Documentation: examples/js/poll-ohlcv.js

## File Metadata

- **Path**: `examples/js/poll-ohlcv.js`
- **Size**: 1,389 bytes
- **Lines**: 43
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `examples/js/poll-ohlcv.js`.
...
```bash
node examples/js/poll-ohlcv.js
```
