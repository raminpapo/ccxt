# Documentation: examples/html/webworker/index.html

## File Metadata

- **Path**: `examples/html/webworker/index.html`
- **Size**: 3,691 bytes
- **Lines**: 97
- **Type**: HTML
- **Extension**: .html
...
This is a HTML file located at `examples/html/webworker/index.html`.

**Functions defined**: handleReceivedData, stopWorker, startWorker
