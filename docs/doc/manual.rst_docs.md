...
This is a reStructuredText file located at `doc/manual.rst`.

**Classes defined**: or, has, implements, also, instantiation, contains, from, and

**Functions defined**: decimalToPrecision, amountToPrecision, priceToPrecision, before, costToPrecision, decimal_to_precision, that, tick
...
- `future` (imported)
- `timestamp` (imported)
- `fetchOrders` (imported)
- `fetchOpenOrders` (imported)
- `as is` (imported)
- `linear` (imported)
- `tier` (imported)
- `BTC/USD` (imported)
