...
This is a reStructuredText file located at `doc/readme.rst`.
...
- `https://cdn.jsdelivr.net/npm/ccxt@2.4.96/dist/ccxt.browser.js` (referenced)
- `https://opencollective.com/ccxt/tiers/sponsor/2/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/sponsor/4/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/sponsor/3/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/sponsor/0/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/sponsor/1/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/sponsor/6/avatar.svg` (referenced)
- `https://opencollective.com/ccxt/tiers/sponsor/5/avatar.svg` (referenced)



## Testing & Execution

**To execute this reStructuredText file:**
