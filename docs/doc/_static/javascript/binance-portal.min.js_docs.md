# Documentation: doc/_static/javascript/binance-portal.min.js

## File Metadata

- **Path**: `doc/_static/javascript/binance-portal.min.js`
- **Size**: 147,654 bytes
- **Lines**: 2,370
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `doc/_static/javascript/binance-portal.min.js`.

**Functions defined**: a, r, l, o, n, i, k, t
...
- `https://public.bnbstatic.com/static/css/broker-sdk/broker-sdk@1.0.0.min.css` (referenced)
...
```bash
node doc/_static/javascript/binance-portal.min.js
```
