# Documentation: doc/_static/javascript/jquery-ui.min.js

## File Metadata

- **Path**: `doc/_static/javascript/jquery-ui.min.js`
- **Size**: 25,154 bytes
- **Lines**: 6
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `doc/_static/javascript/jquery-ui.min.js`.

**Functions defined**: M, q, _, i, H, W, B, t, c, S
...
```bash
node doc/_static/javascript/jquery-ui.min.js
```
