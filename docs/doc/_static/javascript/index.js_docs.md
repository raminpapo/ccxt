# Documentation: doc/_static/javascript/index.js

## File Metadata

- **Path**: `doc/_static/javascript/index.js`
- **Size**: 7,628 bytes
- **Lines**: 196
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `doc/_static/javascript/index.js`.

**Functions defined**: openReplacement, onReadyStateChangeReplacement, open
...
```bash
node doc/_static/javascript/index.js
```
