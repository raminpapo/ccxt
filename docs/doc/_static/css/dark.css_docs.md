# Documentation: doc/_static/css/dark.css

## File Metadata

- **Path**: `doc/_static/css/dark.css`
- **Size**: 2,401 bytes
- **Lines**: 101
- **Type**: CSS
- **Extension**: .css
 ...
 * Modified by Carlo Revelli
 */

:root {
    --dark-body: #3c3c3c;
    --dark-outer: rgba(0,0,0,.6);
    --dark-code: #2d2d2d;
    --dark-text: #d9d9d9;
    --dark-hover: #343131;
    --dark-blue: #222222;
...
html[data-theme='dark'] .wy-nav-content, html[data-theme='dark'] .head {
...
html[data-theme='dark'] code.literal {
    ...
    border: 1px solid var(--dark-body) !important;
}
...
html[data-theme='dark'] ul > .toctree-l1.current > ul > .toctree-l2 > a {
   color: var(--dark-text);
}

html[data-theme='dark'] ul > .toctree-l1.current > ul > .toctree-l2.current > a, .wy-menu-vertical a:hover {
...
html[data-theme='dark'] .row-even td {
    background-color: var(--dark-hover) !important;
}

html[data-theme='dark'] td, html[data-theme='dark'] th {
    border: 1px solid var(--dark-code) !important;
}
...
html[data-theme='dark'] #widget-wrapper {
    border-color: #1e6395;
}
...
This is a CSS file located at `doc/_static/css/dark.css`.
