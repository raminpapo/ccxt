# Documentation: go/tests/base/test.watchMyTrades.go

## File Metadata

- **Path**: `go/tests/base/test.watchMyTrades.go`
- **Size**: 2,860 bytes
- **Lines**: 63
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/base/test.watchMyTrades.go`.
