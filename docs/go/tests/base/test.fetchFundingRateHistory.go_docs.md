# Documentation: go/tests/base/test.fetchFundingRateHistory.go

## File Metadata

- **Path**: `go/tests/base/test.fetchFundingRateHistory.go`
- **Size**: 1,289 bytes
- **Lines**: 29
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/base/test.fetchFundingRateHistory.go`.
