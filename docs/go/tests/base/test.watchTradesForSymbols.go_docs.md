# Documentation: go/tests/base/test.watchTradesForSymbols.go

## File Metadata

- **Path**: `go/tests/base/test.watchTradesForSymbols.go`
- **Size**: 3,272 bytes
- **Lines**: 67
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/base/test.watchTradesForSymbols.go`.
