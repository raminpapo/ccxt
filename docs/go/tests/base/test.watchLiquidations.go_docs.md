# Documentation: go/tests/base/test.watchLiquidations.go

## File Metadata

- **Path**: `go/tests/base/test.watchLiquidations.go`
- **Size**: 3,574 bytes
- **Lines**: 76
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/base/test.watchLiquidations.go`.
