# Documentation: go/tests/base/test.fetchLedger.go

## File Metadata

- **Path**: `go/tests/base/test.fetchLedger.go`
- **Size**: 1,219 bytes
- **Lines**: 30
- **Type**: Go
- **Extension**: .go
...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestFetchLedger(exchange ccxt.ICoreExchange, skippedProperties interface{}, code interface{}) <- chan interface{} {
...
This is a Go file located at `go/tests/base/test.fetchLedger.go`.
