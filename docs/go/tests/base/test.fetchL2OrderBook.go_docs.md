# Documentation: go/tests/base/test.fetchL2OrderBook.go

## File Metadata

- **Path**: `go/tests/base/test.fetchL2OrderBook.go`
- **Size**: 922 bytes
- **Lines**: 25
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/base/test.fetchL2OrderBook.go`.
