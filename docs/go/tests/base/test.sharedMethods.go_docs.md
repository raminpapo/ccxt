# Documentation: go/tests/base/test.sharedMethods.go

## File Metadata

- **Path**: `go/tests/base/test.sharedMethods.go`
- **Size**: 43,621 bytes
- **Lines**: 670
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/base/test.sharedMethods.go`.
