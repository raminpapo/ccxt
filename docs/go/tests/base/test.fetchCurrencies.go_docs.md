# Documentation: go/tests/base/test.fetchCurrencies.go

## File Metadata

- **Path**: `go/tests/base/test.fetchCurrencies.go`
- **Size**: 5,660 bytes
- **Lines**: 81
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/base/test.fetchCurrencies.go`.
