# Documentation: go/tests/base/test.fetchLiquidations.go

## File Metadata

- **Path**: `go/tests/base/test.fetchLiquidations.go`
- **Size**: 1,478 bytes
- **Lines**: 35
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/base/test.fetchLiquidations.go`.
