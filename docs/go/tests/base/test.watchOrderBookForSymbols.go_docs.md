# Documentation: go/tests/base/test.watchOrderBookForSymbols.go

## File Metadata

- **Path**: `go/tests/base/test.watchOrderBookForSymbols.go`
- **Size**: 3,126 bytes
- **Lines**: 63
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/base/test.watchOrderBookForSymbols.go`.
