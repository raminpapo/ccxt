# Documentation: go/tests/types/types.go

## File Metadata

- **Path**: `go/tests/types/types.go`
- **Size**: 6,636 bytes
- **Lines**: 272
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/tests/types/types.go`.
...
- `ts/src/test/static/markets/binance.json` (referenced)
