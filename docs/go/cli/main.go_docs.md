...
This is a Go file located at `go/cli/main.go`.
...
- `/bench/markets.json` (referenced)
- `/bench/trades.json` (referenced)
- `/bench/ohlcv.json` (referenced)
- `/bench/orderbook.json` (referenced)
- `/bench/tickers.json` (referenced)
