# Documentation: go/v4/btcmarkets.go

## File Metadata

- **Path**: `go/v4/btcmarkets.go`
- **Size**: 73,469 bytes
- **Lines**: 1,756
- **Type**: Go
- **Extension**: .go
...
func (this *BtcmarketsCore) Init(userConfig map[string]interface{}) {
...
This is a Go file located at `go/v4/btcmarkets.go`.
