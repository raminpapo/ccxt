# Documentation: go/v4/coinsph.go

## File Metadata

- **Path**: `go/v4/coinsph.go`
- **Size**: 116,584 bytes
- **Lines**: 2,623
- **Type**: Go
- **Extension**: .go
...
func (this *CoinsphCore) Init(userConfig map[string]interface{}) {
...
This is a Go file located at `go/v4/coinsph.go`.
