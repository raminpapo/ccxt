# Documentation: go/v4/coinmate.go

## File Metadata

- **Path**: `go/v4/coinmate.go`
- **Size**: 61,627 bytes
- **Lines**: 1,427
- **Type**: Go
- **Extension**: .go
...
func (this *CoinmateCore) Init(userConfig map[string]interface{}) {
...
This is a Go file located at `go/v4/coinmate.go`.
