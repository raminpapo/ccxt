# Documentation: go/v4/paradex.go

## File Metadata

- **Path**: `go/v4/paradex.go`
- **Size**: 141,933 bytes
- **Lines**: 3,277
- **Type**: Go
- **Extension**: .go
...
func  (this *ParadexCore) ConvertShortString(str interface{}) interface{}  {
...
This is a Go file located at `go/v4/paradex.go`.
