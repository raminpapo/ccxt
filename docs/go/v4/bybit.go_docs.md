...
func  (this *BybitCore) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes144415 :=  (<-this.PrivatePostV5AccountUpgradeToUta(params))
...
func  (this *BybitCore) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes254815 :=  (<-this.FetchTickers(symbols, params))
                PanicOnError(retRes254815)
                ch <- retRes254815
                return nil
...
func  (this *BybitCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes259919 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
                    PanicOnError(retRes259919)
                    ch <- retRes259919
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *BybitCore) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes284619 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 200))
...
func  (this *BybitCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes389715 :=  (<-this.CreateOrder(symbol, "market", "buy", OpNeg(1), nil, this.Extend(req, params)))
                PanicOnError(retRes389715)
                ch <- retRes389715
                return nil
...
func  (this *BybitCore) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes392415 :=  (<-this.CreateOrder(symbol, "market", "sell", OpNeg(1), nil, this.Extend(req, params)))
                PanicOnError(retRes392415)
                ch <- retRes392415
                return nil
...
func  (this *BybitCore) CreateOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    method = GetValue(methodparamsVariable,0);
    params = GetValue(methodparamsVariable,1)
    var isAlternativeEndpoint interface{} = IsEqual(method, "privatePostV5PositionTradingStop")
    ...
    if IsTrue(IsTrue(isTrailingAmountOrder) || IsTrue(isAlternativeEndpoint)) {
        ...
        if IsTrue(IsTrue(isStopLossTriggerOrder) || IsTrue(isTakeProfitTriggerOrder)) {
            var tpslMode interface{} = this.SafeString(params, "tpslMode", "Partial")
            var isFullTpsl interface{} = IsEqual(tpslMode, "Full")
            var isPartialTpsl interface{} = IsEqual(tpslMode, "Partial")
            if IsTrue(IsTrue(isLimit) && IsTrue(isFullTpsl)) {
                panic(InvalidOrder(Add(this.Id, " tpsl orders with \"full\" tpslMode only support \"market\" type")))
            }
            AddElementToObject(request, "tpslMode", tpslMode)
...
func  (this *BybitCore) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(isUnifiedAccount) {
                    ...
                    retRes496219 :=  (<-this.FetchOrderClassic(id, symbol, params))
...
func  (this *BybitCore) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(enableUnifiedAccount) {
                ...
                retRes506615 :=  (<-this.FetchOrdersClassic(symbol, since, limit, params))
...
func  (this *BybitCore) FetchOrdersClassic(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes509219 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes509219)
                    ch <- retRes509219
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *BybitCore) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes526919 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *BybitCore) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes538915 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes538915)
                ch <- retRes538915
                return nil
...
func  (this *BybitCore) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes54118 := (<-this.LoadMarkets())
            PanicOnError(retRes54118)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Cancelled",
            }
        
                retRes541515 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *BybitCore) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes544219 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *BybitCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"clientOrderId", "orderLinkId"})
                ...
                retRes555915 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func  (this *BybitCore) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes558119 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *BybitCore) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes575619 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes575619)
                    ch <- retRes575619
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *BybitCore) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes582519 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes582519)
                    ch <- retRes582519
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *BybitCore) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes600919 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *BybitCore) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes62968 := (<-this.LoadMarkets())
            PanicOnError(retRes62968)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *BybitCore) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes642219 :=  (<-this.FetchPaginatedCallCursor("fetchPositions", symbols, nil, nil, params, "nextPageCursor", "cursor", nil, 200))
                    PanicOnError(retRes642219)
                    ch <- retRes642219
                    return nil
            }
...
func  (this *BybitCore) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes70428 := (<-this.LoadMarkets())
            PanicOnError(retRes70428)
            var market interface{} = this.Market(symbol)
...
func  (this *BybitCore) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes71088 := (<-this.LoadMarkets())
            PanicOnError(retRes71088)
            var paginate interface{} = this.SafeBool(params, "paginate")
            if IsTrue(paginate) {
                params = this.Omit(params, "paginate")
                AddElementToObject(params, "timeframe", timeframe)
        
                    retRes711319 :=  (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
                    PanicOnError(retRes711319)
                    ch <- retRes711319
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(!IsEqual(limit, nil)) {
                ...
                retRes712515 :=  (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
...
func  (this *BybitCore) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73558 := (<-this.LoadMarkets())
            PanicOnError(retRes73558)
...
func  (this *BybitCore) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes74098 := (<-this.LoadMarkets())
            PanicOnError(retRes74098)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes741319 :=  (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes741319)
                    ch <- retRes741319
                    return nil
            }
            var currency interface{} = nil
...
func  (this *BybitCore) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                retRes766115 :=  (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
...
func  (this *BybitCore) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes81298 := (<-this.LoadMarkets())
            PanicOnError(retRes81298)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
                "category": "option",
...
func  (this *BybitCore) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes833219 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *BybitCore) GetLeverageTiersPaginated(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes845519 :=  (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes845519)
                    ch <- retRes845519
                    return nil
            }
            var subType interface{} = nil
...
func  (this *BybitCore) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes85868 := (<-this.LoadMarkets())
            PanicOnError(retRes85868)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes859019 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes859019)
                    ch <- retRes859019
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *BybitCore) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes90428 := (<-this.LoadMarkets())
            PanicOnError(retRes90428)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *BybitCore) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes90978 := (<-this.LoadMarkets())
            PanicOnError(retRes90978)
            var request interface{} = map[string]interface{} {
                "quoteTxId": id,
            }
...
This is a Go file located at `go/v4/bybit.go`.
...
- `https://t1.bycsi.com/app/assets/token/f59301aef2d6ac2165c4c4603e672fb4.svg` (referenced)
