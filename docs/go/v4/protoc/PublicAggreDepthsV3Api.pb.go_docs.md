# Documentation: go/v4/protoc/PublicAggreDepthsV3Api.pb.go

## File Metadata

- **Path**: `go/v4/protoc/PublicAggreDepthsV3Api.pb.go`
- **Size**: 7,268 bytes
- **Lines**: 220
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/protoc/PublicAggreDepthsV3Api.pb.go`.
