# Documentation: go/v4/protoc/PublicMiniTickerV3Api.pb.go

## File Metadata

- **Path**: `go/v4/protoc/PublicMiniTickerV3Api.pb.go`
- **Size**: 7,229 bytes
- **Lines**: 238
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/protoc/PublicMiniTickerV3Api.pb.go`.
