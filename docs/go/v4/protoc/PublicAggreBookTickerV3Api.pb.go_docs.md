# Documentation: go/v4/protoc/PublicAggreBookTickerV3Api.pb.go

## File Metadata

- **Path**: `go/v4/protoc/PublicAggreBookTickerV3Api.pb.go`
- **Size**: 5,212 bytes
- **Lines**: 153
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/protoc/PublicAggreBookTickerV3Api.pb.go`.
