# Documentation: go/v4/protoc/PublicAggreDealsV3Api.pb.go

## File Metadata

- **Path**: `go/v4/protoc/PublicAggreDealsV3Api.pb.go`
- **Size**: 6,791 bytes
- **Lines**: 210
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/protoc/PublicAggreDealsV3Api.pb.go`.
