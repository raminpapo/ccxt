# Documentation: go/v4/protoc/PublicBookTickerBatchV3Api.pb.go

## File Metadata

- **Path**: `go/v4/protoc/PublicBookTickerBatchV3Api.pb.go`
- **Size**: 4,596 bytes
- **Lines**: 129
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/protoc/PublicBookTickerBatchV3Api.pb.go`.
