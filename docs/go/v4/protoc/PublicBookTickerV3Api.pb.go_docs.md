# Documentation: go/v4/protoc/PublicBookTickerV3Api.pb.go

## File Metadata

- **Path**: `go/v4/protoc/PublicBookTickerV3Api.pb.go`
- **Size**: 4,984 bytes
- **Lines**: 153
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/protoc/PublicBookTickerV3Api.pb.go`.
