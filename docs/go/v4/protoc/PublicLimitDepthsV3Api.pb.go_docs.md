# Documentation: go/v4/protoc/PublicLimitDepthsV3Api.pb.go

## File Metadata

- **Path**: `go/v4/protoc/PublicLimitDepthsV3Api.pb.go`
- **Size**: 6,954 bytes
- **Lines**: 211
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/protoc/PublicLimitDepthsV3Api.pb.go`.
