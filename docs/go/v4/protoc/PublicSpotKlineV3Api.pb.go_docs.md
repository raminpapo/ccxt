# Documentation: go/v4/protoc/PublicSpotKlineV3Api.pb.go

## File Metadata

- **Path**: `go/v4/protoc/PublicSpotKlineV3Api.pb.go`
- **Size**: 6,409 bytes
- **Lines**: 207
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/protoc/PublicSpotKlineV3Api.pb.go`.
