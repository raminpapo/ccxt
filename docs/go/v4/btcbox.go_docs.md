# Documentation: go/v4/btcbox.go

## File Metadata

- **Path**: `go/v4/btcbox.go`
- **Size**: 42,870 bytes
- **Lines**: 1,075
- **Type**: Go
- **Extension**: .go
...
func (this *BtcboxCore) Init(userConfig map[string]interface{}) {
...
This is a Go file located at `go/v4/btcbox.go`.
