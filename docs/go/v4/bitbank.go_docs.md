# Documentation: go/v4/bitbank.go

## File Metadata

- **Path**: `go/v4/bitbank.go`
- **Size**: 59,318 bytes
- **Lines**: 1,380
- **Type**: Go
- **Extension**: .go
...
func (this *BitbankCore) Init(userConfig map[string]interface{}) {
...
This is a Go file located at `go/v4/bitbank.go`.
