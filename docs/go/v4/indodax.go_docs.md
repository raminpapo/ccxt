# Documentation: go/v4/indodax.go

## File Metadata

- **Path**: `go/v4/indodax.go`
- **Size**: 75,572 bytes
- **Lines**: 1,766
- **Type**: Go
- **Extension**: .go
...
func (this *IndodaxCore) Init(userConfig map[string]interface{}) {
...
This is a Go file located at `go/v4/indodax.go`.
