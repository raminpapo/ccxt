# Documentation: go/v4/kucoinfutures.go

## File Metadata

- **Path**: `go/v4/kucoinfutures.go`
- **Size**: 187,206 bytes
- **Lines**: 4,122
- **Type**: Go
- **Extension**: .go
 ...
 */
func  (this *KucoinfuturesCore) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *KucoinfuturesCore) FetchTime(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *KucoinfuturesCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes68919 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
                    PanicOnError(retRes68919)
                    ch <- retRes68919
                    return nil
            }
...
func  (this *KucoinfuturesCore) ParseOHLCV(ohlcv interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    [
...
func  (this *KucoinfuturesCore) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "symbol": "LTCUSDTM",
    //         "granularity": 1000,
...
func  (this *KucoinfuturesCore) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes112215 :=  (<-this.FetchTickers(symbols, this.Extend(request, params)))
...
func  (this *KucoinfuturesCore) ParsePosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "code": "200000",
    //        "data": [
...
func  (this *KucoinfuturesCore) CreateContractOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) interface{}  {
    price := GetArg(optionalArgs, 0, nil)
    _ = price
    params := GetArg(optionalArgs, 1, map[string]interface{} {})
    _ = params
 ...
 */
func  (this *KucoinfuturesCore) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *KucoinfuturesCore) ParseMarginModification(info interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //    {
    //        "id": "62311d26064e8f00013f2c6d",
    //        "symbol": "XRPUSDTM",
...
func  (this *KucoinfuturesCore) ParseOrder(order interface{}, optionalArgs ...interface{}) interface{}  {
    //
...
func  (this *KucoinfuturesCore) ParseFundingRate(data interface{}, optionalArgs ...interface{}) interface{}  {
    //
    //     {
    //         "symbol": ".ETHUSDTMFPI8H",
    //         "granularity": 28800000,
...
func  (this *KucoinfuturesCore) ParseFundingInterval(interval interface{}) interface{}  {
...
func  (this *KucoinfuturesCore) ParseBalance(response interface{}) interface{}  {
...
func  (this *KucoinfuturesCore) ParseTransfer(transfer interface{}, optionalArgs ...interface{}) interface{}  {
    //
...
func  (this *KucoinfuturesCore) ParseTransferStatus(status interface{}) interface{}  {
...
func  (this *KucoinfuturesCore) ParseTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    //
    // fetchTrades (public)
    //
    //     {
...
func  (this *KucoinfuturesCore) ParseMarketLeverageTiers(info interface{}, optionalArgs ...interface{}) interface{}  {
    /**
    * @ignore
    * @method
...
func  (this *KucoinfuturesCore) ParseFundingRateHistory(info interface{}, optionalArgs ...interface{}) interface{}  {
    market := GetArg(optionalArgs, 0, nil)
    _ = market
...
func  (this *KucoinfuturesCore) ParseMarginMode(marginMode interface{}, optionalArgs ...interface{}) interface{}  {
    market := GetArg(optionalArgs, 0, nil)
    _ = market
 ...
 */
func  (this *KucoinfuturesCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *KucoinfuturesCore) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 * @returns {object} response from the exchange
 */
func  (this *KucoinfuturesCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *KucoinfuturesCore) ParseLeverage(leverage interface{}, optionalArgs ...interface{}) interface{}  {
    market := GetArg(optionalArgs, 0, nil)
    _ = market
...
This is a Go file located at `go/v4/kucoinfutures.go`.
