...
func  (this *BingxCore) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes175319 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes175319)
                    ch <- retRes175319
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *BingxCore) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "quoteOrderQty", cost)
                ...
                retRes287415 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
...
func  (this *BingxCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "quoteOrderQty", cost)
                ...
                retRes288815 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func  (this *BingxCore) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "quoteOrderQty", cost)
                ...
                retRes290215 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func  (this *BingxCore) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes505019 :=  (<-this.FetchPaginatedCallDynamic("fetchTransfers", nil, since, limit, params, maxLimit))
                    PanicOnError(retRes505019)
                    ch <- retRes505019
                    return nil
            }
            if IsTrue(!IsEqual(since, nil)) {
...
func  (this *BingxCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(subType, "inverse")) {
                    ...
                    retRes545819 :=  (<-this.CswapV1PrivatePostTradeMarginType(this.Extend(request, params)))
                    PanicOnError(retRes545819)
                    ch <- retRes545819
                    return nil
            } else {
        
                    retRes546019 :=  (<-this.SwapV2PrivatePostTradeMarginType(this.Extend(request, params)))
...
func  (this *BingxCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes546815 :=  (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
...
func  (this *BingxCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes547515 :=  (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
...
func  (this *BingxCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(market, "inverse")) {
                    ...
                    retRes566419 :=  (<-this.CswapV1PrivatePostTradeLeverage(this.Extend(request, params)))
                    PanicOnError(retRes566419)
                    ch <- retRes566419
                    return nil
            } else {
        
                    retRes568219 :=  (<-this.SwapV2PrivatePostTradeLeverage(this.Extend(request, params)))
...
func  (this *BingxCore) CloseAllPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes62068 := (<-this.LoadMarkets())
            PanicOnError(retRes62068)
            var defaultRecvWindow interface{} = this.SafeInteger(this.Options, "recvWindow")
            var recvWindow interface{} = this.SafeInteger(this.ParseParams, "recvWindow", defaultRecvWindow)
            var marketType interface{} = nil
...
func  (this *BingxCore) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes631615 :=  (<-this.SwapV1PrivatePostPositionSideDual(this.Extend(request, params)))
...
func  (this *BingxCore) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes64688 := (<-this.LoadMarkets())
            PanicOnError(retRes64688)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
This is a Go file located at `go/v4/bingx.go`.
