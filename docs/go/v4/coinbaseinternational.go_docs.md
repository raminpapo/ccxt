# Documentation: go/v4/coinbaseinternational.go

## File Metadata

- **Path**: `go/v4/coinbaseinternational.go`
- **Size**: 132,565 bytes
- **Lines**: 2,895
- **Type**: Go
- **Extension**: .go
...
func  (this *CoinbaseinternationalCore) SafeNetwork(network interface{}) interface{}  {
...
This is a Go file located at `go/v4/coinbaseinternational.go`.
