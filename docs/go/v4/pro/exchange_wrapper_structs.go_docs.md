# Documentation: go/v4/pro/exchange_wrapper_structs.go

## File Metadata

- **Path**: `go/v4/pro/exchange_wrapper_structs.go`
- **Size**: 64,962 bytes
- **Lines**: 1,139
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/pro/exchange_wrapper_structs.go`.
