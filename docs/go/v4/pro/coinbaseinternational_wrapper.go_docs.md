# Documentation: go/v4/pro/coinbaseinternational_wrapper.go

## File Metadata

- **Path**: `go/v4/pro/coinbaseinternational_wrapper.go`
- **Size**: 52,520 bytes
- **Lines**: 517
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/pro/coinbaseinternational_wrapper.go`.
