# Documentation: go/v4/coinmetro.go

## File Metadata

- **Path**: `go/v4/coinmetro.go`
- **Size**: 102,794 bytes
- **Lines**: 2,347
- **Type**: Go
- **Extension**: .go
...
func (this *CoinmetroCore) Init(userConfig map[string]interface{}) {
...
This is a Go file located at `go/v4/coinmetro.go`.
