# Documentation: go/v4/exchange_generated.go

## File Metadata

- **Path**: `go/v4/exchange_generated.go`
- **Size**: 475,874 bytes
- **Lines**: 10,241
- **Type**: Go
- **Extension**: .go
...
This is a Go file located at `go/v4/exchange_generated.go`.

**Classes defined**: needs
