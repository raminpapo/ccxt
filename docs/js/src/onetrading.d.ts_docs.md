# Documentation: js/src/onetrading.d.ts

## File Metadata

- **Path**: `js/src/onetrading.d.ts`
- **Size**: 12,466 bytes
- **Lines**: 230
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/onetrading.d.ts`.
...
```bash
ts-node js/src/onetrading.d.ts
```
