# Documentation: js/src/hyperliquid.d.ts

## File Metadata

- **Path**: `js/src/hyperliquid.d.ts`
- **Size**: 40,170 bytes
- **Lines**: 658
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/hyperliquid.d.ts`.
...
```bash
ts-node js/src/hyperliquid.d.ts
```
