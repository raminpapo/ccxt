# Documentation: js/src/novadax.js

## File Metadata

- **Path**: `js/src/novadax.js`
- **Size**: 71,012 bytes
- **Lines**: 1,672
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/novadax.js`.
...
- `https://www.novadax.com.br` (referenced)
- `./base/Precise.js` (referenced)
- `./abstract/novadax.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://api.novadax.com` (referenced)
- `https://user-images.githubusercontent.com/1294454/92337550-2b085500-f0b3-11ea-98e7-5794fb07dd3b.jpg` (referenced)
