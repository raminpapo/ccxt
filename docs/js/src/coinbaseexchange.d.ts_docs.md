# Documentation: js/src/coinbaseexchange.d.ts

## File Metadata

- **Path**: `js/src/coinbaseexchange.d.ts`
- **Size**: 20,797 bytes
- **Lines**: 335
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/coinbaseexchange.d.ts`.
...
```bash
ts-node js/src/coinbaseexchange.d.ts
```
