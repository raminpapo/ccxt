# Documentation: js/src/tokocrypto.d.ts

## File Metadata

- **Path**: `js/src/tokocrypto.d.ts`
- **Size**: 15,516 bytes
- **Lines**: 262
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/tokocrypto.d.ts`.
...
```bash
ts-node js/src/tokocrypto.d.ts
```
