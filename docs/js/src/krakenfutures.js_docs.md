# Documentation: js/src/krakenfutures.js

## File Metadata

- **Path**: `js/src/krakenfutures.js`
- **Size**: 128,802 bytes
- **Lines**: 2,914
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/krakenfutures.js`.
