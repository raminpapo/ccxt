# Documentation: js/src/bitteam.js

## File Metadata

- **Path**: `js/src/bitteam.js`
- **Size**: 108,816 bytes
- **Lines**: 2,415
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/bitteam.js`.
...
- `./abstract/bitteam.js` (referenced)
- `https://bit.team` (referenced)
- `./base/functions/number.js` (referenced)
- `https://history.bit.team` (referenced)
