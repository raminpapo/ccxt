# Documentation: js/src/wavesexchange.d.ts

## File Metadata

- **Path**: `js/src/wavesexchange.d.ts`
- **Size**: 13,887 bytes
- **Lines**: 245
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/wavesexchange.d.ts`.
...
```bash
ts-node js/src/wavesexchange.d.ts
```
