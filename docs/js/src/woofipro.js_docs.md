# Documentation: js/src/woofipro.js

## File Metadata

- **Path**: `js/src/woofipro.js`
- **Size**: 130,497 bytes
- **Lines**: 2,936
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/woofipro.js`.

**Classes defined**: woofipro
...
- `./abstract/woofipro.js` (referenced)
