# Documentation: js/src/static_dependencies/noble-hashes/sha1.js

## File Metadata

- **Path**: `js/src/static_dependencies/noble-hashes/sha1.js`
- **Size**: 2,645 bytes
- **Lines**: 85
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/noble-hashes/sha1.js`.
...
```bash
node js/src/static_dependencies/noble-hashes/sha1.js
```
