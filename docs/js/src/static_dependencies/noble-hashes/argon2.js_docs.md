# Documentation: js/src/static_dependencies/noble-hashes/argon2.js

## File Metadata

- **Path**: `js/src/static_dependencies/noble-hashes/argon2.js`
- **Size**: 12,104 bytes
- **Lines**: 306
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/noble-hashes/argon2.js`.

**Functions defined**: mul2, indexAlpha, relPos, P, mul, block, blamka, argon2Init, G, Hp
...
```bash
node js/src/static_dependencies/noble-hashes/argon2.js
```
