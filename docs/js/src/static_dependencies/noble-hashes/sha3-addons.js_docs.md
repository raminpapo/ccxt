# Documentation: js/src/static_dependencies/noble-hashes/sha3-addons.js

## File Metadata

- **Path**: `js/src/static_dependencies/noble-hashes/sha3-addons.js`
- **Size**: 13,583 bytes
- **Lines**: 347
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/noble-hashes/sha3-addons.js`.
...
```bash
node js/src/static_dependencies/noble-hashes/sha3-addons.js
```
