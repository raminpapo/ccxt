# Documentation: js/src/static_dependencies/noble-hashes/utils.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/noble-hashes/utils.d.ts`
- **Size**: 3,588 bytes
- **Lines**: 79
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/noble-hashes/utils.d.ts`.
...
```bash
ts-node js/src/static_dependencies/noble-hashes/utils.d.ts
```
