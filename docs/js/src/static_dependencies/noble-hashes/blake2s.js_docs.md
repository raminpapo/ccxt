# Documentation: js/src/static_dependencies/noble-hashes/blake2s.js

## File Metadata

- **Path**: `js/src/static_dependencies/noble-hashes/blake2s.js`
- **Size**: 5,006 bytes
- **Lines**: 120
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/noble-hashes/blake2s.js`.
...
```bash
node js/src/static_dependencies/noble-hashes/blake2s.js
```
