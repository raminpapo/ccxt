# Documentation: js/src/static_dependencies/ethers/typed.js

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/typed.js`
- **Size**: 17,525 bytes
- **Lines**: 603
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/ethers/typed.js`.

**Classes defined**: did, Typed, to

**Functions defined**: n, b
...
```bash
node js/src/static_dependencies/ethers/typed.js
```
