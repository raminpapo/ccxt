# Documentation: js/src/static_dependencies/ethers/fragments.js

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/fragments.js`
- **Size**: 47,122 bytes
- **Lines**: 1,247
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/ethers/fragments.js`.

**Classes defined**: TokenString, to, ErrorFragment, ParamType, Fragment, did, NamedFragment, EventFragment

**Functions defined**: consumeParams, lex, consumeGas, setify, _TokenString_subTokenString, allowSingle, receive, consumeMutability, consumeName, consumeKeywords
...
**Functions** (17):
- `_ParamType_walkAsync()`
- `_TokenString_subTokenString()`
- `allowSingle()`
- `as()`
- `consumeEoi()`
- `consumeGas()`
...
```bash
node js/src/static_dependencies/ethers/fragments.js
```
