# Documentation: js/src/static_dependencies/ethers/fragments.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/fragments.d.ts`
- **Size**: 13,798 bytes
- **Lines**: 459
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/ethers/fragments.d.ts`.

**Classes defined**: to, ErrorFragment, FunctionFragment, ParamType, FallbackFragment, ConstructorFragment, Fragment, NamedFragment, EventFragment

**Functions defined**: with, as, can, is
...
```bash
ts-node js/src/static_dependencies/ethers/fragments.d.ts
```
