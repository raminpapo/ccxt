# Documentation: js/src/static_dependencies/ethers/interface.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/interface.d.ts`
- **Size**: 13,788 bytes
- **Lines**: 381
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/ethers/interface.d.ts`.

**Classes defined**: ErrorDescription, Interface, is, Indexed, that, TransactionDescription, LogDescription

**Functions defined**: selector, balanceOf, for, name, signature
...
```bash
ts-node js/src/static_dependencies/ethers/interface.d.ts
```
