# Documentation: js/src/static_dependencies/ethers/hash/typed-data.js

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/hash/typed-data.js`
- **Size**: 20,163 bytes
- **Lines**: 485
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/ethers/hash/typed-data.js`.

**Classes defined**: did, TypedDataEncoder

**Functions defined**: encodeType, checkString, checkCircular, _TypedDataEncoder_getEncoder, getBaseEncoder, hexPadRight
...
- `@ethersproject/providerabstract-signer` (imported)
...
```bash
node js/src/static_dependencies/ethers/hash/typed-data.js
```
