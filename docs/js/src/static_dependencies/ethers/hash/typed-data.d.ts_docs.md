# Documentation: js/src/static_dependencies/ethers/hash/typed-data.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/hash/typed-data.d.ts`
- **Size**: 5,022 bytes
- **Lines**: 145
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/ethers/hash/typed-data.d.ts`.
...
```bash
ts-node js/src/static_dependencies/ethers/hash/typed-data.d.ts
```
