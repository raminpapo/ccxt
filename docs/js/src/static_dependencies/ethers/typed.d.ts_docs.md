# Documentation: js/src/static_dependencies/ethers/typed.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/typed.d.ts`
- **Size**: 15,305 bytes
- **Lines**: 570
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/ethers/typed.d.ts`.
...
```bash
ts-node js/src/static_dependencies/ethers/typed.d.ts
```
