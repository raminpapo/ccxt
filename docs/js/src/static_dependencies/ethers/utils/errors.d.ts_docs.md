# Documentation: js/src/static_dependencies/ethers/utils/errors.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/utils/errors.d.ts`
- **Size**: 16,509 bytes
- **Lines**: 510
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/ethers/utils/errors.d.ts`.

**Functions defined**: or, isCallException, assertArgument, assertNormalize, assertPrivate, makeError, assert, can, assertArgumentCount, isError
...
```bash
ts-node js/src/static_dependencies/ethers/utils/errors.d.ts
```
