# Documentation: js/src/static_dependencies/ethers/utils/fixednumber.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/utils/fixednumber.d.ts`
- **Size**: 9,128 bytes
- **Lines**: 252
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/ethers/utils/fixednumber.d.ts`.

**Classes defined**: FixedNumber
...
```bash
ts-node js/src/static_dependencies/ethers/utils/fixednumber.d.ts
```
