# Documentation: js/src/static_dependencies/ethers/utils/units.js

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/utils/units.js`
- **Size**: 2,825 bytes
- **Lines**: 83
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/ethers/utils/units.js`.
...
```bash
node js/src/static_dependencies/ethers/utils/units.js
```
