# Documentation: js/src/static_dependencies/ethers/utils/fixednumber.js

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/utils/fixednumber.js`
- **Size**: 24,444 bytes
- **Lines**: 524
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/ethers/utils/fixednumber.js`.

**Classes defined**: did, FixedNumber, permits

**Functions defined**: getTens, _FixedNumber_mul, _FixedNumber_add, _FixedNumber_checkFormat, checkValue, toString, _FixedNumber_div, _FixedNumber_checkValue, getFormat, _FixedNumber_sub
...
**Functions** (10):
- `_FixedNumber_add()`
- `_FixedNumber_checkFormat()`
- `_FixedNumber_checkValue()`
- `_FixedNumber_div()`
- `_FixedNumber_mul()`
- `_FixedNumber_sub()`
- `checkValue()`
...
```bash
node js/src/static_dependencies/ethers/utils/fixednumber.js
```
