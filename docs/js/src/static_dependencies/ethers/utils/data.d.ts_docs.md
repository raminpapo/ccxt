# Documentation: js/src/static_dependencies/ethers/utils/data.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/utils/data.d.ts`
- **Size**: 3,170 bytes
- **Lines**: 93
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/ethers/utils/data.d.ts`.

**Functions defined**: concat, getBytesCopy, hexlify, zeroPadValue, dataLength, getBytes, stripZerosLeft, isHexString, isBytesLike, dataSlice
...
```bash
ts-node js/src/static_dependencies/ethers/utils/data.d.ts
```
