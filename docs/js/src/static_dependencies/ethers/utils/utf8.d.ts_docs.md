# Documentation: js/src/static_dependencies/ethers/utils/utf8.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/utils/utf8.d.ts`
- **Size**: 3,935 bytes
- **Lines**: 96
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/ethers/utils/utf8.d.ts`.

**Functions defined**: toUtf8CodePoints, toUtf8String, is, should, toUtf8Bytes
...
```bash
ts-node js/src/static_dependencies/ethers/utils/utf8.d.ts
```
