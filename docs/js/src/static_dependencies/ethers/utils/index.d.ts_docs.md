# Documentation: js/src/static_dependencies/ethers/utils/index.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/ethers/utils/index.d.ts`
- **Size**: 2,333 bytes
- **Lines**: 31
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/ethers/utils/index.d.ts`.
...
```bash
ts-node js/src/static_dependencies/ethers/utils/index.d.ts
```
