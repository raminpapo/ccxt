# Documentation: js/src/static_dependencies/scure-bip39/index.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/scure-bip39/index.d.ts`
- **Size**: 2,319 bytes
- **Lines**: 55
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/scure-bip39/index.d.ts`.

**Functions defined**: mnemonicToEntropy, entropyToMnemonic, mnemonicToSeedSync, mnemonicToSeed, validateMnemonic
...
```bash
ts-node js/src/static_dependencies/scure-bip39/index.d.ts
```
