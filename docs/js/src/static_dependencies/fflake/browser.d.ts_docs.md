# Documentation: js/src/static_dependencies/fflake/browser.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/fflake/browser.d.ts`
- **Size**: 7,170 bytes
- **Lines**: 223
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/fflake/browser.d.ts`.

**Functions defined**: deflate, inflateSync, gunzip, inflate, gunzipSync, zlibSync, deflateSync, gzip, gzipSync, zlib
...
```bash
ts-node js/src/static_dependencies/fflake/browser.d.ts
```
