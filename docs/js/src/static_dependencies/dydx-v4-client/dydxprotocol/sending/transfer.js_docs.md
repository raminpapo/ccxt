# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/sending/transfer.js

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/sending/transfer.js`
- **Size**: 9,031 bytes
- **Lines**: 241
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/sending/transfer.js`.
...
```bash
node js/src/static_dependencies/dydx-v4-client/dydxprotocol/sending/transfer.js
```
