# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.js

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.js`
- **Size**: 9,176 bytes
- **Lines**: 281
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.js`.
...
```bash
node js/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.js
```
