# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.d.ts`
- **Size**: 4,841 bytes
- **Lines**: 128
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.d.ts`.
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/dydxprotocol/accountplus/tx.d.ts
```
