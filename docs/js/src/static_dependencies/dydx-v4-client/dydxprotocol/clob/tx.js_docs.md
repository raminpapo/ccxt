# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.js

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.js`
- **Size**: 27,171 bytes
- **Lines**: 752
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.js`.
...
```bash
node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.js
```
