# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.js

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.js`
- **Size**: 9,555 bytes
- **Lines**: 176
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.js`.
...
```bash
node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.js
```
