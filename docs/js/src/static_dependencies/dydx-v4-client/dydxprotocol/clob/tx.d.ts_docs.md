# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.d.ts`
- **Size**: 16,915 bytes
- **Lines**: 398
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.d.ts`.
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/tx.d.ts
```
