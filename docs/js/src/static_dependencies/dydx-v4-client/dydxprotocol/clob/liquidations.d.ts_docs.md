# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations.d.ts`
- **Size**: 3,493 bytes
- **Lines**: 93
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations.d.ts`.
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/liquidations.d.ts
```
