# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.d.ts`
- **Size**: 4,283 bytes
- **Lines**: 85
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.d.ts`.

**Functions defined**: orderRemoval_RemovalReasonToJSON, orderRemoval_RemovalReasonFromJSON
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order_removals.d.ts
```
