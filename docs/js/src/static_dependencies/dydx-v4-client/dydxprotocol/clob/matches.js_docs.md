# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.js

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.js`
- **Size**: 12,949 bytes
- **Lines**: 319
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.js`.
...
```bash
node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.js
```
