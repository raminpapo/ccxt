# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.js

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.js`
- **Size**: 33,594 bytes
- **Lines**: 867
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.js`.
...
```bash
node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.js
```
