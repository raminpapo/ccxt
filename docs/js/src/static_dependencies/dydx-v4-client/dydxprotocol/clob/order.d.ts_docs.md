# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.d.ts`
- **Size**: 22,332 bytes
- **Lines**: 547
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.d.ts`.

**Functions defined**: order_TimeInForceToJSON, order_SideFromJSON, order_ConditionTypeFromJSON, order_ConditionTypeToJSON, order_TimeInForceFromJSON, order_SideToJSON
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/order.d.ts
```
