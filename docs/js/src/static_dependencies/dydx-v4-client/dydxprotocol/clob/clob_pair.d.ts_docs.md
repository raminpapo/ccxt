# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.d.ts`
- **Size**: 4,627 bytes
- **Lines**: 128
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.d.ts`.

**Functions defined**: clobPair_StatusFromJSON, clobPair_StatusToJSON
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.d.ts
```
