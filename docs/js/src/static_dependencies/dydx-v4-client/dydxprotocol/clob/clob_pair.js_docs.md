# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.js

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.js`
- **Size**: 9,738 bytes
- **Lines**: 252
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.js`.
...
```bash
node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/clob_pair.js
```
