# Documentation: js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.d.ts`
- **Size**: 6,353 bytes
- **Lines**: 160
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.d.ts`.
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/dydxprotocol/clob/matches.d.ts
```
