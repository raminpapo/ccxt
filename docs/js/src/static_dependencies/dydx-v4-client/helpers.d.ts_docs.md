# Documentation: js/src/static_dependencies/dydx-v4-client/helpers.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/helpers.d.ts`
- **Size**: 3,524 bytes
- **Lines**: 83
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/helpers.d.ts`.
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/helpers.d.ts
```
