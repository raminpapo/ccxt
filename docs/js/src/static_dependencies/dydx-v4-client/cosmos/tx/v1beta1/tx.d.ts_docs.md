# Documentation: js/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.d.ts`
- **Size**: 16,784 bytes
- **Lines**: 461
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.d.ts`.
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.d.ts
```
