# Documentation: js/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.js

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.js`
- **Size**: 25,228 bytes
- **Lines**: 693
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.js`.
...
```bash
node js/src/static_dependencies/dydx-v4-client/cosmos/tx/v1beta1/tx.js
```
