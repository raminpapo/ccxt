# Documentation: js/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.js

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.js`
- **Size**: 12,608 bytes
- **Lines**: 324
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.js`.
...
```bash
node js/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.js
```
