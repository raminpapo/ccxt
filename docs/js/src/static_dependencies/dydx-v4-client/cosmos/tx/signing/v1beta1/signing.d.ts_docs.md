# Documentation: js/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.d.ts`
- **Size**: 7,089 bytes
- **Lines**: 163
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.d.ts`.

**Functions defined**: signModeFromJSON, signModeToJSON
...
```bash
ts-node js/src/static_dependencies/dydx-v4-client/cosmos/tx/signing/v1beta1/signing.d.ts
```
