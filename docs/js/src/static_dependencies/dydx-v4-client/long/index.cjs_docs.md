# Documentation: js/src/static_dependencies/dydx-v4-client/long/index.cjs

## File Metadata

- **Path**: `js/src/static_dependencies/dydx-v4-client/long/index.cjs`
- **Size**: 52,377 bytes
- **Lines**: 1,468
- **Type**: Unknown
- **Extension**: .cjs
...
This is a Unknown file located at `js/src/static_dependencies/dydx-v4-client/long/index.cjs`.

**Classes defined**: A, for

**Functions defined**: preferDefault, fromBits, Long, fromString, for, fromNumber, isLong, fromInt, ctz32, fromValue
