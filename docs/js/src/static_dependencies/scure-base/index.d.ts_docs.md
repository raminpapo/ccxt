# Documentation: js/src/static_dependencies/scure-base/index.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/scure-base/index.d.ts`
- **Size**: 4,078 bytes
- **Lines**: 93
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/scure-base/index.d.ts`.

**Functions defined**: join, padding, assertNumber, checksum, chain, radix, alphabet, radix2
...
```bash
ts-node js/src/static_dependencies/scure-base/index.d.ts
```
