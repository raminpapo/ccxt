# Documentation: js/src/static_dependencies/messagepack/msgpack.js

## File Metadata

- **Path**: `js/src/static_dependencies/messagepack/msgpack.js`
- **Size**: 20,731 bytes
- **Lines**: 567
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/messagepack/msgpack.js`.

**Functions defined**: appendString, appendBinArray, appendObject, serialize, appendNull, appendNumber, appendArray, appendBoolean, that, append
...
```bash
node js/src/static_dependencies/messagepack/msgpack.js
```
