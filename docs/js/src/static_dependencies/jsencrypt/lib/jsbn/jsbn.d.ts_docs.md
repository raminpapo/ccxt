# Documentation: js/src/static_dependencies/jsencrypt/lib/jsbn/jsbn.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/jsencrypt/lib/jsbn/jsbn.d.ts`
- **Size**: 4,307 bytes
- **Lines**: 102
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/jsencrypt/lib/jsbn/jsbn.d.ts`.

**Classes defined**: BigInteger

**Functions defined**: nbits, intAt, nbi, parseBigInt, nbv
...
```bash
ts-node js/src/static_dependencies/jsencrypt/lib/jsbn/jsbn.d.ts
```
