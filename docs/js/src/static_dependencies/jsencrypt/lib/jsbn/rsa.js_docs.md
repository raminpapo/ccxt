# Documentation: js/src/static_dependencies/jsencrypt/lib/jsbn/rsa.js

## File Metadata

- **Path**: `js/src/static_dependencies/jsencrypt/lib/jsbn/rsa.js`
- **Size**: 12,489 bytes
- **Lines**: 372
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/jsencrypt/lib/jsbn/rsa.js`.
...
```bash
node js/src/static_dependencies/jsencrypt/lib/jsbn/rsa.js
```
