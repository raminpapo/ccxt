# Documentation: js/src/static_dependencies/jsencrypt/lib/asn1js/oids.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/jsencrypt/lib/asn1js/oids.d.ts`
- **Size**: 182,831 bytes
- **Lines**: 9,779
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/jsencrypt/lib/asn1js/oids.d.ts`.
...
```bash
ts-node js/src/static_dependencies/jsencrypt/lib/asn1js/oids.d.ts
```
