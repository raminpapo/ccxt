# Documentation: js/src/static_dependencies/jsencrypt/lib/asn1js/oids.js

## File Metadata

- **Path**: `js/src/static_dependencies/jsencrypt/lib/asn1js/oids.js`
- **Size**: 192,906 bytes
- **Lines**: 1,963
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/jsencrypt/lib/asn1js/oids.js`.
...
```bash
node js/src/static_dependencies/jsencrypt/lib/asn1js/oids.js
```
