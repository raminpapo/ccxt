# Documentation: js/src/static_dependencies/jsencrypt/JSEncryptRSAKey.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/jsencrypt/JSEncryptRSAKey.d.ts`
- **Size**: 5,871 bytes
- **Lines**: 143
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/jsencrypt/JSEncryptRSAKey.d.ts`.
...
```bash
ts-node js/src/static_dependencies/jsencrypt/JSEncryptRSAKey.d.ts
```
