# Documentation: js/src/static_dependencies/jsencrypt/JSEncrypt.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/jsencrypt/JSEncrypt.d.ts`
- **Size**: 4,700 bytes
- **Lines**: 117
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/jsencrypt/JSEncrypt.d.ts`.
...
```bash
ts-node js/src/static_dependencies/jsencrypt/JSEncrypt.d.ts
```
