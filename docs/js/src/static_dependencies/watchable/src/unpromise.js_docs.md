# Documentation: js/src/static_dependencies/watchable/src/unpromise.js

## File Metadata

- **Path**: `js/src/static_dependencies/watchable/src/unpromise.js`
- **Size**: 11,898 bytes
- **Lines**: 292
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/watchable/src/unpromise.js`.

**Classes defined**: Unpromise

**Functions defined**: withResolvers, if, let, allowing, listWithoutMember, listWithMember, resolveSelfTuple, listWithoutIndex
...
```bash
node js/src/static_dependencies/watchable/src/unpromise.js
```
