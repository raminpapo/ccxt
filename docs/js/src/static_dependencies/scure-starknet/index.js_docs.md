# Documentation: js/src/static_dependencies/scure-starknet/index.js

## File Metadata

- **Path**: `js/src/static_dependencies/scure-starknet/index.js`
- **Size**: 13,542 bytes
- **Lines**: 318
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/scure-starknet/index.js`.
...
```bash
node js/src/static_dependencies/scure-starknet/index.js
```
