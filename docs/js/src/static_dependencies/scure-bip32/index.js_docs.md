# Documentation: js/src/static_dependencies/scure-bip32/index.js

## File Metadata

- **Path**: `js/src/static_dependencies/scure-bip32/index.js`
- **Size**: 10,494 bytes
- **Lines**: 290
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/scure-bip32/index.js`.
...
```bash
node js/src/static_dependencies/scure-bip32/index.js
```
