# Documentation: js/src/static_dependencies/zklink/zklink-sdk-web.js

## File Metadata

- **Path**: `js/src/static_dependencies/zklink/zklink-sdk-web.js`
- **Size**: 148,720 bytes
- **Lines**: 4,277
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/zklink/zklink-sdk-web.js`.

**Classes defined**: AccountQuery, or, ContractInfo, Contract, ContractMatching, AutoDeleveraging, AutoDeleveragingBuilder, ChangePubKey, ChangePubKeyBuilder, ContractBuilder

**Functions defined**: getObject, passStringToWasm0, dropObject, getStringFromWasm0, getFloat64Memory0, addHeapObject, getUint8Memory0, isLikeNone, takeObject, getInt32Memory0
...
- `https://qa.omni.apex.exchange/api/v3/download/zklink-sdk-web_bg.wasm` (referenced)
...
```bash
node js/src/static_dependencies/zklink/zklink-sdk-web.js
```
