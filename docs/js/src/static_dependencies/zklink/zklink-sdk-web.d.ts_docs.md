# Documentation: js/src/static_dependencies/zklink/zklink-sdk-web.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/zklink/zklink-sdk-web.d.ts`
- **Size**: 33,168 bytes
- **Lines**: 1,280
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/zklink/zklink-sdk-web.d.ts`.

**Classes defined**: AccountQuery, ContractInfo, ContractMatchingBuilder, Contract, ContractMatching, AutoDeleveraging, AutoDeleveragingBuilder, ChangePubKey, ChangePubKeyBuilder, ContractBuilder

**Functions defined**: newLiquidation, newTransfer, newUpdateGlobalVar, newWithdraw, newAutoDeleveraging, newRpcSignerWithSigner, newForcedExit, newRpcSignerWithProvider, newChangePubkey, newFunding
...
- `newLiquidation()`
- `newOrderMatching()`
- `newRpcSignerWithProvider()`
- `newRpcSignerWithSigner()`
- `newTransfer()`
- `newUpdateGlobalVar()`
- `newWithdraw()`
...
```bash
ts-node js/src/static_dependencies/zklink/zklink-sdk-web.d.ts
```
