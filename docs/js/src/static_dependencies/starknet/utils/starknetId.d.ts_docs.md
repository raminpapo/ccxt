# Documentation: js/src/static_dependencies/starknet/utils/starknetId.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/starknetId.d.ts`
- **Size**: 6,180 bytes
- **Lines**: 114
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/starknet/utils/starknetId.d.ts`.

**Functions defined**: execution, useDecoded, getStarknetIdPopContract, getStarknetIdVerifierContract, useEncoded, getStarknetIdIdentityContract, getStarknetIdPfpContract, dynamicFelt, getStarknetIdMulticallContract, getStarknetIdContract
...
- `./calldata/enum/CairoCustomEnum.js` (imported)
- `../types/index.js` (imported)
- `../constants.js` (referenced)
- `./calldata/enum/CairoCustomEnum.js` (referenced)
...
```bash
ts-node js/src/static_dependencies/starknet/utils/starknetId.d.ts
```
