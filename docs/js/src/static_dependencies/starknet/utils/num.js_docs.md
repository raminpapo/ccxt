# Documentation: js/src/static_dependencies/starknet/utils/num.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/num.js`
- **Size**: 7,036 bytes
- **Lines**: 239
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/num.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/num.js
```
