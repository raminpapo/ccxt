# Documentation: js/src/static_dependencies/starknet/utils/calldata/index.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/calldata/index.js`
- **Size**: 12,703 bytes
- **Lines**: 275
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/calldata/index.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/calldata/index.js
```
