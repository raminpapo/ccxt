# Documentation: js/src/static_dependencies/starknet/utils/calldata/tuple.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/calldata/tuple.js`
- **Size**: 3,440 bytes
- **Lines**: 108
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/calldata/tuple.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/calldata/tuple.js
```
