# Documentation: js/src/static_dependencies/starknet/utils/calldata/cairo.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/calldata/cairo.d.ts`
- **Size**: 6,504 bytes
- **Lines**: 184
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/starknet/utils/calldata/cairo.d.ts`.

**Functions defined**: felt, isCairo1Abi, getAbiContractVersion
...
```bash
ts-node js/src/static_dependencies/starknet/utils/calldata/cairo.d.ts
```
