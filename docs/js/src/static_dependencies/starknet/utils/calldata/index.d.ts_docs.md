# Documentation: js/src/static_dependencies/starknet/utils/calldata/index.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/calldata/index.d.ts`
- **Size**: 4,033 bytes
- **Lines**: 90
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/starknet/utils/calldata/index.d.ts`.
...
- `./parser/interface.js` (imported)
- `./cairo.js` (imported)
- `../../types/index.js` (imported)
- `./byteArray.js` (imported)
- `./parser/interface.js` (referenced)
- `./cairo.js` (referenced)
...
```bash
ts-node js/src/static_dependencies/starknet/utils/calldata/index.d.ts
```
