# Documentation: js/src/static_dependencies/starknet/utils/calldata/cairo.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/calldata/cairo.js`
- **Size**: 7,939 bytes
- **Lines**: 224
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/calldata/cairo.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/calldata/cairo.js
```
