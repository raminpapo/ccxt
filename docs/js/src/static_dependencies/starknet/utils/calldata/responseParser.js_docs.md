# Documentation: js/src/static_dependencies/starknet/utils/calldata/responseParser.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/calldata/responseParser.js`
- **Size**: 8,919 bytes
- **Lines**: 209
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/calldata/responseParser.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/calldata/responseParser.js
```
