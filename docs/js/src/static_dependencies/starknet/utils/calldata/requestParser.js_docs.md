# Documentation: js/src/static_dependencies/starknet/utils/calldata/requestParser.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/calldata/requestParser.js`
- **Size**: 10,320 bytes
- **Lines**: 243
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/calldata/requestParser.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/calldata/requestParser.js
```
