# Documentation: js/src/static_dependencies/starknet/utils/calldata/validate.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/calldata/validate.js`
- **Size**: 10,579 bytes
- **Lines**: 203
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/calldata/validate.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/calldata/validate.js
```
