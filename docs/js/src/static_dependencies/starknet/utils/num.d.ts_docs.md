# Documentation: js/src/static_dependencies/starknet/utils/num.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/num.d.ts`
- **Size**: 5,781 bytes
- **Lines**: 183
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/starknet/utils/num.d.ts`.
...
```bash
ts-node js/src/static_dependencies/starknet/utils/num.d.ts
```
