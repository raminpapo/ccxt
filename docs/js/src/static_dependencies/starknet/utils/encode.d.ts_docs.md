# Documentation: js/src/static_dependencies/starknet/utils/encode.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/encode.d.ts`
- **Size**: 6,496 bytes
- **Lines**: 208
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/starknet/utils/encode.d.ts`.

**Functions defined**: rounds, removeHexPrefix, buf2hex, addHexPrefix, padLeft, utf8ToArray, btoaUniversal, atobUniversal, stringToArrayBuffer, arrayBufferToString
...
```bash
ts-node js/src/static_dependencies/starknet/utils/encode.d.ts
```
