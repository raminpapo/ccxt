# Documentation: js/src/static_dependencies/starknet/utils/hash/classHash.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/hash/classHash.d.ts`
- **Size**: 2,431 bytes
- **Lines**: 58
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/starknet/utils/hash/classHash.d.ts`.

**Classes defined**: hash

**Functions defined**: formatSpaces, hashByteCodeSegments, computePedersenHash, computeCompiledClassHash, computeHashOnElements, computeHintedClassHash, computePoseidonHash, computeLegacyContractClassHash, computePoseidonHashOnElements, calculateContractAddressFromHash
...
```bash
ts-node js/src/static_dependencies/starknet/utils/hash/classHash.d.ts
```
