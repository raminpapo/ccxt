# Documentation: js/src/static_dependencies/starknet/utils/starknetId.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/starknetId.js`
- **Size**: 11,714 bytes
- **Lines**: 260
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/starknetId.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/starknetId.js
```
