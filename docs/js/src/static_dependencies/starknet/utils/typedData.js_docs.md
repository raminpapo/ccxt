# Documentation: js/src/static_dependencies/starknet/utils/typedData.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/typedData.js`
- **Size**: 12,708 bytes
- **Lines**: 316
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/typedData.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/typedData.js
```
