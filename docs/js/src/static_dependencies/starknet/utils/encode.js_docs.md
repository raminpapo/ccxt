# Documentation: js/src/static_dependencies/starknet/utils/encode.js

## File Metadata

- **Path**: `js/src/static_dependencies/starknet/utils/encode.js`
- **Size**: 8,174 bytes
- **Lines**: 277
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/starknet/utils/encode.js`.
...
```bash
node js/src/static_dependencies/starknet/utils/encode.js
```
