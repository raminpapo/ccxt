# Documentation: js/src/static_dependencies/noble-curves/ed25519.js

## File Metadata

- **Path**: `js/src/static_dependencies/noble-curves/ed25519.js`
- **Size**: 18,620 bytes
- **Lines**: 397
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/noble-curves/ed25519.js`.
...
```bash
node js/src/static_dependencies/noble-curves/ed25519.js
```
