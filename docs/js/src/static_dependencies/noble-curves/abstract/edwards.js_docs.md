# Documentation: js/src/static_dependencies/noble-curves/abstract/edwards.js

## File Metadata

- **Path**: `js/src/static_dependencies/noble-curves/abstract/edwards.js`
- **Size**: 19,434 bytes
- **Lines**: 427
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/noble-curves/abstract/edwards.js`.
...
```bash
node js/src/static_dependencies/noble-curves/abstract/edwards.js
```
