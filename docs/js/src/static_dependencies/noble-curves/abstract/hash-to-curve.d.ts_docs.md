# Documentation: js/src/static_dependencies/noble-curves/abstract/hash-to-curve.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/noble-curves/abstract/hash-to-curve.d.ts`
- **Size**: 2,610 bytes
- **Lines**: 57
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/noble-curves/abstract/hash-to-curve.d.ts`.

**Functions defined**: createHasher, expand_message_xmd, expand_message_xof, isogenyMap, hash_to_field
...
```bash
ts-node js/src/static_dependencies/noble-curves/abstract/hash-to-curve.d.ts
```
