# Documentation: js/src/static_dependencies/noble-curves/abstract/weierstrass.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/noble-curves/abstract/weierstrass.d.ts`
- **Size**: 7,808 bytes
- **Lines**: 204
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/noble-curves/abstract/weierstrass.d.ts`.

**Functions defined**: weierstrass, weierstrassPoints, SWUFpSqrtRatio, validateOpts, mapToCurveSimpleSWU, call
...
```bash
ts-node js/src/static_dependencies/noble-curves/abstract/weierstrass.d.ts
```
