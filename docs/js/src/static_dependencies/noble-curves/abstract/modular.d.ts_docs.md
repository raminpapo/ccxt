# Documentation: js/src/static_dependencies/noble-curves/abstract/modular.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/noble-curves/abstract/modular.d.ts`
- **Size**: 2,977 bytes
- **Lines**: 69
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/noble-curves/abstract/modular.d.ts`.

**Functions defined**: validateField, FpPow, FpDiv, invert, pow2, pow, FpInvertBatch, mod, FpSqrt, tonelliShanks
...
```bash
ts-node js/src/static_dependencies/noble-curves/abstract/modular.d.ts
```
