# Documentation: js/src/static_dependencies/noble-curves/abstract/weierstrass.js

## File Metadata

- **Path**: `js/src/static_dependencies/noble-curves/abstract/weierstrass.js`
- **Size**: 43,285 bytes
- **Lines**: 1,011
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/noble-curves/abstract/weierstrass.js`.

**Classes defined**: DERErr, Point, Signature

**Functions defined**: weierstrass, weierstrassEquation, weierstrassPoints, validatePointOpts, isValidFieldElement, isWithinCurveOrder, normPrivateKeyToScalar, validateOpts, assertGE, assertPrjPoint
...
```bash
node js/src/static_dependencies/noble-curves/abstract/weierstrass.js
```
