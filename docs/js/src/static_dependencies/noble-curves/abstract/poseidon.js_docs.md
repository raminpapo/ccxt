# Documentation: js/src/static_dependencies/noble-curves/abstract/poseidon.js

## File Metadata

- **Path**: `js/src/static_dependencies/noble-curves/abstract/poseidon.js`
- **Size**: 4,921 bytes
- **Lines**: 110
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/noble-curves/abstract/poseidon.js`.
...
```bash
node js/src/static_dependencies/noble-curves/abstract/poseidon.js
```
