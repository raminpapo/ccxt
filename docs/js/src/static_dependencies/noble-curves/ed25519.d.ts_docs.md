# Documentation: js/src/static_dependencies/noble-curves/ed25519.d.ts

## File Metadata

- **Path**: `js/src/static_dependencies/noble-curves/ed25519.d.ts`
- **Size**: 2,704 bytes
- **Lines**: 54
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/static_dependencies/noble-curves/ed25519.d.ts`.
...
```bash
ts-node js/src/static_dependencies/noble-curves/ed25519.d.ts
```
