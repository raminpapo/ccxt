# Documentation: js/src/static_dependencies/noble-curves/ed448.js

## File Metadata

- **Path**: `js/src/static_dependencies/noble-curves/ed448.js`
- **Size**: 10,971 bytes
- **Lines**: 213
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/noble-curves/ed448.js`.
...
```bash
node js/src/static_dependencies/noble-curves/ed448.js
```
