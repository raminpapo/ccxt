# Documentation: js/src/static_dependencies/node-fetch/body.js

## File Metadata

- **Path**: `js/src/static_dependencies/node-fetch/body.js`
- **Size**: 11,230 bytes
- **Lines**: 348
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/node-fetch/body.js`.
...
```bash
node js/src/static_dependencies/node-fetch/body.js
```
