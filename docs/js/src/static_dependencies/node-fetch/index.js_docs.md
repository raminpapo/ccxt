# Documentation: js/src/static_dependencies/node-fetch/index.js

## File Metadata

- **Path**: `js/src/static_dependencies/node-fetch/index.js`
- **Size**: 16,947 bytes
- **Lines**: 366
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/static_dependencies/node-fetch/index.js`.
...
```bash
node js/src/static_dependencies/node-fetch/index.js
```
