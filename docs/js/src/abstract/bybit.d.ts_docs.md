# Documentation: js/src/abstract/bybit.d.ts

## File Metadata

- **Path**: `js/src/abstract/bybit.d.ts`
- **Size**: 27,503 bytes
- **Lines**: 329
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bybit.d.ts`.
...
```bash
ts-node js/src/abstract/bybit.d.ts
```
