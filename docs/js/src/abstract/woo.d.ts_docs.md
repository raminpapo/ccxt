# Documentation: js/src/abstract/woo.d.ts

## File Metadata

- **Path**: `js/src/abstract/woo.d.ts`
- **Size**: 10,241 bytes
- **Lines**: 142
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/woo.d.ts`.
...
```bash
ts-node js/src/abstract/woo.d.ts
```
