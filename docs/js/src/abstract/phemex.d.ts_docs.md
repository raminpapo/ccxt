# Documentation: js/src/abstract/phemex.d.ts

## File Metadata

- **Path**: `js/src/abstract/phemex.d.ts`
- **Size**: 9,036 bytes
- **Lines**: 122
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/phemex.d.ts`.
...
```bash
ts-node js/src/abstract/phemex.d.ts
```
