# Documentation: js/src/abstract/bitstamp.d.ts

## File Metadata

- **Path**: `js/src/abstract/bitstamp.d.ts`
- **Size**: 18,461 bytes
- **Lines**: 263
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bitstamp.d.ts`.
...
```bash
ts-node js/src/abstract/bitstamp.d.ts
```
