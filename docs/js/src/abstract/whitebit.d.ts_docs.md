# Documentation: js/src/abstract/whitebit.d.ts

## File Metadata

- **Path**: `js/src/abstract/whitebit.d.ts`
- **Size**: 8,697 bytes
- **Lines**: 118
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/whitebit.d.ts`.
...
```bash
ts-node js/src/abstract/whitebit.d.ts
```
