# Documentation: js/src/abstract/xt.d.ts

## File Metadata

- **Path**: `js/src/abstract/xt.d.ts`
- **Size**: 13,846 bytes
- **Lines**: 161
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/xt.d.ts`.
...
```bash
ts-node js/src/abstract/xt.d.ts
```
