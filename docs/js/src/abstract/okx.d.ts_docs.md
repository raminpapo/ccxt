# Documentation: js/src/abstract/okx.d.ts

## File Metadata

- **Path**: `js/src/abstract/okx.d.ts`
- **Size**: 28,453 bytes
- **Lines**: 355
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/okx.d.ts`.
...
```bash
ts-node js/src/abstract/okx.d.ts
```
