# Documentation: js/src/abstract/bitmex.d.ts

## File Metadata

- **Path**: `js/src/abstract/bitmex.d.ts`
- **Size**: 6,878 bytes
- **Lines**: 101
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bitmex.d.ts`.
...
```bash
ts-node js/src/abstract/bitmex.d.ts
```
