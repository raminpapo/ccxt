# Documentation: js/src/abstract/coinbaseexchange.d.ts

## File Metadata

- **Path**: `js/src/abstract/coinbaseexchange.d.ts`
- **Size**: 6,029 bytes
- **Lines**: 87
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/coinbaseexchange.d.ts`.
...
```bash
ts-node js/src/abstract/coinbaseexchange.d.ts
```
