# Documentation: js/src/abstract/kucoin.d.ts

## File Metadata

- **Path**: `js/src/abstract/kucoin.d.ts`
- **Size**: 19,433 bytes
- **Lines**: 258
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/kucoin.d.ts`.
...
```bash
ts-node js/src/abstract/kucoin.d.ts
```
