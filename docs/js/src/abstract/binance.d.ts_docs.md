# Documentation: js/src/abstract/binance.d.ts

## File Metadata

- **Path**: `js/src/abstract/binance.d.ts`
- **Size**: 58,098 bytes
- **Lines**: 775
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/binance.d.ts`.
...
```bash
ts-node js/src/abstract/binance.d.ts
```
