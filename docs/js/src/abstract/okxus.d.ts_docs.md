# Documentation: js/src/abstract/okxus.d.ts

## File Metadata

- **Path**: `js/src/abstract/okxus.d.ts`
- **Size**: 28,402 bytes
- **Lines**: 355
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/okxus.d.ts`.
...
```bash
ts-node js/src/abstract/okxus.d.ts
```
