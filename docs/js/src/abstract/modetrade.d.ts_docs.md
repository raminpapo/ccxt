# Documentation: js/src/abstract/modetrade.d.ts

## File Metadata

- **Path**: `js/src/abstract/modetrade.d.ts`
- **Size**: 8,986 bytes
- **Lines**: 123
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/modetrade.d.ts`.
...
```bash
ts-node js/src/abstract/modetrade.d.ts
```
