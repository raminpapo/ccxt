# Documentation: js/src/abstract/coinbaseadvanced.d.ts

## File Metadata

- **Path**: `js/src/abstract/coinbaseadvanced.d.ts`
- **Size**: 7,983 bytes
- **Lines**: 99
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/coinbaseadvanced.d.ts`.
...
```bash
ts-node js/src/abstract/coinbaseadvanced.d.ts
```
