# Documentation: js/src/abstract/woofipro.d.ts

## File Metadata

- **Path**: `js/src/abstract/woofipro.d.ts`
- **Size**: 8,986 bytes
- **Lines**: 123
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/woofipro.d.ts`.
...
```bash
ts-node js/src/abstract/woofipro.d.ts
```
