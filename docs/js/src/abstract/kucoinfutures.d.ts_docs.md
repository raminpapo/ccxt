# Documentation: js/src/abstract/kucoinfutures.d.ts

## File Metadata

- **Path**: `js/src/abstract/kucoinfutures.d.ts`
- **Size**: 21,681 bytes
- **Lines**: 286
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/kucoinfutures.d.ts`.
...
```bash
ts-node js/src/abstract/kucoinfutures.d.ts
```
