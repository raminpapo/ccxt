# Documentation: js/src/abstract/mexc.d.ts

## File Metadata

- **Path**: `js/src/abstract/mexc.d.ts`
- **Size**: 14,417 bytes
- **Lines**: 185
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/mexc.d.ts`.
...
```bash
ts-node js/src/abstract/mexc.d.ts
```
