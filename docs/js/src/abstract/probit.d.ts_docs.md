# Documentation: js/src/abstract/probit.d.ts

## File Metadata

- **Path**: `js/src/abstract/probit.d.ts`
- **Size**: 1,489 bytes
- **Lines**: 27
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/probit.d.ts`.
...
```bash
ts-node js/src/abstract/probit.d.ts
```
