# Documentation: js/src/abstract/binanceus.d.ts

## File Metadata

- **Path**: `js/src/abstract/binanceus.d.ts`
- **Size**: 62,010 bytes
- **Lines**: 827
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/binanceus.d.ts`.
...
```bash
ts-node js/src/abstract/binanceus.d.ts
```
