# Documentation: js/src/abstract/poloniex.d.ts

## File Metadata

- **Path**: `js/src/abstract/poloniex.d.ts`
- **Size**: 7,907 bytes
- **Lines**: 109
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/poloniex.d.ts`.
...
```bash
ts-node js/src/abstract/poloniex.d.ts
```
