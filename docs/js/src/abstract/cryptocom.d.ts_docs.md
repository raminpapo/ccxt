# Documentation: js/src/abstract/cryptocom.d.ts

## File Metadata

- **Path**: `js/src/abstract/cryptocom.d.ts`
- **Size**: 10,354 bytes
- **Lines**: 127
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/cryptocom.d.ts`.
...
```bash
ts-node js/src/abstract/cryptocom.d.ts
```
