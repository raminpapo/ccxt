# Documentation: js/src/abstract/bittrade.d.ts

## File Metadata

- **Path**: `js/src/abstract/bittrade.d.ts`
- **Size**: 8,528 bytes
- **Lines**: 118
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bittrade.d.ts`.
...
```bash
ts-node js/src/abstract/bittrade.d.ts
```
