# Documentation: js/src/abstract/htx.d.ts

## File Metadata

- **Path**: `js/src/abstract/htx.d.ts`
- **Size**: 48,993 bytes
- **Lines**: 552
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/htx.d.ts`.
...
```bash
ts-node js/src/abstract/htx.d.ts
```
