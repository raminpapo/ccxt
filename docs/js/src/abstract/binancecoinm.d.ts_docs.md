# Documentation: js/src/abstract/binancecoinm.d.ts

## File Metadata

- **Path**: `js/src/abstract/binancecoinm.d.ts`
- **Size**: 58,071 bytes
- **Lines**: 775
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/binancecoinm.d.ts`.
...
```bash
ts-node js/src/abstract/binancecoinm.d.ts
```
