# Documentation: js/src/abstract/coinex.d.ts

## File Metadata

- **Path**: `js/src/abstract/coinex.d.ts`
- **Size**: 18,721 bytes
- **Lines**: 241
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/coinex.d.ts`.
...
```bash
ts-node js/src/abstract/coinex.d.ts
```
