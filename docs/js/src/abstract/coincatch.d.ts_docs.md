# Documentation: js/src/abstract/coincatch.d.ts

## File Metadata

- **Path**: `js/src/abstract/coincatch.d.ts`
- **Size**: 7,697 bytes
- **Lines**: 98
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/coincatch.d.ts`.
...
```bash
ts-node js/src/abstract/coincatch.d.ts
```
