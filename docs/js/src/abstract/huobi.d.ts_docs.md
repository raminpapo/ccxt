# Documentation: js/src/abstract/huobi.d.ts

## File Metadata

- **Path**: `js/src/abstract/huobi.d.ts`
- **Size**: 48,942 bytes
- **Lines**: 552
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/huobi.d.ts`.
...
```bash
ts-node js/src/abstract/huobi.d.ts
```
