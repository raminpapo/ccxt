# Documentation: js/src/abstract/bitfinex.d.ts

## File Metadata

- **Path**: `js/src/abstract/bitfinex.d.ts`
- **Size**: 10,757 bytes
- **Lines**: 144
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bitfinex.d.ts`.
...
```bash
ts-node js/src/abstract/bitfinex.d.ts
```
