# Documentation: js/src/abstract/bingx.d.ts

## File Metadata

- **Path**: `js/src/abstract/bingx.d.ts`
- **Size**: 14,497 bytes
- **Lines**: 183
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bingx.d.ts`.
...
```bash
ts-node js/src/abstract/bingx.d.ts
```
