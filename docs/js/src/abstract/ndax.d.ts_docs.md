# Documentation: js/src/abstract/ndax.d.ts

## File Metadata

- **Path**: `js/src/abstract/ndax.d.ts`
- **Size**: 7,290 bytes
- **Lines**: 101
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/ndax.d.ts`.
...
```bash
ts-node js/src/abstract/ndax.d.ts
```
