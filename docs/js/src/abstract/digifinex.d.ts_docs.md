# Documentation: js/src/abstract/digifinex.d.ts

## File Metadata

- **Path**: `js/src/abstract/digifinex.d.ts`
- **Size**: 6,988 bytes
- **Lines**: 96
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/digifinex.d.ts`.
...
```bash
ts-node js/src/abstract/digifinex.d.ts
```
