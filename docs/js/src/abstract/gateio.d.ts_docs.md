# Documentation: js/src/abstract/gateio.d.ts

## File Metadata

- **Path**: `js/src/abstract/gateio.d.ts`
- **Size**: 26,228 bytes
- **Lines**: 332
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/gateio.d.ts`.
...
```bash
ts-node js/src/abstract/gateio.d.ts
```
