# Documentation: js/src/abstract/wavesexchange.d.ts

## File Metadata

- **Path**: `js/src/abstract/wavesexchange.d.ts`
- **Size**: 11,961 bytes
- **Lines**: 158
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/wavesexchange.d.ts`.
...
```bash
ts-node js/src/abstract/wavesexchange.d.ts
```
