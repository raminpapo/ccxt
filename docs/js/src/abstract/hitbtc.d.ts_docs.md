# Documentation: js/src/abstract/hitbtc.d.ts

## File Metadata

- **Path**: `js/src/abstract/hitbtc.d.ts`
- **Size**: 8,908 bytes
- **Lines**: 119
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/hitbtc.d.ts`.
...
```bash
ts-node js/src/abstract/hitbtc.d.ts
```
