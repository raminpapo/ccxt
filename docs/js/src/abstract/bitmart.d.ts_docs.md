# Documentation: js/src/abstract/bitmart.d.ts

## File Metadata

- **Path**: `js/src/abstract/bitmart.d.ts`
- **Size**: 9,500 bytes
- **Lines**: 121
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bitmart.d.ts`.
...
```bash
ts-node js/src/abstract/bitmart.d.ts
```
