# Documentation: js/src/abstract/bitget.d.ts

## File Metadata

- **Path**: `js/src/abstract/bitget.d.ts`
- **Size**: 50,338 bytes
- **Lines**: 580
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bitget.d.ts`.
...
```bash
ts-node js/src/abstract/bitget.d.ts
```
