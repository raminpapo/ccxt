# Documentation: js/src/abstract/coinone.d.ts

## File Metadata

- **Path**: `js/src/abstract/coinone.d.ts`
- **Size**: 5,176 bytes
- **Lines**: 71
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/coinone.d.ts`.
...
```bash
ts-node js/src/abstract/coinone.d.ts
```
