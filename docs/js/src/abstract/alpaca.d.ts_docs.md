# Documentation: js/src/abstract/alpaca.d.ts

## File Metadata

- **Path**: `js/src/abstract/alpaca.d.ts`
- **Size**: 6,100 bytes
- **Lines**: 78
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/alpaca.d.ts`.
...
```bash
ts-node js/src/abstract/alpaca.d.ts
```
