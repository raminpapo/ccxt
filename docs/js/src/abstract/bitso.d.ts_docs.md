# Documentation: js/src/abstract/bitso.d.ts

## File Metadata

- **Path**: `js/src/abstract/bitso.d.ts`
- **Size**: 2,945 bytes
- **Lines**: 47
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bitso.d.ts`.
...
```bash
ts-node js/src/abstract/bitso.d.ts
```
