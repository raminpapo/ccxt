# Documentation: js/src/abstract/bequant.d.ts

## File Metadata

- **Path**: `js/src/abstract/bequant.d.ts`
- **Size**: 8,875 bytes
- **Lines**: 119
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/bequant.d.ts`.
...
```bash
ts-node js/src/abstract/bequant.d.ts
```
