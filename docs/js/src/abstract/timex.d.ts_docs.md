# Documentation: js/src/abstract/timex.d.ts

## File Metadata

- **Path**: `js/src/abstract/timex.d.ts`
- **Size**: 4,241 bytes
- **Lines**: 66
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/timex.d.ts`.
...
```bash
ts-node js/src/abstract/timex.d.ts
```
