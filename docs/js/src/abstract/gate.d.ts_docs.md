# Documentation: js/src/abstract/gate.d.ts

## File Metadata

- **Path**: `js/src/abstract/gate.d.ts`
- **Size**: 26,273 bytes
- **Lines**: 332
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/gate.d.ts`.
...
```bash
ts-node js/src/abstract/gate.d.ts
```
