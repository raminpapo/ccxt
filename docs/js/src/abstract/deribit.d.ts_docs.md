# Documentation: js/src/abstract/deribit.d.ts

## File Metadata

- **Path**: `js/src/abstract/deribit.d.ts`
- **Size**: 9,338 bytes
- **Lines**: 130
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/deribit.d.ts`.
...
```bash
ts-node js/src/abstract/deribit.d.ts
```
