# Documentation: js/src/abstract/coinbase.d.ts

## File Metadata

- **Path**: `js/src/abstract/coinbase.d.ts`
- **Size**: 8,004 bytes
- **Lines**: 99
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/coinbase.d.ts`.
...
```bash
ts-node js/src/abstract/coinbase.d.ts
```
