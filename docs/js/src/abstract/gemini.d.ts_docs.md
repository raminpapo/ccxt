# Documentation: js/src/abstract/gemini.d.ts

## File Metadata

- **Path**: `js/src/abstract/gemini.d.ts`
- **Size**: 4,311 bytes
- **Lines**: 63
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/abstract/gemini.d.ts`.
...
```bash
ts-node js/src/abstract/gemini.d.ts
```
