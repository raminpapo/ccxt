# Documentation: js/src/coinbaseinternational.d.ts

## File Metadata

- **Path**: `js/src/coinbaseinternational.d.ts`
- **Size**: 27,305 bytes
- **Lines**: 444
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/coinbaseinternational.d.ts`.
...
```bash
ts-node js/src/coinbaseinternational.d.ts
```
