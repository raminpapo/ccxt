# Documentation: js/src/kucoinfutures.d.ts

## File Metadata

- **Path**: `js/src/kucoinfutures.d.ts`
- **Size**: 33,608 bytes
- **Lines**: 535
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/kucoinfutures.d.ts`.
...
```bash
ts-node js/src/kucoinfutures.d.ts
```
