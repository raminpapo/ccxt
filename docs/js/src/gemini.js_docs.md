# Documentation: js/src/gemini.js

## File Metadata

- **Path**: `js/src/gemini.js`
- **Size**: 85,873 bytes
- **Lines**: 2,006
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/gemini.js`.

**Classes defined**: gemini
...
- `./abstract/gemini.js` (referenced)
- `./base/errors.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/27816857-ce7be644-6096-11e7-82d6-3c257263229c.jpg` (referenced)
- `./base/Precise.js` (referenced)
- `https://api.gemini.com` (referenced)
- `https://docs.gemini.com` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://exchange.gemini.com` (referenced)
