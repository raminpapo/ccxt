# Documentation: js/src/wavesexchange.js

## File Metadata

- **Path**: `js/src/wavesexchange.js`
- **Size**: 127,686 bytes
- **Lines**: 2,776
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/wavesexchange.js`.
...
- `https://matcher.waves.exchange/api-docs/index.html` (referenced)
