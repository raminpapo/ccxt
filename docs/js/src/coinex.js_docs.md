# Documentation: js/src/coinex.js

## File Metadata

- **Path**: `js/src/coinex.js`
- **Size**: 280,660 bytes
- **Lines**: 6,161
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/coinex.js`.

**Classes defined**: coinex
...
- `./abstract/coinex.js` (referenced)
- `https://user-images.githubusercontent.com/51840849/87182089-1e05fa00-c2ec-11ea-8da9-cc73b45abbbc.jpg` (referenced)
- `https://api.coinex.com` (referenced)
- `https://www.coinex.com` (referenced)
