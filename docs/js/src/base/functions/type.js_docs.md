# Documentation: js/src/base/functions/type.js

## File Metadata

- **Path**: `js/src/base/functions/type.js`
- **Size**: 6,623 bytes
- **Lines**: 174
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/base/functions/type.js`.
...
```bash
node js/src/base/functions/type.js
```
