# Documentation: js/src/base/functions/number.js

## File Metadata

- **Path**: `js/src/base/functions/number.js`
- **Size**: 13,543 bytes
- **Lines**: 308
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/base/functions/number.js`.
...
```bash
node js/src/base/functions/number.js
```
