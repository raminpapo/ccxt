# Documentation: js/src/base/functions/time.js

## File Metadata

- **Path**: `js/src/base/functions/time.js`
- **Size**: 6,122 bytes
- **Lines**: 166
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/base/functions/time.js`.
...
```bash
node js/src/base/functions/time.js
```
