# Documentation: js/src/base/Exchange.js

## File Metadata

- **Path**: `js/src/base/Exchange.js`
- **Size**: 379,283 bytes
- **Lines**: 7,962
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/base/Exchange.js`.

**Classes defined**: Exchange, needs, instance

**Functions defined**: will, is, takes
...
- `./ws/OrderBook.js` (imported)
- `./Precise.js` (imported)
- `./ws/WsClient.js` (imported)
- `./functions/totp.js` (imported)
- `./functions/crypto.js` (imported)
- `./errors.js` (imported)
- `./ws/Future.js` (imported)
- `./functions.js` (imported)
- `./ws/OrderBook.js` (referenced)
- `./Precise.js` (referenced)
- `./ws/WsClient.js` (referenced)
- `./functions/totp.js` (referenced)
- `./functions/crypto.js` (referenced)
- `./errors.js` (referenced)
- `./ws/Future.js` (referenced)
- `./functions.js` (referenced)
