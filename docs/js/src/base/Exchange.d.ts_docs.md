# Documentation: js/src/base/Exchange.d.ts

## File Metadata

- **Path**: `js/src/base/Exchange.d.ts`
- **Size**: 64,438 bytes
- **Lines**: 988
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/base/Exchange.d.ts`.
...
- `./ws/Cache.js` (imported)
- `./ws/Client.js` (imported)
...
- `./ws/Cache.js` (referenced)
- `./ws/Client.js` (referenced)
...
```bash
ts-node js/src/base/Exchange.d.ts
```
