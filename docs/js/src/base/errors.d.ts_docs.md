# Documentation: js/src/base/errors.d.ts

## File Metadata

- **Path**: `js/src/base/errors.d.ts`
- **Size**: 6,308 bytes
- **Lines**: 169
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/base/errors.d.ts`.
...
```bash
ts-node js/src/base/errors.d.ts
```
