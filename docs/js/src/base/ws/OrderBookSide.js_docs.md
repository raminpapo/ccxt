# Documentation: js/src/base/ws/OrderBookSide.js

## File Metadata

- **Path**: `js/src/base/ws/OrderBookSide.js`
- **Size**: 10,653 bytes
- **Lines**: 281
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/base/ws/OrderBookSide.js`.
...
```bash
node js/src/base/ws/OrderBookSide.js
```
