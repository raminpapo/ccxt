# Documentation: js/src/base/types.d.ts

## File Metadata

- **Path**: `js/src/base/types.d.ts`
- **Size**: 13,404 bytes
- **Lines**: 587
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/base/types.d.ts`.
...
```bash
ts-node js/src/base/types.d.ts
```
