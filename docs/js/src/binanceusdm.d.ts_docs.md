# Documentation: js/src/binanceusdm.d.ts

## File Metadata

- **Path**: `js/src/binanceusdm.d.ts`
- **Size**: 323 bytes
- **Lines**: 7
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/binanceusdm.d.ts`.
...
```bash
ts-node js/src/binanceusdm.d.ts
```
