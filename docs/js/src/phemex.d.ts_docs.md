# Documentation: js/src/phemex.d.ts

## File Metadata

- **Path**: `js/src/phemex.d.ts`
- **Size**: 31,931 bytes
- **Lines**: 498
- **Type**: TypeScript
- **Extension**: .ts
...
export default class phemex extends Exchange {
    ...
    toEv(amount: any, market?: Dictionary<any>): any;
...
This is a TypeScript file located at `js/src/phemex.d.ts`.
