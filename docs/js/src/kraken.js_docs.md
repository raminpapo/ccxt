# Documentation: js/src/kraken.js

## File Metadata

- **Path**: `js/src/kraken.js`
- **Size**: 161,053 bytes
- **Lines**: 3,624
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/kraken.js`.

**Classes defined**: kraken
...
- `./abstract/kraken.js` (imported)
- `order` (imported)
- `./base/Precise.js` (imported)
- ` + fromAccount + ` (imported)
- `360000292886` (imported)
...
- `https://user-images.githubusercontent.com/51840849/76173629-fc67fb00-61b1-11ea-84fe-f2de582f58a3.jpg` (referenced)
- `./abstract/kraken.js` (referenced)
- `./base/Precise.js` (referenced)
- `./static_dependencies/noble-hashes/sha512.js` (referenced)
- `./base/functions/number.js` (referenced)
- `https://www.kraken.com` (referenced)
- `https://api.kraken.com` (referenced)
