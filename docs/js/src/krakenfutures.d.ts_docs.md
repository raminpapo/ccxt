# Documentation: js/src/krakenfutures.d.ts

## File Metadata

- **Path**: `js/src/krakenfutures.d.ts`
- **Size**: 21,090 bytes
- **Lines**: 363
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/krakenfutures.d.ts`.
...
```bash
ts-node js/src/krakenfutures.d.ts
```
