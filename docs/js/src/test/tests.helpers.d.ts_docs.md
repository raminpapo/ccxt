# Documentation: js/src/test/tests.helpers.d.ts

## File Metadata

- **Path**: `js/src/test/tests.helpers.d.ts`
- **Size**: 3,496 bytes
- **Lines**: 49
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/test/tests.helpers.d.ts`.

**Functions defined**: ioFileExists, jsonStringify, ioFileRead, getCliArgValue, jsonParse, ioDirRead, callMethodSync, callMethod, convertAscii, dump
...
**To run this test:**
```bash
npm test js/src/test/tests.helpers.d.ts
```
