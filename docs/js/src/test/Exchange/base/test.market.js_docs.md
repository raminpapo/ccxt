# Documentation: js/src/test/Exchange/base/test.market.js

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.market.js`
- **Size**: 14,237 bytes
- **Lines**: 266
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/base/test.market.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.market.js
```
