# Documentation: js/src/test/Exchange/base/test.ticker.js

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.ticker.js`
- **Size**: 11,762 bytes
- **Lines**: 189
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/base/test.ticker.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.ticker.js
```
