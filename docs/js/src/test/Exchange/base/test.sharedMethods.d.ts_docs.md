# Documentation: js/src/test/Exchange/base/test.sharedMethods.d.ts

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.sharedMethods.d.ts`
- **Size**: 6,227 bytes
- **Lines**: 70
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/test/Exchange/base/test.sharedMethods.d.ts`.

**Functions defined**: logTemplate, assertSymbol, assertType, assertTimestampAndDatetime, isTemporaryFailure, assertTimestamp, assertValidCurrencyIdAndCode, assertStructure, assertCurrencyCode, assertSymbolInMarkets
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.sharedMethods.d.ts
```
