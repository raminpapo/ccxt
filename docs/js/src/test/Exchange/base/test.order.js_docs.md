# Documentation: js/src/test/Exchange/base/test.order.js

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.order.js`
- **Size**: 3,575 bytes
- **Lines**: 56
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/base/test.order.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.order.js
```
