# Documentation: js/src/test/Exchange/base/test.depositWithdrawal.js

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.depositWithdrawal.js`
- **Size**: 1,995 bytes
- **Lines**: 40
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/base/test.depositWithdrawal.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.depositWithdrawal.js
```
