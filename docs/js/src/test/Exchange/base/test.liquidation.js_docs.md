# Documentation: js/src/test/Exchange/base/test.liquidation.js

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.liquidation.js`
- **Size**: 2,538 bytes
- **Lines**: 42
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/base/test.liquidation.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.liquidation.js
```
