# Documentation: js/src/test/Exchange/base/test.currency.js

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.currency.js`
- **Size**: 4,521 bytes
- **Lines**: 81
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/base/test.currency.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.currency.js
```
