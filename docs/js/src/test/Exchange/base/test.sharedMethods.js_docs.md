# Documentation: js/src/test/Exchange/base/test.sharedMethods.js

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.sharedMethods.js`
- **Size**: 32,401 bytes
- **Lines**: 627
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/base/test.sharedMethods.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.sharedMethods.js
```
