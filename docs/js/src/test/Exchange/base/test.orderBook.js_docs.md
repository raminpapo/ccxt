# Documentation: js/src/test/Exchange/base/test.orderBook.js

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.orderBook.js`
- **Size**: 3,661 bytes
- **Lines**: 72
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/base/test.orderBook.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.orderBook.js
```
