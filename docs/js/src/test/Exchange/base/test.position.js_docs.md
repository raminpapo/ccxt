# Documentation: js/src/test/Exchange/base/test.position.js

## File Metadata

- **Path**: `js/src/test/Exchange/base/test.position.js`
- **Size**: 3,499 bytes
- **Lines**: 49
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/base/test.position.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/base/test.position.js
```
