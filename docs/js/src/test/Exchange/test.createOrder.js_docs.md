# Documentation: js/src/test/Exchange/test.createOrder.js

## File Metadata

- **Path**: `js/src/test/Exchange/test.createOrder.js`
- **Size**: 17,816 bytes
- **Lines**: 267
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/test.createOrder.js`.

**Functions defined**: tcoCreateFillableOrder, tcoMininumAmount, tcoMininumCost, tcoGetMinimumAmountForLimitPrice, tcoAssertFilledOrder, testCreateOrder, tcoCreateOrderSafe, tcoCreateUnfillableOrder, tcoCancelOrder, tcoDebug
...
**To run this test:**
```bash
npm test js/src/test/Exchange/test.createOrder.js
```
