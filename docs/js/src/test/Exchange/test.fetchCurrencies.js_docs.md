# Documentation: js/src/test/Exchange/test.fetchCurrencies.js

## File Metadata

- **Path**: `js/src/test/Exchange/test.fetchCurrencies.js`
- **Size**: 3,949 bytes
- **Lines**: 68
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/Exchange/test.fetchCurrencies.js`.
...
**To run this test:**
```bash
npm test js/src/test/Exchange/test.fetchCurrencies.js
```
