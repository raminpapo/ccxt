# Documentation: js/src/test/base/test.afterConstructor.js

## File Metadata

- **Path**: `js/src/test/base/test.afterConstructor.js`
- **Size**: 3,607 bytes
- **Lines**: 97
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/base/test.afterConstructor.js`.

**Functions defined**: helperTestInitThrottler, testAfterConstructor, helperTestInitSandbox, helperTestSandboxState, helperTestInitMarket
...
**To run this test:**
```bash
npm test js/src/test/base/test.afterConstructor.js
```
