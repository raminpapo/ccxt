# Documentation: js/src/test/base/test.safeMethods.js

## File Metadata

- **Path**: `js/src/test/base/test.safeMethods.js`
- **Size**: 14,591 bytes
- **Lines**: 273
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/base/test.safeMethods.js`.
...
**To run this test:**
```bash
npm test js/src/test/base/test.safeMethods.js
```
