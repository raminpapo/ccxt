# Documentation: js/src/test/base/test.datetime.js

## File Metadata

- **Path**: `js/src/test/base/test.datetime.js`
- **Size**: 5,825 bytes
- **Lines**: 82
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/base/test.datetime.js`.
...
**To run this test:**
```bash
npm test js/src/test/base/test.datetime.js
```
