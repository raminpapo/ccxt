# Documentation: js/src/test/base/language_specific/test.type.js

## File Metadata

- **Path**: `js/src/test/base/language_specific/test.type.js`
- **Size**: 2,089 bytes
- **Lines**: 47
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/base/language_specific/test.type.js`.
...
**To run this test:**
```bash
npm test js/src/test/base/language_specific/test.type.js
```
