# Documentation: js/src/test/base/test.decimalToPrecision.js

## File Metadata

- **Path**: `js/src/test/base/test.decimalToPrecision.js`
- **Size**: 26,574 bytes
- **Lines**: 314
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/test/base/test.decimalToPrecision.js`.
...
**To run this test:**
```bash
npm test js/src/test/base/test.decimalToPrecision.js
```
