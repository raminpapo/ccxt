# Documentation: js/src/test/tests.d.ts

## File Metadata

- **Path**: `js/src/test/tests.d.ts`
- **Size**: 5,281 bytes
- **Lines**: 103
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/test/tests.d.ts`.
...
**To run this test:**
```bash
npm test js/src/test/tests.d.ts
```
