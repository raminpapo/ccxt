# Documentation: js/src/btcmarkets.d.ts

## File Metadata

- **Path**: `js/src/btcmarkets.d.ts`
- **Size**: 14,678 bytes
- **Lines**: 254
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/btcmarkets.d.ts`.
...
```bash
ts-node js/src/btcmarkets.d.ts
```
