# Documentation: js/src/blockchaincom.d.ts

## File Metadata

- **Path**: `js/src/blockchaincom.d.ts`
- **Size**: 14,441 bytes
- **Lines**: 257
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/blockchaincom.d.ts`.
...
```bash
ts-node js/src/blockchaincom.d.ts
```
