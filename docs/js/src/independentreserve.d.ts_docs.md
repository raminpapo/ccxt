# Documentation: js/src/independentreserve.d.ts

## File Metadata

- **Path**: `js/src/independentreserve.d.ts`
- **Size**: 9,315 bytes
- **Lines**: 170
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/independentreserve.d.ts`.
...
```bash
ts-node js/src/independentreserve.d.ts
```
