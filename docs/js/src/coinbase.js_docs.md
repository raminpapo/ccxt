# Documentation: js/src/coinbase.js

## File Metadata

- **Path**: `js/src/coinbase.js`
- **Size**: 251,523 bytes
- **Lines**: 5,234
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/coinbase.js`.

**Classes defined**: coinbase
...
- `./abstract/coinbase.js` (imported)
- `./static_dependencies/noble-hashes/sha256.js` (imported)
- `./base/errors.js` (imported)
- `./base/Precise.js` (imported)
- `pagination` (imported)
- `./base/functions/rsa.js` (imported)
- `./base/functions/number.js` (imported)
- `./abstract/coinbase.js` (referenced)
- `./static_dependencies/noble-hashes/sha256.js` (referenced)
- `./base/errors.js` (referenced)
- `https://user-images.githubusercontent.com/1294454/40811661-b6eceae2-653a-11e8-829e-10bfadb078cf.jpg` (referenced)
- `https://dynamic-assets.coinbase.com/deaca3d47b10ed4a91a872e9618706eec34081127762d88f2476ac8e99ada4b48525a9565cf2206d18c04053f278f693434af4d4629ca084a9d01b7a286a7e26/asset_icons/1f8489bb280fb0a0fd643c1161312ba49655040e9aaaced5f9ad3eeaf868eadc.png` (referenced)
- `./base/Precise.js` (referenced)
- `./base/functions/rsa.js` (referenced)
- `https://www.coinbase.com` (referenced)
- `./base/functions/number.js` (referenced)
- `https://api.coinbase.com` (referenced)
