# Documentation: js/src/pro/woofipro.d.ts

## File Metadata

- **Path**: `js/src/pro/woofipro.d.ts`
- **Size**: 9,365 bytes
- **Lines**: 156
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/woofipro.d.ts`.
...
```bash
ts-node js/src/pro/woofipro.d.ts
```
