# Documentation: js/src/pro/probit.d.ts

## File Metadata

- **Path**: `js/src/pro/probit.d.ts`
- **Size**: 5,430 bytes
- **Lines**: 92
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/probit.d.ts`.
...
```bash
ts-node js/src/pro/probit.d.ts
```
