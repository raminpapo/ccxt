# Documentation: js/src/pro/coinbase.d.ts

## File Metadata

- **Path**: `js/src/pro/coinbase.d.ts`
- **Size**: 12,008 bytes
- **Lines**: 205
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/coinbase.d.ts`.
...
```bash
ts-node js/src/pro/coinbase.d.ts
```
