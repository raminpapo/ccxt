# Documentation: js/src/pro/whitebit.d.ts

## File Metadata

- **Path**: `js/src/pro/whitebit.d.ts`
- **Size**: 7,329 bytes
- **Lines**: 124
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/whitebit.d.ts`.
...
```bash
ts-node js/src/pro/whitebit.d.ts
```
