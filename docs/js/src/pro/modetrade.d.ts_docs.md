# Documentation: js/src/pro/modetrade.d.ts

## File Metadata

- **Path**: `js/src/pro/modetrade.d.ts`
- **Size**: 9,379 bytes
- **Lines**: 156
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/modetrade.d.ts`.
...
```bash
ts-node js/src/pro/modetrade.d.ts
```
