# Documentation: js/src/pro/onetrading.d.ts

## File Metadata

- **Path**: `js/src/pro/onetrading.d.ts`
- **Size**: 6,547 bytes
- **Lines**: 108
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/onetrading.d.ts`.
...
```bash
ts-node js/src/pro/onetrading.d.ts
```
