# Documentation: js/src/pro/gemini.d.ts

## File Metadata

- **Path**: `js/src/pro/gemini.d.ts`
- **Size**: 6,466 bytes
- **Lines**: 107
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/gemini.d.ts`.
...
```bash
ts-node js/src/pro/gemini.d.ts
```
