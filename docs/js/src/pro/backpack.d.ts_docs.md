# Documentation: js/src/pro/backpack.d.ts

## File Metadata

- **Path**: `js/src/pro/backpack.d.ts`
- **Size**: 16,439 bytes
- **Lines**: 265
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/backpack.d.ts`.
...
```bash
ts-node js/src/pro/backpack.d.ts
```
