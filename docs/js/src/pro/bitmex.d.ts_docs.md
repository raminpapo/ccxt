# Documentation: js/src/pro/bitmex.d.ts

## File Metadata

- **Path**: `js/src/pro/bitmex.d.ts`
- **Size**: 10,215 bytes
- **Lines**: 171
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/bitmex.d.ts`.
...
```bash
ts-node js/src/pro/bitmex.d.ts
```
