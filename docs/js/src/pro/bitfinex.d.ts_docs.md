# Documentation: js/src/pro/bitfinex.d.ts

## File Metadata

- **Path**: `js/src/pro/bitfinex.d.ts`
- **Size**: 7,816 bytes
- **Lines**: 130
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/bitfinex.d.ts`.
...
```bash
ts-node js/src/pro/bitfinex.d.ts
```
