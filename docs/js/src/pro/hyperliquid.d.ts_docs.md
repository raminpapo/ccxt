# Documentation: js/src/pro/hyperliquid.d.ts

## File Metadata

- **Path**: `js/src/pro/hyperliquid.d.ts`
- **Size**: 14,435 bytes
- **Lines**: 219
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/hyperliquid.d.ts`.
...
```bash
ts-node js/src/pro/hyperliquid.d.ts
```
