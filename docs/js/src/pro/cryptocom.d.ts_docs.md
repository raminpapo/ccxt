# Documentation: js/src/pro/cryptocom.d.ts

## File Metadata

- **Path**: `js/src/pro/cryptocom.d.ts`
- **Size**: 19,866 bytes
- **Lines**: 301
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/cryptocom.d.ts`.
...
```bash
ts-node js/src/pro/cryptocom.d.ts
```
