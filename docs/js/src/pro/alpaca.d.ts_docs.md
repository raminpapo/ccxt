# Documentation: js/src/pro/alpaca.d.ts

## File Metadata

- **Path**: `js/src/pro/alpaca.d.ts`
- **Size**: 5,765 bytes
- **Lines**: 96
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/alpaca.d.ts`.
...
```bash
ts-node js/src/pro/alpaca.d.ts
```
