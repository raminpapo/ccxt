# Documentation: js/src/pro/toobit.d.ts

## File Metadata

- **Path**: `js/src/pro/toobit.d.ts`
- **Size**: 11,041 bytes
- **Lines**: 175
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/toobit.d.ts`.
...
```bash
ts-node js/src/pro/toobit.d.ts
```
