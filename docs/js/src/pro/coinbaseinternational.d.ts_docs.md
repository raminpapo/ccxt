# Documentation: js/src/pro/coinbaseinternational.d.ts

## File Metadata

- **Path**: `js/src/pro/coinbaseinternational.d.ts`
- **Size**: 8,744 bytes
- **Lines**: 144
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/coinbaseinternational.d.ts`.
...
```bash
ts-node js/src/pro/coinbaseinternational.d.ts
```
