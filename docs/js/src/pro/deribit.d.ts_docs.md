# Documentation: js/src/pro/deribit.d.ts

## File Metadata

- **Path**: `js/src/pro/deribit.d.ts`
- **Size**: 10,352 bytes
- **Lines**: 164
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/deribit.d.ts`.
...
```bash
ts-node js/src/pro/deribit.d.ts
```
