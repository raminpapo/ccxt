# Documentation: js/src/pro/coinbaseexchange.d.ts

## File Metadata

- **Path**: `js/src/pro/coinbaseexchange.d.ts`
- **Size**: 8,037 bytes
- **Lines**: 134
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/coinbaseexchange.d.ts`.
...
```bash
ts-node js/src/pro/coinbaseexchange.d.ts
```
