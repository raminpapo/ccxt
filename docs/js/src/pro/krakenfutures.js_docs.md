# Documentation: js/src/pro/krakenfutures.js

## File Metadata

- **Path**: `js/src/pro/krakenfutures.js`
- **Size**: 67,612 bytes
- **Lines**: 1,587
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/pro/krakenfutures.js`.
...
```bash
node js/src/pro/krakenfutures.js
```
