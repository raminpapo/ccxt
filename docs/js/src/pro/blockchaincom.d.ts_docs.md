# Documentation: js/src/pro/blockchaincom.d.ts

## File Metadata

- **Path**: `js/src/pro/blockchaincom.d.ts`
- **Size**: 5,429 bytes
- **Lines**: 90
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/blockchaincom.d.ts`.
...
```bash
ts-node js/src/pro/blockchaincom.d.ts
```
