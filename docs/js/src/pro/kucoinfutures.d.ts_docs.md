# Documentation: js/src/pro/kucoinfutures.d.ts

## File Metadata

- **Path**: `js/src/pro/kucoinfutures.d.ts`
- **Size**: 12,997 bytes
- **Lines**: 206
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/kucoinfutures.d.ts`.
...
```bash
ts-node js/src/pro/kucoinfutures.d.ts
```
