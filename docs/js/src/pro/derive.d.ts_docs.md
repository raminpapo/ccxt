# Documentation: js/src/pro/derive.d.ts

## File Metadata

- **Path**: `js/src/pro/derive.d.ts`
- **Size**: 5,892 bytes
- **Lines**: 101
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/derive.d.ts`.
...
```bash
ts-node js/src/pro/derive.d.ts
```
