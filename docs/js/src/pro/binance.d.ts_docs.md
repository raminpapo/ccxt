# Documentation: js/src/pro/binance.d.ts

## File Metadata

- **Path**: `js/src/pro/binance.d.ts`
- **Size**: 56,361 bytes
- **Lines**: 855
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/binance.d.ts`.
...
```bash
ts-node js/src/pro/binance.d.ts
```
