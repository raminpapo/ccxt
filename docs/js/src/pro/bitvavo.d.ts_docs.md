# Documentation: js/src/pro/bitvavo.d.ts

## File Metadata

- **Path**: `js/src/pro/bitvavo.d.ts`
- **Size**: 19,404 bytes
- **Lines**: 322
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/bitvavo.d.ts`.
...
```bash
ts-node js/src/pro/bitvavo.d.ts
```
