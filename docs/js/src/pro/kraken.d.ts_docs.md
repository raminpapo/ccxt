# Documentation: js/src/pro/kraken.d.ts

## File Metadata

- **Path**: `js/src/pro/kraken.d.ts`
- **Size**: 13,388 bytes
- **Lines**: 233
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/kraken.d.ts`.
...
```bash
ts-node js/src/pro/kraken.d.ts
```
