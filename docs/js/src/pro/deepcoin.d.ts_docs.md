# Documentation: js/src/pro/deepcoin.d.ts

## File Metadata

- **Path**: `js/src/pro/deepcoin.d.ts`
- **Size**: 9,984 bytes
- **Lines**: 170
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/deepcoin.d.ts`.
...
```bash
ts-node js/src/pro/deepcoin.d.ts
```
