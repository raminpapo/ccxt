# Documentation: js/src/pro/coinex.d.ts

## File Metadata

- **Path**: `js/src/pro/coinex.d.ts`
- **Size**: 8,946 bytes
- **Lines**: 148
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/coinex.d.ts`.
...
```bash
ts-node js/src/pro/coinex.d.ts
```
