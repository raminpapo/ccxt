# Documentation: js/src/pro/bitget.d.ts

## File Metadata

- **Path**: `js/src/pro/bitget.d.ts`
- **Size**: 18,775 bytes
- **Lines**: 283
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/bitget.d.ts`.
...
```bash
ts-node js/src/pro/bitget.d.ts
```
