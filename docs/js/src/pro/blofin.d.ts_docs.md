# Documentation: js/src/pro/blofin.d.ts

## File Metadata

- **Path**: `js/src/pro/blofin.d.ts`
- **Size**: 10,966 bytes
- **Lines**: 180
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/blofin.d.ts`.
...
```bash
ts-node js/src/pro/blofin.d.ts
```
