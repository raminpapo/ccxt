# Documentation: js/src/pro/bithumb.d.ts

## File Metadata

- **Path**: `js/src/pro/bithumb.d.ts`
- **Size**: 5,567 bytes
- **Lines**: 87
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/bithumb.d.ts`.
...
- `../bithumb.js` (imported)
- `../base/ws/WsClient.js` (referenced)
...
```bash
ts-node js/src/pro/bithumb.d.ts
```
