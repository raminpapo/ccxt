# Documentation: js/src/pro/poloniex.d.ts

## File Metadata

- **Path**: `js/src/pro/poloniex.d.ts`
- **Size**: 12,457 bytes
- **Lines**: 215
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/poloniex.d.ts`.
...
```bash
ts-node js/src/pro/poloniex.d.ts
```
