# Documentation: js/src/pro/arkham.d.ts

## File Metadata

- **Path**: `js/src/pro/arkham.d.ts`
- **Size**: 6,172 bytes
- **Lines**: 106
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/arkham.d.ts`.
...
```bash
ts-node js/src/pro/arkham.d.ts
```
