# Documentation: js/src/pro/krakenfutures.d.ts

## File Metadata

- **Path**: `js/src/pro/krakenfutures.d.ts`
- **Size**: 10,293 bytes
- **Lines**: 179
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/krakenfutures.d.ts`.
...
```bash
ts-node js/src/pro/krakenfutures.d.ts
```
