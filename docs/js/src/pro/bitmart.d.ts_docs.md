# Documentation: js/src/pro/bitmart.d.ts

## File Metadata

- **Path**: `js/src/pro/bitmart.d.ts`
- **Size**: 10,615 bytes
- **Lines**: 169
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/bitmart.d.ts`.
...
```bash
ts-node js/src/pro/bitmart.d.ts
```
