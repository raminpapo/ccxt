# Documentation: js/src/pro/coincatch.d.ts

## File Metadata

- **Path**: `js/src/pro/coincatch.d.ts`
- **Size**: 12,867 bytes
- **Lines**: 208
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/coincatch.d.ts`.
...
```bash
ts-node js/src/pro/coincatch.d.ts
```
