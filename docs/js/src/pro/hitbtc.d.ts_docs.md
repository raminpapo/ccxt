# Documentation: js/src/pro/hitbtc.d.ts

## File Metadata

- **Path**: `js/src/pro/hitbtc.d.ts`
- **Size**: 13,714 bytes
- **Lines**: 236
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/hitbtc.d.ts`.
...
```bash
ts-node js/src/pro/hitbtc.d.ts
```
