# Documentation: js/src/pro/test/Exchange/test.watchPositions.js

## File Metadata

- **Path**: `js/src/pro/test/Exchange/test.watchPositions.js`
- **Size**: 2,542 bytes
- **Lines**: 60
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/pro/test/Exchange/test.watchPositions.js`.
...
**To run this test:**
```bash
npm test js/src/pro/test/Exchange/test.watchPositions.js
```
