# Documentation: js/src/pro/test/base/test.orderBook.js

## File Metadata

- **Path**: `js/src/pro/test/base/test.orderBook.js`
- **Size**: 17,589 bytes
- **Lines**: 344
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/pro/test/base/test.orderBook.js`.

**Functions defined**: equals, testWsOrderBook
...
**To run this test:**
```bash
npm test js/src/pro/test/base/test.orderBook.js
```
