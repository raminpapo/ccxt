# Documentation: js/src/pro/test/custom/server.js

## File Metadata

- **Path**: `js/src/pro/test/custom/server.js`
- **Size**: 4,406 bytes
- **Lines**: 121
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/pro/test/custom/server.js`.

**Classes defined**: WebSocketServer

**Functions defined**: incoming
...
**To run this test:**
```bash
npm test js/src/pro/test/custom/server.js
```
