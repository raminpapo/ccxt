# Documentation: js/src/pro/bittrade.d.ts

## File Metadata

- **Path**: `js/src/pro/bittrade.d.ts`
- **Size**: 3,968 bytes
- **Lines**: 67
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/bittrade.d.ts`.
...
```bash
ts-node js/src/pro/bittrade.d.ts
```
