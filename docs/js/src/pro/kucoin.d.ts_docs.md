# Documentation: js/src/pro/kucoin.d.ts

## File Metadata

- **Path**: `js/src/pro/kucoin.d.ts`
- **Size**: 16,146 bytes
- **Lines**: 244
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `js/src/pro/kucoin.d.ts`.
...
```bash
ts-node js/src/pro/kucoin.d.ts
```
