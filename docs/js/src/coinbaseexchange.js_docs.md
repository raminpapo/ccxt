# Documentation: js/src/coinbaseexchange.js

## File Metadata

- **Path**: `js/src/coinbaseexchange.js`
- **Size**: 95,155 bytes
- **Lines**: 2,137
- **Type**: JavaScript
- **Extension**: .js
...
This is a JavaScript file located at `js/src/coinbaseexchange.js`.
...
```bash
node js/src/coinbaseexchange.js
```
