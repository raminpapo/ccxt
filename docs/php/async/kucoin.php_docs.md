# Documentation: php/async/kucoin.php

## File Metadata

- **Path**: `php/async/kucoin.php`
- **Size**: 303,811 bytes
- **Lines**: 5,899
- **Type**: PHP
- **Extension**: .php
...
class kucoin extends Exchange {
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            if ($uta) {
                ...
                $response = Async\await($this->utaGetMarketOrderbook ($this->extend($request, $params)));
                //
                //     {
                //         "code" => "200000",
                //         "data" => {
    ...
    public function fetch_funding_rate_history(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->utaGetMarketFundingRateHistory ($this->extend($request, $params)));
            //
            //     {
            //         "code" => "200000",
            //         "data" => {
...
This is a PHP file located at `php/async/kucoin.php`.

**Classes defined**: kucoin

**Functions defined**: fetch_status, load_migration_status, describe, has, nonce, fetch_uta_markets, fetch_markets, fetch_time, of
...
- `https://www.kucoin.com` (referenced)
- `https://api-broker.kucoin.com` (referenced)
