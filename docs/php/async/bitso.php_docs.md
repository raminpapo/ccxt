# Documentation: php/async/bitso.php

## File Metadata

- **Path**: `php/async/bitso.php`
- **Size**: 89,464 bytes
- **Lines**: 1,947
- **Type**: PHP
- **Extension**: .php
...
class bitso extends Exchange {
    ...
    public function fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = 25, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            /**
...
This is a PHP file located at `php/async/bitso.php`.

**Classes defined**: bitso

**Functions defined**: fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_balance, parse_ledger_entry, parse_ledger_entry_type, fetch_ledger
