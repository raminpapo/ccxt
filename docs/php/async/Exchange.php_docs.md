# Documentation: php/async/Exchange.php

## File Metadata

- **Path**: `php/async/Exchange.php`
- **Size**: 356,197 bytes
- **Lines**: 7,185
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/Exchange.php`.

**Classes defined**: Exchange, needs

**Functions defined**: load_markets_helper, load_markets, loadAccounts, fetch, loadMarkets, __construct, set_request_browser, setProxyAgents, fetch_currencies, create_connector
...
- `since` (imported)
- `defaultNetworks` (imported)
- `reactphp-http-proxy/src/ProxyConnector.php` (referenced)
