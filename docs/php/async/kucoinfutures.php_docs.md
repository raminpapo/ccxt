# Documentation: php/async/kucoinfutures.php

## File Metadata

- **Path**: `php/async/kucoinfutures.php`
- **Size**: 175,167 bytes
- **Lines**: 3,538
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/kucoinfutures.php`.
...
```bash
php php/async/kucoinfutures.php
```
