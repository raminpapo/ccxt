# Documentation: php/async/xt.php

## File Metadata

- **Path**: `php/async/xt.php`
- **Size**: 256,438 bytes
- **Lines**: 5,251
- **Type**: PHP
- **Extension**: .php
...
class xt extends Exchange {
    ...
    public function fetch_currencies($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            list($chainsResponse, $currenciesResponse) = Async\await(Promise\all($promisesRaw));
            //
            // currencies
            //
            //    {
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            if ($market['spot']) {
                ...
                $response = Async\await($this->publicSpotGetDepth ($this->extend($request, $params)));
            } else {
                if ($limit !== null) {
...
This is a PHP file located at `php/async/xt.php`.

**Classes defined**: xt

**Functions defined**: fetch_swap_and_future_markets, parse_market, parse_markets, describe, nonce, fetch_markets, fetch_time, before, fetch_spot_markets, fetch_currencies
...
- `https://a.static-global.com/1/currency/btc.png` (referenced)
