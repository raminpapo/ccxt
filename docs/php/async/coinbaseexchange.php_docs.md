# Documentation: php/async/coinbaseexchange.php

## File Metadata

- **Path**: `php/async/coinbaseexchange.php`
- **Size**: 106,221 bytes
- **Lines**: 2,219
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/coinbaseexchange.php`.
...
```bash
php php/async/coinbaseexchange.php
```
