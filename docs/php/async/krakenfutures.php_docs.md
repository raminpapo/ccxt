# Documentation: php/async/krakenfutures.php

## File Metadata

- **Path**: `php/async/krakenfutures.php`
- **Size**: 144,790 bytes
- **Lines**: 2,986
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/krakenfutures.php`.
...
```bash
php php/async/krakenfutures.php
```
