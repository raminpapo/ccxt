# Documentation: php/async/toobit.php

## File Metadata

- **Path**: `php/async/toobit.php`
- **Size**: 152,200 bytes
- **Lines**: 3,101
- **Type**: PHP
- **Extension**: .php
...
class toobit extends Exchange {
    ...
    public function fetch_status($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->commonGetApiV1Ping ($params));
            return array(
                'status' => 'ok',
                'updated' => null,
                'eta' => null,
    ...
    public function fetch_currencies($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->commonGetApiV1ExchangeInfo ($params));
    ...
    public function fetch_deposits(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $since, $limit, $params) {
             ...
             */
            return Async\await($this->fetch_deposits_or_withdrawals_helper('deposits', $code, $since, $limit, $params));
        }) ();
    }
    ...
    public function fetch_deposit_address(string $code, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $params) {
            ...
            $response = Async\await($this->privateGetApiV1AccountDepositAddress ($this->extend($request, $paramsOmitted)));
            //
            //     {
...
This is a PHP file located at `php/async/toobit.php`.

**Classes defined**: toobit

**Functions defined**: parse_market, fetch_status, describe, parse_currency, fetch_order_book, fetch_markets, parse_trade, fetch_time, fetch_trades, fetch_currencies
