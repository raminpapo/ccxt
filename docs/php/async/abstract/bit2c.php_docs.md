# Documentation: php/async/abstract/bit2c.php

## File Metadata

- **Path**: `php/async/abstract/bit2c.php`
- **Size**: 8,536 bytes
- **Lines**: 149
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bit2c.php`.
...
```bash
php php/async/abstract/bit2c.php
```
