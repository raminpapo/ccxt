# Documentation: php/async/abstract/bitflyer.php

## File Metadata

- **Path**: `php/async/abstract/bitflyer.php`
- **Size**: 12,041 bytes
- **Lines**: 221
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bitflyer.php`.

**Classes defined**: bitflyer

**Functions defined**: public_get_getticker, public_get_getmarkets, public_get_getboardstate, public_get_getexecutions, public_get_getboard, public_get_getfundingrate, public_get_gethealth, public_get_getchats, public_get_getmarkets_eu, public_get_getmarkets_usa
...
```bash
php php/async/abstract/bitflyer.php
```
