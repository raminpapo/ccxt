# Documentation: php/async/abstract/probit.php

## File Metadata

- **Path**: `php/async/abstract/probit.php`
- **Size**: 6,773 bytes
- **Lines**: 125
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/probit.php`.
...
```bash
php php/async/abstract/probit.php
```
