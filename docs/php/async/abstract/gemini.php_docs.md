# Documentation: php/async/abstract/gemini.php

## File Metadata

- **Path**: `php/async/abstract/gemini.php`
- **Size**: 21,050 bytes
- **Lines**: 341
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/gemini.php`.

**Classes defined**: gemini

**Functions defined**: public_get_v1_symbols_details_symbol, public_get_v1_auction_symbol, public_get_v1_pubticker_symbol, webexchange_get, public_get_v1_trades_symbol, public_get_v1_symbols, public_get_v1_staking_rates, web_get_rest_api, public_get_v2_candles_symbol_timeframe, public_get_v2_ticker_symbol
...
```bash
php php/async/abstract/gemini.php
```
