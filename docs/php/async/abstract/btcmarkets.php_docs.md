# Documentation: php/async/abstract/btcmarkets.php

## File Metadata

- **Path**: `php/async/abstract/btcmarkets.php`
- **Size**: 12,086 bytes
- **Lines**: 221
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/btcmarkets.php`.

**Classes defined**: btcmarkets

**Functions defined**: public_get_markets_marketid_orderbook, public_get_markets_tickers, public_get_time, public_get_markets_orderbooks, public_get_markets, public_get_markets_marketid_ticker, private_get_orders, public_get_markets_marketid_candles, private_get_orders_id, public_get_markets_marketid_trades
...
```bash
php php/async/abstract/btcmarkets.php
```
