# Documentation: php/async/abstract/zaif.php

## File Metadata

- **Path**: `php/async/abstract/zaif.php`
- **Size**: 12,558 bytes
- **Lines**: 215
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/zaif.php`.

**Classes defined**: zaif

**Functions defined**: public_get_ticker_pair, public_get_last_price_pair, private_post_active_orders, public_get_currencies_pair, public_get_depth_pair, public_get_currency_pairs_pair, public_get_trades_pair, public_get_currencies_all, public_get_currency_pairs_all, private_post_cancel_order
...
- `ecapi_post_cancelinvoice()`
- `ecapi_post_createinvoice()`
- `ecapi_post_getinvoice()`
- `ecapi_post_getinvoiceidsbyordernumber()`
- `fapiGetDepthGroupIdPair()`
- `fapiGetGroupsGroupId()`
- `fapiGetLastPriceGroupIdPair()`
- `fapiGetTickerGroupIdPair()`
- `fapiGetTradesGroupIdPair()`
- `fapi_get_depth_group_id_pair()`
- `fapi_get_groups_group_id()`
- `fapi_get_last_price_group_id_pair()`
- `fapi_get_ticker_group_id_pair()`
- `fapi_get_trades_group_id_pair()`
...
```bash
php php/async/abstract/zaif.php
```
