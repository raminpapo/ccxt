# Documentation: php/async/abstract/ascendex.php

## File Metadata

- **Path**: `php/async/abstract/ascendex.php`
- **Size**: 31,735 bytes
- **Lines**: 449
- **Type**: PHP
- **Extension**: .php
...
abstract class ascendex extends \ccxt\async\Exchange {
...
This is a PHP file located at `php/async/abstract/ascendex.php`.

**Classes defined**: ascendex

**Functions defined**: v1_public_get_barhist_info, v1_public_get_cash_products, v1_public_get_margin_assets, v1_public_get_ticker, v1_public_get_barhist, v1_public_get_cash_assets, v1_public_get_depth, v1_public_get_assets, v1_public_get_products, v1_public_get_trades
...
```bash
php php/async/abstract/ascendex.php
```
