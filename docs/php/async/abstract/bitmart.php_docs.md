# Documentation: php/async/abstract/bitmart.php

## File Metadata

- **Path**: `php/async/abstract/bitmart.php`
- **Size**: 47,151 bytes
- **Lines**: 689
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bitmart.php`.

**Classes defined**: bitmart

**Functions defined**: public_get_spot_quotation_v3_tickers, public_get_spot_v1_symbols_details, public_get_spot_v1_symbols, public_get_spot_quotation_v3_books, public_get_spot_v1_currencies, public_get_spot_quotation_v3_klines, public_get_spot_quotation_v3_ticker, public_get_system_service, public_get_system_time, public_get_spot_quotation_v3_lite_klines
...
```bash
php php/async/abstract/bitmart.php
```
