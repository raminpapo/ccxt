# Documentation: php/async/abstract/krakenfutures.php

## File Metadata

- **Path**: `php/async/abstract/krakenfutures.php`
- **Size**: 13,187 bytes
- **Lines**: 239
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/krakenfutures.php`.

**Classes defined**: krakenfutures

**Functions defined**: private_get_feeschedules_volumes, public_get_history, public_get_instruments, public_get_orderbook, private_get_notifications, private_get_accounts, public_get_tickers, public_get_feeschedules, private_get_openpositions, public_get_historicalfundingrates
...
- `historyGetOrders()`
- `historyGetTriggers()`
- `history_get_account_log()`
- `history_get_accountlogcsv()`
- `history_get_executions()`
- `history_get_market_symbol_executions()`
- `history_get_market_symbol_orders()`
- `history_get_orders()`
- `history_get_triggers()`
- `privateGetAccounts()`
...
```bash
php php/async/abstract/krakenfutures.php
```
