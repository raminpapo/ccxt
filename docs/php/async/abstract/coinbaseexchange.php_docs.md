# Documentation: php/async/abstract/coinbaseexchange.php

## File Metadata

- **Path**: `php/async/abstract/coinbaseexchange.php`
- **Size**: 28,050 bytes
- **Lines**: 485
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/coinbaseexchange.php`.
...
```bash
php php/async/abstract/coinbaseexchange.php
```
