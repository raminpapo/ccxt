# Documentation: php/async/abstract/lbank.php

## File Metadata

- **Path**: `php/async/abstract/lbank.php`
- **Size**: 24,910 bytes
- **Lines**: 359
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/lbank.php`.

**Classes defined**: lbank

**Functions defined**: spot_public_get_currencypairs, spot_public_get_ticker_24hr, spot_public_get_withdrawconfigs, spot_public_get_ticker, spot_public_get_accuracy, spot_public_get_timestamp, spot_public_get_assetconfigs, spot_public_get_usdtocny, spot_public_get_depth, spot_public_get_incrdepth
...
- `contract_public_get_cfd_openapi_v1_pub_gettime()`
- `contract_public_get_cfd_openapi_v1_pub_instrument()`
- `contract_public_get_cfd_openapi_v1_pub_marketdata()`
- `contract_public_get_cfd_openapi_v1_pub_marketorder()`
...
```bash
php php/async/abstract/lbank.php
```
