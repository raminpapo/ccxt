# Documentation: php/async/abstract/coinmate.php

## File Metadata

- **Path**: `php/async/abstract/coinmate.php`
- **Size**: 20,827 bytes
- **Lines**: 359
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/coinmate.php`.

**Classes defined**: coinmate

**Functions defined**: private_post_bitcoincashwithdrawal, public_get_transactions, public_get_orderbook, public_get_products, public_get_tickerall, public_get_tradingpairs, private_post_bitcoincashdepositaddresses, public_get_ticker, private_post_bitcoindepositaddresses, private_post_balances
...
```bash
php php/async/abstract/coinmate.php
```
