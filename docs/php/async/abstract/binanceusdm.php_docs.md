# Documentation: php/async/abstract/binanceusdm.php

## File Metadata

- **Path**: `php/async/abstract/binanceusdm.php`
- **Size**: 296,434 bytes
- **Lines**: 4,613
- **Type**: PHP
- **Extension**: .php
...
abstract class binanceusdm extends \ccxt\async\binance {
...
This is a PHP file located at `php/async/abstract/binanceusdm.php`.

**Classes defined**: binanceusdm

**Functions defined**: sapi_get_account_info, sapi_get_copytrading_futures_leadsymbol, sapi_get_accountsnapshot, sapi_get_margin_allpairs, sapi_get_margin_asset, sapi_get_margin_priceindex, sapi_get_margin_allassets, sapi_get_copytrading_futures_userstatus, sapi_get_system_status, sapi_get_margin_pair
...
```bash
php php/async/abstract/binanceusdm.php
```
