# Documentation: php/async/abstract/paymium.php

## File Metadata

- **Path**: `php/async/abstract/paymium.php`
- **Size**: 8,768 bytes
- **Lines**: 155
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/paymium.php`.

**Classes defined**: paymium

**Functions defined**: public_get_data_currency_trades, public_get_data_currency_ticker, private_get_user_addresses_address, public_get_currencies, public_get_bitcoin_charts_id_trades, private_get_user_addresses, private_get_user, public_get_countries, public_get_bitcoin_charts_id_depth, public_get_data_currency_depth
...
- `private_delete_user_orders_uuid()`
- `private_delete_user_orders_uuid_cancel()`
- `private_delete_user_price_alerts_id()`
...
```bash
php php/async/abstract/paymium.php
```
