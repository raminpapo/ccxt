# Documentation: php/async/abstract/coinone.php

## File Metadata

- **Path**: `php/async/abstract/coinone.php`
- **Size**: 23,818 bytes
- **Lines**: 389
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/coinone.php`.

**Classes defined**: coinone

**Functions defined**: v2public_get_ticker_new_quote_currency, v2public_get_trades_quote_currency_target_currency, v2public_get_markets_quote_currency, public_get_orderbook, v2public_get_range_units, v2public_get_orderbook_quote_currency_target_currency, public_get_ticker, v2public_get_markets_quote_currency_target_currency, public_get_trades, public_get_ticker_utc
...
- `private_post_account_btc_deposit_address()`
...
```bash
php php/async/abstract/coinone.php
```
