# Documentation: php/async/abstract/wavesexchange.php

## File Metadata

- **Path**: `php/async/abstract/wavesexchange.php`
- **Size**: 56,419 bytes
- **Lines**: 911
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/wavesexchange.php`.

**Classes defined**: wavesexchange

**Functions defined**: matcher_get_matcher_settings, matcher_get_matcher_balance_reserved_publickey, matcher_get_matcher, matcher_get_matcher_debug_oldestsnapshotoffset, matcher_get_matcher_settings_rates, matcher_get_matcher_debug_config, matcher_get_matcher_debug_allsnashotoffsets, matcher_get_matcher_debug_lastoffset, matcher_get_matcher_debug_address_address, matcher_get_matcher_debug_currentoffset
...
- `forward_get_matcher_orders_address()`
- `forward_get_matcher_orders_address_orderid()`
- `forward_post_matcher_orders_wavesaddress_cancel()`
- `marketGetTickers()`
- `market_get_tickers()`
...
```bash
php php/async/abstract/wavesexchange.php
```
