# Documentation: php/async/abstract/exmo.php

## File Metadata

- **Path**: `php/async/abstract/exmo.php`
- **Size**: 18,580 bytes
- **Lines**: 317
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/exmo.php`.

**Classes defined**: exmo

**Functions defined**: public_get_currency, public_get_currency_list_extended, web_get_ctrl_feesandlimits, public_get_candles_history, public_get_ticker, public_get_required_amount, public_get_order_book, web_get_en_docs_fees, public_get_pair_settings, public_get_trades
...
```bash
php php/async/abstract/exmo.php
```
