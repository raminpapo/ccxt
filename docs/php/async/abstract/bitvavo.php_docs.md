# Documentation: php/async/abstract/bitvavo.php

## File Metadata

- **Path**: `php/async/abstract/bitvavo.php`
- **Size**: 8,158 bytes
- **Lines**: 149
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bitvavo.php`.

**Classes defined**: bitvavo

**Functions defined**: public_get_ticker_24h, public_get_ticker_price, public_get_market_book, public_get_time, public_get_ticker_book, public_get_markets, public_get_market_trades, public_get_assets, public_get_market_candles, private_get_account
...
```bash
php php/async/abstract/bitvavo.php
```
