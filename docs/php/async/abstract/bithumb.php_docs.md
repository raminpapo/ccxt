# Documentation: php/async/abstract/bithumb.php

## File Metadata

- **Path**: `php/async/abstract/bithumb.php`
- **Size**: 10,369 bytes
- **Lines**: 179
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bithumb.php`.

**Classes defined**: bithumb

**Functions defined**: public_get_ticker_all_quoteid, public_get_orderbook_baseid_quoteid, public_get_orderbook_all_quoteid, public_get_transaction_history_baseid_quoteid, public_get_assetsstatus_multichain_all, public_get_withdraw_minimum_currency, public_get_withdraw_minimum_all, public_get_network_info, public_get_ticker_baseid_quoteid, public_get_assetsstatus_multichain_currency
...
- `private_post_info_account()`
- `private_post_info_balance()`
- `private_post_info_order_detail()`
- `private_post_info_orders()`
- `private_post_info_ticker()`
...
```bash
php php/async/abstract/bithumb.php
```
