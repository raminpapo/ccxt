# Documentation: php/async/abstract/hitbtc.php

## File Metadata

- **Path**: `php/async/abstract/hitbtc.php`
- **Size**: 44,340 bytes
- **Lines**: 677
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/hitbtc.php`.
...
```bash
php php/async/abstract/hitbtc.php
```
