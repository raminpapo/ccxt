# Documentation: php/async/abstract/delta.php

## File Metadata

- **Path**: `php/async/abstract/delta.php`
- **Size**: 17,566 bytes
- **Lines**: 311
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/delta.php`.

**Classes defined**: delta

**Functions defined**: public_get_trades_symbol, public_get_l2orderbook_symbol, public_get_products, public_get_tickers, public_get_assets, public_get_stats, public_get_products_symbol, public_get_indices, public_get_history_candles, public_get_tickers_symbol
...
- `privateGetHeartbeat()`
- `privateGetOrders()`
- `privateGetOrdersClientOrderIdClientOid()`
...
```bash
php php/async/abstract/delta.php
```
