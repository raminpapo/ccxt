# Documentation: php/async/abstract/bigone.php

## File Metadata

- **Path**: `php/async/abstract/bigone.php`
- **Size**: 14,874 bytes
- **Lines**: 257
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bigone.php`.

**Classes defined**: bigone

**Functions defined**: public_get_asset_pairs_tickers, private_get_assets_asset_symbol_address, private_get_fund_accounts, public_get_asset_pairs_asset_pair_name_depth, public_get_asset_pairs_asset_pair_name_candles, private_get_accounts, public_get_asset_pairs_asset_pair_name_ticker, public_get_asset_pairs_asset_pair_name_trades, public_get_asset_pairs, public_get_ping
...
- `contractprivate_delete_orders_batch()`
...
```bash
php php/async/abstract/bigone.php
```
