# Documentation: php/async/abstract/coinbase.php

## File Metadata

- **Path**: `php/async/abstract/coinbase.php`
- **Size**: 41,572 bytes
- **Lines**: 557
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/coinbase.php`.
...
```bash
php php/async/abstract/coinbase.php
```
