# Documentation: php/async/abstract/xt.php

## File Metadata

- **Path**: `php/async/abstract/xt.php`
- **Size**: 71,534 bytes
- **Lines**: 929
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/xt.php`.

**Classes defined**: xt

**Functions defined**: public_spot_get_symbol, public_spot_get_trade_history, public_spot_get_time, public_spot_get_kline, public_spot_get_ticker_book, public_spot_get_currencies, public_spot_get_ticker, public_spot_get_ticker_price, public_spot_get_ticker_24h, public_spot_get_depth
