# Documentation: php/async/abstract/cex.php

## File Metadata

- **Path**: `php/async/abstract/cex.php`
- **Size**: 10,843 bytes
- **Lines**: 179
- **Type**: PHP
- **Extension**: .php
...
abstract class cex extends \ccxt\async\Exchange {
...
This is a PHP file located at `php/async/abstract/cex.php`.

**Classes defined**: cex

**Functions defined**: public_post_get_ticker, public_post_get_candles, public_post_get_currencies_info, public_post_get_pairs_info, public_post_get_server_time, private_post_get_fee_strategy, private_post_get_my_current_fee, public_post_get_processing_info, public_post_get_trade_history, public_post_get_order_book
...
```bash
php php/async/abstract/cex.php
```
