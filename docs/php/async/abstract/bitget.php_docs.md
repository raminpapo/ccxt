# Documentation: php/async/abstract/bitget.php

## File Metadata

- **Path**: `php/async/abstract/bitget.php`
- **Size**: 263,135 bytes
- **Lines**: 3,443
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bitget.php`.

**Classes defined**: bitget

**Functions defined**: public_spot_get_spot_v1_market_tickers, public_spot_get_spot_v1_market_fills, public_common_get_v2_public_annoucements, public_spot_get_spot_v1_public_products, public_common_get_v2_public_time, public_spot_get_spot_v1_notice_queryallnotices, public_spot_get_spot_v1_market_ticker, public_spot_get_spot_v1_public_time, public_spot_get_spot_v1_public_currencies, public_spot_get_spot_v1_public_product
...
```bash
php php/async/abstract/bitget.php
```
