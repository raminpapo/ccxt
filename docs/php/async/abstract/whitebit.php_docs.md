# Documentation: php/async/abstract/whitebit.php

## File Metadata

- **Path**: `php/async/abstract/whitebit.php`
- **Size**: 43,036 bytes
- **Lines**: 671
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/whitebit.php`.

**Classes defined**: whitebit

**Functions defined**: v1_public_get_markets, v1_private_post_order_new, v1_public_get_symbols, v1_public_get_kline, v1_public_get_ticker, v1_public_get_depth_result, v1_public_get_tickers, v1_public_get_history, v1_private_post_account_balance, web_get_v1_healthcheck
...
- `v1PublicGetTicker()`
- `v1PublicGetTickers()`
- `v1_private_post_account_balance()`
- `v1_private_post_account_executed_history()`
- `v1_private_post_account_executed_history_all()`
- `v1_private_post_account_order()`
- `v1_private_post_account_order_history()`
...
```bash
php php/async/abstract/whitebit.php
```
