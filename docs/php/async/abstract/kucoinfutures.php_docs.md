# Documentation: php/async/abstract/kucoinfutures.php

## File Metadata

- **Path**: `php/async/abstract/kucoinfutures.php`
- **Size**: 108,779 bytes
- **Lines**: 1,679
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/kucoinfutures.php`.

**Classes defined**: kucoinfutures

**Functions defined**: public_get_currencies_currency, public_get_market_stats, public_get_market_orderbook_level_level_limit, public_get_symbols, public_get_market_orderbook_level2_20, public_get_market_orderbook_level2_100, public_get_market_orderbook_level1, public_get_markets, public_get_currencies, public_get_market_alltickers
...
```bash
php php/async/abstract/kucoinfutures.php
```
