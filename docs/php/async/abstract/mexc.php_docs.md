# Documentation: php/async/abstract/mexc.php

## File Metadata

- **Path**: `php/async/abstract/mexc.php`
- **Size**: 75,142 bytes
- **Lines**: 1,073
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/mexc.php`.
...
```bash
php php/async/abstract/mexc.php
```
