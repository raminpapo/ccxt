# Documentation: php/async/abstract/bingx.php

## File Metadata

- **Path**: `php/async/abstract/bingx.php`
- **Size**: 76,538 bytes
- **Lines**: 1,061
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bingx.php`.

**Classes defined**: bingx

**Functions defined**: spot_v1_public_get_common_symbols, fund_v1_private_get_account_balance, spot_v1_public_get_market_depth, spot_v1_public_get_ticker_24hr, spot_v1_public_get_ticker_bookticker, spot_v1_public_get_market_trades, spot_v1_public_get_market_kline, spot_v1_public_get_ticker_price, spot_v1_private_get_trade_query, spot_v1_public_get_server_time
...
```bash
php php/async/abstract/bingx.php
```
