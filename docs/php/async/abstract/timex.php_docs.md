# Documentation: php/async/abstract/timex.php

## File Metadata

- **Path**: `php/async/abstract/timex.php`
- **Size**: 19,573 bytes
- **Lines**: 359
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/timex.php`.

**Classes defined**: timex

**Functions defined**: addressbook_post_id_id, custody_get_credentials, custody_get_credentials_k_key, addressbook_get_me, custody_get_deposit_addresses, custody_get_credentials_me, custody_get_credentials_h_hash, custody_get_credentials_me_address, addressbook_post_id_id_remove, addressbook_post
...
- `currencies_get_a_address()`
- `currencies_get_i_id()`
- `currencies_get_s_symbol()`
...
```bash
php php/async/abstract/timex.php
```
