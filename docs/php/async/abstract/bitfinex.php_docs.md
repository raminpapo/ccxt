# Documentation: php/async/abstract/bitfinex.php

## File Metadata

- **Path**: `php/async/abstract/bitfinex.php`
- **Size**: 54,735 bytes
- **Lines**: 827
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bitfinex.php`.

**Classes defined**: bitfinex

**Functions defined**: public_get_conf_pub_map_object_detail, public_get_conf_config, public_get_conf_pub_map_currency_label, public_get_conf_pub_map_currency_undl, public_get_conf_pub_map_object, public_get_conf_pub_map_currency_detail, public_get_conf_pub_action_object_detail, public_get_conf_pub_map_currency_sym, public_get_conf_pub_map_currency_unit, public_get_conf_pub_action_object
...
```bash
php php/async/abstract/bitfinex.php
```
