# Documentation: php/async/abstract/bitopro.php

## File Metadata

- **Path**: `php/async/abstract/bitopro.php`
- **Size**: 10,204 bytes
- **Lines**: 167
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bitopro.php`.

**Classes defined**: bitopro

**Functions defined**: public_get_provisioning_currencies, public_get_price_otc_currency, public_get_tickers, public_get_tickers_pair, public_get_trading_history_pair, private_get_accounts_balance, public_get_order_book_pair, public_get_trades_pair, public_get_provisioning_trading_pairs, public_get_provisioning_limitations_and_fees
...
- `privatePutOrders()`
- `private_delete_orders_all()`
- `private_delete_orders_pair()`
- `private_delete_orders_pair_id()`
...
```bash
php php/async/abstract/bitopro.php
```
