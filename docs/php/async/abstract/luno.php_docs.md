# Documentation: php/async/abstract/luno.php

## File Metadata

- **Path**: `php/async/abstract/luno.php`
- **Size**: 12,261 bytes
- **Lines**: 215
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/luno.php`.

**Classes defined**: luno

**Functions defined**: exchangeprivate_get_candles, public_get_orderbook_top, public_get_orderbook, exchange_get_markets, private_get_accounts_id_pending, private_get_balance, public_get_ticker, public_get_tickers, private_get_accounts_id_transactions, public_get_trades
...
- `exchange_get_markets()`
- `exchangeprivate_get_candles()`
...
```bash
php php/async/abstract/luno.php
```
