# Documentation: php/async/abstract/bitso.php

## File Metadata

- **Path**: `php/async/abstract/bitso.php`
- **Size**: 13,313 bytes
- **Lines**: 245
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bitso.php`.

**Classes defined**: bitso

**Functions defined**: private_get_balance, public_get_available_books, private_get_fees, private_get_fundings_fid, public_get_ohlc, public_get_ticker, private_get_fundings, public_get_order_book, private_get_account_status, public_get_trades
...
```bash
php php/async/abstract/bitso.php
```
