# Documentation: php/async/abstract/myokx.php

## File Metadata

- **Path**: `php/async/abstract/myokx.php`
- **Size**: 143,914 bytes
- **Lines**: 2,093
- **Type**: PHP
- **Extension**: .php
...
abstract class myokx extends \ccxt\async\okx {
...
This is a PHP file located at `php/async/abstract/myokx.php`.

**Classes defined**: myokx

**Functions defined**: public_get_market_index_candles, public_get_market_books_lite, public_get_market_books, public_get_market_index_tickers, public_get_market_history_candles, public_get_market_ticker, public_get_market_tickers, public_get_market_candles, public_get_market_books_full, public_get_market_history_index_candles
...
```bash
php php/async/abstract/myokx.php
```
