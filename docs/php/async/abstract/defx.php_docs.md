# Documentation: php/async/abstract/defx.php

## File Metadata

- **Path**: `php/async/abstract/defx.php`
- **Size**: 28,533 bytes
- **Lines**: 401
- **Type**: PHP
- **Extension**: .php
...
abstract class defx extends \ccxt\async\Exchange {
...
This is a PHP file located at `php/async/abstract/defx.php`.

**Classes defined**: defx

**Functions defined**: v1_public_get_symbols_symbol_prices, v1_public_get_symbols_symbol_ticker_24hr, v1_public_get_symbols_symbol_depth_level_slab, v1_public_get_healthcheck_ping, v1_public_get_c_markets_metadata, v1_public_get_symbols_symbol_trades, v1_public_get_ticker_24hragg, v1_public_get_analytics_market_stats_newusers, v1_public_get_symbols_symbol_ohlc, v1_public_get_c_markets
...
```bash
php php/async/abstract/defx.php
```
