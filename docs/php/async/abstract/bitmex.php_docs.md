# Documentation: php/async/abstract/bitmex.php

## File Metadata

- **Path**: `php/async/abstract/bitmex.php`
- **Size**: 33,973 bytes
- **Lines**: 569
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bitmex.php`.

**Classes defined**: bitmex

**Functions defined**: public_get_instrument, public_get_chat_connected, public_get_announcement_urgent, public_get_instrument_active, public_get_chat, public_get_chat_channels, public_get_funding, public_get_guild, public_get_chat_pinned, public_get_announcement
...
```bash
php php/async/abstract/bitmex.php
```
