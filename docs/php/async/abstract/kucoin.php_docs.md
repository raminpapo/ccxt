# Documentation: php/async/abstract/kucoin.php

## File Metadata

- **Path**: `php/async/abstract/kucoin.php`
- **Size**: 97,480 bytes
- **Lines**: 1,511
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/kucoin.php`.
...
```bash
php php/async/abstract/kucoin.php
```
