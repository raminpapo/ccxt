# Documentation: php/async/abstract/binancecoinm.php

## File Metadata

- **Path**: `php/async/abstract/binancecoinm.php`
- **Size**: 296,435 bytes
- **Lines**: 4,613
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/binancecoinm.php`.
...
```bash
php php/async/abstract/binancecoinm.php
```
