# Documentation: php/async/abstract/coinbaseadvanced.php

## File Metadata

- **Path**: `php/async/abstract/coinbaseadvanced.php`
- **Size**: 41,580 bytes
- **Lines**: 557
- **Type**: PHP
- **Extension**: .php
...
abstract class coinbaseadvanced extends \ccxt\async\coinbase {
...
This is a PHP file located at `php/async/abstract/coinbaseadvanced.php`.

**Classes defined**: coinbaseadvanced

**Functions defined**: v2_private_get_accounts_account_id, v2_public_get_currencies_crypto, v2_public_get_prices_symbol_sell, v2_public_get_exchange_rates, v2_public_get_prices_symbol_spot, v2_public_get_time, v2_private_get_accounts, v2_public_get_prices_symbol_buy, v2_public_get_users_user_id, v2_public_get_currencies
...
```bash
php php/async/abstract/coinbaseadvanced.php
```
