# Documentation: php/async/abstract/independentreserve.php

## File Metadata

- **Path**: `php/async/abstract/independentreserve.php`
- **Size**: 14,573 bytes
- **Lines**: 245
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/independentreserve.php`.

**Classes defined**: independentreserve

**Functions defined**: public_get_getvalidprimarycurrencycodes, public_get_getvalidlimitordertypes, public_get_getallorders, public_get_getvalidtransactiontypes, public_get_getorderbook, public_get_gettradehistorysummary, public_get_getmarketsummary, public_get_getvalidordertypes, public_get_getvalidsecondarycurrencycodes, public_get_getvalidmarketordertypes
...
```bash
php php/async/abstract/independentreserve.php
```
