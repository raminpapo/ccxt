# Documentation: php/async/abstract/kraken.php

## File Metadata

- **Path**: `php/async/abstract/kraken.php`
- **Size**: 19,419 bytes
- **Lines**: 335
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/kraken.php`.

**Classes defined**: kraken

**Functions defined**: public_get_time, public_get_ohlc, public_get_assetpairs, zendesk_get_360000292886, public_get_assets, public_get_spread, public_get_systemstatus, public_get_ticker, zendesk_get_201893608, public_get_depth
...
```bash
php php/async/abstract/kraken.php
```
