# Documentation: php/async/abstract/binance.php

## File Metadata

- **Path**: `php/async/abstract/binance.php`
- **Size**: 296,431 bytes
- **Lines**: 4,613
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/binance.php`.
...
```bash
php php/async/abstract/binance.php
```
