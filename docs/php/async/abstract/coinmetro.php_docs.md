# Documentation: php/async/abstract/coinmetro.php

## File Metadata

- **Path**: `php/async/abstract/coinmetro.php`
- **Size**: 11,791 bytes
- **Lines**: 191
- **Type**: PHP
- **Extension**: .php
...
abstract class coinmetro extends \ccxt\async\Exchange {
...
This is a PHP file located at `php/async/abstract/coinmetro.php`.

**Classes defined**: coinmetro

**Functions defined**: public_get_exchange_book_pair, private_get_users_wallets, public_get_exchange_prices, public_get_demo_temp, public_get_exchange_candles_pair_timeframe_from_to, public_get_exchange_ticks_pair_from, public_get_markets, public_get_assets, public_get_exchange_bookupdates_pair_from, private_get_users_balances
...
```bash
php php/async/abstract/coinmetro.php
```
