# Documentation: php/async/abstract/phemex.php

## File Metadata

- **Path**: `php/async/abstract/phemex.php`
- **Size**: 44,824 bytes
- **Lines**: 695
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/phemex.php`.

**Classes defined**: phemex

**Functions defined**: public_get_md_v2_kline_list, public_get_nomics_trades, public_get_md_trade, public_get_md_v2_kline, public_get_cfg_fundingrates, public_get_md_orderbook, public_get_products, public_get_cfg_v2_products, public_get_md_v2_kline_last, public_get_md_kline
...
```bash
php php/async/abstract/phemex.php
```
