# Documentation: php/async/abstract/bittrade.php

## File Metadata

- **Path**: `php/async/abstract/bittrade.php`
- **Size**: 42,348 bytes
- **Lines**: 671
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bittrade.php`.

**Classes defined**: bittrade

**Functions defined**: v2private_get_account_withdraw_quota, v2private_get_account_ledger, v2private_get_account_repayment, v2private_get_account_asset_valuation, v2public_get_reference_currencies, v2private_get_point_account, v2private_get_account_deposit_address, v2private_get_account_withdraw_address, v2private_get_reference_transact_fee_rate, v2public_get_market_status
...
- `market_get_depth()`
- `market_get_detail()`
- `market_get_detail_merged()`
- `market_get_etp()`
- `market_get_history_kline()`
- `market_get_history_trade()`
- `market_get_tickers()`
- `market_get_trade()`
...
```bash
php php/async/abstract/bittrade.php
```
