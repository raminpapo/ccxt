# Documentation: php/async/abstract/poloniex.php

## File Metadata

- **Path**: `php/async/abstract/poloniex.php`
- **Size**: 39,566 bytes
- **Lines**: 617
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/poloniex.php`.

**Classes defined**: poloniex

**Functions defined**: public_get_currencies_currency, public_get_markets_symbol_price, public_get_timestamp, public_get_markets_price, public_get_markets, public_get_markets_symbol, public_get_v2_currencies, public_get_currencies, public_get_v2_currencies_currency, public_get_markets_markprice
...
```bash
php php/async/abstract/poloniex.php
```
