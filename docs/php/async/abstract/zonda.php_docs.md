# Documentation: php/async/abstract/zonda.php

## File Metadata

- **Path**: `php/async/abstract/zonda.php`
- **Size**: 19,572 bytes
- **Lines**: 305
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/zonda.php`.

**Classes defined**: zonda

**Functions defined**: private_post_info, private_post_orderbook, private_post_orders, private_post_cancel, public_get_id_trades, public_get_id_ticker, public_get_id_orderbook, public_get_id_all, public_get_id_market, private_post_trade
...
- `private_post_info()`
- `private_post_orderbook()`
- `private_post_orders()`
- `private_post_trade()`
- `private_post_transactions()`
- `private_post_transfer()`
...
```bash
php php/async/abstract/zonda.php
```
