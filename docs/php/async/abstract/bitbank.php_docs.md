# Documentation: php/async/abstract/bitbank.php

## File Metadata

- **Path**: `php/async/abstract/bitbank.php`
- **Size**: 10,304 bytes
- **Lines**: 179
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/async/abstract/bitbank.php`.

**Classes defined**: bitbank

**Functions defined**: private_get_user_spot_order, public_get_pair_depth, public_get_pair_transactions_yyyymmdd, public_get_pair_ticker, public_get_pair_circuit_break_info, public_get_tickers, public_get_pair_transactions, public_get_pair_candlestick_candletype_yyyymmdd, private_get_user_assets, public_get_tickers_jpy
...
```bash
php php/async/abstract/bitbank.php
```
