# Documentation: php/async/abstract/foxbit.php

## File Metadata

- **Path**: `php/async/abstract/foxbit.php`
- **Size**: 9,012 bytes
- **Lines**: 143
- **Type**: PHP
- **Extension**: .php
...
abstract class foxbit extends \ccxt\async\Exchange {
...
This is a PHP file located at `php/async/abstract/foxbit.php`.
...
```bash
php php/async/abstract/foxbit.php
```
