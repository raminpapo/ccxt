# Documentation: php/async/abstract/hibachi.php

## File Metadata

- **Path**: `php/async/abstract/hibachi.php`
- **Size**: 8,476 bytes
- **Lines**: 143
- **Type**: PHP
- **Extension**: .php
...
abstract class hibachi extends \ccxt\async\Exchange {
...
This is a PHP file located at `php/async/abstract/hibachi.php`.
...
```bash
php php/async/abstract/hibachi.php
```
