# Documentation: php/Precise.php

## File Metadata

- **Path**: `php/Precise.php`
- **Size**: 9,723 bytes
- **Lines**: 296
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/Precise.php`.

**Classes defined**: Precise

**Functions defined**: or, sub, mul, div, add, mod, __construct, abs, gmp_pow, neg
