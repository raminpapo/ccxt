# Documentation: php/static_dependencies/proxies/reactphp-http-proxy/src/ProxyConnector.php

## File Metadata

- **Path**: `php/static_dependencies/proxies/reactphp-http-proxy/src/ProxyConnector.php`
- **Size**: 12,143 bytes
- **Lines**: 287
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/proxies/reactphp-http-proxy/src/ProxyConnector.php`.

**Classes defined**: ProxyConnector

**Functions defined**: connect, __construct
...
- `/ringcentral-psr7/loader.php` (referenced)
...
```bash
php php/static_dependencies/proxies/reactphp-http-proxy/src/ProxyConnector.php
```
