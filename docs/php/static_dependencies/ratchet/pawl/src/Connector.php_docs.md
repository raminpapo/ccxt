# Documentation: php/static_dependencies/ratchet/pawl/src/Connector.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/pawl/src/Connector.php`
- **Size**: 5,584 bytes
- **Lines**: 157
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/pawl/src/Connector.php`.

**Classes defined**: Connector

**Functions defined**: generateRequest, __invoke, __construct
...
```bash
php php/static_dependencies/ratchet/pawl/src/Connector.php
```
