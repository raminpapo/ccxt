# Documentation: php/static_dependencies/ratchet/pawl/src/WebSocket.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/pawl/src/WebSocket.php`
- **Size**: 5,260 bytes
- **Lines**: 170
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/pawl/src/WebSocket.php`.

**Classes defined**: WebSocket

**Functions defined**: send, resume, __construct, pause, close
...
```bash
php php/static_dependencies/ratchet/pawl/src/WebSocket.php
```
