# Documentation: php/static_dependencies/ratchet/rfc6455/src/Handshake/ServerNegotiator.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/rfc6455/src/Handshake/ServerNegotiator.php`
- **Size**: 6,142 bytes
- **Lines**: 163
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/rfc6455/src/Handshake/ServerNegotiator.php`.

**Classes defined**: ServerNegotiator

**Functions defined**: isProtocol, handshake, getVersionNumber, setSupportedSubProtocols, sign, __construct, setStrictSubProtocolCheck
...
```bash
php php/static_dependencies/ratchet/rfc6455/src/Handshake/ServerNegotiator.php
```
