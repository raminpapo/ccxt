# Documentation: php/static_dependencies/ratchet/rfc6455/src/Handshake/RequestVerifier.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/rfc6455/src/Handshake/RequestVerifier.php`
- **Size**: 5,451 bytes
- **Lines**: 164
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/rfc6455/src/Handshake/RequestVerifier.php`.

**Classes defined**: RequestVerifier

**Functions defined**: verifyConnection, verifyAll, verifyHTTPVersion, verifyHost, verifyMethod, verifyUpgradeRequest, verifyRequestURI, verifies, verifyKey, verifyVersion
...
```bash
php php/static_dependencies/ratchet/rfc6455/src/Handshake/RequestVerifier.php
```
