# Documentation: php/static_dependencies/ratchet/rfc6455/src/Messaging/MessageBuffer.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/rfc6455/src/Messaging/MessageBuffer.php`
- **Size**: 19,396 bytes
- **Lines**: 585
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/rfc6455/src/Messaging/MessageBuffer.php`.

**Classes defined**: MessageBuffer

**Functions defined**: sendFrame, processData, newCloseFrame, newMessage, checkMessage, onData, __construct, checkUtf8, frameCheck, newFrame
...
```bash
php php/static_dependencies/ratchet/rfc6455/src/Messaging/MessageBuffer.php
```
