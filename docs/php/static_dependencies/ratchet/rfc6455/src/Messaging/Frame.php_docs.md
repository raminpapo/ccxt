# Documentation: php/static_dependencies/ratchet/rfc6455/src/Messaging/Frame.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/rfc6455/src/Messaging/Frame.php`
- **Size**: 13,966 bytes
- **Lines**: 482
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/rfc6455/src/Messaging/Frame.php`.

**Classes defined**: Frame

**Functions defined**: setRsv1, getRsv3, isFinal, getRsv2, getMaskingKey, getRsv1, isMasked, __construct, isCoalesced, addBuffer
...
```bash
php php/static_dependencies/ratchet/rfc6455/src/Messaging/Frame.php
```
