# Documentation: php/static_dependencies/ratchet/rfc6455/tests/ab/clientRunner.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/rfc6455/tests/ab/clientRunner.php`
- **Size**: 9,425 bytes
- **Lines**: 269
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/rfc6455/tests/ab/clientRunner.php`.

**Functions defined**: runTest, echoStreamerFactory, createReport, getTestCases
