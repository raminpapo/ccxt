# Documentation: php/static_dependencies/ratchet/rfc6455/tests/unit/Messaging/FrameTest.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/rfc6455/tests/unit/Messaging/FrameTest.php`
- **Size**: 18,978 bytes
- **Lines**: 505
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/rfc6455/tests/unit/Messaging/FrameTest.php`.

**Classes defined**: FrameTest

**Functions defined**: testUnderflowExceptionFromAllTheMethodsMimickingBuffering, firstByteProvider, encode, testFinCodeFromFullMessage, setUp, testGetRsvFromBits, testOpcodeFromBits, underflowProvider, testFinCodeFromBits, UnframeMessageProvider
