# Documentation: php/static_dependencies/ratchet/rfc6455/tests/unit/Handshake/ServerNegotiatorTest.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/rfc6455/tests/unit/Handshake/ServerNegotiatorTest.php`
- **Size**: 8,424 bytes
- **Lines**: 220
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/rfc6455/tests/unit/Handshake/ServerNegotiatorTest.php`.

**Classes defined**: ServerNegotiatorTest

**Functions defined**: testInvalidSecWebsocketKey, testNoConnectionUpgradeRequested, testNoUpgradeRequested, testSuggestsAppropriateSubprotocol, testInvalidSecWebsocketVersion, testNonStrictSubprotocolDoesNotIncludeHeaderWhenNoneAgreedOn, testBadSubprotocolResponse
