# Documentation: php/static_dependencies/ratchet/rfc6455/tests/unit/Handshake/RequestVerifierTest.php

## File Metadata

- **Path**: `php/static_dependencies/ratchet/rfc6455/tests/unit/Handshake/RequestVerifierTest.php`
- **Size**: 5,337 bytes
- **Lines**: 180
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ratchet/rfc6455/tests/unit/Handshake/RequestVerifierTest.php`.

**Classes defined**: RequestVerifierTest

**Functions defined**: uRIProvider, testMethodMustBeGet, upgradeProvider, testRequestUri, hostProvider, setUp, httpVersionProvider, methodProvider, testVerifyHostIsSet, testHttpVersionIsAtLeast1Point1
