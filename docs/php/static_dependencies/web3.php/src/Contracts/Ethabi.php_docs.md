# Documentation: php/static_dependencies/web3.php/src/Contracts/Ethabi.php

## File Metadata

- **Path**: `php/static_dependencies/web3.php/src/Contracts/Ethabi.php`
- **Size**: 13,277 bytes
- **Lines**: 490
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/web3.php/src/Contracts/Ethabi.php`.

**Classes defined**: Ethabi

**Functions defined**: __set, parseTupleType, isDynamicArray, __callStatic, nestedName, isStaticArray, __construct, __get, nestedTypes, isTuple
...
```bash
php php/static_dependencies/web3.php/src/Contracts/Ethabi.php
```
