# Documentation: php/static_dependencies/web3.php/src/Contracts/TypedDataEncoder.php

## File Metadata

- **Path**: `php/static_dependencies/web3.php/src/Contracts/TypedDataEncoder.php`
- **Size**: 11,959 bytes
- **Lines**: 395
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/web3.php/src/Contracts/TypedDataEncoder.php`.

**Classes defined**: TypedDataEncoder

**Functions defined**: __set, encodeType, parseArrayType, parseParentArrayType, encodeField, __construct, __get, getEthabi, findType, strEndsWith
...
```bash
php php/static_dependencies/web3.php/src/Contracts/TypedDataEncoder.php
```
