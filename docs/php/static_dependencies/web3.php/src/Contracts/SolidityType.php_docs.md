# Documentation: php/static_dependencies/web3.php/src/Contracts/SolidityType.php

## File Metadata

- **Path**: `php/static_dependencies/web3.php/src/Contracts/SolidityType.php`
- **Size**: 5,203 bytes
- **Lines**: 242
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/web3.php/src/Contracts/SolidityType.php`.

**Classes defined**: SolidityType

**Functions defined**: __set, isDynamicArray, __callStatic, nestedName, isStaticArray, staticArrayLength, __construct, __get, nestedTypes, staticPartLength
...
```bash
php php/static_dependencies/web3.php/src/Contracts/SolidityType.php
```
