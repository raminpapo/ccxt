# Documentation: php/static_dependencies/web3.php/src/Contracts/Types/Integer.php

## File Metadata

- **Path**: `php/static_dependencies/web3.php/src/Contracts/Types/Integer.php`
- **Size**: 1,369 bytes
- **Lines**: 76
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/web3.php/src/Contracts/Types/Integer.php`.
...
```bash
php php/static_dependencies/web3.php/src/Contracts/Types/Integer.php
```
