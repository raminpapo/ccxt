# Documentation: php/static_dependencies/web3.php/src/Contracts/Types/Tuple.php

## File Metadata

- **Path**: `php/static_dependencies/web3.php/src/Contracts/Types/Tuple.php`
- **Size**: 3,381 bytes
- **Lines**: 130
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/web3.php/src/Contracts/Types/Tuple.php`.

**Classes defined**: Tuple
...
```bash
php php/static_dependencies/web3.php/src/Contracts/Types/Tuple.php
```
