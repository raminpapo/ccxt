# Documentation: php/static_dependencies/web3.php/src/Utils.php

## File Metadata

- **Path**: `php/static_dependencies/web3.php/src/Utils.php`
- **Size**: 16,708 bytes
- **Lines**: 565
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/web3.php/src/Utils.php`.

**Classes defined**: Utils

**Functions defined**: stripZero, isNegative, must, is, isZeroPrefixed, __construct, toHex, hexToBin
...
```bash
php php/static_dependencies/web3.php/src/Utils.php
```
