# Documentation: php/static_dependencies/MessagePack/Packer.php

## File Metadata

- **Path**: `php/static_dependencies/MessagePack/Packer.php`
- **Size**: 9,720 bytes
- **Lines**: 393
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/MessagePack/Packer.php`.

**Classes defined**: Packer

**Functions defined**: packInt, packNil, pack, packBool, packFloat32, packFloat64, packStr, extendWith, __construct, packFloat
...
```bash
php php/static_dependencies/MessagePack/Packer.php
```
