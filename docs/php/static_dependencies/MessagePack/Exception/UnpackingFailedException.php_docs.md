# Documentation: php/static_dependencies/MessagePack/Exception/UnpackingFailedException.php

## File Metadata

- **Path**: `php/static_dependencies/MessagePack/Exception/UnpackingFailedException.php`
- **Size**: 1,768 bytes
- **Lines**: 62
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/MessagePack/Exception/UnpackingFailedException.php`.

**Classes defined**: UnpackingFailedException

**Functions defined**: unknownCode, unexpectedCode, invalidMapKeyType
...
```bash
php php/static_dependencies/MessagePack/Exception/UnpackingFailedException.php
```
