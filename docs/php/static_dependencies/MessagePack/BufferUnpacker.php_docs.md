# Documentation: php/static_dependencies/MessagePack/BufferUnpacker.php

## File Metadata

- **Path**: `php/static_dependencies/MessagePack/BufferUnpacker.php`
- **Size**: 22,278 bytes
- **Lines**: 833
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/MessagePack/BufferUnpacker.php`.

**Classes defined**: BufferUnpacker

**Functions defined**: seek, reset, withBuffer, hasRemaining, getRemainingCount, extendWith, __construct, append, release, skip
...
```bash
php php/static_dependencies/MessagePack/BufferUnpacker.php
```
