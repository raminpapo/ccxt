# Documentation: php/static_dependencies/MessagePack/PackOptions.php

## File Metadata

- **Path**: `php/static_dependencies/MessagePack/PackOptions.php`
- **Size**: 3,690 bytes
- **Lines**: 135
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/MessagePack/PackOptions.php`.

**Classes defined**: PackOptions

**Functions defined**: isForceBinMode, fromBitmask, isForceMapMode, isDetectArrMapMode, isForceArrMode, isForceFloat32Mode, isForceStrMode, isDetectStrBinMode, __construct, fromDefaults
...
```bash
php php/static_dependencies/MessagePack/PackOptions.php
```
