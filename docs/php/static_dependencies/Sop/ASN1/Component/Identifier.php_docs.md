# Documentation: php/static_dependencies/Sop/ASN1/Component/Identifier.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Component/Identifier.php`
- **Size**: 6,987 bytes
- **Lines**: 291
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Component/Identifier.php`.

**Classes defined**: Identifier, to, enumerations, One, Type, of

**Functions defined**: typeClass, toDER, tag, isUniversal, isApplication, __construct, fromDER, isContextSpecific, intTag, pc
...
```bash
php php/static_dependencies/Sop/ASN1/Component/Identifier.php
```
