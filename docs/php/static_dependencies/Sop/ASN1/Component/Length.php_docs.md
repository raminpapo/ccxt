# Documentation: php/static_dependencies/Sop/ASN1/Component/Length.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Component/Length.php`
- **Size**: 6,542 bytes
- **Lines**: 226
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Component/Length.php`.

**Classes defined**: Length

**Functions defined**: isIndefinite, _decodeLongFormLength, toDER, __construct, fromDER, intLength, expectFromDER, length
...
```bash
php php/static_dependencies/Sop/ASN1/Component/Length.php
```
