# Documentation: php/static_dependencies/Sop/ASN1/Type/Tagged/DERTaggedType.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Type/Tagged/DERTaggedType.php`
- **Size**: 4,144 bytes
- **Lines**: 157
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Type/Tagged/DERTaggedType.php`.

**Classes defined**: DERTaggedType, to

**Functions defined**: _encodedContentDER, typeClass, implicit, isConstructed, __construct, _decodeFromDER, explicit
...
```bash
php php/static_dependencies/Sop/ASN1/Type/Tagged/DERTaggedType.php
```
