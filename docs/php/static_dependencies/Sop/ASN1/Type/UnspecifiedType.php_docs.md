# Documentation: php/static_dependencies/Sop/ASN1/Type/UnspecifiedType.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Type/UnspecifiedType.php`
- **Size**: 20,051 bytes
- **Lines**: 675
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Type/UnspecifiedType.php`.

**Classes defined**: UnspecifiedType, to

**Functions defined**: asBitString, asBoolean, asPrivate, __construct, asApplication, fromDER, asOctetString, fromElementBase, asInteger, asTagged
...
```bash
php php/static_dependencies/Sop/ASN1/Type/UnspecifiedType.php
```
