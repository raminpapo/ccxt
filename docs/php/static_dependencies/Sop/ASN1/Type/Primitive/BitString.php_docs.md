# Documentation: php/static_dependencies/Sop/ASN1/Type/Primitive/BitString.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Type/Primitive/BitString.php`
- **Size**: 5,612 bytes
- **Lines**: 202
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Type/Primitive/BitString.php`.

**Classes defined**: BitString

**Functions defined**: _encodedContentDER, numBits, range, withoutTrailingZeroes, testBit, unusedBits, _decodeFromDER, __construct
...
```bash
php php/static_dependencies/Sop/ASN1/Type/Primitive/BitString.php
```
