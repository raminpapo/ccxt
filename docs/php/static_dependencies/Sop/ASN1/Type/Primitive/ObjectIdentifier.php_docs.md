# Documentation: php/static_dependencies/Sop/ASN1/Type/Primitive/ObjectIdentifier.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Type/Primitive/ObjectIdentifier.php`
- **Size**: 5,780 bytes
- **Lines**: 208
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Type/Primitive/ObjectIdentifier.php`.

**Classes defined**: ObjectIdentifier

**Functions defined**: _encodedContentDER, _decodeSubIDs, oid, _encodeSubIDs, _explodeDottedOID, _decodeFromDER, __construct, _implodeSubIDs
...
```bash
php php/static_dependencies/Sop/ASN1/Type/Primitive/ObjectIdentifier.php
```
