# Documentation: php/static_dependencies/Sop/ASN1/Type/Primitive/Real.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Type/Primitive/Real.php`
- **Size**: 19,703 bytes
- **Lines**: 699
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Type/Primitive/Real.php`.

**Classes defined**: Real

**Functions defined**: exponent, nr3Val, fromString, mantissa, __toString, withStrictDER, __construct, base, floatVal, fromFloat
...
```bash
php php/static_dependencies/Sop/ASN1/Type/Primitive/Real.php
```
