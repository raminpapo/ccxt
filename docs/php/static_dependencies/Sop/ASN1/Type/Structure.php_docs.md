# Documentation: php/static_dependencies/Sop/ASN1/Type/Structure.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Type/Structure.php`
- **Size**: 10,521 bytes
- **Lines**: 385
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Type/Structure.php`.

**Classes defined**: Structure, for

**Functions defined**: __clone, withReplaced, withoutElement, elements, withAppended, explodeDER, isConstructed, __construct, withInserted, withPrepended
...
```bash
php php/static_dependencies/Sop/ASN1/Type/Structure.php
```
