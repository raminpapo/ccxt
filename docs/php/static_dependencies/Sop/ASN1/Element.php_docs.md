# Documentation: php/static_dependencies/Sop/ASN1/Element.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Element.php`
- **Size**: 14,971 bytes
- **Lines**: 466
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Element.php`.

**Classes defined**: if, Element, for, name, that

**Functions defined**: isType, isTagged, typeClass, toDER, expectType, tag, expectTagged, isConstructed, fromDER, hasIndefiniteLength
...
```bash
php php/static_dependencies/Sop/ASN1/Element.php
```
