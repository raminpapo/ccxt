# Documentation: php/static_dependencies/Sop/ASN1/Util/BigInt.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Util/BigInt.php`
- **Size**: 5,500 bytes
- **Lines**: 219
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Util/BigInt.php`.

**Classes defined**: BigInt

**Functions defined**: base10, signedOctets, fromSignedOctets, _signedPositiveOctets, __toString, intVal, __construct, unsignedOctets, gmpObj, fromUnsignedOctets
...
```bash
php php/static_dependencies/Sop/ASN1/Util/BigInt.php
```
