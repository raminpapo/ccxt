# Documentation: php/static_dependencies/Sop/ASN1/Util/Flags.php

## File Metadata

- **Path**: `php/static_dependencies/Sop/ASN1/Util/Flags.php`
- **Size**: 3,872 bytes
- **Lines**: 145
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/Sop/ASN1/Util/Flags.php`.

**Classes defined**: Flags

**Functions defined**: intNumber, number, fromBitString, string, test, __construct, bitString
...
```bash
php php/static_dependencies/Sop/ASN1/Util/Flags.php
```
