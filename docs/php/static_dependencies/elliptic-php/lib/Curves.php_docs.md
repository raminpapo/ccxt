# Documentation: php/static_dependencies/elliptic-php/lib/Curves.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/Curves.php`
- **Size**: 44,535 bytes
- **Lines**: 976
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/Curves.php`.

**Classes defined**: Curves

**Functions defined**: hasCurve, getCurve, defineCurve
...
```bash
php php/static_dependencies/elliptic-php/lib/Curves.php
```
