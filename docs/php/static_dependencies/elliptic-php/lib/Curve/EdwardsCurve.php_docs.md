# Documentation: php/static_dependencies/elliptic-php/lib/Curve/EdwardsCurve.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/Curve/EdwardsCurve.php`
- **Size**: 3,720 bytes
- **Lines**: 131
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/Curve/EdwardsCurve.php`.

**Classes defined**: EdwardsCurve

**Functions defined**: pointFromY, pointFromX, pointFromJSON, point, __construct, _mulA, _mulC, validate, jpoint
...
```bash
php php/static_dependencies/elliptic-php/lib/Curve/EdwardsCurve.php
```
