# Documentation: php/static_dependencies/elliptic-php/lib/Curve/BaseCurve.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/Curve/BaseCurve.php`
- **Size**: 9,435 bytes
- **Lines**: 322
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/Curve/BaseCurve.php`.

**Classes defined**: BaseCurve

**Functions defined**: _wnafMulAdd, _wnafMul, point, __construct, validate, decodePoint, _fixedNafMul
...
```bash
php php/static_dependencies/elliptic-php/lib/Curve/BaseCurve.php
```
