# Documentation: php/static_dependencies/elliptic-php/lib/Curve/ShortCurve/JPoint.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/Curve/ShortCurve/JPoint.php`
- **Size**: 14,101 bytes
- **Lines**: 489
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/Curve/ShortCurve/JPoint.php`.

**Classes defined**: JPoint

**Functions defined**: _threeDbl, _zOneDbl, toP, dblp, add, mixedAdd, dbl, _zeroDbl, __construct, neg
...
```bash
php php/static_dependencies/elliptic-php/lib/Curve/ShortCurve/JPoint.php
```
