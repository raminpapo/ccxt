# Documentation: php/static_dependencies/elliptic-php/lib/Curve/ShortCurve/Point.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/Curve/ShortCurve/Point.php`
- **Size**: 8,811 bytes
- **Lines**: 318
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/Curve/ShortCurve/Point.php`.

**Classes defined**: Point

**Functions defined**: inspect, isInfinity, jsonSerialize, add, dbl, __construct, _getBeta, fromJSON, __debugInfo, getX
...
```bash
php php/static_dependencies/elliptic-php/lib/Curve/ShortCurve/Point.php
```
