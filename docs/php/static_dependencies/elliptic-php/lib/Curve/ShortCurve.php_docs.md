# Documentation: php/static_dependencies/elliptic-php/lib/Curve/ShortCurve.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/Curve/ShortCurve.php`
- **Size**: 8,179 bytes
- **Lines**: 305
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/Curve/ShortCurve.php`.

**Classes defined**: ShortCurve

**Functions defined**: _getEndoRoots, pointFromX, pointFromJSON, _getEndoBasis, point, _endoWnafMulAdd, __construct, validate, _getEndomorphism, _endoSplit
...
```bash
php php/static_dependencies/elliptic-php/lib/Curve/ShortCurve.php
```
