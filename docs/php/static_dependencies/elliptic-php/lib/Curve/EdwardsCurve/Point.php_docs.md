# Documentation: php/static_dependencies/elliptic-php/lib/Curve/EdwardsCurve/Point.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/Curve/EdwardsCurve/Point.php`
- **Size**: 10,128 bytes
- **Lines**: 324
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/Curve/EdwardsCurve/Point.php`.

**Classes defined**: Point

**Functions defined**: inspect, isInfinity, _extDbl, _extAdd, dbl, add, __construct, fromJSON, _projAdd, _projDbl
...
```bash
php php/static_dependencies/elliptic-php/lib/Curve/EdwardsCurve/Point.php
```
