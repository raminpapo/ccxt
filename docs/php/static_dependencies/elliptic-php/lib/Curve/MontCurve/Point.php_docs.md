# Documentation: php/static_dependencies/elliptic-php/lib/Curve/MontCurve/Point.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/Curve/MontCurve/Point.php`
- **Size**: 4,259 bytes
- **Lines**: 161
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/Curve/MontCurve/Point.php`.

**Classes defined**: Point

**Functions defined**: diffAdd, inspect, isInfinity, mul, dbl, add, precompute, fromJSON, __construct, _encode
...
```bash
php php/static_dependencies/elliptic-php/lib/Curve/MontCurve/Point.php
```
