# Documentation: php/static_dependencies/elliptic-php/lib/EC/Signature.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/EC/Signature.php`
- **Size**: 3,864 bytes
- **Lines**: 156
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/EC/Signature.php`.

**Classes defined**: Signature

**Functions defined**: toDER, _importDER, __construct, constructLength, getLength, rmPadding
...
```bash
php php/static_dependencies/elliptic-php/lib/EC/Signature.php
```
