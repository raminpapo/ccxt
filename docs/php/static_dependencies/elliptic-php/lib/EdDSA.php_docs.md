# Documentation: php/static_dependencies/elliptic-php/lib/EdDSA.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/EdDSA.php`
- **Size**: 4,948 bytes
- **Lines**: 147
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/EdDSA.php`.

**Classes defined**: EdDSA

**Functions defined**: makeSignature, keyFromSecret, verify, sign, __construct, keyFromPublic, decodePoint, signModified, encodePoint, hashInt
...
```bash
php php/static_dependencies/elliptic-php/lib/EdDSA.php
```
