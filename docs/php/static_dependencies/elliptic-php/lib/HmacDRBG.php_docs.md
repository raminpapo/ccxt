# Documentation: php/static_dependencies/elliptic-php/lib/HmacDRBG.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/HmacDRBG.php`
- **Size**: 3,844 bytes
- **Lines**: 136
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/HmacDRBG.php`.

**Classes defined**: HmacDRBG

**Functions defined**: _update, generate, _hmac, __construct, _init
...
```bash
php php/static_dependencies/elliptic-php/lib/HmacDRBG.php
```
