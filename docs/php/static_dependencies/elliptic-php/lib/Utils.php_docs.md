# Documentation: php/static_dependencies/elliptic-php/lib/Utils.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/Utils.php`
- **Size**: 4,104 bytes
- **Lines**: 167
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/Utils.php`.

**Classes defined**: Utils

**Functions defined**: toArray, parseBytes, optionAssert, encode, intFromLE, toBin, getJSF, randBytes, getNAF, toHex
...
```bash
php php/static_dependencies/elliptic-php/lib/Utils.php
```
