# Documentation: php/static_dependencies/elliptic-php/lib/EC.php

## File Metadata

- **Path**: `php/static_dependencies/elliptic-php/lib/EC.php`
- **Size**: 8,231 bytes
- **Lines**: 279
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/elliptic-php/lib/EC.php`.

**Classes defined**: EC

**Functions defined**: keyFromPrivate, for, verify, sign, genKeyPair, __construct, keyFromPublic, _truncateToN, recoverPubKey, keyPair
...
```bash
php php/static_dependencies/elliptic-php/lib/EC.php
```
