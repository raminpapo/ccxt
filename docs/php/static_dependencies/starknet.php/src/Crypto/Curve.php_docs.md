# Documentation: php/static_dependencies/starknet.php/src/Crypto/Curve.php

## File Metadata

- **Path**: `php/static_dependencies/starknet.php/src/Crypto/Curve.php`
- **Size**: 3,413 bytes
- **Lines**: 111
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/starknet.php/src/Crypto/Curve.php`.

**Classes defined**: Curve

**Functions defined**: sign, constantPoints, fixHex, constantPointsPedersen, ec
...
```bash
php php/static_dependencies/starknet.php/src/Crypto/Curve.php
```
