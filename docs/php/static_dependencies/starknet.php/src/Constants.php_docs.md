# Documentation: php/static_dependencies/starknet.php/src/Constants.php

## File Metadata

- **Path**: `php/static_dependencies/starknet.php/src/Constants.php`
- **Size**: 89,720 bytes
- **Lines**: 2,077
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/starknet.php/src/Constants.php`.

**Classes defined**: Constants

**Functions defined**: MASK_250, ZERO, TWO, ONE, MASK_256
...
```bash
php php/static_dependencies/starknet.php/src/Constants.php
```
