# Documentation: php/static_dependencies/starknet.php/src/Utils.php

## File Metadata

- **Path**: `php/static_dependencies/starknet.php/src/Utils.php`
- **Size**: 7,793 bytes
- **Lines**: 296
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/starknet.php/src/Utils.php`.

**Classes defined**: Utils

**Functions defined**: stripZeroPrefix, must, removeLeadingZero, is, isZeroPrefixed, __construct, toHex, hexToBin
...
```bash
php php/static_dependencies/starknet.php/src/Utils.php
```
