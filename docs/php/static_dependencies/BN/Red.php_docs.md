# Documentation: php/static_dependencies/BN/Red.php

## File Metadata

- **Path**: `php/static_dependencies/BN/Red.php`
- **Size**: 5,636 bytes
- **Lines**: 220
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/BN/Red.php`.

**Classes defined**: Red

**Functions defined**: verify2, sub, iadd, isub, verify1, neg, add, __construct, primeByName, imod
...
```bash
php php/static_dependencies/BN/Red.php
```
