# Documentation: php/static_dependencies/BN/BN.php

## File Metadata

- **Path**: `php/static_dependencies/BN/BN.php`
- **Size**: 20,374 bytes
- **Lines**: 767
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/BN/BN.php`.

**Classes defined**: BN

**Functions defined**: _clone, min, toNumber, copy, toString, jsonSerialize, max, __construct, negative, isBN
...
```bash
php php/static_dependencies/BN/BN.php
```
