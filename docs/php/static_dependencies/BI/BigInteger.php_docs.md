# Documentation: php/static_dependencies/BI/BigInteger.php

## File Metadata

- **Path**: `php/static_dependencies/BI/BigInteger.php`
- **Size**: 19,196 bytes
- **Lines**: 644
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/BI/BigInteger.php`.

**Classes defined**: BigInteger

**Functions defined**: getGmp, toString, toBase, isGmp, toBytes, __construct, createSafe, toBits, toHex, toDec
...
```bash
php php/static_dependencies/BI/BigInteger.php
```
