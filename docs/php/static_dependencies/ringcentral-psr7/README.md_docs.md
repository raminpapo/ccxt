# Documentation: php/static_dependencies/ringcentral-psr7/README.md

## File Metadata

- **Path**: `php/static_dependencies/ringcentral-psr7/README.md`
- **Size**: 15,534 bytes
- **Lines**: 588
- **Type**: Markdown
- **Extension**: .md
...
This is a Markdown file located at `php/static_dependencies/ringcentral-psr7/README.md`.

**Classes defined**: has, EofCallbackStream, for, if

**Functions defined**: uri_for, accepts, each, stream_for, __construct, read, of, str
...
- `http://www.google.com` (referenced)
- `/tmp/test.txt` (referenced)
