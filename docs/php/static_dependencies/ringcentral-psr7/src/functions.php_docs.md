# Documentation: php/static_dependencies/ringcentral-psr7/src/functions.php

## File Metadata

- **Path**: `php/static_dependencies/ringcentral-psr7/src/functions.php`
- **Size**: 24,419 bytes
- **Lines**: 836
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/ringcentral-psr7/src/functions.php`.

**Functions defined**: uri_for, parse_header, modify_request, rewind_body, accepts, adds, normalize_header, stream_for, will, str
...
```bash
php php/static_dependencies/ringcentral-psr7/src/functions.php
```
