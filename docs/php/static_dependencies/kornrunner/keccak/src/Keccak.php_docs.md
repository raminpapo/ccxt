# Documentation: php/static_dependencies/kornrunner/keccak/src/Keccak.php

## File Metadata

- **Path**: `php/static_dependencies/kornrunner/keccak/src/Keccak.php`
- **Size**: 12,017 bytes
- **Lines**: 315
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/static_dependencies/kornrunner/keccak/src/Keccak.php`.

**Classes defined**: Keccak

**Functions defined**: hash, keccakf32, shake, keccakf64, keccak32, mb_substr, mb_strlen, keccak64, keccak
...
```bash
php php/static_dependencies/kornrunner/keccak/src/Keccak.php
```
