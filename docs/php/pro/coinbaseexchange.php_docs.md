# Documentation: php/pro/coinbaseexchange.php

## File Metadata

- **Path**: `php/pro/coinbaseexchange.php`
- **Size**: 45,443 bytes
- **Lines**: 997
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/coinbaseexchange.php`.
...
```bash
php php/pro/coinbaseexchange.php
```
