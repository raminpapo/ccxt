# Documentation: php/pro/OrderBookSide.php

## File Metadata

- **Path**: `php/pro/OrderBookSide.php`
- **Size**: 8,360 bytes
- **Lines**: 237
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/OrderBookSide.php`.
...
**Functions defined**: store_array, JsonSerialize, limit, storeArray, store, count, __construct, bisectLeft, offsetExists, offsetGet
