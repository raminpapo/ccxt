# Documentation: php/pro/krakenfutures.php

## File Metadata

- **Path**: `php/pro/krakenfutures.php`
- **Size**: 73,388 bytes
- **Lines**: 1,648
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/krakenfutures.php`.
