# Documentation: php/pro/test/base/test_order_book.php

## File Metadata

- **Path**: `php/pro/test/base/test_order_book.php`
- **Size**: 17,758 bytes
- **Lines**: 333
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/test/base/test_order_book.php`.

**Functions defined**: test_ws_order_book
