# Documentation: php/pro/test/base/test_close.php

## File Metadata

- **Path**: `php/pro/test/base/test_close.php`
- **Size**: 2,613 bytes
- **Lines**: 94
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/test/base/test_close.php`.

**Functions defined**: close_after, watch_ticker_loop, watch_order_book_for_symbols_loop
...
**Functions** (3):
- `close_after()`
- `watch_order_book_for_symbols_loop()`
- `watch_ticker_loop()`
