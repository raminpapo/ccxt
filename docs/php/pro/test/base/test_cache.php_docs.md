# Documentation: php/pro/test/base/test_cache.php

## File Metadata

- **Path**: `php/pro/test/base/test_cache.php`
- **Size**: 19,947 bytes
- **Lines**: 615
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/test/base/test_cache.php`.

**Functions defined**: test_ws_cache
