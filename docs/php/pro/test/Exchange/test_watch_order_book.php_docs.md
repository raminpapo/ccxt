# Documentation: php/pro/test/Exchange/test_watch_order_book.php

## File Metadata

- **Path**: `php/pro/test/Exchange/test_watch_order_book.php`
- **Size**: 1,740 bytes
- **Lines**: 43
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/test/Exchange/test_watch_order_book.php`.

**Functions defined**: test_watch_order_book
