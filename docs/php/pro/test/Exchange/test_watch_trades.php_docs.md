# Documentation: php/pro/test/Exchange/test_watch_trades.php

## File Metadata

- **Path**: `php/pro/test/Exchange/test_watch_trades.php`
- **Size**: 1,836 bytes
- **Lines**: 46
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/test/Exchange/test_watch_trades.php`.
