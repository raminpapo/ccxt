# Documentation: php/pro/ClientTrait.php

## File Metadata

- **Path**: `php/pro/ClientTrait.php`
- **Size**: 11,298 bytes
- **Lines**: 274
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/ClientTrait.php`.

**Functions defined**: indexed_order_book, client, gunzip, inflate, delay, counted_order_book, order_book, inflate64, spawn, configure_proxy_client
