# Documentation: php/pro/Client.php

## File Metadata

- **Path**: `php/pro/Client.php`
- **Size**: 13,190 bytes
- **Lines**: 372
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/Client.php`.

**Classes defined**: Client, NoOriginHeaderConnector

**Functions defined**: reusable_future, future, connect, set_ws_connector, generateRequest, create_connection, reusableFuture, resolve, __construct, reject
