# Documentation: php/pro/ndax.php

## File Metadata

- **Path**: `php/pro/ndax.php`
- **Size**: 26,447 bytes
- **Lines**: 562
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/ndax.php`.

**Classes defined**: ndax

**Functions defined**: watch_ticker, describe, handle_trades, request_id, watch_trades, being, watch_ohlcv, handle_ticker
