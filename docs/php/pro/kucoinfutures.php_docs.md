# Documentation: php/pro/kucoinfutures.php

## File Metadata

- **Path**: `php/pro/kucoinfutures.php`
- **Size**: 66,928 bytes
- **Lines**: 1,380
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/pro/kucoinfutures.php`.
