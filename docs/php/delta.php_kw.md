# Keywords: php/delta.php

## Extracted Keywords

This file contains 109 keywords extracted from `php/delta.php`.
...
Identifier defined in php/delta.php
...
URL referenced in php/delta.php
