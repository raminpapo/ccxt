...
class lbank extends Exchange {
    ...
    public function fetch_trading_fee(string $symbol, $params = array ()): array {
         ...
         */
        $market = $this->market($symbol);
        $result = $this->fetch_trading_fees($this->extend($params, array( 'category' => $market['id'] )));
    ...
    public function fetch_deposit_withdraw_fees(?array $codes = null, $params = array ()) {
        ...
        if ($isAuthorized === true) {
            ...
            if ($method === 'fetchPublicDepositWithdrawFees') {
                $response = $this->fetch_public_deposit_withdraw_fees($codes, $params);
            } else {
                $response = $this->fetch_private_deposit_withdraw_fees($codes, $params);
            }
        } else {
            $response = $this->fetch_public_deposit_withdraw_fees($codes, $params);
        }
...
This is a PHP file located at `php/lbank.php`.

**Classes defined**: lbank

**Functions defined**: parse_ticker, describe, fetch_ticker, fetch_swap_markets, fetch_order_book, fetch_markets, fetch_time, fetch_spot_markets, fetch_tickers, fetch_currencies
...
- `fetch_deposit_address_default()`
- `fetch_deposit_address_supplement()`
...
- `https://www.lbank.com` (referenced)
...
- `https://api.lbkex.com` (referenced)
- `https://www.lbank.com/en-US/docs/index.html` (referenced)
