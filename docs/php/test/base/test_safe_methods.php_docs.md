# Documentation: php/test/base/test_safe_methods.php

## File Metadata

- **Path**: `php/test/base/test_safe_methods.php`
- **Size**: 15,376 bytes
- **Lines**: 269
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/base/test_safe_methods.php`.

**Functions defined**: test_safe_methods
