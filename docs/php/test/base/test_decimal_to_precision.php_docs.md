# Documentation: php/test/base/test_decimal_to_precision.php

## File Metadata

- **Path**: `php/test/base/test_decimal_to_precision.php`
- **Size**: 27,583 bytes
- **Lines**: 314
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/base/test_decimal_to_precision.php`.
