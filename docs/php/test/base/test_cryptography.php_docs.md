# Documentation: php/test/base/test_cryptography.php

## File Metadata

- **Path**: `php/test/base/test_cryptography.php`
- **Size**: 8,516 bytes
- **Lines**: 147
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/base/test_cryptography.php`.

**Functions defined**: crc32, hash, encode, eddsa, hmac, test_cryptography, ecdsa, jwt, rsa
