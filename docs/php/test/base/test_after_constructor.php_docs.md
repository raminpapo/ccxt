# Documentation: php/test/base/test_after_constructor.php

## File Metadata

- **Path**: `php/test/base/test_after_constructor.php`
- **Size**: 4,043 bytes
- **Lines**: 116
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/base/test_after_constructor.php`.
