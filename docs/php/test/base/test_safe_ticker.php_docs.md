# Documentation: php/test/base/test_safe_ticker.php

## File Metadata

- **Path**: `php/test/base/test_safe_ticker.php`
- **Size**: 5,516 bytes
- **Lines**: 134
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/base/test_safe_ticker.php`.
