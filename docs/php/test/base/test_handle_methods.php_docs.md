# Documentation: php/test/base/test_handle_methods.php

## File Metadata

- **Path**: `php/test/base/test_handle_methods.php`
- **Size**: 3,532 bytes
- **Lines**: 92
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/base/test_handle_methods.php`.
