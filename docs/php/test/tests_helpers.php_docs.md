# Documentation: php/test/tests_helpers.php

## File Metadata

- **Path**: `php/test/tests_helpers.php`
- **Size**: 10,769 bytes
- **Lines**: 343
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/tests_helpers.php`.

**Functions defined**: select_argv, convert_ascii, get_cli_arg_value, json_stringify, json_parse, filter_argvs, equals, convert_to_snake_case, dump
