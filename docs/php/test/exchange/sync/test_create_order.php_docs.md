# Documentation: php/test/exchange/sync/test_create_order.php

## File Metadata

- **Path**: `php/test/exchange/sync/test_create_order.php`
- **Size**: 17,678 bytes
- **Lines**: 273
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/sync/test_create_order.php`.
