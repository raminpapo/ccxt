# Documentation: php/test/exchange/sync/test_fetch_currencies.php

## File Metadata

- **Path**: `php/test/exchange/sync/test_fetch_currencies.php`
- **Size**: 4,460 bytes
- **Lines**: 76
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/sync/test_fetch_currencies.php`.
