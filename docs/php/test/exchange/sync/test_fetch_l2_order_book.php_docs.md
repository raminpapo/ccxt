# Documentation: php/test/exchange/sync/test_fetch_l2_order_book.php

## File Metadata

- **Path**: `php/test/exchange/sync/test_fetch_l2_order_book.php`
- **Size**: 688 bytes
- **Lines**: 18
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/sync/test_fetch_l2_order_book.php`.
