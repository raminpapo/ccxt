# Documentation: php/test/exchange/sync/test_fetch_markets.php

## File Metadata

- **Path**: `php/test/exchange/sync/test_fetch_markets.php`
- **Size**: 1,712 bytes
- **Lines**: 41
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/sync/test_fetch_markets.php`.
