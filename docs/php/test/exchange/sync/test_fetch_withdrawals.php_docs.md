# Documentation: php/test/exchange/sync/test_fetch_withdrawals.php

## File Metadata

- **Path**: `php/test/exchange/sync/test_fetch_withdrawals.php`
- **Size**: 969 bytes
- **Lines**: 23
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/sync/test_fetch_withdrawals.php`.
