# Documentation: php/test/exchange/sync/test_fetch_closed_orders.php

## File Metadata

- **Path**: `php/test/exchange/sync/test_fetch_closed_orders.php`
- **Size**: 1,061 bytes
- **Lines**: 25
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/sync/test_fetch_closed_orders.php`.
