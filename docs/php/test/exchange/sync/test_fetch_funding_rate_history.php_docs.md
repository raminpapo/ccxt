# Documentation: php/test/exchange/sync/test_fetch_funding_rate_history.php

## File Metadata

- **Path**: `php/test/exchange/sync/test_fetch_funding_rate_history.php`
- **Size**: 1,009 bytes
- **Lines**: 22
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/sync/test_fetch_funding_rate_history.php`.
