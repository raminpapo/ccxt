# Documentation: php/test/exchange/sync/test_fetch_tickers.php

## File Metadata

- **Path**: `php/test/exchange/sync/test_fetch_tickers.php`
- **Size**: 3,145 bytes
- **Lines**: 59
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/sync/test_fetch_tickers.php`.
