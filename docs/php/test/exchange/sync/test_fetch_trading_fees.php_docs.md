# Documentation: php/test/exchange/sync/test_fetch_trading_fees.php

## File Metadata

- **Path**: `php/test/exchange/sync/test_fetch_trading_fees.php`
- **Size**: 899 bytes
- **Lines**: 23
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/sync/test_fetch_trading_fees.php`.
