# Documentation: php/test/exchange/async/test_fetch_order_books.php

## File Metadata

- **Path**: `php/test/exchange/async/test_fetch_order_books.php`
- **Size**: 1,333 bytes
- **Lines**: 29
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/async/test_fetch_order_books.php`.
