# Documentation: php/test/exchange/async/test_fetch_balance.php

## File Metadata

- **Path**: `php/test/exchange/async/test_fetch_balance.php`
- **Size**: 787 bytes
- **Lines**: 22
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/async/test_fetch_balance.php`.
