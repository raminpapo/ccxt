# Documentation: php/test/exchange/async/test_create_order.php

## File Metadata

- **Path**: `php/test/exchange/async/test_create_order.php`
- **Size**: 19,395 bytes
- **Lines**: 288
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/async/test_create_order.php`.

**Functions defined**: tco_mininum_amount, tco_create_unfillable_order, tco_get_minimum_amount_for_limit_price, tco_create_order_safe, tco_create_fillable_order, tco_debug, tco_mininum_cost, tco_cancel_order, tco_assert_filled_order, test_create_order
