# Documentation: php/test/exchange/async/test_fetch_deposits.php

## File Metadata

- **Path**: `php/test/exchange/async/test_fetch_deposits.php`
- **Size**: 1,212 bytes
- **Lines**: 28
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/async/test_fetch_deposits.php`.
