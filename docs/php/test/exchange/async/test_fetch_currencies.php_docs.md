# Documentation: php/test/exchange/async/test_fetch_currencies.php

## File Metadata

- **Path**: `php/test/exchange/async/test_fetch_currencies.php`
- **Size**: 4,841 bytes
- **Lines**: 81
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/async/test_fetch_currencies.php`.

**Functions defined**: detect_currency_conflicts, test_fetch_currencies
...
- `/test/exchange/base/test_currency.php` (referenced)
