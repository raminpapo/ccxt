# Documentation: php/test/exchange/async/test_load_markets.php

## File Metadata

- **Path**: `php/test/exchange/async/test_load_markets.php`
- **Size**: 1,652 bytes
- **Lines**: 33
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/async/test_load_markets.php`.
