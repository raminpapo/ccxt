# Documentation: php/test/exchange/base/test_currency.php

## File Metadata

- **Path**: `php/test/exchange/base/test_currency.php`
- **Size**: 4,996 bytes
- **Lines**: 89
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/base/test_currency.php`.
