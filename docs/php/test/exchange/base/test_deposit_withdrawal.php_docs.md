# Documentation: php/test/exchange/base/test_deposit_withdrawal.php

## File Metadata

- **Path**: `php/test/exchange/base/test_deposit_withdrawal.php`
- **Size**: 2,280 bytes
- **Lines**: 48
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/base/test_deposit_withdrawal.php`.
