# Documentation: php/test/exchange/base/test_order.php

## File Metadata

- **Path**: `php/test/exchange/base/test_order.php`
- **Size**: 3,932 bytes
- **Lines**: 69
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/base/test_order.php`.

**Functions defined**: test_order
