# Documentation: php/test/exchange/base/test_ticker.php

## File Metadata

- **Path**: `php/test/exchange/base/test_ticker.php`
- **Size**: 12,250 bytes
- **Lines**: 193
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/base/test_ticker.php`.
