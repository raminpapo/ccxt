# Documentation: php/test/exchange/base/test_shared_methods.php

## File Metadata

- **Path**: `php/test/exchange/base/test_shared_methods.php`
- **Size**: 33,673 bytes
- **Lines**: 651
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/base/test_shared_methods.php`.
