# Documentation: php/test/exchange/base/test_market.php

## File Metadata

- **Path**: `php/test/exchange/base/test_market.php`
- **Size**: 14,606 bytes
- **Lines**: 262
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/base/test_market.php`.
