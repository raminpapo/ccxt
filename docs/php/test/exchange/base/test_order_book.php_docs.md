# Documentation: php/test/exchange/base/test_order_book.php

## File Metadata

- **Path**: `php/test/exchange/base/test_order_book.php`
- **Size**: 4,105 bytes
- **Lines**: 73
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/base/test_order_book.php`.
