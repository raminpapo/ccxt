# Documentation: php/test/exchange/base/test_trade.php

## File Metadata

- **Path**: `php/test/exchange/base/test_trade.php`
- **Size**: 2,243 bytes
- **Lines**: 47
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/base/test_trade.php`.
