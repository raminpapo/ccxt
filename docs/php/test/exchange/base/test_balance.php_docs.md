# Documentation: php/test/exchange/base/test_balance.php

## File Metadata

- **Path**: `php/test/exchange/base/test_balance.php`
- **Size**: 3,118 bytes
- **Lines**: 54
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/test/exchange/base/test_balance.php`.
