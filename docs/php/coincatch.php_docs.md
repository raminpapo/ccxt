# Documentation: php/coincatch.php

## File Metadata

- **Path**: `php/coincatch.php`
- **Size**: 268,183 bytes
- **Lines**: 5,485
- **Type**: PHP
- **Extension**: .php
...
class coincatch extends Exchange {
    ...
    public function edit_order(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array ()) {
        ...
        if ($market['spot']) {
            ...
            // todo return $this->editSwapOrder ($id, $symbol, $type, $side, $amount, $price, $params);
            throw new NotSupported($this->id . ' ' . $methodName . '() is not supported for ' . $market['type'] . ' $type of markets');
        }
    }
...
This is a PHP file located at `php/coincatch.php`.
