# Documentation: php/abstract/onetrading.php

## File Metadata

- **Path**: `php/abstract/onetrading.php`
- **Size**: 7,005 bytes
- **Lines**: 125
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/onetrading.php`.
...
```bash
php php/abstract/onetrading.php
```
