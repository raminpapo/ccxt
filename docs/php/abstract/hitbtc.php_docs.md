# Documentation: php/abstract/hitbtc.php

## File Metadata

- **Path**: `php/abstract/hitbtc.php`
- **Size**: 44,328 bytes
- **Lines**: 677
- **Type**: PHP
- **Extension**: .php
...
abstract class hitbtc extends \ccxt\Exchange {
...
This is a PHP file located at `php/abstract/hitbtc.php`.

**Classes defined**: hitbtc

**Functions defined**: public_get_public_currency_currency, public_get_public_symbol_symbol, public_get_public_ticker, public_get_public_ticker_symbol, public_get_public_price_rate, public_get_public_currency, public_get_public_symbol, public_get_public_price_ticker_symbol, public_get_public_price_history, public_get_public_price_ticker
