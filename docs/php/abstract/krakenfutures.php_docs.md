# Documentation: php/abstract/krakenfutures.php

## File Metadata

- **Path**: `php/abstract/krakenfutures.php`
- **Size**: 13,175 bytes
- **Lines**: 239
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/krakenfutures.php`.
...
```bash
php php/abstract/krakenfutures.php
```
