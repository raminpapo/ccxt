# Documentation: php/abstract/wavesexchange.php

## File Metadata

- **Path**: `php/abstract/wavesexchange.php`
- **Size**: 56,407 bytes
- **Lines**: 911
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/wavesexchange.php`.
...
```bash
php php/abstract/wavesexchange.php
```
