# Documentation: php/abstract/binanceusdm.php

## File Metadata

- **Path**: `php/abstract/binanceusdm.php`
- **Size**: 296,422 bytes
- **Lines**: 4,613
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/binanceusdm.php`.
...
```bash
php php/abstract/binanceusdm.php
```
