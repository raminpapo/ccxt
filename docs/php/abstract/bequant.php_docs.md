# Documentation: php/abstract/bequant.php

## File Metadata

- **Path**: `php/abstract/bequant.php`
- **Size**: 44,327 bytes
- **Lines**: 677
- **Type**: PHP
- **Extension**: .php
...
abstract class bequant extends \ccxt\hitbtc {
...
This is a PHP file located at `php/abstract/bequant.php`.
