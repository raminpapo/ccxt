# Documentation: php/abstract/poloniex.php

## File Metadata

- **Path**: `php/abstract/poloniex.php`
- **Size**: 39,554 bytes
- **Lines**: 617
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/poloniex.php`.
