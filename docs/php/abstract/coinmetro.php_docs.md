# Documentation: php/abstract/coinmetro.php

## File Metadata

- **Path**: `php/abstract/coinmetro.php`
- **Size**: 11,779 bytes
- **Lines**: 191
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/coinmetro.php`.
...
```bash
php php/abstract/coinmetro.php
```
