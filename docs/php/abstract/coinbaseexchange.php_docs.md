# Documentation: php/abstract/coinbaseexchange.php

## File Metadata

- **Path**: `php/abstract/coinbaseexchange.php`
- **Size**: 28,038 bytes
- **Lines**: 485
- **Type**: PHP
- **Extension**: .php
...
abstract class coinbaseexchange extends \ccxt\Exchange {
    ...
    public function public_get_products_volume_summary($params = array()) {
        return $this->request('products/volume-summary', 'public', 'GET', $params, null, null, array());
    }
    ...
    public function publicGetProductsVolumeSummary($params = array()) {
        return $this->request('products/volume-summary', 'public', 'GET', $params, null, null, array());
    }
...
This is a PHP file located at `php/abstract/coinbaseexchange.php`.

**Classes defined**: coinbaseexchange

**Functions defined**: public_get_products_id_stats, public_get_products_id_trades, public_get_time, public_get_products_id_candles, public_get_products_id_ticker, public_get_products, public_get_products_spark_lines, public_get_currencies, public_get_products_id, public_get_products_id_book
...
```bash
php php/abstract/coinbaseexchange.php
```
