# Documentation: php/abstract/bitfinex.php

## File Metadata

- **Path**: `php/abstract/bitfinex.php`
- **Size**: 54,723 bytes
- **Lines**: 827
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/bitfinex.php`.
