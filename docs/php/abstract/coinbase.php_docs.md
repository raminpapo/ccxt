# Documentation: php/abstract/coinbase.php

## File Metadata

- **Path**: `php/abstract/coinbase.php`
- **Size**: 41,560 bytes
- **Lines**: 557
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/coinbase.php`.
