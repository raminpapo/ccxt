# Documentation: php/abstract/cryptomus.php

## File Metadata

- **Path**: `php/abstract/cryptomus.php`
- **Size**: 7,099 bytes
- **Lines**: 107
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/cryptomus.php`.
...
```bash
php php/abstract/cryptomus.php
```
