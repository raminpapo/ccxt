# Documentation: php/abstract/binancecoinm.php

## File Metadata

- **Path**: `php/abstract/binancecoinm.php`
- **Size**: 296,423 bytes
- **Lines**: 4,613
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/binancecoinm.php`.
...
```bash
php php/abstract/binancecoinm.php
```
