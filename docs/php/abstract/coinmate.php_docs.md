# Documentation: php/abstract/coinmate.php

## File Metadata

- **Path**: `php/abstract/coinmate.php`
- **Size**: 20,815 bytes
- **Lines**: 359
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/coinmate.php`.
