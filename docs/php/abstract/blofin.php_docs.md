# Documentation: php/abstract/blofin.php

## File Metadata

- **Path**: `php/abstract/blofin.php`
- **Size**: 25,717 bytes
- **Lines**: 389
- **Type**: PHP
- **Extension**: .php
...
abstract class blofin extends \ccxt\Exchange {
...
This is a PHP file located at `php/abstract/blofin.php`.

**Classes defined**: blofin

**Functions defined**: private_get_trade_orders_pending, public_get_market_books, public_get_market_funding_rate_history, public_get_market_instruments, public_get_market_trades, public_get_market_tickers, public_get_market_candles, private_get_asset_balances, public_get_market_funding_rate, public_get_market_mark_price
