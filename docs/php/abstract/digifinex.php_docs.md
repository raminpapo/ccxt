# Documentation: php/abstract/digifinex.php

## File Metadata

- **Path**: `php/abstract/digifinex.php`
- **Size**: 34,360 bytes
- **Lines**: 539
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/digifinex.php`.
...
```bash
php php/abstract/digifinex.php
```
