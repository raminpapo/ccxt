# Documentation: php/abstract/coinbaseinternational.php

## File Metadata

- **Path**: `php/abstract/coinbaseinternational.php`
- **Size**: 14,139 bytes
- **Lines**: 221
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/coinbaseinternational.php`.
...
```bash
php php/abstract/coinbaseinternational.php
```
