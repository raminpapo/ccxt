# Documentation: php/abstract/coinbaseadvanced.php

## File Metadata

- **Path**: `php/abstract/coinbaseadvanced.php`
- **Size**: 41,568 bytes
- **Lines**: 557
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/coinbaseadvanced.php`.
...
```bash
php php/abstract/coinbaseadvanced.php
```
