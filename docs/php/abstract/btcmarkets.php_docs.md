# Documentation: php/abstract/btcmarkets.php

## File Metadata

- **Path**: `php/abstract/btcmarkets.php`
- **Size**: 12,074 bytes
- **Lines**: 221
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/btcmarkets.php`.
...
```bash
php php/abstract/btcmarkets.php
```
