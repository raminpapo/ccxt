# Documentation: php/abstract/kucoinfutures.php

## File Metadata

- **Path**: `php/abstract/kucoinfutures.php`
- **Size**: 108,767 bytes
- **Lines**: 1,679
- **Type**: PHP
- **Extension**: .php
...
This is a PHP file located at `php/abstract/kucoinfutures.php`.
...
```bash
php php/abstract/kucoinfutures.php
```
