# Keywords: php/derive.php

## Extracted Keywords

This file contains 98 keywords extracted from `php/derive.php`.
...
Module imported in php/derive.php
...
Identifier defined in php/derive.php
...
URL referenced in php/derive.php
