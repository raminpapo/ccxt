# Documentation: php/poloniex.php

## File Metadata

- **Path**: `php/poloniex.php`
- **Size**: 169,980 bytes
- **Lines**: 3,719
- **Type**: PHP
- **Extension**: .php
...
class poloniex extends Exchange {
    ...
    public function fetch_ohlcv(string $symbol, string $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        if ($paginate) {
            return $this->fetch_paginated_call_deterministic('fetchOHLCV', $symbol, $since, $limit, $timeframe, $params, 500);
        }
...
This is a PHP file located at `php/poloniex.php`.

**Classes defined**: poloniex

**Functions defined**: parse_market, parse_swap_market, describe, load_markets, fetch_ohlcv, fetch_swap_markets, fetch_markets, parse_ohlcv, parse_spot_market, fetch_spot_markets
