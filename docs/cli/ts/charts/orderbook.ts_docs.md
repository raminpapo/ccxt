# Documentation: cli/ts/charts/orderbook.ts

## File Metadata

- **Path**: `cli/ts/charts/orderbook.ts`
- **Size**: 3,957 bytes
- **Lines**: 120
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `cli/ts/charts/orderbook.ts`.

**Functions defined**: renderOrderBook, plotOrderBook, center
...
```bash
ts-node cli/ts/charts/orderbook.ts
```
