# Documentation: cli/ts/charts/ohlcv.ts

## File Metadata

- **Path**: `cli/ts/charts/ohlcv.ts`
- **Size**: 3,753 bytes
- **Lines**: 125
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `cli/ts/charts/ohlcv.ts`.

**Functions defined**: plotOHLCVChart, generateHTML
...
- `https://unpkg.com/lightweight-charts@4.1.1/dist/lightweight-charts.standalone.production.js` (referenced)
...
```bash
ts-node cli/ts/charts/ohlcv.ts
```
