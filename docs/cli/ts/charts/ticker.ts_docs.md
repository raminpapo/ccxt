# Documentation: cli/ts/charts/ticker.ts

## File Metadata

- **Path**: `cli/ts/charts/ticker.ts`
- **Size**: 6,944 bytes
- **Lines**: 207
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `cli/ts/charts/ticker.ts`.

**Functions defined**: renderTicker, colorize, fmt, plotTicker, center, colorForNumber, formatShortDate, addLine, fmtDate
...
```bash
ts-node cli/ts/charts/ticker.ts
```
