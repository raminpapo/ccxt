# Documentation: cli/ts/cache.ts

## File Metadata

- **Path**: `cli/ts/cache.ts`
- **Size**: 5,313 bytes
- **Lines**: 188
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `cli/ts/cache.ts`.

**Functions defined**: changeConfigPath, getChartsFolder, checkCache, getCachePathForHelp, getDateForNamefile, saveCommand, getCacheDirectory, getExchangeSettings, saveConfigFile, loadMainConfigFile
