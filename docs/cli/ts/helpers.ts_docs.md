# Documentation: cli/ts/helpers.ts

## File Metadata

- **Path**: `cli/ts/helpers.ts`
- **Size**: 24,868 bytes
- **Lines**: 798
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `cli/ts/helpers.ts`.

**Functions defined**: createResponseTemplate, jsonStringify, countAllParams, createRequestTemplate, printSavedCommand, injectMissingUndefined, writeFile, printUsage, printSupportedExchanges, handleMarketsLoading
...
- `path` (imported)
- `as-table` (imported)
- `../../utils/update-static-tests-data.js` (referenced)
- `./cache.js` (referenced)
