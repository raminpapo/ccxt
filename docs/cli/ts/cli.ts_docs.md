...
This is a TypeScript file located at `cli/ts/cli.ts`.

**Functions defined**: executeCCXTCommand, run
...
- `clipboardy` (imported)
- `ansicolor` (imported)
- `./charts/orderbook.js` (imported)
- `./helpers.js` (imported)
- `ololog` (imported)
- `./charts/ticker.js` (imported)
- `./cache.js` (imported)
- `commander` (imported)
- `./charts/ohlcv.js` (imported)
- `./cache.js` (referenced)
- `./helpers.js` (referenced)
- `./charts/ticker.js` (referenced)
- `./charts/orderbook.js` (referenced)
- `config ./some/path/config.json` (referenced)
- `./charts/ohlcv.js` (referenced)
