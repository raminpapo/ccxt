# Documentation: utils/check_modified_files.sh

## File Metadata

- **Path**: `utils/check_modified_files.sh`
- **Size**: 4,095 bytes
- **Lines**: 102
- **Type**: Shell Script
- **Extension**: .sh
...
This is a Shell Script file located at `utils/check_modified_files.sh`.
...
```bash
bash utils/check_modified_files.sh
```
