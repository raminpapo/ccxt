# Documentation: utils/dev-helpers/required-symbols-for-methods.ts

## File Metadata

- **Path**: `utils/dev-helpers/required-symbols-for-methods.ts`
- **Size**: 2,747 bytes
- **Lines**: 79
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `utils/dev-helpers/required-symbols-for-methods.ts`.

**Functions defined**: runCheck
...
```bash
ts-node utils/dev-helpers/required-symbols-for-methods.ts
```
