# Documentation: utils/granular-go-build.ts

## File Metadata

- **Path**: `utils/granular-go-build.ts`
- **Size**: 7,221 bytes
- **Lines**: 236
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `utils/granular-go-build.ts`.

**Functions defined**: createExchangeTypedInterfaceFile, createWsExchangeTypedInterfaceFile, deleteFilesRecursively, main, transpileAndGenerateAPI, createExchangeDynamicFile, capitalizeFirstLetter
...
- `createExchangeDynamicFile()`
- `createExchangeTypedInterfaceFile()`
- `createWsExchangeTypedInterfaceFile()`
- `deleteFilesRecursively()`
- `main()`
- `transpileAndGenerateAPI()`
...
- `ololog` (imported)
- `path` (imported)
- `./go/tests/base/test.types.rest.go` (referenced)
- `./go/v4/pro/exchange_dynamic.go` (referenced)
- `./go/v4/exchange_dynamic.go` (referenced)
- `./go/tests/base/test.types.pro.go` (referenced)
- `./go/tests/base/test.structs.go` (referenced)
- `./go/v4/pro/exchange_typed_interface.go` (referenced)
- `./go/v4/exchange_typed_interface.go` (referenced)
...
```bash
ts-node utils/granular-go-build.ts
```
