# Documentation: utils/update-static-json.ts

## File Metadata

- **Path**: `utils/update-static-json.ts`
- **Size**: 7,542 bytes
- **Lines**: 220
- **Type**: TypeScript
- **Extension**: .ts
...
This is a TypeScript file located at `utils/update-static-json.ts`.

**Functions defined**: writeJson, writeString, jsonStringify, twoSpacedIndent, die, ccxtClass, readFileInit, spaces, getExchangeSettings, update_markets_and_currencies
...
- `spaces()`
- `twoSpacedIndent()`
- `updateMarketOrCurrency()`
- `updateMarketsOrCurrencies()`
- `update_markets_and_currencies()`
- `writeJson()`
- `writeString()`
...
```bash
ts-node utils/update-static-json.ts
```
