# Documentation: python/README.rst
...
This is a reStructuredText file located at `python/README.rst`.
...
- `https://cdn.jsdelivr.net/npm/ccxt@1.29.74/dist/ccxt.browser.js` (referenced)
