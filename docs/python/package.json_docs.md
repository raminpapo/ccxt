# Documentation: python/package.json
...
This is a JSON file located at `python/package.json`.
...
- `https://registry.npmjs.com` (referenced)
- `dist/ccxt.browser.min.js` (referenced)
- `./js/ccxt.js` (referenced)
- `tsx build/csharpTranspiler.ts` (referenced)
- `./index.d.ts` (referenced)
- `dotnet build cs/ccxt.sln` (referenced)
- `./dist/ccxt.cjs` (referenced)
- `git+https://github.com/ccxt/ccxt.git` (referenced)
- `./js/ccxt.d.ts` (referenced)
