# Documentation: python/ccxt/abstract/coinsph.py

## File Metadata

- **Path**: `python/ccxt/abstract/coinsph.py`
- **Size**: 8,007 bytes
- **Lines**: 55
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/coinsph.py`.
...
```bash
python python/ccxt/abstract/coinsph.py
```
