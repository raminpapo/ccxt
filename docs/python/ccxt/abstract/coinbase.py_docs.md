# Documentation: python/ccxt/abstract/coinbase.py
...
This is a Python file located at `python/ccxt/abstract/coinbase.py`.
...
```bash
python python/ccxt/abstract/coinbase.py
```
