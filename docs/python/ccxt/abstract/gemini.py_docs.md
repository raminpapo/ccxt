# Documentation: python/ccxt/abstract/gemini.py

## File Metadata

- **Path**: `python/ccxt/abstract/gemini.py`
- **Size**: 7,014 bytes
- **Lines**: 60
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/gemini.py`.
...
```bash
python python/ccxt/abstract/gemini.py
```
