# Documentation: python/ccxt/abstract/mexc.py

## File Metadata

- **Path**: `python/ccxt/abstract/mexc.py`
- **Size**: 26,614 bytes
- **Lines**: 182
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/mexc.py`.
...
```bash
python python/ccxt/abstract/mexc.py
```
