# Documentation: python/ccxt/abstract/wavesexchange.py

## File Metadata

- **Path**: `python/ccxt/abstract/wavesexchange.py`
- **Size**: 19,631 bytes
- **Lines**: 155
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/wavesexchange.py`.
...
```bash
python python/ccxt/abstract/wavesexchange.py
```
