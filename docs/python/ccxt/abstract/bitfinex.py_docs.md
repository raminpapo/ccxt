# Documentation: python/ccxt/abstract/bitfinex.py

## File Metadata

- **Path**: `python/ccxt/abstract/bitfinex.py`
- **Size**: 19,290 bytes
- **Lines**: 141
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/bitfinex.py`.
...
```bash
python python/ccxt/abstract/bitfinex.py
```
