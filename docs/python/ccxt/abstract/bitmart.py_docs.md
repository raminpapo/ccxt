# Documentation: python/ccxt/abstract/bitmart.py

## File Metadata

- **Path**: `python/ccxt/abstract/bitmart.py`
- **Size**: 17,395 bytes
- **Lines**: 118
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/bitmart.py`.
...
```bash
python python/ccxt/abstract/bitmart.py
```
