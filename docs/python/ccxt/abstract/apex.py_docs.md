# Documentation: python/ccxt/abstract/apex.py

## File Metadata

- **Path**: `python/ccxt/abstract/apex.py`
- **Size**: 3,150 bytes
- **Lines**: 32
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/apex.py`.
...
```bash
python python/ccxt/abstract/apex.py
```
