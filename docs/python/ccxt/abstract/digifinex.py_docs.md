# Documentation: python/ccxt/abstract/digifinex.py

## File Metadata

- **Path**: `python/ccxt/abstract/digifinex.py`
- **Size**: 11,585 bytes
- **Lines**: 93
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/digifinex.py`.
...
```bash
python python/ccxt/abstract/digifinex.py
```
