# Documentation: python/ccxt/abstract/hitbtc.py

## File Metadata

- **Path**: `python/ccxt/abstract/hitbtc.py`
- **Size**: 15,601 bytes
- **Lines**: 116
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/hitbtc.py`.
...
```bash
python python/ccxt/abstract/hitbtc.py
```
