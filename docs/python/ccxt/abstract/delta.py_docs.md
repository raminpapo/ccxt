# Documentation: python/ccxt/abstract/delta.py

## File Metadata

- **Path**: `python/ccxt/abstract/delta.py`
- **Size**: 5,567 bytes
- **Lines**: 55
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/delta.py`.
...
```bash
python python/ccxt/abstract/delta.py
```
