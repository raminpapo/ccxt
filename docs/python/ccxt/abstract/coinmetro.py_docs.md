# Documentation: python/ccxt/abstract/coinmetro.py

## File Metadata

- **Path**: `python/ccxt/abstract/coinmetro.py`
- **Size**: 3,975 bytes
- **Lines**: 35
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/coinmetro.py`.
...
```bash
python python/ccxt/abstract/coinmetro.py
```
