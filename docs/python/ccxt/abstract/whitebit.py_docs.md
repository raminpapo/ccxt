# Documentation: python/ccxt/abstract/whitebit.py

## File Metadata

- **Path**: `python/ccxt/abstract/whitebit.py`
- **Size**: 14,577 bytes
- **Lines**: 115
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/whitebit.py`.
...
```bash
python python/ccxt/abstract/whitebit.py
```
