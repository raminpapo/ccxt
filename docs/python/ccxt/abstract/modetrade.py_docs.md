# Documentation: python/ccxt/abstract/modetrade.py

## File Metadata

- **Path**: `python/ccxt/abstract/modetrade.py`
- **Size**: 16,016 bytes
- **Lines**: 120
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/modetrade.py`.
...
```bash
python python/ccxt/abstract/modetrade.py
```
