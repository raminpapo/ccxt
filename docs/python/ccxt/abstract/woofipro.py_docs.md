# Documentation: python/ccxt/abstract/woofipro.py

## File Metadata

- **Path**: `python/ccxt/abstract/woofipro.py`
- **Size**: 16,016 bytes
- **Lines**: 120
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/woofipro.py`.
...
```bash
python python/ccxt/abstract/woofipro.py
```
