# Documentation: python/ccxt/abstract/oxfun.py

## File Metadata

- **Path**: `python/ccxt/abstract/oxfun.py`
- **Size**: 3,457 bytes
- **Lines**: 35
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/oxfun.py`.
...
```bash
python python/ccxt/abstract/oxfun.py
```
