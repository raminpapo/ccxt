# Documentation: python/ccxt/abstract/coinmate.py

## File Metadata

- **Path**: `python/ccxt/abstract/coinmate.py`
- **Size**: 6,842 bytes
- **Lines**: 63
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/coinmate.py`.
...
```bash
python python/ccxt/abstract/coinmate.py
```
