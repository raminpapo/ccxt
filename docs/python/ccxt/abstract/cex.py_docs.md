# Documentation: python/ccxt/abstract/cex.py

## File Metadata

- **Path**: `python/ccxt/abstract/cex.py`
- **Size**: 3,600 bytes
- **Lines**: 33
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/cex.py`.
...
```bash
python python/ccxt/abstract/cex.py
```
