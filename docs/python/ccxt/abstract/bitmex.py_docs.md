# Documentation: python/ccxt/abstract/bitmex.py

## File Metadata

- **Path**: `python/ccxt/abstract/bitmex.py`
- **Size**: 10,774 bytes
- **Lines**: 98
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/bitmex.py`.
...
```bash
python python/ccxt/abstract/bitmex.py
```
