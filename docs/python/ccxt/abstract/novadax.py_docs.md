# Documentation: python/ccxt/abstract/novadax.py

## File Metadata

- **Path**: `python/ccxt/abstract/novadax.py`
- **Size**: 3,093 bytes
- **Lines**: 30
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/novadax.py`.
...
```bash
python python/ccxt/abstract/novadax.py
```
