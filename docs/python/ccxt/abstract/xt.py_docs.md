# Documentation: python/ccxt/abstract/xt.py

## File Metadata

- **Path**: `python/ccxt/abstract/xt.py`
- **Size**: 27,837 bytes
- **Lines**: 158
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/xt.py`.
...
```bash
python python/ccxt/abstract/xt.py
```
