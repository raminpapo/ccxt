# Documentation: python/ccxt/abstract/krakenfutures.py

## File Metadata

- **Path**: `python/ccxt/abstract/krakenfutures.py`
- **Size**: 4,080 bytes
- **Lines**: 43
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/krakenfutures.py`.
...
```bash
python python/ccxt/abstract/krakenfutures.py
```
