# Documentation: python/ccxt/abstract/bitrue.py

## File Metadata

- **Path**: `python/ccxt/abstract/bitrue.py`
- **Size**: 9,459 bytes
- **Lines**: 73
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/bitrue.py`.
...
```bash
python python/ccxt/abstract/bitrue.py
```
