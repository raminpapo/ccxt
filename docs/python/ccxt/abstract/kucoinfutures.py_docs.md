# Documentation: python/ccxt/abstract/kucoinfutures.py

## File Metadata

- **Path**: `python/ccxt/abstract/kucoinfutures.py`
- **Size**: 37,691 bytes
- **Lines**: 283
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/kucoinfutures.py`.
...
```bash
python python/ccxt/abstract/kucoinfutures.py
```
