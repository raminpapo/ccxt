# Documentation: python/ccxt/abstract/woo.py

## File Metadata

- **Path**: `python/ccxt/abstract/woo.py`
- **Size**: 17,954 bytes
- **Lines**: 139
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/woo.py`.
...
```bash
python python/ccxt/abstract/woo.py
```
