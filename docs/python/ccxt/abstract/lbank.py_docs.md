# Documentation: python/ccxt/abstract/lbank.py

## File Metadata

- **Path**: `python/ccxt/abstract/lbank.py`
- **Size**: 8,803 bytes
- **Lines**: 63
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/lbank.py`.
...
```bash
python python/ccxt/abstract/lbank.py
```
