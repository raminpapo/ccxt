# Documentation: python/ccxt/abstract/deribit.py

## File Metadata

- **Path**: `python/ccxt/abstract/deribit.py`
- **Size**: 15,633 bytes
- **Lines**: 127
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/deribit.py`.
...
```bash
python python/ccxt/abstract/deribit.py
```
