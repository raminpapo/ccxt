# Documentation: python/ccxt/abstract/btcmarkets.py

## File Metadata

- **Path**: `python/ccxt/abstract/btcmarkets.py`
- **Size**: 3,690 bytes
- **Lines**: 40
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/btcmarkets.py`.
...
```bash
python python/ccxt/abstract/btcmarkets.py
```
