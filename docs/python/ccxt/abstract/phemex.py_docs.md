# Documentation: python/ccxt/abstract/phemex.py

## File Metadata

- **Path**: `python/ccxt/abstract/phemex.py`
- **Size**: 15,570 bytes
- **Lines**: 119
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/phemex.py`.
...
```bash
python python/ccxt/abstract/phemex.py
```
