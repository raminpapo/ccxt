# Documentation: python/ccxt/abstract/upbit.py

## File Metadata

- **Path**: `python/ccxt/abstract/upbit.py`
- **Size**: 6,168 bytes
- **Lines**: 57
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/upbit.py`.
...
```bash
python python/ccxt/abstract/upbit.py
```
