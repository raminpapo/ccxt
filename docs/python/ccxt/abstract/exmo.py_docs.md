# Documentation: python/ccxt/abstract/exmo.py

## File Metadata

- **Path**: `python/ccxt/abstract/exmo.py`
- **Size**: 6,177 bytes
- **Lines**: 56
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/exmo.py`.
...
```bash
python python/ccxt/abstract/exmo.py
```
