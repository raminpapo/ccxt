# Documentation: python/ccxt/abstract/probit.py

## File Metadata

- **Path**: `python/ccxt/abstract/probit.py`
- **Size**: 1,969 bytes
- **Lines**: 24
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/probit.py`.
...
```bash
python python/ccxt/abstract/probit.py
```
