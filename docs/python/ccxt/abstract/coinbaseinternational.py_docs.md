# Documentation: python/ccxt/abstract/coinbaseinternational.py

## File Metadata

- **Path**: `python/ccxt/abstract/coinbaseinternational.py`
- **Size**: 4,861 bytes
- **Lines**: 40
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/coinbaseinternational.py`.
...
```bash
python python/ccxt/abstract/coinbaseinternational.py
```
