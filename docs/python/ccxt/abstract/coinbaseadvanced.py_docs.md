# Documentation: python/ccxt/abstract/coinbaseadvanced.py

## File Metadata

- **Path**: `python/ccxt/abstract/coinbaseadvanced.py`
- **Size**: 15,666 bytes
- **Lines**: 96
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/abstract/coinbaseadvanced.py`.
...
```bash
python python/ccxt/abstract/coinbaseadvanced.py
```
