# Documentation: python/ccxt/pro/p2b.py

## File Metadata

- **Path**: `python/ccxt/pro/p2b.py`
- **Size**: 20,914 bytes
- **Lines**: 486
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/p2b.py`.

**Classes defined**: p2b

**Functions defined**: watch_ticker, describe, watch_order_book, watch_tickers, watch_trades_for_symbols, handle_trade, watch_trades, handle_ohlcv, subscribe, watch_ohlcv
