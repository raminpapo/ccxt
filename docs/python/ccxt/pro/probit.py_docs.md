# Documentation: python/ccxt/pro/probit.py

## File Metadata

- **Path**: `python/ccxt/pro/probit.py`
- **Size**: 23,150 bytes
- **Lines**: 559
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/probit.py`.

**Classes defined**: probit

**Functions defined**: watch_ticker, describe, handle_balance, parse_ws_balance, watch_my_trades, handle_my_trades, handle_trades, watch_balance, watch_trades, handle_ticker
...
```bash
python python/ccxt/pro/probit.py
```
