# Documentation: python/ccxt/pro/bitopro.py

## File Metadata

- **Path**: `python/ccxt/pro/bitopro.py`
- **Size**: 19,117 bytes
- **Lines**: 458
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/bitopro.py`.

**Classes defined**: bitopro

**Functions defined**: watch_ticker, watch_order_book, describe, handle_my_trade, parse_ws_trade, watch_my_trades, handle_order_book, handle_trade, watch_trades, watch_public
...
```bash
python python/ccxt/pro/bitopro.py
```
