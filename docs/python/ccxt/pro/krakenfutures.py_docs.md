# Documentation: python/ccxt/pro/krakenfutures.py

## File Metadata

- **Path**: `python/ccxt/pro/krakenfutures.py`
- **Size**: 63,953 bytes
- **Lines**: 1,520
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/krakenfutures.py`.

**Classes defined**: krakenfutures

**Functions defined**: watch_ticker, describe, subscribe_private, watch_tickers, watch_trades_for_symbols, subscribe_public, watch_order_book_for_symbols, watch_trades, authenticate, watch_bids_asks
...
- `handle_order()`
- `handle_order_book()`
- `handle_order_book_snapshot()`
- `handle_order_snapshot()`
- `handle_positions()`
- `handle_ticker()`
- `handle_trade()`
- `parse_ws_my_trade()`
- `parse_ws_order()`
- `parse_ws_order_trade()`
- `parse_ws_position()`
...
```bash
python python/ccxt/pro/krakenfutures.py
```
