# Documentation: python/ccxt/pro/coinbaseexchange.py

## File Metadata

- **Path**: `python/ccxt/pro/coinbaseexchange.py`
- **Size**: 39,046 bytes
- **Lines**: 896
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/coinbaseexchange.py`.

**Classes defined**: coinbaseexchange

**Functions defined**: watch_ticker, describe, watch_tickers, watch_my_trades, watch_my_trades_for_symbols, watch_trades_for_symbols, watch_trades, authenticate, subscribe_multiple, subscribe
...
```bash
python python/ccxt/pro/coinbaseexchange.py
```
