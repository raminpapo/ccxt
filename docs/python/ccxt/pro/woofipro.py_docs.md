# Documentation: python/ccxt/pro/woofipro.py

## File Metadata

- **Path**: `python/ccxt/pro/woofipro.py`
- **Size**: 51,767 bytes
- **Lines**: 1,272
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/woofipro.py`.
...
```bash
python python/ccxt/pro/woofipro.py
```
