# Documentation: python/ccxt/pro/oxfun.py

## File Metadata

- **Path**: `python/ccxt/pro/oxfun.py`
- **Size**: 46,666 bytes
- **Lines**: 1,055
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/oxfun.py`.

**Classes defined**: oxfun

**Functions defined**: describe, parse_ws_trade, handle_ohlcv, watch_ohlcv_for_symbols, watch_trades_for_symbols, handle_trades, watch_trades, parse_ws_ohlcv, subscribe_multiple, watch_ohlcv
...
```bash
python python/ccxt/pro/oxfun.py
```
