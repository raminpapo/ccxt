# Documentation: python/ccxt/pro/mexc.py

## File Metadata

- **Path**: `python/ccxt/pro/mexc.py`
- **Size**: 77,390 bytes
- **Lines**: 1,901
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/mexc.py`.

**Classes defined**: mexc

**Functions defined**: watch_spot_public, handle_tickers, watch_ticker, describe, parse_ws_ticker, watch_tickers, parse_ws_bid_ask, handle_bid_ask, watch_bids_asks, handle_ticker
...
```bash
python python/ccxt/pro/mexc.py
```
