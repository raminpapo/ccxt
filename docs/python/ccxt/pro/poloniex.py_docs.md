# Documentation: python/ccxt/pro/poloniex.py

## File Metadata

- **Path**: `python/ccxt/pro/poloniex.py`
- **Size**: 53,604 bytes
- **Lines**: 1,250
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/poloniex.py`.

**Classes defined**: poloniex

**Functions defined**: trade_request, cancel_all_orders_ws, describe, create_order_ws, cancel_order_ws, cancel_orders_ws, authenticate, subscribe, watch_ohlcv, handle_order_request
...
```bash
python python/ccxt/pro/poloniex.py
```
