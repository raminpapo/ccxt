# Documentation: python/ccxt/pro/paradex.py

## File Metadata

- **Path**: `python/ccxt/pro/paradex.py`
- **Size**: 14,441 bytes
- **Lines**: 353
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/paradex.py`.

**Classes defined**: paradex

**Functions defined**: watch_ticker, watch_order_book, describe, handle_error_message, watch_tickers, handle_order_book, handle_trade, watch_trades, handle_message, handle_ticker
...
```bash
python python/ccxt/pro/paradex.py
```
