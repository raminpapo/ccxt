# Documentation: python/ccxt/pro/phemex.py

## File Metadata

- **Path**: `python/ccxt/pro/phemex.py`
- **Size**: 63,425 bytes
- **Lines**: 1,497
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/phemex.py`.

**Classes defined**: phemex

**Functions defined**: from_ep, parse_perpetual_ticker, describe, handle_ticker, parse_swap_ticker, from_ev, watch_balance, request_id, from_er, from_en
...
```bash
python python/ccxt/pro/phemex.py
```
