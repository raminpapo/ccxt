# Documentation: python/ccxt/pro/bitfinex.py

## File Metadata

- **Path**: `python/ccxt/pro/bitfinex.py`
- **Size**: 49,190 bytes
- **Lines**: 1,219
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/bitfinex.py`.

**Classes defined**: bitfinex

**Functions defined**: un_subscribe, un_watch_trades, describe, subscribe_private, watch_my_trades, un_watch_ohlcv, watch_trades, handle_ohlcv, subscribe, watch_ohlcv
...
```bash
python python/ccxt/pro/bitfinex.py
```
