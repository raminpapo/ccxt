# Documentation: python/ccxt/pro/coinone.py

## File Metadata

- **Path**: `python/ccxt/pro/coinone.py`
- **Size**: 15,748 bytes
- **Lines**: 403
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/coinone.py`.

**Classes defined**: coinone

**Functions defined**: watch_ticker, watch_order_book, describe, parse_ws_trade, parse_ws_ticker, handle_delta, handle_trades, handle_order_book, watch_trades, handle_ticker
...
```bash
python python/ccxt/pro/coinone.py
```
