# Documentation: python/ccxt/pro/ascendex.py

## File Metadata

- **Path**: `python/ccxt/pro/ascendex.py`
- **Size**: 37,547 bytes
- **Lines**: 965
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/ascendex.py`.

**Classes defined**: ascendex

**Functions defined**: describe, watch_order_book, watch_private, watch_trades_for_symbols, watch_public_multiple, handle_trades, watch_trades, watch_public, handle_ohlcv, watch_ohlcv
...
- `authenticate()`
- `describe()`
- `fetch_order_book_snapshot_custom()`
- `handle_authenticate()`
- `handle_balance()`
- `handle_delta()`
- `handle_deltas()`
...
```bash
python python/ccxt/pro/ascendex.py
```
