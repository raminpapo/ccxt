# Documentation: python/ccxt/pro/test/base/test_close.py

## File Metadata

- **Path**: `python/ccxt/pro/test/base/test_close.py`
- **Size**: 6,832 bytes
- **Lines**: 185
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/base/test_close.py`.

**Functions defined**: watch_ticker_task, test_unwatch_tickers_after_cancellation, watch_tickers_task, close_after, watch_trades_for_symbols_loop, test_cancelled_task_no_invalid_state, watch_ticker_loop, test_ws_close
...
- `test_unwatch_tickers_after_cancellation()`
- `test_ws_close()`
- `watch_ticker_loop()`
- `watch_ticker_task()`
- `watch_tickers_task()`
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/base/test_close.py
```
