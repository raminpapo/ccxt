# Documentation: python/ccxt/pro/test/base/test_order_book.py

## File Metadata

- **Path**: `python/ccxt/pro/test/base/test_order_book.py`
- **Size**: 17,353 bytes
- **Lines**: 346
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/base/test_order_book.py`.

**Functions defined**: equals, test_ws_order_book
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/base/test_order_book.py
```
