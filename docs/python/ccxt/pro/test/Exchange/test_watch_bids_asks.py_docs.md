# Documentation: python/ccxt/pro/test/Exchange/test_watch_bids_asks.py

## File Metadata

- **Path**: `python/ccxt/pro/test/Exchange/test_watch_bids_asks.py`
- **Size**: 2,893 bytes
- **Lines**: 63
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/Exchange/test_watch_bids_asks.py`.
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/Exchange/test_watch_bids_asks.py
```
