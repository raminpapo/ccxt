# Documentation: python/ccxt/pro/test/Exchange/test_watch_liquidations.py

## File Metadata

- **Path**: `python/ccxt/pro/test/Exchange/test_watch_liquidations.py`
- **Size**: 1,989 bytes
- **Lines**: 48
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/Exchange/test_watch_liquidations.py`.
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/Exchange/test_watch_liquidations.py
```
