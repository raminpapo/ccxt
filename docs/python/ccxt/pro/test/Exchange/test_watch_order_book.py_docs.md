# Documentation: python/ccxt/pro/test/Exchange/test_watch_order_book.py

## File Metadata

- **Path**: `python/ccxt/pro/test/Exchange/test_watch_order_book.py`
- **Size**: 1,567 bytes
- **Lines**: 39
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/Exchange/test_watch_order_book.py`.
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/Exchange/test_watch_order_book.py
```
