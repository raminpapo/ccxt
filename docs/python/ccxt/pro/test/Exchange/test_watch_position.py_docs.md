# Documentation: python/ccxt/pro/test/Exchange/test_watch_position.py

## File Metadata

- **Path**: `python/ccxt/pro/test/Exchange/test_watch_position.py`
- **Size**: 1,454 bytes
- **Lines**: 38
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/Exchange/test_watch_position.py`.
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/Exchange/test_watch_position.py
```
