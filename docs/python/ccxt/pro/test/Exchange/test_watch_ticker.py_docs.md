# Documentation: python/ccxt/pro/test/Exchange/test_watch_ticker.py

## File Metadata

- **Path**: `python/ccxt/pro/test/Exchange/test_watch_ticker.py`
- **Size**: 1,441 bytes
- **Lines**: 38
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/Exchange/test_watch_ticker.py`.
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/Exchange/test_watch_ticker.py
```
