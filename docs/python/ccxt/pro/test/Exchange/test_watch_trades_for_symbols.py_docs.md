# Documentation: python/ccxt/pro/test/Exchange/test_watch_trades_for_symbols.py

## File Metadata

- **Path**: `python/ccxt/pro/test/Exchange/test_watch_trades_for_symbols.py`
- **Size**: 1,860 bytes
- **Lines**: 43
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/Exchange/test_watch_trades_for_symbols.py`.
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/Exchange/test_watch_trades_for_symbols.py
```
