# Documentation: python/ccxt/pro/test/Exchange/test_watch_orders.py

## File Metadata

- **Path**: `python/ccxt/pro/test/Exchange/test_watch_orders.py`
- **Size**: 1,555 bytes
- **Lines**: 40
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/Exchange/test_watch_orders.py`.
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/Exchange/test_watch_orders.py
```
