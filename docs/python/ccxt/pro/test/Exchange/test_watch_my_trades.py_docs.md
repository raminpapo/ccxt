# Documentation: python/ccxt/pro/test/Exchange/test_watch_my_trades.py

## File Metadata

- **Path**: `python/ccxt/pro/test/Exchange/test_watch_my_trades.py`
- **Size**: 1,563 bytes
- **Lines**: 40
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/Exchange/test_watch_my_trades.py`.
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/Exchange/test_watch_my_trades.py
```
