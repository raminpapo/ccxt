# Documentation: python/ccxt/pro/test/Exchange/test_watch_tickers.py

## File Metadata

- **Path**: `python/ccxt/pro/test/Exchange/test_watch_tickers.py`
- **Size**: 2,898 bytes
- **Lines**: 65
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/test/Exchange/test_watch_tickers.py`.
...
**To run this test:**
```bash
pytest python/ccxt/pro/test/Exchange/test_watch_tickers.py
```
