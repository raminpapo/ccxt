# Documentation: python/ccxt/pro/dydx.py

## File Metadata

- **Path**: `python/ccxt/pro/dydx.py`
- **Size**: 16,517 bytes
- **Lines**: 406
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/dydx.py`.

**Classes defined**: dydx

**Functions defined**: un_watch_trades, describe, parse_ws_trade, watch_order_book, handle_delta, handle_trades, handle_order_book, watch_trades, un_watch_order_book, watch_ohlcv
...
```bash
python python/ccxt/pro/dydx.py
```
