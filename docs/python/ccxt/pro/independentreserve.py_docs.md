# Documentation: python/ccxt/pro/independentreserve.py

## File Metadata

- **Path**: `python/ccxt/pro/independentreserve.py`
- **Size**: 11,391 bytes
- **Lines**: 275
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/independentreserve.py`.

**Classes defined**: independentreserve

**Functions defined**: watch_order_book, describe, parse_ws_trade, value_to_checksum, handle_delta, handle_trades, handle_order_book, handle_deltas, watch_trades, handle_heartbeat
...
```bash
python python/ccxt/pro/independentreserve.py
```
