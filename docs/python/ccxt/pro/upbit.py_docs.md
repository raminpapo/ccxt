# Documentation: python/ccxt/pro/upbit.py

## File Metadata

- **Path**: `python/ccxt/pro/upbit.py`
- **Size**: 28,924 bytes
- **Lines**: 680
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/upbit.py`.

**Classes defined**: upbit

**Functions defined**: watch_ticker, describe, watch_order_book, watch_tickers, watch_trades_for_symbols, watch_public_multiple, watch_trades, watch_public, watch_ohlcv, handle_ticker
...
```bash
python python/ccxt/pro/upbit.py
```
