# Documentation: python/ccxt/pro/kucoinfutures.py

## File Metadata

- **Path**: `python/ccxt/pro/kucoinfutures.py`
- **Size**: 56,092 bytes
- **Lines**: 1,226
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/kucoinfutures.py`.

**Classes defined**: kucoinfutures

**Functions defined**: un_subscribe_multiple, watch_ticker, describe, negotiate, watch_tickers, negotiate_helper, request_id, subscribe_multiple, subscribe, handle_ticker
...
```bash
python python/ccxt/pro/kucoinfutures.py
```
