# Documentation: python/ccxt/pro/xt.py

## File Metadata

- **Path**: `python/ccxt/pro/xt.py`
- **Size**: 63,171 bytes
- **Lines**: 1,376
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/xt.py`.

**Classes defined**: xt, method

**Functions defined**: un_subscribe, watch_ticker, describe, get_cache_index, un_watch_tickers, watch_tickers, handle_delta, un_watch_ticker, get_listen_key, subscribe
