# Documentation: python/ccxt/pro/exmo.py

## File Metadata

- **Path**: `python/ccxt/pro/exmo.py`
- **Size**: 33,960 bytes
- **Lines**: 863
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/exmo.py`.

**Classes defined**: exmo

**Functions defined**: watch_ticker, describe, handle_balance, watch_tickers, parse_spot_balance, watch_balance, request_id, watch_trades, parse_margin_balance, handle_ticker
...
```bash
python python/ccxt/pro/exmo.py
```
