# Documentation: python/ccxt/pro/gemini.py

## File Metadata

- **Path**: `python/ccxt/pro/gemini.py`
- **Size**: 37,083 bytes
- **Lines**: 886
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/gemini.py`.

**Classes defined**: gemini

**Functions defined**: describe, parse_ws_trade, watch_order_book, handle_ohlcv, watch_trades_for_symbols, handle_trades, handle_trade, watch_trades, handle_trades_for_multidata, watch_ohlcv
...
- `authenticate()`
- `describe()`
- `handle_bids_asks_for_multidata()`
- `handle_error()`
- `handle_heartbeat()`
- `handle_l2_updates()`
- `handle_message()`
...
- `handle_order()`
- `handle_order_book()`
- `handle_order_book_for_multidata()`
- `handle_subscription()`
- `handle_trade()`
- `handle_trades()`
- `handle_trades_for_multidata()`
...
```bash
python python/ccxt/pro/gemini.py
```
