# Documentation: python/ccxt/pro/derive.py

## File Metadata

- **Path**: `python/ccxt/pro/derive.py`
- **Size**: 28,625 bytes
- **Lines**: 705
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/derive.py`.

**Classes defined**: derive

**Functions defined**: watch_ticker, un_watch_trades, watch_order_book, describe, un_watch_public, handle_order_book, request_id, un_watch_order_book, watch_public, handle_ticker
...
```bash
python python/ccxt/pro/derive.py
```
