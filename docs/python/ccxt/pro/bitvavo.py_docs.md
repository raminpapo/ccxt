# Documentation: python/ccxt/pro/bitvavo.py

## File Metadata

- **Path**: `python/ccxt/pro/bitvavo.py`
- **Size**: 59,981 bytes
- **Lines**: 1,395
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/bitvavo.py`.

**Classes defined**: bitvavo

**Functions defined**: watch_ticker, describe, watch_tickers, parse_ws_bid_ask, watch_bids_asks, watch_public_multiple, handle_bid_ask, watch_trades, watch_public, handle_ticker
...
**Functions** (63):
- `action_and_market_message_hash()`
- `action_and_order_id_message_hash()`
- `authenticate()`
- `build_message_hash()`
...
- `fetch_order_ws()`
- `fetch_orders_ws()`
- `fetch_trading_fees_ws()`
- `fetch_withdrawals_ws()`
...
```bash
python python/ccxt/pro/bitvavo.py
```
