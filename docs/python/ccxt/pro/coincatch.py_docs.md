# Documentation: python/ccxt/pro/coincatch.py

## File Metadata

- **Path**: `python/ccxt/pro/coincatch.py`
- **Size**: 62,348 bytes
- **Lines**: 1,464
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/coincatch.py`.

**Classes defined**: coincatch

**Functions defined**: un_watch_channel, describe, get_market_from_arg, watch_private, handle_authenticate, watch_public_multiple, un_watch_public, authenticate, watch_public, watch_private_multiple
...
- `describe()`
- `get_market_from_arg()`
- `get_private_inst_type()`
- `get_public_inst_type_and_id()`
- `handle_authenticate()`
- `handle_balance()`
- `handle_check_sum_error()`
- `handle_delta()`
- `handle_deltas()`
- `handle_dmcbl_market_by_message_hashes()`
- `handle_error_message()`
- `handle_message()`
- `handle_ohlcv()`
- `handle_ohlcv_un_subscription()`
- `handle_order()`
- `handle_order_book()`
...
```bash
python python/ccxt/pro/coincatch.py
```
