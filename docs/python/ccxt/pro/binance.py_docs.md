# Documentation: python/ccxt/pro/binance.py

## File Metadata

- **Path**: `python/ccxt/pro/binance.py`
- **Size**: 210,732 bytes
- **Lines**: 4,202
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/binance.py`.

**Classes defined**: binance

**Functions defined**: watch_my_liquidations, parse_ws_liquidation, describe, watch_liquidations, stream, handle_liquidation, is_spot_url, request_id, watch_liquidations_for_symbols, describe_data
...
```bash
python python/ccxt/pro/binance.py
```
