# Documentation: python/ccxt/pro/hitbtc.py

## File Metadata

- **Path**: `python/ccxt/pro/hitbtc.py`
- **Size**: 59,554 bytes
- **Lines**: 1,322
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/hitbtc.py`.

**Classes defined**: hitbtc

**Functions defined**: trade_request, watch_ticker, describe, watch_order_book, subscribe_private, handle_delta, subscribe_public, handle_order_book, handle_deltas, authenticate
...
```bash
python python/ccxt/pro/hitbtc.py
```
