# Documentation: python/ccxt/pro/ndax.py

## File Metadata

- **Path**: `python/ccxt/pro/ndax.py`
- **Size**: 22,982 bytes
- **Lines**: 520
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/ndax.py`.

**Classes defined**: ndax

**Functions defined**: watch_ticker, describe, handle_ticker, handle_trades, name, request_id, watch_trades, being
...
```bash
python python/ccxt/pro/ndax.py
```
