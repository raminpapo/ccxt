# Documentation: python/ccxt/pro/cex.py

## File Metadata

- **Path**: `python/ccxt/pro/cex.py`
- **Size**: 58,596 bytes
- **Lines**: 1,477
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/cex.py`.

**Classes defined**: cex

**Functions defined**: watch_ticker, describe, handle_balance, parse_ws_old_trade, watch_tickers, handle_trades_snapshot, watch_balance, request_id, watch_trades, handle_trade
