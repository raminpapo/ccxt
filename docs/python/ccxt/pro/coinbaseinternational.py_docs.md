# Documentation: python/ccxt/pro/coinbaseinternational.py

## File Metadata

- **Path**: `python/ccxt/pro/coinbaseinternational.py`
- **Size**: 32,170 bytes
- **Lines**: 777
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/coinbaseinternational.py`.

**Classes defined**: coinbaseinternational

**Functions defined**: watch_funding_rates, watch_ticker, describe, watch_tickers, watch_funding_rate, get_active_symbols, parse_ws_instrument, handle_instrument, subscribe_multiple, subscribe
...
```bash
python python/ccxt/pro/coinbaseinternational.py
```
