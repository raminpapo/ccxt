# Documentation: python/ccxt/pro/coinbase.py

## File Metadata

- **Path**: `python/ccxt/pro/coinbase.py`
- **Size**: 40,749 bytes
- **Lines**: 927
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/coinbase.py`.

**Classes defined**: coinbase

**Functions defined**: un_subscribe_multiple, un_subscribe, watch_ticker, describe, un_watch_tickers, watch_tickers, un_watch_ticker, create_ws_auth, subscribe_multiple, subscribe
...
```bash
python python/ccxt/pro/coinbase.py
```
