# Documentation: python/ccxt/pro/kraken.py

## File Metadata

- **Path**: `python/ccxt/pro/kraken.py`
- **Size**: 69,191 bytes
- **Lines**: 1,518
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/kraken.py`.

**Classes defined**: kraken

**Functions defined**: cancel_all_orders_ws, describe, create_order_ws, cancel_order_ws, handle_cancel_all_orders, handle_cancel_order, cancel_orders_ws, handle_create_edit_order, order_request_ws, edit_order_ws
...
```bash
python python/ccxt/pro/kraken.py
```
