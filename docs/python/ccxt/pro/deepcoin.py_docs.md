# Documentation: python/ccxt/pro/deepcoin.py

## File Metadata

- **Path**: `python/ccxt/pro/deepcoin.py`
- **Size**: 48,063 bytes
- **Lines**: 1,167
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/deepcoin.py`.

**Classes defined**: deepcoin

**Functions defined**: watch_ticker, describe, watch_private, create_public_request, ping, request_id, handle_pong, un_watch_public, authenticate, watch_public
...
```bash
python python/ccxt/pro/deepcoin.py
```
