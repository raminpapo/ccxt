# Documentation: python/ccxt/pro/woo.py

## File Metadata

- **Path**: `python/ccxt/pro/woo.py`
- **Size**: 60,816 bytes
- **Lines**: 1,471
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/woo.py`.

**Classes defined**: woo

**Functions defined**: watch_order_book, describe, handle_order_book_message, handle_order_book_subscription, handle_order_book, request_id, un_watch_order_book, fetch_order_book_snapshot, watch_public, unwatch_public
