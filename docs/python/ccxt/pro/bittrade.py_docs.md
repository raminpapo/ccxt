# Documentation: python/ccxt/pro/bittrade.py

## File Metadata

- **Path**: `python/ccxt/pro/bittrade.py`
- **Size**: 23,355 bytes
- **Lines**: 572
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/bittrade.py`.

**Classes defined**: bittrade

**Functions defined**: watch_ticker, handle_order_book_snapshot, describe, watch_order_book, handle_trades, request_id, watch_trades, handle_ohlcv, watch_ohlcv, handle_ticker
...
```bash
python python/ccxt/pro/bittrade.py
```
