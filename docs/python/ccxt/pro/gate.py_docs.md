# Documentation: python/ccxt/pro/gate.py

## File Metadata

- **Path**: `python/ccxt/pro/gate.py`
- **Size**: 89,798 bytes
- **Lines**: 1,975
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/gate.py`.

**Classes defined**: gate

**Functions defined**: cancel_all_orders_ws, fetch_orders_by_status_ws, describe, cancel_order_ws, create_order_ws, create_orders_ws, fetch_closed_orders_ws, fetch_open_orders_ws, edit_order_ws, fetch_order_ws
...
- `fetch_order_ws()`
- `fetch_orders_by_status_ws()`
- `get_cache_index()`
- `get_market_type_by_url()`
- `get_type_by_market()`
- `get_url_by_market()`
- `get_url_by_market_type()`
- `handle_authentication_message()`
- `handle_balance()`
- `handle_balance_subscription()`
...
```bash
python python/ccxt/pro/gate.py
```
