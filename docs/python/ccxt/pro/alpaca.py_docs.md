# Documentation: python/ccxt/pro/alpaca.py

## File Metadata

- **Path**: `python/ccxt/pro/alpaca.py`
- **Size**: 28,420 bytes
- **Lines**: 717
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/alpaca.py`.

**Classes defined**: alpaca

**Functions defined**: parse_ticker, watch_ticker, describe, watch_order_book, handle_delta, handle_order_book, handle_deltas, handle_ohlcv, watch_ohlcv, handle_ticker
...
```bash
python python/ccxt/pro/alpaca.py
```
