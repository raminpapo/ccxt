# Documentation: python/ccxt/pro/apex.py

## File Metadata

- **Path**: `python/ccxt/pro/apex.py`
- **Size**: 42,760 bytes
- **Lines**: 1,005
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/apex.py`.

**Classes defined**: apex

**Functions defined**: describe, parse_ws_trade, watch_order_book, watch_topics, handle_delta, watch_trades_for_symbols, handle_trades, handle_order_book, watch_trades, watch_order_book_for_symbols
...
```bash
python python/ccxt/pro/apex.py
```
