# Documentation: python/ccxt/pro/defx.py

## File Metadata

- **Path**: `python/ccxt/pro/defx.py`
- **Size**: 38,835 bytes
- **Lines**: 832
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/defx.py`.

**Classes defined**: defx

**Functions defined**: watch_ticker, describe, watch_ohlcv_for_symbols, un_watch_ohlcv_for_symbols, un_watch_ticker, un_watch_ohlcv, un_watch_public, watch_public, handle_ohlcv, watch_ohlcv
...
- `parse_ws_bid_ask()`
- `un_watch_ohlcv()`
- `un_watch_ohlcv_for_symbols()`
- `un_watch_order_book()`
- `un_watch_order_book_for_symbols()`
- `un_watch_public()`
- `un_watch_ticker()`
- `un_watch_tickers()`
...
```bash
python python/ccxt/pro/defx.py
```
