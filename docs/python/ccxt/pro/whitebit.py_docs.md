# Documentation: python/ccxt/pro/whitebit.py

## File Metadata

- **Path**: `python/ccxt/pro/whitebit.py`
- **Size**: 37,049 bytes
- **Lines**: 918
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/whitebit.py`.

**Classes defined**: whitebit

**Functions defined**: watch_ticker, watch_order_book, describe, watch_tickers, handle_delta, handle_order_book, handle_deltas, handle_ohlcv, watch_ohlcv, handle_ticker
...
```bash
python python/ccxt/pro/whitebit.py
```
