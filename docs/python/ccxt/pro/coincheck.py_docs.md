# Documentation: python/ccxt/pro/coincheck.py

## File Metadata

- **Path**: `python/ccxt/pro/coincheck.py`
- **Size**: 7,855 bytes
- **Lines**: 205
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/coincheck.py`.

**Classes defined**: coincheck

**Functions defined**: watch_order_book, describe, parse_ws_trade, handle_trades, handle_order_book, watch_trades, handle_message
...
```bash
python python/ccxt/pro/coincheck.py
```
