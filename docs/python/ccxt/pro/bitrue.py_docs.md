# Documentation: python/ccxt/pro/bitrue.py

## File Metadata

- **Path**: `python/ccxt/pro/bitrue.py`
- **Size**: 16,292 bytes
- **Lines**: 448
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/bitrue.py`.

**Classes defined**: bitrue

**Functions defined**: parse_ws_order_type, parse_ws_balances, describe, handle_balance, watch_order_book, parse_ws_order, watch_balance, handle_order_book, handle_order, watch_orders
...
```bash
python python/ccxt/pro/bitrue.py
```
