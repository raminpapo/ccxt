# Documentation: python/ccxt/pro/coinex.py

## File Metadata

- **Path**: `python/ccxt/pro/coinex.py`
- **Size**: 56,701 bytes
- **Lines**: 1,366
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/coinex.py`.

**Classes defined**: coinex

**Functions defined**: describe, handle_balance, parse_ws_balance, parse_ws_ticker, watch_my_trades, handle_my_trades, handle_trades, watch_balance, request_id, handle_ticker
...
```bash
python python/ccxt/pro/coinex.py
```
