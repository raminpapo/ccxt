# Documentation: python/ccxt/pro/arkham.py

## File Metadata

- **Path**: `python/ccxt/pro/arkham.py`
- **Size**: 27,784 bytes
- **Lines**: 687
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/arkham.py`.

**Classes defined**: arkham

**Functions defined**: watch_ticker, describe, watch_order_book, parse_ws_ticker, parse_ws_ohlcv, handle_ohlcv, handle_message, watch_ohlcv, subscribe, handle_ticker
...
```bash
python python/ccxt/pro/arkham.py
```
