# Documentation: python/ccxt/pro/htx.py

## File Metadata

- **Path**: `python/ccxt/pro/htx.py`
- **Size**: 106,157 bytes
- **Lines**: 2,410
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/htx.py`.

**Classes defined**: htx

**Functions defined**: watch_ticker, un_watch_trades, describe, un_watch_ticker, handle_trades, request_id, watch_trades, un_watch_ohlcv, watch_ohlcv, handle_ticker
