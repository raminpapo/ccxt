# Documentation: python/ccxt/pro/backpack.py

## File Metadata

- **Path**: `python/ccxt/pro/backpack.py`
- **Size**: 53,490 bytes
- **Lines**: 1,241
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/backpack.py`.

**Classes defined**: backpack

**Functions defined**: handle_unsubscriptions, watch_ticker, describe, watch_private, un_watch_tickers, watch_tickers, parse_ws_ticker, un_watch_ticker, watch_public, handle_ticker
...
```bash
python python/ccxt/pro/backpack.py
```
