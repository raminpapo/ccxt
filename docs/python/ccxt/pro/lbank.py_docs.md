# Documentation: python/ccxt/pro/lbank.py

## File Metadata

- **Path**: `python/ccxt/pro/lbank.py`
- **Size**: 37,816 bytes
- **Lines**: 925
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/lbank.py`.

**Classes defined**: lbank

**Functions defined**: watch_ticker, describe, parse_ws_ticker, fetch_ticker_ws, fetch_ohlcv_ws, fetch_trades_ws, request_id, handle_ohlcv, watch_ohlcv, handle_ticker
...
```bash
python python/ccxt/pro/lbank.py
```
