# Documentation: python/ccxt/pro/modetrade.py

## File Metadata

- **Path**: `python/ccxt/pro/modetrade.py`
- **Size**: 51,770 bytes
- **Lines**: 1,272
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/modetrade.py`.

**Classes defined**: modetrade

**Functions defined**: watch_ticker, handle_tickers, watch_order_book, describe, parse_ws_ticker, watch_tickers, handle_order_book, request_id, watch_public, handle_ticker
...
```bash
python python/ccxt/pro/modetrade.py
```
