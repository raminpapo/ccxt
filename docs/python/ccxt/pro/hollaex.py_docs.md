# Documentation: python/ccxt/pro/hollaex.py

## File Metadata

- **Path**: `python/ccxt/pro/hollaex.py`
- **Size**: 22,433 bytes
- **Lines**: 580
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/hollaex.py`.

**Classes defined**: hollaex

**Functions defined**: watch_order_book, describe, watch_my_trades, handle_my_trades, handle_trades, watch_balance, handle_order_book, watch_trades, handle_order, watch_orders
...
```bash
python python/ccxt/pro/hollaex.py
```
