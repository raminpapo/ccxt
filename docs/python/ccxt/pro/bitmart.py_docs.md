# Documentation: python/ccxt/pro/bitmart.py

## File Metadata

- **Path**: `python/ccxt/pro/bitmart.py`
- **Size**: 67,239 bytes
- **Lines**: 1,579
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/bitmart.py`.

**Classes defined**: bitmart

**Functions defined**: set_balance_cache, describe, handle_balance, watch_trades_for_symbols, watch_balance, watch_trades, get_params_for_multiple_sub, subscribe_multiple, subscribe, load_balance_snapshot
...
```bash
python python/ccxt/pro/bitmart.py
```
