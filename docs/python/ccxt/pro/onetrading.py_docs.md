# Documentation: python/ccxt/pro/onetrading.py

## File Metadata

- **Path**: `python/ccxt/pro/onetrading.py`
- **Size**: 54,862 bytes
- **Lines**: 1,293
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/onetrading.py`.

**Classes defined**: onetrading

**Functions defined**: handle_balance_snapshot, watch_ticker, describe, watch_order_book, parse_ws_ticker, watch_tickers, watch_my_trades, watch_balance, handle_order_book, handle_ticker
...
- `handle_order_book()`
- `handle_orders()`
- `handle_price_point_updates()`
- `handle_subscriptions()`
- `handle_ticker()`
- `handle_trading()`
- `parse_trading_order()`
- `parse_trading_order_status()`
...
```bash
python python/ccxt/pro/onetrading.py
```
