# Documentation: python/ccxt/pro/bitstamp.py

## File Metadata

- **Path**: `python/ccxt/pro/bitstamp.py`
- **Size**: 22,397 bytes
- **Lines**: 556
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/bitstamp.py`.

**Classes defined**: bitstamp

**Functions defined**: watch_order_book, describe, parse_ws_trade, get_cache_index, handle_delta, handle_order_book, handle_trade, watch_trades, watch_orders, handle_bid_asks
...
```bash
python python/ccxt/pro/bitstamp.py
```
