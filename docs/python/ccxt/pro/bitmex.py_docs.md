# Documentation: python/ccxt/pro/bitmex.py

## File Metadata

- **Path**: `python/ccxt/pro/bitmex.py`
- **Size**: 74,674 bytes
- **Lines**: 1,695
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/bitmex.py`.

**Classes defined**: bitmex

**Functions defined**: watch_ticker, describe, watch_liquidations, handle_balance, watch_tickers, handle_liquidation, handle_trades, watch_balance, watch_liquidations_for_symbols, handle_ticker
...
```bash
python python/ccxt/pro/bitmex.py
```
