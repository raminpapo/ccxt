# Documentation: python/ccxt/pro/okx.py

## File Metadata

- **Path**: `python/ccxt/pro/okx.py`
- **Size**: 106,545 bytes
- **Lines**: 2,366
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/okx.py`.

**Classes defined**: okx

**Functions defined**: un_watch_trades, get_url, describe, un_watch_trades_for_symbols, watch_trades_for_symbols, handle_trades, watch_funding_rate, watch_trades, subscribe_multiple, subscribe
