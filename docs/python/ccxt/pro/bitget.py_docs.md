# Documentation: python/ccxt/pro/bitget.py

## File Metadata

- **Path**: `python/ccxt/pro/bitget.py`
- **Size**: 118,787 bytes
- **Lines**: 2,713
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/bitget.py`.

**Classes defined**: bitget

**Functions defined**: watch_ticker, describe, parse_ws_ticker, watch_tickers, parse_ws_bid_ask, un_watch_ticker, handle_bid_ask, watch_bids_asks, get_inst_type, handle_ticker
...
```bash
python python/ccxt/pro/bitget.py
```
