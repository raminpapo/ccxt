# Documentation: python/ccxt/pro/kucoin.py

## File Metadata

- **Path**: `python/ccxt/pro/kucoin.py`
- **Size**: 63,938 bytes
- **Lines**: 1,419
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/pro/kucoin.py`.

**Classes defined**: kucoin

**Functions defined**: un_subscribe_multiple, un_subscribe, watch_ticker, describe, negotiate, un_watch_ticker, negotiate_helper, request_id, subscribe_multiple, subscribe
...
```bash
python python/ccxt/pro/kucoin.py
```
