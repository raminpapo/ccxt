# Documentation: python/ccxt/coinmate.py

## File Metadata

- **Path**: `python/ccxt/coinmate.py`
- **Size**: 50,352 bytes
- **Lines**: 1,194
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/coinmate.py`.
...
```bash
python python/ccxt/coinmate.py
```
