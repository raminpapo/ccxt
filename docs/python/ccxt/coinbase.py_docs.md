# Documentation: python/ccxt/coinbase.py

## File Metadata

- **Path**: `python/ccxt/coinbase.py`
- **Size**: 240,067 bytes
- **Lines**: 5,002
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/coinbase.py`.
...
```bash
python python/ccxt/coinbase.py
```
