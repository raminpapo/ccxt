# Documentation: python/ccxt/static_dependencies/keccak/keccak.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/keccak/keccak.py`
- **Size**: 6,934 bytes
- **Lines**: 198
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/keccak/keccak.py`.

**Functions defined**: rotate, SHA3, store64, load64, Keccak, can, keccak_f_1600, minus, c
...
```bash
python python/ccxt/static_dependencies/keccak/keccak.py
```
