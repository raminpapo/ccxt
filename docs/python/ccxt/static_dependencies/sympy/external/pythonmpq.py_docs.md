# Documentation: python/ccxt/static_dependencies/sympy/external/pythonmpq.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/sympy/external/pythonmpq.py`
- **Size**: 11,243 bytes
- **Lines**: 342
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/sympy/external/pythonmpq.py`.

**Classes defined**: here, is, PythonMPQ

**Functions defined**: _new, __str__, __new__, __bool__, __reduce__, __float__, __hash__, __int__, __eq__, _new_check
...
```bash
python python/ccxt/static_dependencies/sympy/external/pythonmpq.py
```
