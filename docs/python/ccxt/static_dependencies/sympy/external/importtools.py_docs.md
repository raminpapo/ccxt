# Documentation: python/ccxt/static_dependencies/sympy/external/importtools.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/sympy/external/importtools.py`
- **Size**: 7,671 bytes
- **Lines**: 188
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/sympy/external/importtools.py`.

**Functions defined**: import_module, will, __sympy_debug, uses, from, version_tuple
...
```bash
python python/ccxt/static_dependencies/sympy/external/importtools.py
```
