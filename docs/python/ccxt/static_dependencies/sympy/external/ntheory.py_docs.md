# Documentation: python/ccxt/static_dependencies/sympy/external/ntheory.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/sympy/external/ntheory.py`
- **Size**: 18,051 bytes
- **Lines**: 638
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/sympy/external/ntheory.py`.

**Functions defined**: _sign, sqrtrem, gcd, gcdext, bit_scan1, remove, sqrt, lcm, bit_scan0, factorial
...
```bash
python python/ccxt/static_dependencies/sympy/external/ntheory.py
```
