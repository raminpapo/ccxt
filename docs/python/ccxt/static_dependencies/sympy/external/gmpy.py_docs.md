# Documentation: python/ccxt/static_dependencies/sympy/external/gmpy.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/sympy/external/gmpy.py`
- **Size**: 10,283 bytes
- **Lines**: 346
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/sympy/external/gmpy.py`.

**Functions defined**: is_square, sqrtrem, gcd, jacobi, _get_gmpy2, iroot, _get_flint, sqrt, lcm, _flint_version_okay
...
```bash
python python/ccxt/static_dependencies/sympy/external/gmpy.py
```
