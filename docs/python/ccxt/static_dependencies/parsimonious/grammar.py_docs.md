# Documentation: python/ccxt/static_dependencies/parsimonious/grammar.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/parsimonious/grammar.py`
- **Size**: 19,190 bytes
- **Lines**: 488
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/parsimonious/grammar.py`.

**Classes defined**: TokenRuleVisitor, LazyReference, TokenGrammar, RuleVisitor, Grammar, BootstrappingGrammar

**Functions defined**: _copy, __str__, _check_default_rule, __init__, parse, match, _expressions_from_rules, default, __repr__
...
```bash
python python/ccxt/static_dependencies/parsimonious/grammar.py
```
