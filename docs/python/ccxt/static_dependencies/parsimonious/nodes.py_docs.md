# Documentation: python/ccxt/static_dependencies/parsimonious/nodes.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/parsimonious/nodes.py`
- **Size**: 13,084 bytes
- **Lines**: 326
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/parsimonious/nodes.py`.

**Classes defined**: Node, RuleDecoratorMeta, is, var, NodeVisitor, that, RegexNode

**Functions defined**: __str__, expr_name, __init__, text, __ne__, __iter__, indent, prettily, __eq__, __repr__
...
```bash
python python/ccxt/static_dependencies/parsimonious/nodes.py
```
