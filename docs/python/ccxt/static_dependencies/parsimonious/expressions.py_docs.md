# Documentation: python/ccxt/static_dependencies/parsimonious/expressions.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/parsimonious/expressions.py`
- **Size**: 16,864 bytes
- **Lines**: 480
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/parsimonious/expressions.py`.

**Classes defined**: Compound, Expression, directly, Regex, Literal, TokenMatcher, AdHocExpression, Sequence, lookups, OneOf

**Functions defined**: is_callable, __init__, __hash__, expression, __ne__, foo, _uncached_match, _as_rhs, __eq__
...
```bash
python python/ccxt/static_dependencies/parsimonious/expressions.py
```
