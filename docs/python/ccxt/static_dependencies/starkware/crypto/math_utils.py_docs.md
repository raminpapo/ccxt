# Documentation: python/ccxt/static_dependencies/starkware/crypto/math_utils.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starkware/crypto/math_utils.py`
- **Size**: 3,145 bytes
- **Lines**: 79
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starkware/crypto/math_utils.py`.

**Functions defined**: ec_neg, ec_add, div_mod, ec_double, div_ceil, ec_mult
...
```bash
python python/ccxt/static_dependencies/starkware/crypto/math_utils.py
```
