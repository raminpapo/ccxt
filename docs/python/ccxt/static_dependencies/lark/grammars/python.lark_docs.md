# Documentation: python/ccxt/static_dependencies/lark/grammars/python.lark

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/grammars/python.lark`
- **Size**: 10,641 bytes
- **Lines**: 303
- **Type**: Unknown
- **Extension**: .lark
...
This is a Unknown file located at `python/ccxt/static_dependencies/lark/grammars/python.lark`.
