# Documentation: python/ccxt/static_dependencies/lark/tree_matcher.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/tree_matcher.py`
- **Size**: 6,003 bytes
- **Lines**: 187
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/tree_matcher.py`.

**Classes defined**: _MakeTreeMatch, ChildrenLexer, TreeMatcher

**Functions defined**: _match, _best_from_group, __call__, make_recons_rule, make_recons_rule_to_term, __init__, _best_rules_from_group, is_discarded_terminal, parse_rulename
...
```bash
python python/ccxt/static_dependencies/lark/tree_matcher.py
```
