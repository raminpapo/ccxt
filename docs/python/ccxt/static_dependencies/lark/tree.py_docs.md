# Documentation: python/ccxt/static_dependencies/lark/tree.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/tree.py`
- **Size**: 8,522 bytes
- **Lines**: 268
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/tree.py`.

**Classes defined**: Meta, Tree, SlottedTree

**Functions defined**: pretty, meta, _pretty, __rich__, __init__, _pretty_label, _rich, __eq__, __repr__
...
```bash
python python/ccxt/static_dependencies/lark/tree.py
```
