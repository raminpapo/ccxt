# Documentation: python/ccxt/static_dependencies/lark/indenter.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/indenter.py`
- **Size**: 4,221 bytes
- **Lines**: 144
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/indenter.py`.

**Classes defined**: PythonIndenter, Indenter, DedentError

**Functions defined**: NL_type, DEDENT_type, OPEN_PAREN_types, handle_NL, _process, CLOSE_PAREN_types, __init__, process, INDENT_type, always_accept
...
```bash
python python/ccxt/static_dependencies/lark/indenter.py
```
