# Documentation: python/ccxt/static_dependencies/lark/lark.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/lark.py`
- **Size**: 28,184 bytes
- **Lines**: 659
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/lark.py`.

**Classes defined**: instead, Lark, LarkOptions, PostLex

**Functions defined**: _prepare_callbacks, __init__, __setattr__, _build_parser, serialize, _build_lexer, deserialize, process, __getattr__
...
- `punctuation` (imported)
- `/.lark_cache_%s_%s_%s_%s.tmp` (referenced)
...
```bash
python python/ccxt/static_dependencies/lark/lark.py
```
