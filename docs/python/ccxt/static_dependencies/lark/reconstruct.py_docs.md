# Documentation: python/ccxt/static_dependencies/lark/reconstruct.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/reconstruct.py`
- **Size**: 3,763 bytes
- **Lines**: 108
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/reconstruct.py`.

**Classes defined**: WriteTokensTransformer, Reconstructor

**Functions defined**: is_iter_empty, _reconstruct, __init__, reconstruct, __default__
...
```bash
python python/ccxt/static_dependencies/lark/reconstruct.py
```
