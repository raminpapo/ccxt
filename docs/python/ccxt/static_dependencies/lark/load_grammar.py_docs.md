# Documentation: python/ccxt/static_dependencies/lark/load_grammar.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/load_grammar.py`
- **Size**: 53,946 bytes
- **Lines**: 1,429
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/load_grammar.py`.

**Classes defined**: PrepareAnonTerminals, PrepareLiterals, _ReplaceSymbols, FindRuleSize, TerminalTreeToPattern, EBNF_to_BNF, ApplyTemplates, ValidateSymbols, RuleTreeToText, SimplifyRule_Visitor

**Functions defined**: _args_as_int, _add_repeat_rule, expansions, _add_recurse_rule, _name_rule, __init__, _add_rule, _will_not_get_removed, expansion
...
```bash
python python/ccxt/static_dependencies/lark/load_grammar.py
```
