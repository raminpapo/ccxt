# Documentation: python/ccxt/static_dependencies/lark/parser_frontends.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/parser_frontends.py`
- **Size**: 10,165 bytes
- **Lines**: 258
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/parser_frontends.py`.

**Classes defined**: PostLexConnector, ParsingFrontend, EarleyRegexpMatcher, CYK_FrontEnd, CustomLexerWrapper

**Functions defined**: lex, _make_lexer_thread, _wrap_lexer, __init__, parse, _verify_start, _deserialize_parsing_frontend, parse_interactive, _validate_frontend_args
...
```bash
python python/ccxt/static_dependencies/lark/parser_frontends.py
```
