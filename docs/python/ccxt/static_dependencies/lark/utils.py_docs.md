# Documentation: python/ccxt/static_dependencies/lark/utils.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/utils.py`
- **Size**: 11,176 bytes
- **Lines**: 344
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/utils.py`.

**Classes defined**: SerializeMemoizer, FS, OrderedSet, fzset, Enumerator, Serialize

**Functions defined**: get_regexp_width, memo_serialize, classify, __init__, serialize, in_types, deserialize, _deserialize
...
```bash
python python/ccxt/static_dependencies/lark/utils.py
```
