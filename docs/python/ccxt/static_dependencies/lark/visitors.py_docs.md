# Documentation: python/ccxt/static_dependencies/lark/visitors.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/visitors.py`
- **Size**: 21,422 bytes
- **Lines**: 597
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/visitors.py`.

**Classes defined**: TransformerChain, Transformer_InPlace, _Decoratable, TImportedGrammar, T, InlineTransformer, TBase, _DiscardType, Transformer, Transformer_NonRecursive

**Functions defined**: ignore_tree, _apply_v_args, level, __init__, IGNORE_TOKEN, __class_getitem__, isn, _call_userfunc_token, _call_userfunc, __repr__
...
```bash
python python/ccxt/static_dependencies/lark/visitors.py
```
