# Documentation: python/ccxt/static_dependencies/lark/tree_templates.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/tree_templates.py`
- **Size**: 5,959 bytes
- **Lines**: 181
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/tree_templates.py`.

**Classes defined**: for, _ReplaceVars, TemplateTranslator, Template, TemplateConf

**Functions defined**: search, __call__, _match_tree_template, __init__, test_var, _get_tree, match, __default__
...
```bash
python python/ccxt/static_dependencies/lark/tree_templates.py
```
