# Documentation: python/ccxt/static_dependencies/lark/parsers/xearley.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/parsers/xearley.py`
- **Size**: 7,825 bytes
- **Lines**: 166
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/parsers/xearley.py`.

**Classes defined**: Parser

**Functions defined**: scan, _parse, __init__
...
```bash
python python/ccxt/static_dependencies/lark/parsers/xearley.py
```
