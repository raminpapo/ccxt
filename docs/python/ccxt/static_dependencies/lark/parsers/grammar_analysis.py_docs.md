# Documentation: python/ccxt/static_dependencies/lark/parsers/grammar_analysis.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/parsers/grammar_analysis.py`
- **Size**: 7,106 bytes
- **Lines**: 204
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/parsers/grammar_analysis.py`.

**Classes defined**: GrammarAnalyzer, RulePtr, LR0ItemSet

**Functions defined**: advance, update_set, __init__, __hash__, next, __eq__, __repr__, is_satisfied
...
```bash
python python/ccxt/static_dependencies/lark/parsers/grammar_analysis.py
```
