# Documentation: python/ccxt/static_dependencies/lark/parsers/earley.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/parsers/earley.py`
- **Size**: 14,883 bytes
- **Lines**: 315
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/parsers/earley.py`.

**Classes defined**: Parser

**Functions defined**: scan, is_quasi_complete, __init__, parse, _parse, predict_and_complete, create_leo_transitives
...
```bash
python python/ccxt/static_dependencies/lark/parsers/earley.py
```
