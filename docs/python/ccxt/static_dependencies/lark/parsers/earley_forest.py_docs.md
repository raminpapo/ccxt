# Documentation: python/ccxt/static_dependencies/lark/parsers/earley_forest.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/parsers/earley_forest.py`
- **Size**: 31,313 bytes
- **Lines**: 802
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/parsers/earley_forest.py`.

**Classes defined**: ForestVisitor, performs, ForestTransformer, StableSymbolNode, ForestNode, SymbolNode, TokenNode, for, PackedNode

**Functions defined**: load_paths, children, __init__, add_path, __iter__, add_family, is_empty, __repr__, is_ambiguous
...
```bash
python python/ccxt/static_dependencies/lark/parsers/earley_forest.py
```
