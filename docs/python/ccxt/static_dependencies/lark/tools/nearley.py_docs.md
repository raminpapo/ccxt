# Documentation: python/ccxt/static_dependencies/lark/tools/nearley.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/tools/nearley.py`
- **Size**: 6,265 bytes
- **Lines**: 203
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/tools/nearley.py`.

**Classes defined**: NearleyToLark, TransformNearley

**Functions defined**: rule, _new_function, _extra_rule, __init__, null, string, expr, regexp, ruledef, _get_rulename
...
```bash
python python/ccxt/static_dependencies/lark/tools/nearley.py
```
