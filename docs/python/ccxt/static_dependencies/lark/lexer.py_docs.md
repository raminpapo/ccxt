# Documentation: python/ccxt/static_dependencies/lark/lexer.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/lark/lexer.py`
- **Size**: 24,037 bytes
- **Lines**: 679
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/lark/lexer.py`.

**Classes defined**: LineCounter, for, TerminalDef, Token, inherits, UnlessCallback, PatternStr, Pattern, CallChain, PatternRE

**Functions defined**: _get_flags, __init__, __hash__, min_width, __eq__, __repr__, max_width, to_regexp
...
```bash
python python/ccxt/static_dependencies/lark/lexer.py
```
