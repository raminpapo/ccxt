# Documentation: python/ccxt/static_dependencies/msgpack/unpack.h

## File Metadata

- **Path**: `python/ccxt/static_dependencies/msgpack/unpack.h`
- **Size**: 10,976 bytes
- **Lines**: 392
- **Type**: C/C++ Header
- **Extension**: .h
...
This is a C/C++ Header file located at `python/ccxt/static_dependencies/msgpack/unpack.h`.
