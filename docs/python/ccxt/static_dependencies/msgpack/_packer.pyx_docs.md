# Documentation: python/ccxt/static_dependencies/msgpack/_packer.pyx

## File Metadata

- **Path**: `python/ccxt/static_dependencies/msgpack/_packer.pyx`
- **Size**: 14,607 bytes
- **Lines**: 375
- **Type**: Unknown
- **Extension**: .pyx
...
This is a Unknown file located at `python/ccxt/static_dependencies/msgpack/_packer.pyx`.

**Classes defined**: Packer

**Functions defined**: pack_array_header, __dealloc__, reset, __init__, pack_map_pairs, pack_map_header, pack_ext_type, __cinit__, bytes, getbuffer
