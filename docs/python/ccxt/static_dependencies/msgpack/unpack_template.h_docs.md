# Documentation: python/ccxt/static_dependencies/msgpack/unpack_template.h

## File Metadata

- **Path**: `python/ccxt/static_dependencies/msgpack/unpack_template.h`
- **Size**: 14,846 bytes
- **Lines**: 465
- **Type**: C/C++ Header
- **Extension**: .h
...
This is a C/C++ Header file located at `python/ccxt/static_dependencies/msgpack/unpack_template.h`.
