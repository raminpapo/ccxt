# Documentation: python/ccxt/static_dependencies/msgpack/_unpacker.pyx

## File Metadata

- **Path**: `python/ccxt/static_dependencies/msgpack/_unpacker.pyx`
- **Size**: 18,888 bytes
- **Lines**: 548
- **Type**: Unknown
- **Extension**: .pyx
...
This is a Unknown file located at `python/ccxt/static_dependencies/msgpack/_unpacker.pyx`.

**Classes defined**: Unpacker

**Functions defined**: skip, __dealloc__, feed, read_array_header, __init__, __cinit__, read_bytes, unpack, unpackb, default_read_extended_type
