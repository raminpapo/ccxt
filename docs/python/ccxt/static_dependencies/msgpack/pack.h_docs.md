# Documentation: python/ccxt/static_dependencies/msgpack/pack.h

## File Metadata

- **Path**: `python/ccxt/static_dependencies/msgpack/pack.h`
- **Size**: 2,072 bytes
- **Lines**: 90
- **Type**: C/C++ Header
- **Extension**: .h
...
This is a C/C++ Header file located at `python/ccxt/static_dependencies/msgpack/pack.h`.
