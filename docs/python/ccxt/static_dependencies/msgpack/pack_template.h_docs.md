# Documentation: python/ccxt/static_dependencies/msgpack/pack_template.h

## File Metadata

- **Path**: `python/ccxt/static_dependencies/msgpack/pack_template.h`
- **Size**: 21,775 bytes
- **Lines**: 821
- **Type**: C/C++ Header
- **Extension**: .h
...
This is a C/C++ Header file located at `python/ccxt/static_dependencies/msgpack/pack_template.h`.
