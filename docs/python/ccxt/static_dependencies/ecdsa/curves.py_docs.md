# Documentation: python/ccxt/static_dependencies/ecdsa/curves.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ecdsa/curves.py`
- **Size**: 1,886 bytes
- **Lines**: 57
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ecdsa/curves.py`.

**Classes defined**: UnknownCurveError, Curve

**Functions defined**: orderlen, __init__, find_curve
...
```bash
python python/ccxt/static_dependencies/ecdsa/curves.py
```
