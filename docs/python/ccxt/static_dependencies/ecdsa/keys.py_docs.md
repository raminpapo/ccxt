# Documentation: python/ccxt/static_dependencies/ecdsa/keys.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ecdsa/keys.py`
- **Size**: 14,557 bytes
- **Lines**: 344
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ecdsa/keys.py`.

**Classes defined**: VerifyingKey, SigningKey, BadSignatureError, BadDigestError

**Functions defined**: from_public_key_recovery_with_digest, from_der, from_public_point, _raw_encode, __init__, to_string, from_pem, _compressed_encode, from_string, from_public_key_recovery
...
```bash
python python/ccxt/static_dependencies/ecdsa/keys.py
```
