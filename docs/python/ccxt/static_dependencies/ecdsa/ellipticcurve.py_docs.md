# Documentation: python/ccxt/static_dependencies/ecdsa/ellipticcurve.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ecdsa/ellipticcurve.py`
- **Size**: 35,839 bytes
- **Lines**: 1,040
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ecdsa/ellipticcurve.py`.

**Classes defined**: CurveFp, Point, PointJacobi, AbstractPoint

**Functions defined**: a, b, __str__, __mul__, __init__, contains_point, __add__, __eq__, p
...
```bash
python python/ccxt/static_dependencies/ecdsa/ellipticcurve.py
```
