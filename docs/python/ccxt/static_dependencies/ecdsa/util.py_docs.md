# Documentation: python/ccxt/static_dependencies/ecdsa/util.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ecdsa/util.py`
- **Size**: 10,037 bytes
- **Lines**: 267
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ecdsa/util.py`.

**Classes defined**: PRNG

**Functions defined**: block_generator, bits_and_bytes, lsb_of_ones, __call__, __init__, is, randrange_from_seed__truncate_bytes, randrange_from_seed__overshoot_modulo, not, randrange
...
```bash
python python/ccxt/static_dependencies/ecdsa/util.py
```
