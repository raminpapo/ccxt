# Documentation: python/ccxt/static_dependencies/ecdsa/der.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ecdsa/der.py`
- **Size**: 6,942 bytes
- **Lines**: 222
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ecdsa/der.py`.

**Classes defined**: UnexpectedDER

**Functions defined**: encode_octet_string, encode_number, encode_bitstring, remove_sequence, remove_constructed, encode_sequence, remove_octet_string, encode_oid, encode_integer, encode_constructed
...
```bash
python python/ccxt/static_dependencies/ecdsa/der.py
```
