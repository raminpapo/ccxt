# Documentation: python/ccxt/static_dependencies/ecdsa/ecdsa.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ecdsa/ecdsa.py`
- **Size**: 11,336 bytes
- **Lines**: 311
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ecdsa/ecdsa.py`.

**Classes defined**: Signature, Public_key, Private_key, RSZeroError

**Functions defined**: string_to_int, to, int_to_string, sign, __init__, recover_public_keys, verifies, digest_integer
...
```bash
python python/ccxt/static_dependencies/ecdsa/ecdsa.py
```
