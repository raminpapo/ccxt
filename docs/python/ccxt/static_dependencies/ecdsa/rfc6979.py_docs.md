# Documentation: python/ccxt/static_dependencies/ecdsa/rfc6979.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ecdsa/rfc6979.py`
- **Size**: 2,572 bytes
- **Lines**: 101
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ecdsa/rfc6979.py`.

**Functions defined**: bit_length, used, bits2octets, generate_k, bits2int
...
```bash
python python/ccxt/static_dependencies/ecdsa/rfc6979.py
```
