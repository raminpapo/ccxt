# Documentation: python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/clob_pair_pb2.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/clob_pair_pb2.py`
- **Size**: 3,314 bytes
- **Lines**: 42
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/clob_pair_pb2.py`.
...
```bash
python python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/clob_pair_pb2.py
```
