# Documentation: python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/liquidations_pb2.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/liquidations_pb2.py`
- **Size**: 2,909 bytes
- **Lines**: 39
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/liquidations_pb2.py`.
...
```bash
python python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/liquidations_pb2.py
```
