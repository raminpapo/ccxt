# Documentation: python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/order_pb2.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/order_pb2.py`
- **Size**: 8,850 bytes
- **Lines**: 87
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/order_pb2.py`.
...
```bash
python python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/clob/order_pb2.py
```
