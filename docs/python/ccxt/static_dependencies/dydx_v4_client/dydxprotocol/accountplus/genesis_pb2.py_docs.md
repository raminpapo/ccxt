# Documentation: python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/accountplus/genesis_pb2.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/accountplus/genesis_pb2.py`
- **Size**: 3,011 bytes
- **Lines**: 41
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/accountplus/genesis_pb2.py`.
...
```bash
python python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/accountplus/genesis_pb2.py
```
