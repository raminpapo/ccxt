# Documentation: python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/accountplus/query_pb2.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/accountplus/query_pb2.py`
- **Size**: 5,291 bytes
- **Lines**: 58
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/accountplus/query_pb2.py`.
...
```bash
python python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/accountplus/query_pb2.py
```
