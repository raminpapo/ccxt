# Documentation: python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/subaccounts/query_pb2.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/subaccounts/query_pb2.py`
- **Size**: 6,570 bytes
- **Lines**: 64
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/subaccounts/query_pb2.py`.
...
```bash
python python/ccxt/static_dependencies/dydx_v4_client/dydxprotocol/subaccounts/query_pb2.py
```
