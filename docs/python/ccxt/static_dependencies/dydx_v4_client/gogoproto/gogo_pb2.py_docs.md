# Documentation: python/ccxt/static_dependencies/dydx_v4_client/gogoproto/gogo_pb2.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/dydx_v4_client/gogoproto/gogo_pb2.py`
- **Size**: 14,516 bytes
- **Lines**: 103
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/dydx_v4_client/gogoproto/gogo_pb2.py`.
...
```bash
python python/ccxt/static_dependencies/dydx_v4_client/gogoproto/gogo_pb2.py
```
