# Documentation: python/ccxt/static_dependencies/dydx_v4_client/cosmos/tx/v1beta1/tx_pb2.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/dydx_v4_client/cosmos/tx/v1beta1/tx_pb2.py`
- **Size**: 7,230 bytes
- **Lines**: 76
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/dydx_v4_client/cosmos/tx/v1beta1/tx_pb2.py`.
...
```bash
python python/ccxt/static_dependencies/dydx_v4_client/cosmos/tx/v1beta1/tx_pb2.py
```
