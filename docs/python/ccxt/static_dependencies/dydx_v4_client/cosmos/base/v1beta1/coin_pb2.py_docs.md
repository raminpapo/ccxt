# Documentation: python/ccxt/static_dependencies/dydx_v4_client/cosmos/base/v1beta1/coin_pb2.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/dydx_v4_client/cosmos/base/v1beta1/coin_pb2.py`
- **Size**: 3,238 bytes
- **Lines**: 48
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/dydx_v4_client/cosmos/base/v1beta1/coin_pb2.py`.
...
```bash
python python/ccxt/static_dependencies/dydx_v4_client/cosmos/base/v1beta1/coin_pb2.py
```
