# Documentation: python/ccxt/static_dependencies/marshmallow/fields.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/marshmallow/fields.py`
- **Size**: 72,898 bytes
- **Lines**: 2,115
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/marshmallow/fields.py`.

**Classes defined**: Nested, ChildSchema, Pluck, TitleCase, ParentSchema, Raw, AlbumSchema, name, ArtistSchema, Field

**Functions defined**: _validate_all, make_error, fail, _validate_missing, __init__, _validate, serialize, __repr__, __deepcopy__, get_value
...
```bash
python python/ccxt/static_dependencies/marshmallow/fields.py
```
