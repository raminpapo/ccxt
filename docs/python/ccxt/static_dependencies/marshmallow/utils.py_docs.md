# Documentation: python/ccxt/static_dependencies/marshmallow/utils.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/marshmallow/utils.py`
- **Size**: 11,853 bytes
- **Lines**: 379
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/marshmallow/utils.py`.

**Classes defined**: or, _Missing, return

**Functions defined**: is_keyed_tuple, __bool__, pprint, is_iterable_but_not_string, is_collection, is_instance_or_subclass, is_generator, __copy__, __repr__, __deepcopy__
...
```bash
python python/ccxt/static_dependencies/marshmallow/utils.py
```
