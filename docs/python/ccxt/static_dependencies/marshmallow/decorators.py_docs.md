# Documentation: python/ccxt/static_dependencies/marshmallow/decorators.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/marshmallow/decorators.py`
- **Size**: 8,290 bytes
- **Lines**: 232
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/marshmallow/decorators.py`.

**Classes defined**: UserSchema, MarshmallowHook

**Functions defined**: validates, remove_envelope, validate_age, lowerstrip_email, add_envelope, pre_load, post_dump, validates_schema, validate_email, pre_dump
...
```bash
python python/ccxt/static_dependencies/marshmallow/decorators.py
```
