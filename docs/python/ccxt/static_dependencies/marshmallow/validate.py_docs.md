# Documentation: python/ccxt/static_dependencies/marshmallow/validate.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/marshmallow/validate.py`
- **Size**: 23,826 bytes
- **Lines**: 679
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/marshmallow/validate.py`.

**Classes defined**: Range, And, does, Length, Validator, for, Equal, Email, RegexMemoizer, URL

**Functions defined**: __call__, _regex_generator, __init__, _repr_args, is_even, __repr__
...
```bash
python python/ccxt/static_dependencies/marshmallow/validate.py
```
