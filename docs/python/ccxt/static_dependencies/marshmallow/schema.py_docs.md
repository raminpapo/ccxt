# Documentation: python/ccxt/static_dependencies/marshmallow/schema.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/marshmallow/schema.py`
- **Size**: 48,832 bytes
- **Lines**: 1,229
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/marshmallow/schema.py`.

**Classes defined**: SchemaMeta, Meta, object, itself, attributes, klass, attribute

**Functions defined**: allows, _get_fields, _get_fields_by_mro, __new__, __init__, resolve_hooks, __repr__, get_declared_fields
...
```bash
python python/ccxt/static_dependencies/marshmallow/schema.py
```
