# Documentation: python/ccxt/static_dependencies/ethereum/utils/logging.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/utils/logging.py`
- **Size**: 5,155 bytes
- **Lines**: 160
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/utils/logging.py`.

**Classes defined**: exists, HasLoggerMeta, HasLogger, _BaseHasExtendedDebugLogger, _BaseHasLogger, ExtendedDebugLogger, changes, HasExtendedDebugLogger, that

**Functions defined**: debug2, setup_DEBUG2_logging, get_extended_debug_logger, in, __new__, get_logger, __reduce__, replace_logger_class, _use_logger_class, show_debug2
...
```bash
python python/ccxt/static_dependencies/ethereum/utils/logging.py
```
