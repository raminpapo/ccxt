# Documentation: python/ccxt/static_dependencies/ethereum/utils/address.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/utils/address.py`
- **Size**: 4,364 bytes
- **Lines**: 172
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/utils/address.py`.

**Functions defined**: is_canonical_address, is_address, is_normalized_address, to_canonical_address, is_binary_address, is_same_address, to_normalized_address, is_hex_address, is_checksum_address, to_checksum_address
...
```bash
python python/ccxt/static_dependencies/ethereum/utils/address.py
```
