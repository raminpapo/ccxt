# Documentation: python/ccxt/static_dependencies/ethereum/utils/humanize.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/utils/humanize.py`
- **Size**: 4,137 bytes
- **Lines**: 189
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/utils/humanize.py`.

**Functions defined**: _humanize_seconds, is_ipfs_uri, _find_breakpoints, _extract_integer_ranges, humanize_seconds, _is_CIDv0_ipfs_hash, humanize_hash, humanize_bytes, humanize_ipfs_uri, _consume_leading_zero_units
...
**Functions** (13):
- `_consume_leading_zero_units()`
- `_extract_integer_ranges()`
- `_find_breakpoints()`
- `_humanize_range()`
- `_humanize_seconds()`
- `_is_CIDv0_ipfs_hash()`
...
```bash
python python/ccxt/static_dependencies/ethereum/utils/humanize.py
```
