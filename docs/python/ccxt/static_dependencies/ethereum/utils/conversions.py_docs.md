# Documentation: python/ccxt/static_dependencies/ethereum/utils/conversions.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/utils/conversions.py`
- **Size**: 5,498 bytes
- **Lines**: 191
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/utils/conversions.py`.

**Functions defined**: text_if_str, hexstr_if_str, to_text, to_bytes, to_int, to_hex
...
```bash
python python/ccxt/static_dependencies/ethereum/utils/conversions.py
```
