# Documentation: python/ccxt/static_dependencies/ethereum/utils/functional.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/utils/functional.py`
- **Size**: 2,100 bytes
- **Lines**: 76
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/utils/functional.py`.

**Functions defined**: identity, apply_to_return_value, combine, outer, inner
...
```bash
python python/ccxt/static_dependencies/ethereum/utils/functional.py
```
