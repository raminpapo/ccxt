# Documentation: python/ccxt/static_dependencies/ethereum/utils/applicators.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/utils/applicators.py`
- **Size**: 4,342 bytes
- **Lines**: 152
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/utils/applicators.py`.

**Functions defined**: apply_one_of_formatters, combine_argument_formatters, apply_formatter_to_array, apply_formatter_if, apply_formatters_to_dict, apply_key_map, apply_formatters_to_sequence, apply_formatter_at_index
...
```bash
python python/ccxt/static_dependencies/ethereum/utils/applicators.py
```
