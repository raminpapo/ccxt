# Documentation: python/ccxt/static_dependencies/ethereum/utils/currency.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/utils/currency.py`
- **Size**: 3,021 bytes
- **Lines**: 108
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/utils/currency.py`.

**Classes defined**: denoms

**Functions defined**: from_wei, to_wei
...
```bash
python python/ccxt/static_dependencies/ethereum/utils/currency.py
```
