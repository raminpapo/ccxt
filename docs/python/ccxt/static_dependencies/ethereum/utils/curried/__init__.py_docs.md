# Documentation: python/ccxt/static_dependencies/ethereum/utils/curried/__init__.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/utils/curried/__init__.py`
- **Size**: 6,398 bytes
- **Lines**: 270
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/utils/curried/__init__.py`.

**Functions defined**: apply_formatter_if, hexstr_if_str, apply_one_of_formatters
...
```bash
python python/ccxt/static_dependencies/ethereum/utils/curried/__init__.py
```
