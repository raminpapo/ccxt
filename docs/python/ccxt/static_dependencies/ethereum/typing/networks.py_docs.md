# Documentation: python/ccxt/static_dependencies/ethereum/typing/networks.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/typing/networks.py`
- **Size**: 20,845 bytes
- **Lines**: 1,123
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/typing/networks.py`.

**Classes defined**: ChainId
...
```bash
python python/ccxt/static_dependencies/ethereum/typing/networks.py
```
