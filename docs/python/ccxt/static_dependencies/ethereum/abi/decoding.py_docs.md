# Documentation: python/ccxt/static_dependencies/ethereum/abi/decoding.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/abi/decoding.py`
- **Size**: 16,828 bytes
- **Lines**: 566
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/abi/decoding.py`.

**Classes defined**: HeadTailDecoder, SingleDecoder, BaseArrayDecoder, for, BaseDecoder, DynamicArrayDecoder, ContextFramesBytesIO, SizedArrayDecoder, TupleDecoder, FixedByteSizeDecoder

**Functions defined**: seek_in_frame, pop_frame, __call__, __init__, decode, validate, push_frame
...
```bash
python python/ccxt/static_dependencies/ethereum/abi/decoding.py
```
