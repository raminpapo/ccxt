# Documentation: python/ccxt/static_dependencies/ethereum/abi/registry.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/abi/registry.py`
- **Size**: 19,329 bytes
- **Lines**: 644
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/abi/registry.py`.

**Classes defined**: Predicate, to, Equals, BaseEquals, PredicateMapping, ABIRegistry, Copyable, BaseRegistry

**Functions defined**: remove_by_equality, find, copy, remove_by_label, __init__, _label_for_predicate, add, __copy__, remove, __deepcopy__
...
```bash
python python/ccxt/static_dependencies/ethereum/abi/registry.py
```
