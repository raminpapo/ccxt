# Documentation: python/ccxt/static_dependencies/ethereum/abi/grammar.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/abi/grammar.py`
- **Size**: 12,358 bytes
- **Lines**: 444
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/abi/grammar.py`.

**Classes defined**: for, ABIType, BasicType, NodeVisitor, TupleType

**Functions defined**: visit_zero_tuple, visit_next_type, visit_const_arr, visit_tuple_type, visit_digits, visit_basic_type, visit_dynam_arr, visit_two_size, visit_alphas, visit_non_zero_tuple
...
```bash
python python/ccxt/static_dependencies/ethereum/abi/grammar.py
```
