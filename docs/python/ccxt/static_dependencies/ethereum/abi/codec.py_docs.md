# Documentation: python/ccxt/static_dependencies/ethereum/abi/codec.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/abi/codec.py`
- **Size**: 6,871 bytes
- **Lines**: 218
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/abi/codec.py`.

**Classes defined**: ABIEncoder, ABICodec, for, ABIDecoder, BaseABICoder

**Functions defined**: decode_abi, decode_single, encode, __init__, encode_single, decode, is_encodable_type, encode_abi, is_encodable
...
```bash
python python/ccxt/static_dependencies/ethereum/abi/codec.py
```
