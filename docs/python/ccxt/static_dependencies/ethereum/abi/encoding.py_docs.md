# Documentation: python/ccxt/static_dependencies/ethereum/abi/encoding.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/abi/encoding.py`
- **Size**: 20,162 bytes
- **Lines**: 721
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/abi/encoding.py`.

**Classes defined**: for, UnsignedIntegerEncoder, FixedSizeEncoder, PackedBooleanEncoder, NumberEncoder, TupleEncoder, BaseEncoder, Fixed32ByteSizeEncoder, BooleanEncoder, PackedUnsignedIntegerEncoder

**Functions defined**: __call__, encode, validate_value, __init__, from_type_str, validate, invalidate_value
...
- `FixedSizeEncoder`
- `NumberEncoder`
- `PackedAddressEncoder`
- `PackedArrayEncoder`
- `PackedBooleanEncoder`
- `PackedByteStringEncoder`
- `PackedBytesEncoder`
- `PackedSignedFixedEncoder`
- `PackedSignedIntegerEncoder`
- `PackedTextStringEncoder`
- `PackedUnsignedFixedEncoder`
...
```bash
python python/ccxt/static_dependencies/ethereum/abi/encoding.py
```
