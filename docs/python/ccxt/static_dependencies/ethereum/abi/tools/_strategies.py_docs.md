# Documentation: python/ccxt/static_dependencies/ethereum/abi/tools/_strategies.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/abi/tools/_strategies.py`
- **Size**: 5,742 bytes
- **Lines**: 231
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/abi/tools/_strategies.py`.

**Classes defined**: StrategyRegistry

**Functions defined**: get_ufixed_strategy, __init__, get_fixed_strategy, get_uint_strategy, unregister_strategy, get_strategy, get_bytes_strategy, get_int_strategy, get_array_strategy, register_strategy
...
```bash
python python/ccxt/static_dependencies/ethereum/abi/tools/_strategies.py
```
