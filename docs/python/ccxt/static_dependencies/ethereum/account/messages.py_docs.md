# Documentation: python/ccxt/static_dependencies/ethereum/account/messages.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/account/messages.py`
- **Size**: 10,588 bytes
- **Lines**: 264
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/account/messages.py`.

**Classes defined**: SignableMessage

**Functions defined**: encode_typed_data
...
```bash
python python/ccxt/static_dependencies/ethereum/account/messages.py
```
