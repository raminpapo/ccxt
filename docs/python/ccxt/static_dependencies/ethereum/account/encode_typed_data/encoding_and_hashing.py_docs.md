# Documentation: python/ccxt/static_dependencies/ethereum/account/encode_typed_data/encoding_and_hashing.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/ethereum/account/encode_typed_data/encoding_and_hashing.py`
- **Size**: 7,126 bytes
- **Lines**: 240
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/ethereum/account/encode_typed_data/encoding_and_hashing.py`.

**Functions defined**: hash_type, encode_data, find_type_dependencies, encode_type, hash_struct, hash_eip712_message, hash_domain, encode_field, get_primary_type
...
```bash
python python/ccxt/static_dependencies/ethereum/account/encode_typed_data/encoding_and_hashing.py
```
