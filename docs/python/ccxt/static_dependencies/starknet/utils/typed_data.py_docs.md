# Documentation: python/ccxt/static_dependencies/starknet/utils/typed_data.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/utils/typed_data.py`
- **Size**: 5,561 bytes
- **Lines**: 183
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/utils/typed_data.py`.

**Classes defined**: ParameterSchema, Parameter, TypedData, TypedDataSchema

**Functions defined**: collect_deps, from_dict, struct_hash, _get_dependencies, _encode_data, _encode_type, make_dependency_str, _is_struct, type_hash, _encode_value
...
```bash
python python/ccxt/static_dependencies/starknet/utils/typed_data.py
```
