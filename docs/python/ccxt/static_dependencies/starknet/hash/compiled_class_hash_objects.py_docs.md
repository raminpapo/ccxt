# Documentation: python/ccxt/static_dependencies/starknet/hash/compiled_class_hash_objects.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/hash/compiled_class_hash_objects.py`
- **Size**: 3,349 bytes
- **Lines**: 112
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/hash/compiled_class_hash_objects.py`.

**Classes defined**: BytecodeSegmentedNode, BytecodeSegmentStructure, BytecodeSegment, BytecodeLeaf

**Functions defined**: bytecode_with_skipped_segments, hash, add_bytecode_with_skipped_segments, __post_init__
...
**Functions** (4):
- `__post_init__()`
- `add_bytecode_with_skipped_segments()`
- `bytecode_with_skipped_segments()`
- `hash()`
...
```bash
python python/ccxt/static_dependencies/starknet/hash/compiled_class_hash_objects.py
```
