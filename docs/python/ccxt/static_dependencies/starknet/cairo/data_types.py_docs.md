# Documentation: python/ccxt/static_dependencies/starknet/cairo/data_types.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/cairo/data_types.py`
- **Size**: 2,174 bytes
- **Lines**: 124
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/cairo/data_types.py`.

**Classes defined**: NamedTupleType, EnumType, ArrayType, OptionType, FeltType, UintType, StructType, BoolType, CairoType, TupleType

**Functions defined**: check_range
...
```bash
python python/ccxt/static_dependencies/starknet/cairo/data_types.py
```
