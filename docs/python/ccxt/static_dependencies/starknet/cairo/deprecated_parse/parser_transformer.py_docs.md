# Documentation: python/ccxt/static_dependencies/starknet/cairo/deprecated_parse/parser_transformer.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/cairo/deprecated_parse/parser_transformer.py`
- **Size**: 3,883 bytes
- **Lines**: 139
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/cairo/deprecated_parse/parser_transformer.py`.

**Classes defined**: ParserError, CommaSeparated, ParserTransformer, ParserContext

**Functions defined**: type_felt, type_codeoffset, type_pointer, __init__, type_pointer2, comma_separated, type_tuple, type_struct, named_type, __default__
...
```bash
python python/ccxt/static_dependencies/starknet/cairo/deprecated_parse/parser_transformer.py
```
