# Documentation: python/ccxt/static_dependencies/starknet/cairo/type_parser.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/cairo/type_parser.py`
- **Size**: 4,407 bytes
- **Lines**: 122
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/cairo/type_parser.py`.

**Classes defined**: UnknownCairoTypeError, for, TypeParser

**Functions defined**: _transform_cairo_lang_type, __init__, takes, parse_inline_type, from, _get_struct
...
```bash
python python/ccxt/static_dependencies/starknet/cairo/type_parser.py
```
