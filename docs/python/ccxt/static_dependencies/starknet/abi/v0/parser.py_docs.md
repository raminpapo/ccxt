# Documentation: python/ccxt/static_dependencies/starknet/abi/v0/parser.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/abi/v0/parser.py`
- **Size**: 7,897 bytes
- **Lines**: 217
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/abi/v0/parser.py`.

**Classes defined**: AbiParsingError, for, DataclassSupportingEncoder, AbiParser

**Functions defined**: _parse_event, __init__, parse, _group_by_entry_name, _check_for_cycles, _parse_members, _to_json, _parse_function, _parse_structures, type_parser
...
```bash
python python/ccxt/static_dependencies/starknet/abi/v0/parser.py
```
