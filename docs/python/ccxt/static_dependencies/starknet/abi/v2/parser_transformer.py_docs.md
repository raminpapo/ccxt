# Documentation: python/ccxt/static_dependencies/starknet/abi/v2/parser_transformer.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/abi/v2/parser_transformer.py`
- **Size**: 5,623 bytes
- **Lines**: 193
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/abi/v2/parser_transformer.py`.

**Classes defined**: ParserTransformer

**Functions defined**: type_felt, type, __init__, type_bytes, type_uint, type_unit, type_option, type_bool, actual_type, __default__
...
```bash
python python/ccxt/static_dependencies/starknet/abi/v2/parser_transformer.py
```
