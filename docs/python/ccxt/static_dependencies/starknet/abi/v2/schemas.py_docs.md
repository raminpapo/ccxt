# Documentation: python/ccxt/static_dependencies/starknet/abi/v2/schemas.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/abi/v2/schemas.py`
- **Size**: 4,242 bytes
- **Lines**: 133
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/abi/v2/schemas.py`.

**Classes defined**: L1HandlerAbiEntrySchema, FunctionAbiEntrySchema, TypedParameterSchema, EventEnumVariantSchema, ConstructorAbiEntrySchema, EventStructAbiEntrySchema, EventEnumAbiEntrySchema, EventStructMemberSchema, FunctionBaseSchema, TypeSchema
...
```bash
python python/ccxt/static_dependencies/starknet/abi/v2/schemas.py
```
