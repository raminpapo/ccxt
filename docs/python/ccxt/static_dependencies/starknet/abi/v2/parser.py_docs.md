# Documentation: python/ccxt/static_dependencies/starknet/abi/v2/parser.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/abi/v2/parser.py`
- **Size**: 10,439 bytes
- **Lines**: 294
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/abi/v2/parser.py`.

**Classes defined**: AbiParsingError, for, DataclassSupportingEncoder, AbiParser

**Functions defined**: _parse_structures_and_enums, _parse_event, _parse_interface, __init__, parse, _check_for_cycles, _parse_members, _parse_function, _parse_constructor, type_parser
...
```bash
python python/ccxt/static_dependencies/starknet/abi/v2/parser.py
```
