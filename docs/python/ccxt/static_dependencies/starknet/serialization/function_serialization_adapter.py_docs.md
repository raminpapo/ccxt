# Documentation: python/ccxt/static_dependencies/starknet/serialization/function_serialization_adapter.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/serialization/function_serialization_adapter.py`
- **Size**: 3,837 bytes
- **Lines**: 111
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/serialization/function_serialization_adapter.py`.

**Classes defined**: FunctionSerializationAdapter, FunctionSerializationAdapterV1

**Functions defined**: _merge_arguments, _ensure_no_unnecessary_positional_args, __post_init__, inputs, serialize, deserialize, _ensure_no_missing_args, _ensure_no_unnecessary_args
...
**Functions** (8):
- `__post_init__()`
- `_ensure_no_missing_args()`
- `_ensure_no_unnecessary_args()`
- `_ensure_no_unnecessary_positional_args()`
- `_merge_arguments()`
- `deserialize()`
- `inputs()`
- `serialize()`
...
```bash
python python/ccxt/static_dependencies/starknet/serialization/function_serialization_adapter.py
```
