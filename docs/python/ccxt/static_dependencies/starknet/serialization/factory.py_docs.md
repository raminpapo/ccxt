# Documentation: python/ccxt/static_dependencies/starknet/serialization/factory.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/serialization/factory.py`
- **Size**: 7,237 bytes
- **Lines**: 230
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/serialization/factory.py`.

**Functions defined**: calls, serializer_for_function_v1, outputs, serializer_for_outputs, serializer_for_payload, inputs, serializer_for_type, serializer_for_event, serializer_for_function
...
```bash
python python/ccxt/static_dependencies/starknet/serialization/factory.py
```
