# Documentation: python/ccxt/static_dependencies/starknet/serialization/_context.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/starknet/serialization/_context.py`
- **Size**: 4,821 bytes
- **Lines**: 143
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/starknet/serialization/_context.py`.

**Classes defined**: Context, SerializationContext, DeserializationContext

**Functions defined**: current_entity, create, _error_prefix, __init__, _wrap_errors, ensure_valid_type, ensure_valid_value, push_entity
...
```bash
python python/ccxt/static_dependencies/starknet/serialization/_context.py
```
