# Documentation: python/ccxt/static_dependencies/toolz/functoolz.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/toolz/functoolz.py`
- **Size**: 29,821 bytes
- **Lines**: 1,050
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/toolz/functoolz.py`.

**Classes defined**: Compose, docstring, juxt, MyClass, excepts, InstanceProperty, attribute, curry

**Functions defined**: inc, identity, add, thread_first, double, apply, and, expects
...
```bash
python python/ccxt/static_dependencies/toolz/functoolz.py
```
