# Documentation: python/ccxt/static_dependencies/toolz/itertoolz.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/toolz/itertoolz.py`
- **Size**: 27,612 bytes
- **Lines**: 1,058
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/toolz/itertoolz.py`.

**Functions defined**: _merge_sorted_binary, to, iseven, used, groupby, merge_sorted, accumulate, interleave, remove, _merge_sorted_binary_key
...
```bash
python python/ccxt/static_dependencies/toolz/itertoolz.py
```
