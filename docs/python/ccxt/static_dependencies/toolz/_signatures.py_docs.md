# Documentation: python/ccxt/static_dependencies/toolz/_signatures.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/toolz/_signatures.py`
- **Size**: 20,555 bytes
- **Lines**: 785
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/toolz/_signatures.py`.

**Functions defined**: get_exclude_keywords, check_valid, num_pos_args, signature_or_spec, create_signature_registry, _is_partial_args, check_partial, _is_valid_args, expand_sig, that
...
```bash
python python/ccxt/static_dependencies/toolz/_signatures.py
```
