# Documentation: python/ccxt/static_dependencies/marshmallow_dataclass/__init__.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/marshmallow_dataclass/__init__.py`
- **Size**: 36,024 bytes
- **Lines**: 1,048
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/marshmallow_dataclass/__init__.py`.

**Classes defined**: Point, module, User, Artist, object, when, attribute, BaseSchema

**Functions defined**: add_schema, on_bind_field, dataclass, decorator, _maybe_get_callers_frame
...
- `_field_for_generic_type()`
- `_field_for_schema()`
- `_field_for_union_type()`
- `_generic_type_add_any()`
- `_get_field_default()`
- `_internal_class_schema()`
- `_maybe_get_callers_frame()`
- `add_schema()`
- `class_schema()`
- `dataclass()`
- `decorator()`
...
```bash
python python/ccxt/static_dependencies/marshmallow_dataclass/__init__.py
```
