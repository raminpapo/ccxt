# Documentation: python/ccxt/static_dependencies/marshmallow_dataclass/union_field.py

## File Metadata

- **Path**: `python/ccxt/static_dependencies/marshmallow_dataclass/union_field.py`
- **Size**: 2,914 bytes
- **Lines**: 83
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/static_dependencies/marshmallow_dataclass/union_field.py`.

**Classes defined**: Union

**Functions defined**: _serialize, _bind_to_schema, __init__, _check_type, _deserialize
...
```bash
python python/ccxt/static_dependencies/marshmallow_dataclass/union_field.py
```
