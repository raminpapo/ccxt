# Documentation: python/ccxt/digifinex.py

## File Metadata

- **Path**: `python/ccxt/digifinex.py`
- **Size**: 174,847 bytes
- **Lines**: 4,176
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/digifinex.py`.
...
```bash
python python/ccxt/digifinex.py
```
