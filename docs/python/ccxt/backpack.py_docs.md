# Documentation: python/ccxt/backpack.py

## File Metadata

- **Path**: `python/ccxt/backpack.py`
- **Size**: 97,390 bytes
- **Lines**: 2,231
- **Type**: Python
- **Extension**: .py
...
class backpack(Exchange, ImplicitAPI):
    ...
    def fetch_currencies(self, params={}) -> Currencies:
        ...
        """
        response = self.publicGetApiV1Assets(params)
        #
        #     [
        #         {
    ...
    def fetch_funding_rate_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        response = self.publicGetApiV1FundingRates(self.extend(request, params))
        #
        #     [
        #         {
        #             "fundingRate": "0.0001",
    ...
    def fetch_status(self, params={}):
        ...
        """
        response = self.publicGetApiV1Status(params)
        #
        #     {
        #         "message":null,
        #         "status":"Ok"
    ...
    def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.privateGetWapiV1HistoryOrders(self.extend(request, params))
        return self.parse_orders(response, market, since, limit)
...
This is a Python file located at `python/ccxt/backpack.py`.

**Classes defined**: backpack

**Functions defined**: parse_market, parse_ticker, describe, fetch_ticker, fetch_ohlcv, fetch_order_book, fetch_markets, parse_market_type, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/backpack.py
```
