# Documentation: python/ccxt/async_support/gemini.py

## File Metadata

- **Path**: `python/ccxt/async_support/gemini.py`
- **Size**: 84,550 bytes
- **Lines**: 1,935
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/gemini.py`.

**Classes defined**: gemini

**Functions defined**: parse_market, fetch_markets_from_api, describe, fetch_order_book, fetch_markets, fetch_markets_from_web, fetch_usdt_markets, parse_market_active, fetch_currencies, fetch_currencies_from_web
...
- `https://api.sandbox.gemini.com` (referenced)
- `https://api.gemini.com` (referenced)
- `https://docs.gemini.com` (referenced)
- `https://docs.sandbox.gemini.com` (referenced)
...
```bash
python python/ccxt/async_support/gemini.py
```
