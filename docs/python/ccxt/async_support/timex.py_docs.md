# Documentation: python/ccxt/async_support/timex.py

## File Metadata

- **Path**: `python/ccxt/async_support/timex.py`
- **Size**: 77,078 bytes
- **Lines**: 1,753
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/timex.py`.

**Classes defined**: timex

**Functions defined**: fetch_withdrawals, describe, parse_transaction, fetch_ticker, get_currency_by_address, fetch_markets, fetch_deposits, fetch_time, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/timex.py
```
