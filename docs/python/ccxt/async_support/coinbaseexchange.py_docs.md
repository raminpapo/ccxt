# Documentation: python/ccxt/async_support/coinbaseexchange.py

## File Metadata

- **Path**: `python/ccxt/async_support/coinbaseexchange.py`
- **Size**: 90,929 bytes
- **Lines**: 2,049
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/coinbaseexchange.py`.

**Classes defined**: coinbaseexchange

**Functions defined**: fetch_balance, parse_ticker, fetch_tickers, describe, fetch_accounts, fetch_order_book, fetch_markets, parse_balance, parse_account, fetch_currencies
...
```bash
python python/ccxt/async_support/coinbaseexchange.py
```
