# Documentation: python/ccxt/async_support/bitflyer.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitflyer.py`
- **Size**: 47,301 bytes
- **Lines**: 1,172
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitflyer.py`.

**Classes defined**: bitflyer

**Functions defined**: fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, parse_balance, fetch_markets, parse_trade, safe_market, parse_expiry_date
...
```bash
python python/ccxt/async_support/bitflyer.py
```
