# Documentation: python/ccxt/async_support/btcmarkets.py

## File Metadata

- **Path**: `python/ccxt/async_support/btcmarkets.py`
- **Size**: 57,946 bytes
- **Lines**: 1,378
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/btcmarkets.py`.

**Classes defined**: btcmarkets

**Functions defined**: parse_market, fetch_withdrawals, describe, parse_transaction, parse_transaction_type, fetch_markets, fetch_deposits, parse_transaction_status, fetch_transactions_with_method, fetch_deposits_withdrawals
...
```bash
python python/ccxt/async_support/btcmarkets.py
```
