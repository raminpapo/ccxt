# Documentation: python/ccxt/async_support/binance.py

## File Metadata

- **Path**: `python/ccxt/async_support/binance.py`
- **Size**: 691,857 bytes
- **Lines**: 13,488
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/binance.py`.

**Classes defined**: binance

**Functions defined**: is_inverse, describe, nonce, market, is, set_sandbox_mode, create_expired_option_market, safe_market, cost_to_precision, is_linear
...
```bash
python python/ccxt/async_support/binance.py
```
