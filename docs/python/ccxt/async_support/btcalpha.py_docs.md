# Documentation: python/ccxt/async_support/btcalpha.py

## File Metadata

- **Path**: `python/ccxt/async_support/btcalpha.py`
- **Size**: 41,650 bytes
- **Lines**: 1,031
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/btcalpha.py`.

**Classes defined**: btcalpha

**Functions defined**: parse_market, parse_ticker, fetch_ticker, describe, parse_bids_asks, fetch_order_book, fetch_markets, parse_trade, fetch_trades, fetch_tickers
...
```bash
python python/ccxt/async_support/btcalpha.py
```
