# Keywords: python/ccxt/async_support/krakenfutures.py

## Extracted Keywords

This file contains 113 keywords extracted from `python/ccxt/async_support/krakenfutures.py`.
...
[Back to file docs](krakenfutures.py_docs.md)
...
API endpoint in python/ccxt/async_support/krakenfutures.py
...
Constant in python/ccxt/async_support/krakenfutures.py
...
#### <a name="gb00jvmlmp88"></a> `GB00JVMLMP88`
...
#### <a name="pf_enjusd"></a> `PF_ENJUSD`

Constant in python/ccxt/async_support/krakenfutures.py

[Back to file docs](krakenfutures.py_docs.md)

#### <a name="pf_ethusd"></a> `PF_ETHUSD`
...
#### <a name="pf_xrpusd"></a> `PF_XRPUSD`

Constant in python/ccxt/async_support/krakenfutures.py

[Back to file docs](krakenfutures.py_docs.md)

#### <a name="pi_xrpusd"></a> `PI_XRPUSD`
...
#### <a name="would_not_reduce_position"></a> `WOULD_NOT_REDUCE_POSITION`
...
Identifier defined in python/ccxt/async_support/krakenfutures.py
...
#### <a name="https---demo-futures-kraken-com"></a> `https://demo-futures.kraken.com`

URL referenced in python/ccxt/async_support/krakenfutures.py
...
#### <a name="verify_order_action_success"></a> `verify_order_action_success`
