# Documentation: python/ccxt/async_support/mercado.py

## File Metadata

- **Path**: `python/ccxt/async_support/mercado.py`
- **Size**: 40,305 bytes
- **Lines**: 951
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/mercado.py`.

**Classes defined**: mercado

**Functions defined**: parse_ticker, fetch_balance, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_trade, parse_balance, fetch_trades, create_order
...
```bash
python python/ccxt/async_support/mercado.py
```
