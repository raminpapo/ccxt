# Documentation: python/ccxt/async_support/derive.py

## File Metadata

- **Path**: `python/ccxt/async_support/derive.py`
- **Size**: 122,780 bytes
- **Lines**: 2,573
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/derive.py`.

**Classes defined**: derive

**Functions defined**: describe, params, fetch_markets, set_sandbox_mode, fetch_time, param, name, fetch_currencies
...
```bash
python python/ccxt/async_support/derive.py
```
