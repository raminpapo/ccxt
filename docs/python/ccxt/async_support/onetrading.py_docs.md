# Documentation: python/ccxt/async_support/onetrading.py

## File Metadata

- **Path**: `python/ccxt/async_support/onetrading.py`
- **Size**: 80,781 bytes
- **Lines**: 1,828
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/onetrading.py`.

**Classes defined**: onetrading

**Functions defined**: parse_market, parse_ticker, describe, fetch_trading_fees, fetch_markets, fetch_public_trading_fees, fetch_private_trading_fees, fetch_time, parse_fee_tiers, fetch_currencies
...
```bash
python python/ccxt/async_support/onetrading.py
```
