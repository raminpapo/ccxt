# Documentation: python/ccxt/async_support/whitebit.py

## File Metadata

- **Path**: `python/ccxt/async_support/whitebit.py`
- **Size**: 177,828 bytes
- **Lines**: 3,817
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/whitebit.py`.

**Classes defined**: whitebit

**Functions defined**: parse_market, describe, fetch_deposit_withdraw_fees, fetch_trading_fees, fetch_markets, fetch_trading_limits, fetch_funding_limits, fetch_transaction_fees, fetch_currencies, parse_deposit_withdraw_fees
...
```bash
python python/ccxt/async_support/whitebit.py
```
