# Documentation: python/ccxt/async_support/bitvavo.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitvavo.py`
- **Size**: 98,112 bytes
- **Lines**: 2,135
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitvavo.py`.

**Classes defined**: bitvavo

**Functions defined**: parse_ticker, parse_markets, fetch_tickers, describe, fetch_ticker, fetch_markets, fetch_time, fetch_trades, parse_currencies_custom, fetch_currencies
...
```bash
python python/ccxt/async_support/bitvavo.py
```
