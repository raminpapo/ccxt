# Documentation: python/ccxt/async_support/bitget.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitget.py`
- **Size**: 526,607 bytes
- **Lines**: 10,519
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitget.py`.

**Classes defined**: bitget

**Functions defined**: describe, handle_product_type_and_params, enable_demo_trading, is, set_sandbox_mode, fetch_markets, fetch_time, suspended, cannot
...
```bash
python python/ccxt/async_support/bitget.py
```
