# Documentation: python/ccxt/async_support/bitstamp.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitstamp.py`
- **Size**: 97,912 bytes
- **Lines**: 2,338
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitstamp.py`.

**Classes defined**: bitstamp

**Functions defined**: parse_ticker, fetch_tickers, describe, fetch_ticker, get_currency_id_from_transaction, fetch_order_book, fetch_markets, construct_currency_object, fetch_markets_from_cache, fetch_currencies
...
```bash
python python/ccxt/async_support/bitstamp.py
```
