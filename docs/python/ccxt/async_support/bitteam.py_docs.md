# Documentation: python/ccxt/async_support/bitteam.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitteam.py`
- **Size**: 107,091 bytes
- **Lines**: 2,382
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitteam.py`.

**Classes defined**: bitteam

**Functions defined**: parse_market, describe, fetch_order, fetch_ohlcv, fetch_order_book, fetch_markets, fetch_orders, parse_ohlcv, fetch_open_orders, fetch_currencies
...
```bash
python python/ccxt/async_support/bitteam.py
```
