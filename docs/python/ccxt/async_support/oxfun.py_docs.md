# Documentation: python/ccxt/async_support/oxfun.py

## File Metadata

- **Path**: `python/ccxt/async_support/oxfun.py`
- **Size**: 125,523 bytes
- **Lines**: 2,862
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/oxfun.py`.

**Classes defined**: oxfun

**Functions defined**: parse_market, parse_ticker, parse_markets, describe, fetch_ticker, fetch_ohlcv, fetch_markets, parse_ohlcv, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/oxfun.py
```
