# Documentation: python/ccxt/async_support/oceanex.py

## File Metadata

- **Path**: `python/ccxt/async_support/oceanex.py`
- **Size**: 44,593 bytes
- **Lines**: 1,094
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/oceanex.py`.

**Classes defined**: oceanex

**Functions defined**: parse_market, parse_ticker, fetch_ticker, describe, fetch_order_book, fetch_markets, parse_trade, fetch_order_books, fetch_trades, fetch_tickers
...
```bash
python python/ccxt/async_support/oceanex.py
```
