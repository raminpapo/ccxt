# Documentation: python/ccxt/async_support/independentreserve.py

## File Metadata

- **Path**: `python/ccxt/async_support/independentreserve.py`
- **Size**: 45,154 bytes
- **Lines**: 1,059
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/independentreserve.py`.

**Classes defined**: independentreserve

**Functions defined**: fetch_balance, parse_ticker, parse_order, describe, fetch_ticker, fetch_order, fetch_order_book, fetch_markets, parse_balance, parse_order_status
...
```bash
python python/ccxt/async_support/independentreserve.py
```
