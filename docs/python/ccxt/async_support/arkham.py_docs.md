# Documentation: python/ccxt/async_support/arkham.py

## File Metadata

- **Path**: `python/ccxt/async_support/arkham.py`
- **Size**: 102,624 bytes
- **Lines**: 2,408
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/arkham.py`.

**Classes defined**: arkham

**Functions defined**: parse_ticker, describe, fetch_ticker, fetch_ohlcv, fetch_order_book, fetch_markets, parse_ohlcv, fetch_time, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/arkham.py
```
