# Documentation: python/ccxt/async_support/coinspot.py

## File Metadata

- **Path**: `python/ccxt/async_support/coinspot.py`
- **Size**: 27,773 bytes
- **Lines**: 634
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/coinspot.py`.

**Classes defined**: coinspot

**Functions defined**: fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, parse_balance, parse_trade, fetch_trades, fetch_tickers, fetch_my_trades
...
```bash
python python/ccxt/async_support/coinspot.py
```
