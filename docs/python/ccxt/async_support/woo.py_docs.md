# Documentation: python/ccxt/async_support/woo.py

## File Metadata

- **Path**: `python/ccxt/async_support/woo.py`
- **Size**: 182,972 bytes
- **Lines**: 4,049
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/woo.py`.

**Classes defined**: woo

**Functions defined**: parse_market, fetch_status, describe, fetch_markets, parse_trade, parse_token_and_fee_temp, fetch_time, fetch_trades, parse_trading_fee, fetch_trading_fee
...
- `default_network_code_for_currency()`
- `describe()`
- `edit_order()`
- `encode_margin_mode()`
- `fetch_accounts()`
...
```bash
python python/ccxt/async_support/woo.py
```
