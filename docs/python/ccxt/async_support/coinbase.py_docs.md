# Documentation: python/ccxt/async_support/coinbase.py

## File Metadata

- **Path**: `python/ccxt/async_support/coinbase.py`
- **Size**: 241,328 bytes
- **Lines**: 5,003
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/coinbase.py`.

**Classes defined**: coinbase

**Functions defined**: fetch_accounts_v2, describe, fetch_portfolios, fetch_accounts, fetch_time, create_deposit_address, fetch_accounts_v3, fetch_my_sells, parse_account, fetch_my_buys
...
- `https://static-assets.coinbase.com/p2p/l2/asset_network_combinations/v5/usdc-solana.png` (referenced)
- `https://user-images.githubusercontent.com/1294454/40811661-b6eceae2-653a-11e8-829e-10bfadb078cf.jpg` (referenced)
- `https://www.coinbase.com/assets/receive-warning-2f3269d83547a7748fb39d6e0c1c393aee26669bfea6b9f12718094a1abff155.png` (referenced)
...
- `https://www.coinbase.com/assets/addresses/global-receive-warning-a3d91807e61c717e5a38d270965003dcc025ca8a3cea40ec3d7835b7c86087fa.png` (referenced)
...
```bash
python python/ccxt/async_support/coinbase.py
```
