# Documentation: python/ccxt/async_support/yobit.py

## File Metadata

- **Path**: `python/ccxt/async_support/yobit.py`
- **Size**: 58,521 bytes
- **Lines**: 1,419
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/yobit.py`.

**Classes defined**: yobit

**Functions defined**: fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, parse_balance, fetch_markets, fetch_order_books, fetch_tickers_helper, fetch_tickers
...
```bash
python python/ccxt/async_support/yobit.py
```
