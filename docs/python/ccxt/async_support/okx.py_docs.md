# Documentation: python/ccxt/async_support/okx.py

## File Metadata

- **Path**: `python/ccxt/async_support/okx.py`
- **Size**: 414,495 bytes
- **Lines**: 8,652
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/okx.py`.

**Classes defined**: okx

**Functions defined**: with, fetch_status, describe, is, convert_to_instrument_type, create_expired_option_market, fetch_time, safe_market, handle_market_type_and_params, of
...
```bash
python python/ccxt/async_support/okx.py
```
