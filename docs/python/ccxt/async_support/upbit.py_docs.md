# Documentation: python/ccxt/async_support/upbit.py

## File Metadata

- **Path**: `python/ccxt/async_support/upbit.py`
- **Size**: 101,638 bytes
- **Lines**: 2,247
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/upbit.py`.

**Classes defined**: upbit

**Functions defined**: parse_market, fetch_balance, describe, fetch_currency, fetch_market, fetch_markets, parse_balance, fetch_market_by_id, fetch_order_books, fetch_currency_by_id
...
```bash
python python/ccxt/async_support/upbit.py
```
