# Documentation: python/ccxt/async_support/woofipro.py

## File Metadata

- **Path**: `python/ccxt/async_support/woofipro.py`
- **Size**: 126,208 bytes
- **Lines**: 2,826
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/woofipro.py`.

**Classes defined**: woofipro

**Functions defined**: parse_market, fetch_status, describe, fetch_markets, set_sandbox_mode, parse_token_and_fee_temp, parse_trade, fetch_time, fetch_trades, fetch_currencies
...
- `https://testnet-api-evm.orderly.org` (referenced)
- `https://dex.woo.org` (referenced)
...
```bash
python python/ccxt/async_support/woofipro.py
```
