# Documentation: python/ccxt/async_support/bitmart.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitmart.py`
- **Size**: 251,007 bytes
- **Lines**: 5,361
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitmart.py`.

**Classes defined**: bitmart

**Functions defined**: fetch_status, fetch_transaction_fee, describe, get_currency_id_from_code_and_network, is, fetch_markets, fetch_time, fetch_spot_markets, fetch_contract_markets, fetch_currencies
...
```bash
python python/ccxt/async_support/bitmart.py
```
