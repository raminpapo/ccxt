# Documentation: python/ccxt/async_support/kraken.py

## File Metadata

- **Path**: `python/ccxt/async_support/kraken.py`
- **Size**: 153,686 bytes
- **Lines**: 3,445
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/kraken.py`.

**Classes defined**: kraken

**Functions defined**: fetch_status, describe, fee_to_precision, fetch_order_book, fetch_markets, safe_currency_code, parse_trading_fee, fetch_currencies, fetch_trading_fee, parse_bid_ask
...
```bash
python python/ccxt/async_support/kraken.py
```
