# Documentation: python/ccxt/async_support/hibachi.py

## File Metadata

- **Path**: `python/ccxt/async_support/hibachi.py`
- **Size**: 86,164 bytes
- **Lines**: 2,074
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/hibachi.py`.

**Classes defined**: hibachi

**Functions defined**: parse_market, fetch_balance, parse_ticker, describe, get_account_id, fetch_markets, hardcoded_currencies, parse_balance, parse_trade, fetch_trades
...
```bash
python python/ccxt/async_support/hibachi.py
```
