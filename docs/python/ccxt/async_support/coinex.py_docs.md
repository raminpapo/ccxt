# Documentation: python/ccxt/async_support/coinex.py

## File Metadata

- **Path**: `python/ccxt/async_support/coinex.py`
- **Size**: 271,638 bytes
- **Lines**: 5,901
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/coinex.py`.

**Classes defined**: coinex

**Functions defined**: parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, fetch_time, fetch_spot_markets, fetch_contract_markets, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/coinex.py
```
