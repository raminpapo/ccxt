# Documentation: python/ccxt/async_support/defx.py

## File Metadata

- **Path**: `python/ccxt/async_support/defx.py`
- **Size**: 85,937 bytes
- **Lines**: 2,073
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/defx.py`.
...
```bash
python python/ccxt/async_support/defx.py
```
