# Documentation: python/ccxt/async_support/probit.py

## File Metadata

- **Path**: `python/ccxt/async_support/probit.py`
- **Size**: 79,604 bytes
- **Lines**: 1,864
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/probit.py`.

**Classes defined**: probit

**Functions defined**: parse_market, fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_balance, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/probit.py
```
