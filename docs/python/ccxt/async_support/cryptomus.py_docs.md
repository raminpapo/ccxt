# Documentation: python/ccxt/async_support/cryptomus.py

## File Metadata

- **Path**: `python/ccxt/async_support/cryptomus.py`
- **Size**: 48,731 bytes
- **Lines**: 1,138
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/cryptomus.py`.

**Classes defined**: cryptomus

**Functions defined**: parse_market, parse_ticker, fetch_balance, describe, fetch_order_book, fetch_markets, parse_trade, fetch_trades, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/cryptomus.py
```
