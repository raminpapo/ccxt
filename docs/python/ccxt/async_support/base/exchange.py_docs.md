# Documentation: python/ccxt/async_support/base/exchange.py

## File Metadata

- **Path**: `python/ccxt/async_support/base/exchange.py`
- **Size**: 128,985 bytes
- **Lines**: 2,312
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/base/exchange.py`.

**Classes defined**: Exchange, details

**Functions defined**: throttle, get_event_loop, open, get_session, __del__, __aexit__, __init__, init_throttler, __aenter__, close
...
```bash
python python/ccxt/async_support/base/exchange.py
```
