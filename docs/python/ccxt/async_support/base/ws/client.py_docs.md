# Documentation: python/ccxt/async_support/base/ws/client.py

## File Metadata

- **Path**: `python/ccxt/async_support/base/ws/client.py`
- **Size**: 14,524 bytes
- **Lines**: 347
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/base/ws/client.py`.

**Classes defined**: Client

**Functions defined**: if, reusable_future, open, future, __init__, reusableFuture, resolve, after_interrupt, reject, receive_loop
...
```bash
python python/ccxt/async_support/base/ws/client.py
```
