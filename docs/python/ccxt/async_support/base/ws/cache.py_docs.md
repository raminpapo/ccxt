# Documentation: python/ccxt/async_support/base/ws/cache.py

## File Metadata

- **Path**: `python/ccxt/async_support/base/ws/cache.py`
- **Size**: 8,370 bytes
- **Lines**: 219
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/base/ws/cache.py`.

**Classes defined**: ArrayCacheBySymbolBySide, ArrayCacheBySymbolById, ArrayCache, ArrayCacheByTimestamp, Delegate, BaseCache

**Functions defined**: __init__, get_limit, __getitem__, __add__, __get__, __eq__, __repr__, getLimit
...
```bash
python python/ccxt/async_support/base/ws/cache.py
```
