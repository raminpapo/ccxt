# Documentation: python/ccxt/async_support/base/ws/order_book_side.py

## File Metadata

- **Path**: `python/ccxt/async_support/base/ws/order_book_side.py`
- **Size**: 6,551 bytes
- **Lines**: 175
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/base/ws/order_book_side.py`.

**Classes defined**: Bids, CountedOrderBookSide, IndexedBids, stores, IndexedOrderBookSide, Asks, CountedBids, OrderBookSide, IndexedAsks, CountedAsks

**Functions defined**: store_array, limit, storeArray, store, __init__, __len__, remove_index, __getitem__, __eq__, __repr__
...
```bash
python python/ccxt/async_support/base/ws/order_book_side.py
```
