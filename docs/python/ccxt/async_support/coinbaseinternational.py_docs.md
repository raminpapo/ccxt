# Documentation: python/ccxt/async_support/coinbaseinternational.py

## File Metadata

- **Path**: `python/ccxt/async_support/coinbaseinternational.py`
- **Size**: 101,468 bytes
- **Lines**: 2,255
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/coinbaseinternational.py`.

**Classes defined**: coinbaseinternational

**Functions defined**: describe, fetch_accounts, fetch_ohlcv, fetch_funding_rate_history, parse_funding_rate, parse_ohlcv, handle_network_id_and_params, parse_account, handle_portfolio_and_params, parse_funding_rate_history
...
```bash
python python/ccxt/async_support/coinbaseinternational.py
```
