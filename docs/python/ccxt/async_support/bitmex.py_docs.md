# Documentation: python/ccxt/async_support/bitmex.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitmex.py`
- **Size**: 132,587 bytes
- **Lines**: 2,942
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitmex.py`.

**Classes defined**: bitmex

**Functions defined**: parse_market, describe, fetch_markets, convert_to_real_amount, amount_to_precision, convert_from_raw_quantity, parse_balance, convert_from_real_amount, convert_from_raw_cost, fetch_currencies
...
- `cancel_order()`
- `cancel_orders()`
- `convert_from_raw_cost()`
- `convert_from_raw_quantity()`
- `convert_from_real_amount()`
- `convert_to_real_amount()`
- `create_order()`
- `describe()`
- `edit_order()`
- `fetch_balance()`
...
```bash
python python/ccxt/async_support/bitmex.py
```
