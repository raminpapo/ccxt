# Documentation: python/ccxt/async_support/zaif.py

## File Metadata

- **Path**: `python/ccxt/async_support/zaif.py`
- **Size**: 31,406 bytes
- **Lines**: 803
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/zaif.py`.

**Classes defined**: zaif

**Functions defined**: parse_market, fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_balance, parse_trade, fetch_trades
...
```bash
python python/ccxt/async_support/zaif.py
```
