# Documentation: python/ccxt/async_support/p2b.py

## File Metadata

- **Path**: `python/ccxt/async_support/p2b.py`
- **Size**: 58,420 bytes
- **Lines**: 1,317
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/p2b.py`.

**Classes defined**: p2b

**Functions defined**: parse_market, parse_ticker, fetch_ticker, describe, fetch_ohlcv, fetch_order_book, fetch_markets, parse_trade, fetch_trades, fetch_tickers
...
```bash
python python/ccxt/async_support/p2b.py
```
