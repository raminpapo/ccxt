# Documentation: python/ccxt/async_support/hitbtc.py

## File Metadata

- **Path**: `python/ccxt/async_support/hitbtc.py`
- **Size**: 160,737 bytes
- **Lines**: 3,652
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/hitbtc.py`.

**Classes defined**: hitbtc

**Functions defined**: fetch_balance, describe, fetch_ticker, nonce, fetch_markets, parse_balance, create_deposit_address, fetch_deposit_address, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/hitbtc.py
```
