# Documentation: python/ccxt/async_support/hollaex.py

## File Metadata

- **Path**: `python/ccxt/async_support/hollaex.py`
- **Size**: 82,968 bytes
- **Lines**: 2,002
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/hollaex.py`.

**Classes defined**: hollaex

**Functions defined**: parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, fetch_order_books, fetch_trades, fetch_tickers, fetch_currencies, parse_tickers
...
```bash
python python/ccxt/async_support/hollaex.py
```
