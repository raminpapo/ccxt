# Documentation: python/ccxt/async_support/ascendex.py

## File Metadata

- **Path**: `python/ccxt/async_support/ascendex.py`
- **Size**: 159,581 bytes
- **Lines**: 3,528
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/ascendex.py`.
...
```bash
python python/ccxt/async_support/ascendex.py
```
