# Documentation: python/ccxt/async_support/zonda.py

## File Metadata

- **Path**: `python/ccxt/async_support/zonda.py`
- **Size**: 85,915 bytes
- **Lines**: 1,957
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/zonda.py`.

**Classes defined**: zonda

**Functions defined**: parse_market, fetch_balance, parse_ticker, parse_order, describe, fetch_order_book, fetch_markets, parse_balance, fetch_open_orders, fetch_my_trades
...
```bash
python python/ccxt/async_support/zonda.py
```
