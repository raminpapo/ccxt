# Documentation: python/ccxt/async_support/foxbit.py

## File Metadata

- **Path**: `python/ccxt/async_support/foxbit.py`
- **Size**: 85,687 bytes
- **Lines**: 1,936
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/foxbit.py`.

**Classes defined**: foxbit

**Functions defined**: fetch_balance, describe, fetch_ticker, fetch_trading_fees, fetch_ohlcv, fetch_order_book, fetch_markets, fetch_trades, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/foxbit.py
```
