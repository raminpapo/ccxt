# Documentation: python/ccxt/async_support/paymium.py

## File Metadata

- **Path**: `python/ccxt/async_support/paymium.py`
- **Size**: 26,407 bytes
- **Lines**: 628
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/paymium.py`.

**Classes defined**: paymium

**Functions defined**: fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, parse_balance, parse_trade, create_deposit_address, fetch_deposit_address, fetch_trades
...
```bash
python python/ccxt/async_support/paymium.py
```
