# Documentation: python/ccxt/async_support/coinmetro.py

## File Metadata

- **Path**: `python/ccxt/async_support/coinmetro.py`
- **Size**: 85,602 bytes
- **Lines**: 1,947
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/coinmetro.py`.

**Classes defined**: coinmetro

**Functions defined**: parse_market, parse_market_precision_and_limits, describe, fetch_ohlcv, fetch_markets, parse_ohlcv, fetch_trades, parse_market_id, fetch_my_trades, fetch_currencies
...
```bash
python python/ccxt/async_support/coinmetro.py
```
