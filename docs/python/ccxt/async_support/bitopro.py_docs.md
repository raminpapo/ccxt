# Documentation: python/ccxt/async_support/bitopro.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitopro.py`
- **Size**: 75,887 bytes
- **Lines**: 1,831
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitopro.py`.

**Classes defined**: bitopro

**Functions defined**: parse_market, parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_trade, fetch_trades, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/bitopro.py
```
