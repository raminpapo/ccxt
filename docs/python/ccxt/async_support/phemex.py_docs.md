# Documentation: python/ccxt/async_support/phemex.py

## File Metadata

- **Path**: `python/ccxt/async_support/phemex.py`
- **Size**: 245,712 bytes
- **Lines**: 5,032
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/phemex.py`.
...
```bash
python python/ccxt/async_support/phemex.py
```
