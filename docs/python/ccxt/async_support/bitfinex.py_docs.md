# Documentation: python/ccxt/async_support/bitfinex.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitfinex.py`
- **Size**: 168,878 bytes
- **Lines**: 3,798
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitfinex.py`.

**Classes defined**: if, bitfinex

**Functions defined**: fetch_status, fetch_balance, get_currency_name, describe, price_to_precision, get_currency_id, fetch_markets, is_fiat, amount_to_precision, fetch_currencies
...
```bash
python python/ccxt/async_support/bitfinex.py
```
