# Documentation: python/ccxt/async_support/paradex.py

## File Metadata

- **Path**: `python/ccxt/async_support/paradex.py`
- **Size**: 109,100 bytes
- **Lines**: 2,529
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/paradex.py`.

**Classes defined**: paradex

**Functions defined**: parse_market, fetch_status, parse_ticker, describe, fetch_ticker, fetch_ohlcv, fetch_markets, parse_ohlcv, fetch_time, fetch_tickers
...
```bash
python python/ccxt/async_support/paradex.py
```
