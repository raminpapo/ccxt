# Documentation: python/ccxt/async_support/gate.py

## File Metadata

- **Path**: `python/ccxt/async_support/gate.py`
- **Size**: 359,798 bytes
- **Lines**: 7,870
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/gate.py`.

**Classes defined**: gate

**Functions defined**: upgrade_unified_trade_account, describe, fetch_swap_markets, fetch_markets, set_sandbox_mode, create_expired_option_market, fetch_time, fetch_spot_markets, safe_market, load_unified_status
...
```bash
python python/ccxt/async_support/gate.py
```
