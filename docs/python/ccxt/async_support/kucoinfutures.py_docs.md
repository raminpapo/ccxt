# Documentation: python/ccxt/async_support/kucoinfutures.py

## File Metadata

- **Path**: `python/ccxt/async_support/kucoinfutures.py`
- **Size**: 149,641 bytes
- **Lines**: 3,307
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/kucoinfutures.py`.

**Classes defined**: kucoinfutures

**Functions defined**: fetch_status, describe, fetch_ticker, fetch_ohlcv, fetch_mark_price, fetch_order_book, fetch_markets, parse_ohlcv, fetch_time, fetch_deposit_address
...
```bash
python python/ccxt/async_support/kucoinfutures.py
```
