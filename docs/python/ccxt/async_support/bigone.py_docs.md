# Documentation: python/ccxt/async_support/bigone.py

## File Metadata

- **Path**: `python/ccxt/async_support/bigone.py`
- **Size**: 96,997 bytes
- **Lines**: 2,269
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bigone.py`.

**Classes defined**: bigone

**Functions defined**: parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_contract_bids_asks, fetch_time, parse_contract_order_book, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/bigone.py
```
