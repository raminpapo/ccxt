# Documentation: python/ccxt/async_support/coinmate.py

## File Metadata

- **Path**: `python/ccxt/async_support/coinmate.py`
- **Size**: 50,618 bytes
- **Lines**: 1,194
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/coinmate.py`.

**Classes defined**: coinmate

**Functions defined**: fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_balance, fetch_deposits_withdrawals, parse_transaction_status, fetch_tickers
...
```bash
python python/ccxt/async_support/coinmate.py
```
