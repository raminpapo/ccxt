# Documentation: python/ccxt/async_support/bit2c.py

## File Metadata

- **Path**: `python/ccxt/async_support/bit2c.py`
- **Size**: 41,402 bytes
- **Lines**: 987
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bit2c.py`.

**Classes defined**: bit2c

**Functions defined**: fetch_balance, parse_ticker, describe, fetch_ticker, fetch_trading_fees, cancel_order, fetch_order_book, parse_balance, fetch_trades, create_order
...
```bash
python python/ccxt/async_support/bit2c.py
```
