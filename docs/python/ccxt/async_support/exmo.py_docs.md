# Documentation: python/ccxt/async_support/exmo.py

## File Metadata

- **Path**: `python/ccxt/async_support/exmo.py`
- **Size**: 122,532 bytes
- **Lines**: 2,676
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/exmo.py`.

**Classes defined**: exmo

**Functions defined**: add_margin, describe, parse_margin_modification, fetch_trading_fees, fetch_private_trading_fees, fetch_public_trading_fees, parse_fixed_float_value, do, modify_margin_helper, reduce_margin
...
```bash
python python/ccxt/async_support/exmo.py
```
