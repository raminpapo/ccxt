# Documentation: python/ccxt/async_support/bitbank.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitbank.py`
- **Size**: 48,098 bytes
- **Lines**: 1,131
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitbank.py`.

**Classes defined**: bitbank

**Functions defined**: parse_market, parse_ticker, fetch_ticker, describe, fetch_trading_fees, fetch_order_book, fetch_markets, parse_trade, parse_ohlcv, fetch_trades
...
```bash
python python/ccxt/async_support/bitbank.py
```
