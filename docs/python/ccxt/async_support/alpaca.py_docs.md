# Documentation: python/ccxt/async_support/alpaca.py

## File Metadata

- **Path**: `python/ccxt/async_support/alpaca.py`
- **Size**: 81,147 bytes
- **Lines**: 1,861
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/alpaca.py`.

**Classes defined**: alpaca

**Functions defined**: parse_market, describe, fetch_ticker, fetch_ohlcv, fetch_order_book, fetch_markets, parse_ohlcv, fetch_time, fetch_trades, fetch_tickers
...
```bash
python python/ccxt/async_support/alpaca.py
```
