# Documentation: python/ccxt/async_support/digifinex.py

## File Metadata

- **Path**: `python/ccxt/async_support/digifinex.py`
- **Size**: 175,835 bytes
- **Lines**: 4,177
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/digifinex.py`.

**Classes defined**: digifinex

**Functions defined**: fetch_markets_v1, fetch_balance, describe, fetch_ticker, fetch_markets_v2, fetch_order_book, fetch_markets, parse_balance, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/digifinex.py
```
