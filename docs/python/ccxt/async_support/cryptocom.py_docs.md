# Documentation: python/ccxt/async_support/cryptocom.py

## File Metadata

- **Path**: `python/ccxt/async_support/cryptocom.py`
- **Size**: 153,543 bytes
- **Lines**: 3,380
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/cryptocom.py`.

**Classes defined**: cryptocom

**Functions defined**: describe, fetch_ticker, fetch_ohlcv, fetch_order_book, fetch_markets, fetch_orders, parse_balance, fetch_trades, fetch_tickers, fetch_currencies
...
- `close_position()`
- `create_advanced_order_request()`
- `create_order()`
- `create_order_request()`
- `create_orders()`
- `custom_handle_margin_mode_and_params()`
- `describe()`
- `edit_order()`
- `edit_order_request()`
- `fetch_accounts()`
...
- `40103` (imported)
- `https://exchange-docs.crypto.com/derivatives/index.html` (referenced)
...
```bash
python python/ccxt/async_support/cryptocom.py
```
