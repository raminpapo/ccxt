# Documentation: python/ccxt/async_support/btcturk.py

## File Metadata

- **Path**: `python/ccxt/async_support/btcturk.py`
- **Size**: 41,366 bytes
- **Lines**: 1,036
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/btcturk.py`.

**Classes defined**: btcturk

**Functions defined**: parse_market, fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_balance, parse_trade, fetch_tickers
...
```bash
python python/ccxt/async_support/btcturk.py
```
