# Documentation: python/ccxt/async_support/bithumb.py

## File Metadata

- **Path**: `python/ccxt/async_support/bithumb.py`
- **Size**: 52,257 bytes
- **Lines**: 1,228
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bithumb.py`.

**Classes defined**: bithumb

**Functions defined**: fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_balance, amount_to_precision, safe_market, fetch_tickers
...
```bash
python python/ccxt/async_support/bithumb.py
```
