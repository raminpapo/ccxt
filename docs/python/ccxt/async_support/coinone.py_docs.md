# Documentation: python/ccxt/async_support/coinone.py

## File Metadata

- **Path**: `python/ccxt/async_support/coinone.py`
- **Size**: 51,045 bytes
- **Lines**: 1,235
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/coinone.py`.

**Classes defined**: coinone

**Functions defined**: fetch_balance, parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, parse_balance, parse_trade, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/coinone.py
```
