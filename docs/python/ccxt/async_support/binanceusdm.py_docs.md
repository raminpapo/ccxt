# Documentation: python/ccxt/async_support/binanceusdm.py

## File Metadata

- **Path**: `python/ccxt/async_support/binanceusdm.py`
- **Size**: 2,739 bytes
- **Lines**: 64
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/binanceusdm.py`.
...
```bash
python python/ccxt/async_support/binanceusdm.py
```
