# Documentation: python/ccxt/async_support/bitrue.py

## File Metadata

- **Path**: `python/ccxt/async_support/bitrue.py`
- **Size**: 141,938 bytes
- **Lines**: 3,197
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/bitrue.py`.

**Classes defined**: bitrue

**Functions defined**: parse_market, fetch_status, fetch_balance, describe, nonce, fetch_order_book, fetch_markets, parse_balance, fetch_time, fetch_currencies
...
```bash
python python/ccxt/async_support/bitrue.py
```
