# Documentation: python/ccxt/async_support/btcbox.py

## File Metadata

- **Path**: `python/ccxt/async_support/btcbox.py`
- **Size**: 32,915 bytes
- **Lines**: 815
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/btcbox.py`.
...
```bash
python python/ccxt/async_support/btcbox.py
```
