# Documentation: python/ccxt/async_support/coinsph.py

## File Metadata

- **Path**: `python/ccxt/async_support/coinsph.py`
- **Size**: 101,365 bytes
- **Lines**: 2,129
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/coinsph.py`.

**Classes defined**: coinsph

**Functions defined**: fetch_status, parse_ticker, describe, fetch_ticker, fetch_order_book, fetch_markets, calculate_rate_limiter_cost, fetch_time, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/coinsph.py
```
