# Documentation: python/ccxt/async_support/krakenfutures.py

## File Metadata

- **Path**: `python/ccxt/async_support/krakenfutures.py`
- **Size**: 124,550 bytes
- **Lines**: 2,783
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/krakenfutures.py`.

**Classes defined**: krakenfutures

**Functions defined**: parse_ticker, describe, create_order_request, fetch_ohlcv, fetch_order_book, fetch_markets, parse_trade, parse_ohlcv, fetch_trades, fetch_tickers
...
```bash
python python/ccxt/async_support/krakenfutures.py
```
