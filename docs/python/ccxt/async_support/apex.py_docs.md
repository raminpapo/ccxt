# Documentation: python/ccxt/async_support/apex.py

## File Metadata

- **Path**: `python/ccxt/async_support/apex.py`
- **Size**: 84,561 bytes
- **Lines**: 1,899
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/apex.py`.

**Classes defined**: apex

**Functions defined**: parse_market, fetch_balance, parse_ticker, describe, fetch_account, parse_balance, fetch_markets, fetch_time, parse_account, fetch_currencies
...
```bash
python python/ccxt/async_support/apex.py
```
