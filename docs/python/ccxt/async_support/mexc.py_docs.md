# Documentation: python/ccxt/async_support/mexc.py

## File Metadata

- **Path**: `python/ccxt/async_support/mexc.py`
- **Size**: 264,477 bytes
- **Lines**: 5,878
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/mexc.py`.

**Classes defined**: mexc

**Functions defined**: fetch_status, describe, fetch_swap_markets, fetch_order_book, fetch_markets, fetch_time, fetch_trades, fetch_spot_markets, fetch_currencies, parse_bid_ask
...
```bash
python python/ccxt/async_support/mexc.py
```
