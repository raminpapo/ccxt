# Documentation: python/ccxt/async_support/cex.py

## File Metadata

- **Path**: `python/ccxt/async_support/cex.py`
- **Size**: 75,707 bytes
- **Lines**: 1,743
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/async_support/cex.py`.

**Classes defined**: cex

**Functions defined**: parse_market, parse_ticker, describe, fetch_ticker, parse_currency, fetch_markets, fetch_time, fetch_trades, fetch_tickers, fetch_currencies
...
```bash
python python/ccxt/async_support/cex.py
```
