# Documentation: python/ccxt/btcmarkets.py

## File Metadata

- **Path**: `python/ccxt/btcmarkets.py`
- **Size**: 57,596 bytes
- **Lines**: 1,378
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/btcmarkets.py`.
...
```bash
python python/ccxt/btcmarkets.py
```
