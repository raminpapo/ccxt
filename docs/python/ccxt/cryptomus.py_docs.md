# Documentation: python/ccxt/cryptomus.py

## File Metadata

- **Path**: `python/ccxt/cryptomus.py`
- **Size**: 48,531 bytes
- **Lines**: 1,138
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/cryptomus.py`.
...
```bash
python python/ccxt/cryptomus.py
```
