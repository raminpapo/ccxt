# Documentation: python/ccxt/protobuf/mexc/PushDataV3ApiWrapper_pb2.py

## File Metadata

- **Path**: `python/ccxt/protobuf/mexc/PushDataV3ApiWrapper_pb2.py`
- **Size**: 5,035 bytes
- **Lines**: 53
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/protobuf/mexc/PushDataV3ApiWrapper_pb2.py`.
...
```bash
python python/ccxt/protobuf/mexc/PushDataV3ApiWrapper_pb2.py
```
