# Documentation: python/ccxt/protobuf/mexc/PublicBookTickerBatchV3Api_pb2.py

## File Metadata

- **Path**: `python/ccxt/protobuf/mexc/PublicBookTickerBatchV3Api_pb2.py`
- **Size**: 1,750 bytes
- **Lines**: 39
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/protobuf/mexc/PublicBookTickerBatchV3Api_pb2.py`.
...
```bash
python python/ccxt/protobuf/mexc/PublicBookTickerBatchV3Api_pb2.py
```
