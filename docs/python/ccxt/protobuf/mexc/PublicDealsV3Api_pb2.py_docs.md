# Documentation: python/ccxt/protobuf/mexc/PublicDealsV3Api_pb2.py

## File Metadata

- **Path**: `python/ccxt/protobuf/mexc/PublicDealsV3Api_pb2.py`
- **Size**: 1,881 bytes
- **Lines**: 40
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/protobuf/mexc/PublicDealsV3Api_pb2.py`.
...
```bash
python python/ccxt/protobuf/mexc/PublicDealsV3Api_pb2.py
```
