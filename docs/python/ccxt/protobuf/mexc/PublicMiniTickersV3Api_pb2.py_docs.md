# Documentation: python/ccxt/protobuf/mexc/PublicMiniTickersV3Api_pb2.py

## File Metadata

- **Path**: `python/ccxt/protobuf/mexc/PublicMiniTickersV3Api_pb2.py`
- **Size**: 1,717 bytes
- **Lines**: 39
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/protobuf/mexc/PublicMiniTickersV3Api_pb2.py`.
...
```bash
python python/ccxt/protobuf/mexc/PublicMiniTickersV3Api_pb2.py
```
