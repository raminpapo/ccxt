# Documentation: python/ccxt/protobuf/mexc/PublicSpotKlineV3Api_pb2.py

## File Metadata

- **Path**: `python/ccxt/protobuf/mexc/PublicSpotKlineV3Api_pb2.py`
- **Size**: 1,886 bytes
- **Lines**: 38
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/protobuf/mexc/PublicSpotKlineV3Api_pb2.py`.
...
```bash
python python/ccxt/protobuf/mexc/PublicSpotKlineV3Api_pb2.py
```
