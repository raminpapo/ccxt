# Documentation: python/ccxt/coinmetro.py

## File Metadata

- **Path**: `python/ccxt/coinmetro.py`
- **Size**: 85,256 bytes
- **Lines**: 1,946
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/coinmetro.py`.
...
```bash
python python/ccxt/coinmetro.py
```
