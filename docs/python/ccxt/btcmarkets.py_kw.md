# Keywords: python/ccxt/btcmarkets.py

## Extracted Keywords

This file contains 74 keywords extracted from `python/ccxt/btcmarkets.py`.
...
Constant in python/ccxt/btcmarkets.py

[Back to file docs](btcmarkets.py_docs.md)
...
Identifier defined in python/ccxt/btcmarkets.py
...
#### <a name="fetch_ticker_2"></a> `fetch_ticker_2`
...
URL referenced in python/ccxt/btcmarkets.py
