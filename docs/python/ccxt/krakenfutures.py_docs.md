# Documentation: python/ccxt/krakenfutures.py

## File Metadata

- **Path**: `python/ccxt/krakenfutures.py`
- **Size**: 124,062 bytes
- **Lines**: 2,783
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/krakenfutures.py`.
...
```bash
python python/ccxt/krakenfutures.py
```
