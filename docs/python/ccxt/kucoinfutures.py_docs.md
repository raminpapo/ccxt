# Documentation: python/ccxt/kucoinfutures.py

## File Metadata

- **Path**: `python/ccxt/kucoinfutures.py`
- **Size**: 148,835 bytes
- **Lines**: 3,307
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/kucoinfutures.py`.
...
```bash
python python/ccxt/kucoinfutures.py
```
