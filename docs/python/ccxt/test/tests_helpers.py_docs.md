# Documentation: python/ccxt/test/tests_helpers.py

## File Metadata

- **Path**: `python/ccxt/test/tests_helpers.py`
- **Size**: 9,754 bytes
- **Lines**: 286
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/tests_helpers.py`.

**Classes defined**: Argv

**Functions defined**: get_test_name, convert_ascii, get_cli_arg_value, json_stringify, json_parse, dump_error, handle_all_unhandled_exceptions, io_file_exists, convert_to_snake_case, dump
...
- `call_exchange_method_dynamically_sync()`
- `call_method()`
- `call_method_sync()`
- `call_overriden_method()`
- `close()`
- `convert_ascii()`
...
**To run this test:**
```bash
pytest python/ccxt/test/tests_helpers.py
```
