# Documentation: python/ccxt/test/base/tests_init.py

## File Metadata

- **Path**: `python/ccxt/test/base/tests_init.py`
- **Size**: 2,763 bytes
- **Lines**: 61
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/base/tests_init.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/base/tests_init.py
```
