# Documentation: python/ccxt/test/base/test_safe_methods.py

## File Metadata

- **Path**: `python/ccxt/test/base/test_safe_methods.py`
- **Size**: 14,313 bytes
- **Lines**: 276
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/base/test_safe_methods.py`.

**Functions defined**: equals, test_safe_methods
...
**To run this test:**
```bash
pytest python/ccxt/test/base/test_safe_methods.py
```
