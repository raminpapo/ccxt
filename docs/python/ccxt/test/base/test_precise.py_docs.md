# Documentation: python/ccxt/test/base/test_precise.py

## File Metadata

- **Path**: `python/ccxt/test/base/test_precise.py`
- **Size**: 5,569 bytes
- **Lines**: 117
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/base/test_precise.py`.

**Functions defined**: test_precise
...
**To run this test:**
```bash
pytest python/ccxt/test/base/test_precise.py
```
