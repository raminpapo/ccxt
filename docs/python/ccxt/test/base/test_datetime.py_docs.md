# Documentation: python/ccxt/test/base/test_datetime.py

## File Metadata

- **Path**: `python/ccxt/test/base/test_datetime.py`
- **Size**: 4,367 bytes
- **Lines**: 70
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/base/test_datetime.py`.

**Functions defined**: test_datetime
...
**To run this test:**
```bash
pytest python/ccxt/test/base/test_datetime.py
```
