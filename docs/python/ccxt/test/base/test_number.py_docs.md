# Documentation: python/ccxt/test/base/test_number.py

## File Metadata

- **Path**: `python/ccxt/test/base/test_number.py`
- **Size**: 24,338 bytes
- **Lines**: 343
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/base/test_number.py`.

**Functions defined**: test_number
...
**To run this test:**
```bash
pytest python/ccxt/test/base/test_number.py
```
