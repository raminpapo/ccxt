# Documentation: python/ccxt/test/base/test_safe_ticker.py

## File Metadata

- **Path**: `python/ccxt/test/base/test_safe_ticker.py`
- **Size**: 5,317 bytes
- **Lines**: 138
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/base/test_safe_ticker.py`.

**Functions defined**: precise_equal_str, test_safe_ticker
...
**To run this test:**
```bash
pytest python/ccxt/test/base/test_safe_ticker.py
```
