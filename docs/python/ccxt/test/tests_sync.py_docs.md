# Documentation: python/ccxt/test/tests_sync.py

## File Metadata

- **Path**: `python/ccxt/test/tests_sync.py`
- **Size**: 89,458 bytes
- **Lines**: 1,762
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/tests_sync.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/tests_sync.py
```
