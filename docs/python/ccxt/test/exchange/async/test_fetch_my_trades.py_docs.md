# Documentation: python/ccxt/test/exchange/async/test_fetch_my_trades.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_my_trades.py`
- **Size**: 1,133 bytes
- **Lines**: 27
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_my_trades.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_my_trades.py
```
