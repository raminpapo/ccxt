# Documentation: python/ccxt/test/exchange/async/test_fetch_positions.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_positions.py`
- **Size**: 1,949 bytes
- **Lines**: 36
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_positions.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_positions.py
```
