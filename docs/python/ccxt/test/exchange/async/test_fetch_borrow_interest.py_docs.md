# Documentation: python/ccxt/test/exchange/async/test_fetch_borrow_interest.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_borrow_interest.py`
- **Size**: 1,103 bytes
- **Lines**: 25
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_borrow_interest.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_borrow_interest.py
```
