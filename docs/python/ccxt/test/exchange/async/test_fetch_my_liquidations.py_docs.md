# Documentation: python/ccxt/test/exchange/async/test_fetch_my_liquidations.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_my_liquidations.py`
- **Size**: 1,250 bytes
- **Lines**: 29
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_my_liquidations.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_my_liquidations.py
```
