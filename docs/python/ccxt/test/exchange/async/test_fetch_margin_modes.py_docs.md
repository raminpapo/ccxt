# Documentation: python/ccxt/test/exchange/async/test_fetch_margin_modes.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_margin_modes.py`
- **Size**: 1,413 bytes
- **Lines**: 29
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_margin_modes.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_margin_modes.py
```
