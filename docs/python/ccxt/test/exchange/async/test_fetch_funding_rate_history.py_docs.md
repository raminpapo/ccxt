# Documentation: python/ccxt/test/exchange/async/test_fetch_funding_rate_history.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_funding_rate_history.py`
- **Size**: 1,231 bytes
- **Lines**: 26
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_funding_rate_history.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_funding_rate_history.py
```
