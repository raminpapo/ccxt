# Documentation: python/ccxt/test/exchange/async/test_create_order.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_create_order.py`
- **Size**: 17,721 bytes
- **Lines**: 254
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_create_order.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_create_order.py
```
