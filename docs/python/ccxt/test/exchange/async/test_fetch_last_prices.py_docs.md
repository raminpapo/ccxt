# Documentation: python/ccxt/test/exchange/async/test_fetch_last_prices.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_last_prices.py`
- **Size**: 1,742 bytes
- **Lines**: 38
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_last_prices.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_last_prices.py
```
