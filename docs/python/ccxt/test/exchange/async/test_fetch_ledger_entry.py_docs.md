# Documentation: python/ccxt/test/exchange/async/test_fetch_ledger_entry.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_ledger_entry.py`
- **Size**: 1,178 bytes
- **Lines**: 30
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_ledger_entry.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_ledger_entry.py
```
