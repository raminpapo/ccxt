# Documentation: python/ccxt/test/exchange/async/test_fetch_currencies.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_currencies.py`
- **Size**: 4,157 bytes
- **Lines**: 74
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_currencies.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_currencies.py
```
