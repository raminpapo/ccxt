# Documentation: python/ccxt/test/exchange/async/test_fetch_markets.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_markets.py`
- **Size**: 1,779 bytes
- **Lines**: 42
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_markets.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_markets.py
```
