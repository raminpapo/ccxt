# Documentation: python/ccxt/test/exchange/async/test_fetch_open_orders.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_fetch_open_orders.py`
- **Size**: 1,270 bytes
- **Lines**: 29
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_fetch_open_orders.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_fetch_open_orders.py
```
