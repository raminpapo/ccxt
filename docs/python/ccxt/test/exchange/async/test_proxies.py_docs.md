# Documentation: python/ccxt/test/exchange/async/test_proxies.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/async/test_proxies.py`
- **Size**: 4,376 bytes
- **Lines**: 74
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/async/test_proxies.py`.

**Functions defined**: test_proxies, test_http_proxy, test_proxy_for_exceptions, test_proxy_url
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/async/test_proxies.py
```
