# Documentation: python/ccxt/test/exchange/base/test_currency.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/base/test_currency.py`
- **Size**: 4,908 bytes
- **Lines**: 86
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/base/test_currency.py`.

**Functions defined**: test_currency
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/base/test_currency.py
```
