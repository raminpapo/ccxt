# Documentation: python/ccxt/test/exchange/base/test_order.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/base/test_order.py`
- **Size**: 4,155 bytes
- **Lines**: 70
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/base/test_order.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/base/test_order.py
```
