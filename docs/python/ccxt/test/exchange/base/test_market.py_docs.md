# Documentation: python/ccxt/test/exchange/base/test_market.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/base/test_market.py`
- **Size**: 13,811 bytes
- **Lines**: 242
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/base/test_market.py`.

**Functions defined**: test_market
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/base/test_market.py
```
