# Documentation: python/ccxt/test/exchange/base/test_balance.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/base/test_balance.py`
- **Size**: 2,957 bytes
- **Lines**: 57
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/base/test_balance.py`.

**Functions defined**: test_balance
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/base/test_balance.py
```
