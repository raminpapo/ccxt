# Documentation: python/ccxt/test/exchange/base/test_ticker.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/base/test_ticker.py`
- **Size**: 11,826 bytes
- **Lines**: 178
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/base/test_ticker.py`.

**Functions defined**: test_ticker
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/base/test_ticker.py
```
