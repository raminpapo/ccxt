# Documentation: python/ccxt/test/exchange/base/test_borrow_rate.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/base/test_borrow_rate.py`
- **Size**: 1,526 bytes
- **Lines**: 33
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/base/test_borrow_rate.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/base/test_borrow_rate.py
```
