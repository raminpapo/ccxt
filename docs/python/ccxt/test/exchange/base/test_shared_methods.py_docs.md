# Documentation: python/ccxt/test/exchange/base/test_shared_methods.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/base/test_shared_methods.py`
- **Size**: 29,936 bytes
- **Lines**: 552
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/base/test_shared_methods.py`.

**Functions defined**: is_temporary_failure, assert_type, assert_timestamp_and_datetime, log_template, assert_currency_code, assert_valid_currency_id_and_code, assert_symbol, string_value, assert_timestamp, assert_structure
...
- `assert_non_emtpy_array()`
- `assert_non_equal()`
- `assert_order_state()`
- `assert_round_minute_timestamp()`
- `assert_structure()`
- `assert_symbol()`
- `assert_symbol_in_markets()`
- `assert_timestamp()`
- `assert_timestamp_and_datetime()`
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/base/test_shared_methods.py
```
