# Documentation: python/ccxt/test/exchange/sync/test_fetch_open_interest_history.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_fetch_open_interest_history.py`
- **Size**: 1,104 bytes
- **Lines**: 25
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_fetch_open_interest_history.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_fetch_open_interest_history.py
```
