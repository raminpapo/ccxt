# Documentation: python/ccxt/test/exchange/sync/test_fetch_closed_orders.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_fetch_closed_orders.py`
- **Size**: 1,278 bytes
- **Lines**: 29
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_fetch_closed_orders.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_fetch_closed_orders.py
```
