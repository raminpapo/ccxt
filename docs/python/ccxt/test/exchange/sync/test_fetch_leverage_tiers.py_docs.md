# Documentation: python/ccxt/test/exchange/sync/test_fetch_leverage_tiers.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_fetch_leverage_tiers.py`
- **Size**: 1,509 bytes
- **Lines**: 35
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_fetch_leverage_tiers.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_fetch_leverage_tiers.py
```
