# Documentation: python/ccxt/test/exchange/sync/test_features.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_features.py`
- **Size**: 4,351 bytes
- **Lines**: 125
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_features.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_features.py
```
