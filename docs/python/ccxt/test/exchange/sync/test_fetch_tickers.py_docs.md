# Documentation: python/ccxt/test/exchange/sync/test_fetch_tickers.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_fetch_tickers.py`
- **Size**: 3,047 bytes
- **Lines**: 59
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_fetch_tickers.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_fetch_tickers.py
```
