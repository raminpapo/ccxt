# Documentation: python/ccxt/test/exchange/sync/test_fetch_trading_fee.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_fetch_trading_fee.py`
- **Size**: 926 bytes
- **Lines**: 23
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_fetch_trading_fee.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_fetch_trading_fee.py
```
