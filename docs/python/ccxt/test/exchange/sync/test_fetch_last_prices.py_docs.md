# Documentation: python/ccxt/test/exchange/sync/test_fetch_last_prices.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_fetch_last_prices.py`
- **Size**: 1,724 bytes
- **Lines**: 38
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_fetch_last_prices.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_fetch_last_prices.py
```
