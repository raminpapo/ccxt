# Documentation: python/ccxt/test/exchange/sync/test_proxies.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_proxies.py`
- **Size**: 4,316 bytes
- **Lines**: 74
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_proxies.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_proxies.py
```
