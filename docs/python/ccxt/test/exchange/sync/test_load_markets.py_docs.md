# Documentation: python/ccxt/test/exchange/sync/test_load_markets.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_load_markets.py`
- **Size**: 1,434 bytes
- **Lines**: 32
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_load_markets.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_load_markets.py
```
