# Documentation: python/ccxt/test/exchange/sync/test_fetch_ohlcv.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_fetch_ohlcv.py`
- **Size**: 1,607 bytes
- **Lines**: 36
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_fetch_ohlcv.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_fetch_ohlcv.py
```
