# Documentation: python/ccxt/test/exchange/sync/test_fetch_deposit_withdrawals.py

## File Metadata

- **Path**: `python/ccxt/test/exchange/sync/test_fetch_deposit_withdrawals.py`
- **Size**: 1,184 bytes
- **Lines**: 27
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/exchange/sync/test_fetch_deposit_withdrawals.py`.
...
**To run this test:**
```bash
pytest python/ccxt/test/exchange/sync/test_fetch_deposit_withdrawals.py
```
