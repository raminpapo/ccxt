# Documentation: python/ccxt/test/tests_async.py

## File Metadata

- **Path**: `python/ccxt/test/tests_async.py`
- **Size**: 90,522 bytes
- **Lines**: 1,765
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/test/tests_async.py`.

**Classes defined**: testMainClass

**Functions defined**: load_credentials_from_env, parse_cli_args_and_props, test_method, add_padding, init_inner, import_files, get_skips, expand_settings, check_if_specific_test_is_chosen, init
...
**Functions** (75):
- `add_padding()`
- `assert_new_and_stored_output()`
- `assert_new_and_stored_output_inner()`
- `assert_static_error()`
- `assert_static_request_output()`
- `assert_static_response_output()`
- `check_constructor()`
- `check_if_exchange_is_disabled()`
- `check_if_specific_test_is_chosen()`
- `expand_settings()`
- `get_exchange_code()`
- `get_markets_from_exchange()`
...
**To run this test:**
```bash
pytest python/ccxt/test/tests_async.py
```
