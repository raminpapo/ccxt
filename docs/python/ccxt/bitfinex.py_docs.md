# Documentation: python/ccxt/bitfinex.py

## File Metadata

- **Path**: `python/ccxt/bitfinex.py`
- **Size**: 168,118 bytes
- **Lines**: 3,797
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/bitfinex.py`.
...
```bash
python python/ccxt/bitfinex.py
```
