# Documentation: python/ccxt/modetrade.py

## File Metadata

- **Path**: `python/ccxt/modetrade.py`
- **Size**: 124,940 bytes
- **Lines**: 2,819
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/modetrade.py`.
...
```bash
python python/ccxt/modetrade.py
```
