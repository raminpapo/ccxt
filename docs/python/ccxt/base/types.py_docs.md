# Documentation: python/ccxt/base/types.py

## File Metadata

- **Path**: `python/ccxt/base/types.py`
- **Size**: 11,544 bytes
- **Lines**: 613
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/base/types.py`.

**Classes defined**: FeeInterface, Balance, Trade, OrderRequest, CancellationRequest, Entry, Position, Account, BalanceAccount, TradingFeeInterface

**Functions defined**: __get__, unbound_method, __init__, __set_name__
...
```bash
python python/ccxt/base/types.py
```
