# Documentation: python/ccxt/base/exchange.py

## File Metadata

- **Path**: `python/ccxt/base/exchange.py`
- **Size**: 360,756 bytes
- **Lines**: 7,583
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/base/exchange.py`.

**Classes defined**: error_string, Exchange, needs, SafeJSONEncoder

**Functions defined**: throttle, __str__, __del__, prepare_request_headers, __init__, init_throttler, log, gzip_deflate, default, __repr__
...
```bash
python python/ccxt/base/exchange.py
```
