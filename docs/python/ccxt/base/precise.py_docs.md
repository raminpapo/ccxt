# Documentation: python/ccxt/base/precise.py
...
This is a Python file located at `python/ccxt/base/precise.py`.

**Classes defined**: Precise

**Functions defined**: __sub__, __mod__, __mul__, __neg__, __init__, __max__, __min__, __abs__, __add__, __truediv__
...
```bash
python python/ccxt/base/precise.py
```
