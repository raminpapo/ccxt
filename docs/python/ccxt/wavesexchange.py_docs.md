# Documentation: python/ccxt/wavesexchange.py

## File Metadata

- **Path**: `python/ccxt/wavesexchange.py`
- **Size**: 121,654 bytes
- **Lines**: 2,642
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/wavesexchange.py`.
...
```bash
python python/ccxt/wavesexchange.py
```
