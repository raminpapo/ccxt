# Documentation: python/ccxt/deepcoin.py

## File Metadata

- **Path**: `python/ccxt/deepcoin.py`
- **Size**: 129,043 bytes
- **Lines**: 2,859
- **Type**: Python
- **Extension**: .py
...
class deepcoin(Exchange, ImplicitAPI):
    ...
    def fetch_deposit_addresses(self, codes: Strings = None, params={}) -> List[DepositAddress]:
        ...
        response = self.privateGetDeepcoinAssetRechargeChainList(self.extend(request, params))
        #
        #     {
        #         "code": "0",
        #         "msg": "",
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        if triggerPrice is not None:
            # trigger orders
            response = self.privatePostDeepcoinTradeTriggerOrder(request)
        else:
            # regular orders
            #
            #     {
            ...
            #     }
            #
            response = self.privatePostDeepcoinTradeOrder(request)
        data = self.safe_dict(response, 'data', {})
 ...
 @ignore
    ...
    def fetch_closed_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        response = self.privateGetDeepcoinTradeFinishOrderByID(self.extend(request, params))
        #
        #     {
        #         "code": "0",
        #         "msg": "",
    ...
    def fetch_open_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        response = self.privateGetDeepcoinTradeOrderByID(self.extend(request, params))
        data = self.safe_list(response, 'data', [])
        length = len(data)
        if length == 0:
            return None
    ...
    def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if trigger:
            ...
            #     }
            #
            response = self.privateGetDeepcoinTradeV2OrdersPending(self.extend(request, params))
        data = self.safe_list(response, 'data', [])
...
This is a Python file located at `python/ccxt/deepcoin.py`.

**Classes defined**: deepcoin

**Functions defined**: parse_market, describe, fetch_ohlcv, set_markets, fetch_order_book, convert_to_instrument_type, fetch_markets, fetch_tickers, handle_market_type_and_params, fetch_markets_by_type
...
```bash
python python/ccxt/deepcoin.py
```
