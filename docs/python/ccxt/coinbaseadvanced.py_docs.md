# Documentation: python/ccxt/coinbaseadvanced.py

## File Metadata

- **Path**: `python/ccxt/coinbaseadvanced.py`
- **Size**: 577 bytes
- **Lines**: 19
- **Type**: Python
- **Extension**: .py
...
This is a Python file located at `python/ccxt/coinbaseadvanced.py`.
...
```bash
python python/ccxt/coinbaseadvanced.py
```
