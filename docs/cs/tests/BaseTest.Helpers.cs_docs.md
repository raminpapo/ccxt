# Documentation: cs/tests/BaseTest.Helpers.cs

## File Metadata

- **Path**: `cs/tests/BaseTest.Helpers.cs`
- **Size**: 11,588 bytes
- **Lines**: 378
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/BaseTest.Helpers.cs`.

**Classes defined**: testMainClass, SharedMethods
