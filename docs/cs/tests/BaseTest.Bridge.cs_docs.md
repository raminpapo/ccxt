# Documentation: cs/tests/BaseTest.Bridge.cs

## File Metadata

- **Path**: `cs/tests/BaseTest.Bridge.cs`
- **Size**: 7,521 bytes
- **Lines**: 196
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/BaseTest.Bridge.cs`.

**Classes defined**: Helper, BaseTest
