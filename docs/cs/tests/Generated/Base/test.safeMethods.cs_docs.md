# Documentation: cs/tests/Generated/Base/test.safeMethods.cs

## File Metadata

- **Path**: `cs/tests/Generated/Base/test.safeMethods.cs`
- **Size**: 18,360 bytes
- **Lines**: 267
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Base/test.safeMethods.cs`.
