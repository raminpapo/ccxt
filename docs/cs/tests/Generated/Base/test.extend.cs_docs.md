# Documentation: cs/tests/Generated/Base/test.extend.cs

## File Metadata

- **Path**: `cs/tests/Generated/Base/test.extend.cs`
- **Size**: 3,157 bytes
- **Lines**: 79
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Base/test.extend.cs`.
