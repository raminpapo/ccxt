# Documentation: cs/tests/Generated/Base/test.afterConstructor.cs

## File Metadata

- **Path**: `cs/tests/Generated/Base/test.afterConstructor.cs`
- **Size**: 5,208 bytes
- **Lines**: 114
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Base/test.afterConstructor.cs`.
