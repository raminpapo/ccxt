# Documentation: cs/tests/Generated/Base/test.number.cs

## File Metadata

- **Path**: `cs/tests/Generated/Base/test.number.cs`
- **Size**: 27,782 bytes
- **Lines**: 327
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Base/test.number.cs`.
