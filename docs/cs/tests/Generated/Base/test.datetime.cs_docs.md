# Documentation: cs/tests/Generated/Base/test.datetime.cs

## File Metadata

- **Path**: `cs/tests/Generated/Base/test.datetime.cs`
- **Size**: 4,725 bytes
- **Lines**: 61
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Base/test.datetime.cs`.
