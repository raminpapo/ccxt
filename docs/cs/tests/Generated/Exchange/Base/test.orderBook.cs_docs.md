# Documentation: cs/tests/Generated/Exchange/Base/test.orderBook.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/Base/test.orderBook.cs`
- **Size**: 4,678 bytes
- **Lines**: 82
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/Base/test.orderBook.cs`.
