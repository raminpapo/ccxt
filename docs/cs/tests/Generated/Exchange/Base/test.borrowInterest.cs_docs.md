# Documentation: cs/tests/Generated/Exchange/Base/test.borrowInterest.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/Base/test.borrowInterest.cs`
- **Size**: 1,761 bytes
- **Lines**: 32
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/Base/test.borrowInterest.cs`.
