# Documentation: cs/tests/Generated/Exchange/Base/test.currency.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/Base/test.currency.cs`
- **Size**: 6,023 bytes
- **Lines**: 97
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/Base/test.currency.cs`.
