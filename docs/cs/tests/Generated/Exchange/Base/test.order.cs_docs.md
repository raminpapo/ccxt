# Documentation: cs/tests/Generated/Exchange/Base/test.order.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/Base/test.order.cs`
- **Size**: 4,503 bytes
- **Lines**: 71
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/Base/test.order.cs`.
