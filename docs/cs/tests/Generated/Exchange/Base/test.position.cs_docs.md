# Documentation: cs/tests/Generated/Exchange/Base/test.position.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/Base/test.position.cs`
- **Size**: 3,961 bytes
- **Lines**: 57
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/Base/test.position.cs`.
