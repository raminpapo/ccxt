# Documentation: cs/tests/Generated/Exchange/Base/test.depositWithdrawal.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/Base/test.depositWithdrawal.cs`
- **Size**: 2,617 bytes
- **Lines**: 50
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/Base/test.depositWithdrawal.cs`.
