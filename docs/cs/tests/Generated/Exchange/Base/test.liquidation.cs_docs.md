# Documentation: cs/tests/Generated/Exchange/Base/test.liquidation.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/Base/test.liquidation.cs`
- **Size**: 3,042 bytes
- **Lines**: 52
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/Base/test.liquidation.cs`.
