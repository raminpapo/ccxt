# Documentation: cs/tests/Generated/Exchange/Base/test.openInterest.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/Base/test.openInterest.cs`
- **Size**: 1,459 bytes
- **Lines**: 29
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/Base/test.openInterest.cs`.
