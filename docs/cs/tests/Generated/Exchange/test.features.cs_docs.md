# Documentation: cs/tests/Generated/Exchange/test.features.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/test.features.cs`
- **Size**: 5,900 bytes
- **Lines**: 134
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/test.features.cs`.
