# Documentation: cs/tests/Generated/Exchange/test.fetchLiquidations.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/test.fetchLiquidations.cs`
- **Size**: 1,212 bytes
- **Lines**: 28
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/test.fetchLiquidations.cs`.
