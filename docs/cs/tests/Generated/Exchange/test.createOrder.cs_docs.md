# Documentation: cs/tests/Generated/Exchange/test.createOrder.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/test.createOrder.cs`
- **Size**: 21,052 bytes
- **Lines**: 295
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/test.createOrder.cs`.
