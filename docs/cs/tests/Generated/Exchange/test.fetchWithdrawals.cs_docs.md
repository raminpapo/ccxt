# Documentation: cs/tests/Generated/Exchange/test.fetchWithdrawals.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/test.fetchWithdrawals.cs`
- **Size**: 964 bytes
- **Lines**: 24
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/test.fetchWithdrawals.cs`.
