# Documentation: cs/tests/Generated/Exchange/test.fetchClosedOrders.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/test.fetchClosedOrders.cs`
- **Size**: 1,111 bytes
- **Lines**: 26
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/test.fetchClosedOrders.cs`.
