# Documentation: cs/tests/Generated/Exchange/test.fetchOrderBook.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/test.fetchOrderBook.cs`
- **Size**: 575 bytes
- **Lines**: 18
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/test.fetchOrderBook.cs`.
