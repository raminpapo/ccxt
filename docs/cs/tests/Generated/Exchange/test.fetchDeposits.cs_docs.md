# Documentation: cs/tests/Generated/Exchange/test.fetchDeposits.cs

## File Metadata

- **Path**: `cs/tests/Generated/Exchange/test.fetchDeposits.cs`
- **Size**: 955 bytes
- **Lines**: 24
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/tests/Generated/Exchange/test.fetchDeposits.cs`.
