# Documentation: cs/ccxt/ws/SlimConcurrentList.cs

## File Metadata

- **Path**: `cs/ccxt/ws/SlimConcurrentList.cs`
- **Size**: 16,352 bytes
- **Lines**: 397
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/ws/SlimConcurrentList.cs`.

**Classes defined**: SlimConcurrentList
