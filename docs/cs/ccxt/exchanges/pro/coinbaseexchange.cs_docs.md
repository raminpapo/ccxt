# Documentation: cs/ccxt/exchanges/pro/coinbaseexchange.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/coinbaseexchange.cs`
- **Size**: 49,567 bytes
- **Lines**: 1,074
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/coinbaseexchange.cs`.
