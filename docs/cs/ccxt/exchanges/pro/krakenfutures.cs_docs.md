# Documentation: cs/ccxt/exchanges/pro/krakenfutures.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/krakenfutures.cs`
- **Size**: 79,025 bytes
- **Lines**: 1,738
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/krakenfutures.cs`.
