# Documentation: cs/ccxt/exchanges/pro/kucoinfutures.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/kucoinfutures.cs`
- **Size**: 70,274 bytes
- **Lines**: 1,437
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/kucoinfutures.cs`.
