# Documentation: cs/ccxt/exchanges/pro/independentreserve.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/independentreserve.cs`
- **Size**: 14,603 bytes
- **Lines**: 324
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/independentreserve.cs`.
