# Documentation: cs/ccxt/exchanges/pro/wrappers/whitebit.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/whitebit.cs`
- **Size**: 9,699 bytes
- **Lines**: 240
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/whitebit.cs`.

**Classes defined**: whitebit, Whitebit
