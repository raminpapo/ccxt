# Documentation: cs/ccxt/exchanges/pro/wrappers/arkham.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/arkham.cs`
- **Size**: 8,446 bytes
- **Lines**: 213
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/arkham.cs`.

**Classes defined**: arkham, Arkham
