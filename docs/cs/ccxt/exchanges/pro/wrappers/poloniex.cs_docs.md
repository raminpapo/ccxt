# Documentation: cs/ccxt/exchanges/pro/wrappers/poloniex.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/poloniex.cs`
- **Size**: 16,252 bytes
- **Lines**: 408
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/poloniex.cs`.

**Classes defined**: Poloniex, poloniex
