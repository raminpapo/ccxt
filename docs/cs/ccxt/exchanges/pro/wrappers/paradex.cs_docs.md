# Documentation: cs/ccxt/exchanges/pro/wrappers/paradex.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/paradex.cs`
- **Size**: 4,611 bytes
- **Lines**: 111
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/paradex.cs`.

**Classes defined**: paradex, Paradex
