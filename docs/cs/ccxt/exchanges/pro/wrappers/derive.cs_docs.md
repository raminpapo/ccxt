# Documentation: cs/ccxt/exchanges/pro/wrappers/derive.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/derive.cs`
- **Size**: 6,692 bytes
- **Lines**: 171
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/derive.cs`.

**Classes defined**: derive, Derive
