# Documentation: cs/ccxt/exchanges/pro/wrappers/toobit.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/toobit.cs`
- **Size**: 15,184 bytes
- **Lines**: 368
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/toobit.cs`.

**Classes defined**: toobit, Toobit
