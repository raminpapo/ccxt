# Documentation: cs/ccxt/exchanges/pro/wrappers/xt.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/xt.cs`
- **Size**: 10,030 bytes
- **Lines**: 227
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/xt.cs`.

**Classes defined**: xt, Xt
