# Documentation: cs/ccxt/exchanges/pro/wrappers/backpack.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/backpack.cs`
- **Size**: 13,678 bytes
- **Lines**: 334
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/backpack.cs`.

**Classes defined**: Backpack, backpack
