# Documentation: cs/ccxt/exchanges/pro/wrappers/bitget.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/bitget.cs`
- **Size**: 21,261 bytes
- **Lines**: 495
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/bitget.cs`.

**Classes defined**: Bitget, bitget
