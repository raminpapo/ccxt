# Documentation: cs/ccxt/exchanges/pro/wrappers/hitbtc.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/hitbtc.cs`
- **Size**: 14,826 bytes
- **Lines**: 379
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/hitbtc.cs`.

**Classes defined**: hitbtc, Hitbtc
