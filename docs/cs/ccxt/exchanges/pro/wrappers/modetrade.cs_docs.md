# Documentation: cs/ccxt/exchanges/pro/wrappers/modetrade.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/modetrade.cs`
- **Size**: 12,199 bytes
- **Lines**: 288
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/modetrade.cs`.

**Classes defined**: modetrade, Modetrade
