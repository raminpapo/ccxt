# Documentation: cs/ccxt/exchanges/pro/wrappers/bitmex.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/bitmex.cs`
- **Size**: 16,075 bytes
- **Lines**: 395
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/bitmex.cs`.

**Classes defined**: bitmex, Bitmex
