# Documentation: cs/ccxt/exchanges/pro/wrappers/woo.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/woo.cs`
- **Size**: 11,778 bytes
- **Lines**: 294
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/woo.cs`.

**Classes defined**: Woo, woo
