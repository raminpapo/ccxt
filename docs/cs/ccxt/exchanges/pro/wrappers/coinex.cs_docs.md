# Documentation: cs/ccxt/exchanges/pro/wrappers/coinex.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/coinex.cs`
- **Size**: 12,637 bytes
- **Lines**: 302
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/coinex.cs`.

**Classes defined**: coinex, Coinex
