# Documentation: cs/ccxt/exchanges/pro/wrappers/alpaca.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/alpaca.cs`
- **Size**: 7,894 bytes
- **Lines**: 198
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/alpaca.cs`.

**Classes defined**: alpaca, Alpaca
