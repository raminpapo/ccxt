# Documentation: cs/ccxt/exchanges/pro/wrappers/ascendex.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/ascendex.cs`
- **Size**: 8,262 bytes
- **Lines**: 204
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/ascendex.cs`.

**Classes defined**: ascendex, Ascendex
