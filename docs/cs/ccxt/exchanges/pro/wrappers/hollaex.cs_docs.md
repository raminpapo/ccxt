# Documentation: cs/ccxt/exchanges/pro/wrappers/hollaex.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/hollaex.cs`
- **Size**: 6,281 bytes
- **Lines**: 159
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/hollaex.cs`.

**Classes defined**: hollaex, Hollaex
