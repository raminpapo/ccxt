# Documentation: cs/ccxt/exchanges/pro/wrappers/cex.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/cex.cs`
- **Size**: 17,585 bytes
- **Lines**: 422
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/cex.cs`.

**Classes defined**: Cex, cex
