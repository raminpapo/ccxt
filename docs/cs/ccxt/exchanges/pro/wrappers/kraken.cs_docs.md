# Documentation: cs/ccxt/exchanges/pro/wrappers/kraken.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/kraken.cs`
- **Size**: 18,634 bytes
- **Lines**: 457
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/kraken.cs`.

**Classes defined**: Kraken, kraken
