# Documentation: cs/ccxt/exchanges/pro/wrappers/woofipro.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/woofipro.cs`
- **Size**: 12,195 bytes
- **Lines**: 288
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/woofipro.cs`.

**Classes defined**: Woofipro, woofipro
