# Documentation: cs/ccxt/exchanges/pro/wrappers/oxfun.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/oxfun.cs`
- **Size**: 20,314 bytes
- **Lines**: 493
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/oxfun.cs`.

**Classes defined**: Oxfun, oxfun
