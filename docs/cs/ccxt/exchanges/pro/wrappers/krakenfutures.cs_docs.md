# Documentation: cs/ccxt/exchanges/pro/wrappers/krakenfutures.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/krakenfutures.cs`
- **Size**: 12,977 bytes
- **Lines**: 308
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/krakenfutures.cs`.

**Classes defined**: Krakenfutures, krakenfutures
