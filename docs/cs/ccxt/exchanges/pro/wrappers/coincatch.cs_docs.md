# Documentation: cs/ccxt/exchanges/pro/wrappers/coincatch.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/coincatch.cs`
- **Size**: 13,913 bytes
- **Lines**: 331
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/coincatch.cs`.

**Classes defined**: Coincatch, coincatch
