# Documentation: cs/ccxt/exchanges/pro/wrappers/okx.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/okx.cs`
- **Size**: 28,641 bytes
- **Lines**: 696
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/okx.cs`.

**Classes defined**: Okx, okx
