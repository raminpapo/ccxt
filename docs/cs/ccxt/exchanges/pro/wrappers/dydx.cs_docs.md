# Documentation: cs/ccxt/exchanges/pro/wrappers/dydx.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/dydx.cs`
- **Size**: 4,197 bytes
- **Lines**: 105
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/dydx.cs`.

**Classes defined**: Dydx, dydx
