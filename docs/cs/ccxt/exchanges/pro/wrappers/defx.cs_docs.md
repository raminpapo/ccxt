# Documentation: cs/ccxt/exchanges/pro/wrappers/defx.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/defx.cs`
- **Size**: 14,495 bytes
- **Lines**: 348
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/defx.cs`.

**Classes defined**: Defx, defx
