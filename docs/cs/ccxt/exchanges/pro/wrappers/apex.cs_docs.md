# Documentation: cs/ccxt/exchanges/pro/wrappers/apex.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/apex.cs`
- **Size**: 14,419 bytes
- **Lines**: 347
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/apex.cs`.

**Classes defined**: Apex, apex
