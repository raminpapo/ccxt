# Documentation: cs/ccxt/exchanges/pro/wrappers/bitfinex.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/bitfinex.cs`
- **Size**: 8,115 bytes
- **Lines**: 212
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/bitfinex.cs`.

**Classes defined**: Bitfinex, bitfinex
