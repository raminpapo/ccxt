# Documentation: cs/ccxt/exchanges/pro/wrappers/coincheck.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/coincheck.cs`
- **Size**: 2,819 bytes
- **Lines**: 71
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/coincheck.cs`.

**Classes defined**: Coincheck, coincheck
