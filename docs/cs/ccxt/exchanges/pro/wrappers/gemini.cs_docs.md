# Documentation: cs/ccxt/exchanges/pro/wrappers/gemini.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/gemini.cs`
- **Size**: 7,969 bytes
- **Lines**: 193
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/gemini.cs`.

**Classes defined**: Gemini, gemini
