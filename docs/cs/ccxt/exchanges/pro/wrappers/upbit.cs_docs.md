# Documentation: cs/ccxt/exchanges/pro/wrappers/upbit.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/upbit.cs`
- **Size**: 11,186 bytes
- **Lines**: 273
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/upbit.cs`.

**Classes defined**: Upbit, upbit
