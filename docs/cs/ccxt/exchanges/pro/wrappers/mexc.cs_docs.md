# Documentation: cs/ccxt/exchanges/pro/wrappers/mexc.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/mexc.cs`
- **Size**: 12,996 bytes
- **Lines**: 299
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/mexc.cs`.

**Classes defined**: Mexc, mexc
