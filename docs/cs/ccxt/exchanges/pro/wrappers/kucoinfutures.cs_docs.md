# Documentation: cs/ccxt/exchanges/pro/wrappers/kucoinfutures.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/kucoinfutures.cs`
- **Size**: 12,275 bytes
- **Lines**: 297
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/kucoinfutures.cs`.

**Classes defined**: Kucoinfutures, kucoinfutures
