# Documentation: cs/ccxt/exchanges/pro/wrappers/gate.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/gate.cs`
- **Size**: 30,193 bytes
- **Lines**: 741
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/gate.cs`.

**Classes defined**: Gate, gate
