# Documentation: cs/ccxt/exchanges/pro/wrappers/onetrading.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/onetrading.cs`
- **Size**: 8,656 bytes
- **Lines**: 210
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/onetrading.cs`.

**Classes defined**: Onetrading, onetrading
