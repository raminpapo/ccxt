# Documentation: cs/ccxt/exchanges/pro/wrappers/bitmart.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/bitmart.cs`
- **Size**: 14,019 bytes
- **Lines**: 329
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/bitmart.cs`.

**Classes defined**: bitmart, Bitmart
