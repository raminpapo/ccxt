# Documentation: cs/ccxt/exchanges/pro/wrappers/binance.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/binance.cs`
- **Size**: 51,532 bytes
- **Lines**: 1,107
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/binance.cs`.

**Classes defined**: Binance, binance
