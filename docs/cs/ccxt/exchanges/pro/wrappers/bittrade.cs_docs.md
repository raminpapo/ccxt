# Documentation: cs/ccxt/exchanges/pro/wrappers/bittrade.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/bittrade.cs`
- **Size**: 4,695 bytes
- **Lines**: 121
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/bittrade.cs`.

**Classes defined**: bittrade, Bittrade
