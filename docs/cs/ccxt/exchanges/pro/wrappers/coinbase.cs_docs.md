# Documentation: cs/ccxt/exchanges/pro/wrappers/coinbase.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/coinbase.cs`
- **Size**: 9,038 bytes
- **Lines**: 222
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/coinbase.cs`.

**Classes defined**: Coinbase, coinbase
