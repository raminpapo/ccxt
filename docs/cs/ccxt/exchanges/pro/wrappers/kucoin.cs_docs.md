# Documentation: cs/ccxt/exchanges/pro/wrappers/kucoin.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/kucoin.cs`
- **Size**: 15,342 bytes
- **Lines**: 356
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/kucoin.cs`.

**Classes defined**: kucoin, Kucoin
