# Documentation: cs/ccxt/exchanges/pro/wrappers/blofin.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/blofin.cs`
- **Size**: 15,289 bytes
- **Lines**: 366
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/blofin.cs`.

**Classes defined**: blofin, Blofin
