# Documentation: cs/ccxt/exchanges/pro/wrappers/coinbaseexchange.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/coinbaseexchange.cs`
- **Size**: 11,071 bytes
- **Lines**: 278
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/coinbaseexchange.cs`.

**Classes defined**: Coinbaseexchange, coinbaseexchange
