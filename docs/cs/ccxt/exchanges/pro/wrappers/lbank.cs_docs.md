# Documentation: cs/ccxt/exchanges/pro/wrappers/lbank.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/lbank.cs`
- **Size**: 11,205 bytes
- **Lines**: 264
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/lbank.cs`.

**Classes defined**: Lbank, lbank
