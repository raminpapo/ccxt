# Documentation: cs/ccxt/exchanges/pro/wrappers/bithumb.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/bithumb.cs`
- **Size**: 7,313 bytes
- **Lines**: 171
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/bithumb.cs`.

**Classes defined**: bithumb, Bithumb
