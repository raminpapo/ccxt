# Documentation: cs/ccxt/exchanges/pro/wrappers/bingx.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/bingx.cs`
- **Size**: 11,127 bytes
- **Lines**: 239
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/bingx.cs`.

**Classes defined**: bingx, Bingx
