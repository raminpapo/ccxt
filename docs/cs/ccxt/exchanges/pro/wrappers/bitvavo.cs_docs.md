# Documentation: cs/ccxt/exchanges/pro/wrappers/bitvavo.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/bitvavo.cs`
- **Size**: 28,400 bytes
- **Lines**: 721
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/bitvavo.cs`.

**Classes defined**: Bitvavo, bitvavo
