# Documentation: cs/ccxt/exchanges/pro/wrappers/bitstamp.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/bitstamp.cs`
- **Size**: 3,870 bytes
- **Lines**: 102
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/bitstamp.cs`.

**Classes defined**: Bitstamp, bitstamp
