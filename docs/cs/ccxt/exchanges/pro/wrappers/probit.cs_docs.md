# Documentation: cs/ccxt/exchanges/pro/wrappers/probit.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/probit.cs`
- **Size**: 7,632 bytes
- **Lines**: 197
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/probit.cs`.

**Classes defined**: probit, Probit
