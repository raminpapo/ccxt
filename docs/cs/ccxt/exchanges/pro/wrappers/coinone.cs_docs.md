# Documentation: cs/ccxt/exchanges/pro/wrappers/coinone.cs

## File Metadata

- **Path**: `cs/ccxt/exchanges/pro/wrappers/coinone.cs`
- **Size**: 3,661 bytes
- **Lines**: 91
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/exchanges/pro/wrappers/coinone.cs`.

**Classes defined**: coinone, Coinone
