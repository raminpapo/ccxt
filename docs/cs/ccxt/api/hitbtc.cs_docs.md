# Documentation: cs/ccxt/api/hitbtc.cs

## File Metadata

- **Path**: `cs/ccxt/api/hitbtc.cs`
- **Size**: 20,928 bytes
- **Lines**: 569
- **Type**: C#
- **Extension**: .cs
...
{
    public hitbtc (object args = null): base(args) {}
...
This is a C# file located at `cs/ccxt/api/hitbtc.cs`.
