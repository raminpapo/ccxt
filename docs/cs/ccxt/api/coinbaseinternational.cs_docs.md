# Documentation: cs/ccxt/api/coinbaseinternational.cs

## File Metadata

- **Path**: `cs/ccxt/api/coinbaseinternational.cs`
- **Size**: 6,968 bytes
- **Lines**: 189
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/api/coinbaseinternational.cs`.
