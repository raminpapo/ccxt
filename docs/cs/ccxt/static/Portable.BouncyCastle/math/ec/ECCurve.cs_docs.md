# Documentation: cs/ccxt/static/Portable.BouncyCastle/math/ec/ECCurve.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/math/ec/ECCurve.cs`
- **Size**: 48,831 bytes
- **Lines**: 1,438
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/math/ec/ECCurve.cs`.

**Classes defined**: ECCurve, F2mCurve, DefaultF2mLookupTable, DefaultLookupTable, AbstractFpCurve, for, Config, AbstractF2mCurve, FpCurve
