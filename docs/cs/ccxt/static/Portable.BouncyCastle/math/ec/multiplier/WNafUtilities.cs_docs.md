# Documentation: cs/ccxt/static/Portable.BouncyCastle/math/ec/multiplier/WNafUtilities.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/math/ec/multiplier/WNafUtilities.cs`
- **Size**: 26,244 bytes
- **Lines**: 756
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/math/ec/multiplier/WNafUtilities.cs`.

**Classes defined**: PrecomputeWithPointMapCallback, ConfigureBasepointCallback, PrecomputeCallback, WNafUtilities, MapPointCallback
