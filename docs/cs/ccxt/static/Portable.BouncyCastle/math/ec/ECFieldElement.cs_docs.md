# Documentation: cs/ccxt/static/Portable.BouncyCastle/math/ec/ECFieldElement.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/math/ec/ECFieldElement.cs`
- **Size**: 28,111 bytes
- **Lines**: 925
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/math/ec/ECFieldElement.cs`.

**Classes defined**: ECFieldElement, F2mFieldElement, AbstractFpFieldElement, FpFieldElement, AbstractF2mFieldElement
