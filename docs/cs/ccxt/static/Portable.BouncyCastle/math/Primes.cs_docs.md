# Documentation: cs/ccxt/static/Portable.BouncyCastle/math/Primes.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/math/Primes.cs`
- **Size**: 21,285 bytes
- **Lines**: 630
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/math/Primes.cs`.

**Classes defined**: MROutput, Primes, STOutput
