# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/collections/ReadOnlyDictionary.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/collections/ReadOnlyDictionary.cs`
- **Size**: 2,612 bytes
- **Lines**: 65
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/collections/ReadOnlyDictionary.cs`.

**Classes defined**: ReadOnlyDictionaryProxy, ReadOnlyDictionary
