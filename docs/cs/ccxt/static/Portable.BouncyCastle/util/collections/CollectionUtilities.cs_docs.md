# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/collections/CollectionUtilities.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/collections/CollectionUtilities.cs`
- **Size**: 2,795 bytes
- **Lines**: 105
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/collections/CollectionUtilities.cs`.

**Classes defined**: CollectionUtilities
