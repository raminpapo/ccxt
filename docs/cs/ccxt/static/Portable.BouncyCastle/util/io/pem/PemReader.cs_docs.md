# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/io/pem/PemReader.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/io/pem/PemReader.cs`
- **Size**: 6,315 bytes
- **Lines**: 361
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/io/pem/PemReader.cs`.

**Classes defined**: PemReader
