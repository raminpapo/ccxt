# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/encoders/BufferedDecoder.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/encoders/BufferedDecoder.cs`
- **Size**: 3,548 bytes
- **Lines**: 118
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/encoders/BufferedDecoder.cs`.

**Classes defined**: BufferedDecoder, to
