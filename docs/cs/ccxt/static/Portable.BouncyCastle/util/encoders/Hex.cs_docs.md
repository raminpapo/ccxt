# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/encoders/Hex.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/encoders/Hex.cs`
- **Size**: 4,145 bytes
- **Lines**: 152
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/encoders/Hex.cs`.
