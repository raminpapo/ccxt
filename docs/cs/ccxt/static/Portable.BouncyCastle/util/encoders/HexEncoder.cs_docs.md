# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/encoders/HexEncoder.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/encoders/HexEncoder.cs`
- **Size**: 6,649 bytes
- **Lines**: 242
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/encoders/HexEncoder.cs`.

**Classes defined**: HexEncoder
