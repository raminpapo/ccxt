# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/encoders/BufferedEncoder.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/encoders/BufferedEncoder.cs`
- **Size**: 3,507 bytes
- **Lines**: 118
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/encoders/BufferedEncoder.cs`.

**Classes defined**: BufferedEncoder, that
