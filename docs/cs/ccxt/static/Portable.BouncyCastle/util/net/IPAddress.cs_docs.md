# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/net/IPAddress.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/net/IPAddress.cs`
- **Size**: 3,970 bytes
- **Lines**: 198
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/net/IPAddress.cs`.

**Classes defined**: IPAddress
