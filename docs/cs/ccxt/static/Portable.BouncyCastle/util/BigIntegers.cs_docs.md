# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/BigIntegers.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/BigIntegers.cs`
- **Size**: 6,629 bytes
- **Lines**: 191
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/BigIntegers.cs`.

**Classes defined**: SecureRandom, BigIntegers
