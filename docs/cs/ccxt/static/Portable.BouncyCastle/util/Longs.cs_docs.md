# Documentation: cs/ccxt/static/Portable.BouncyCastle/util/Longs.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/util/Longs.cs`
- **Size**: 4,334 bytes
- **Lines**: 149
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/util/Longs.cs`.

**Classes defined**: Longs
