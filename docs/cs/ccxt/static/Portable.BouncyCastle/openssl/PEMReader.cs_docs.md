# Documentation: cs/ccxt/static/Portable.BouncyCastle/openssl/PEMReader.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/openssl/PEMReader.cs`
- **Size**: 13,871 bytes
- **Lines**: 366
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/openssl/PEMReader.cs`.

**Classes defined**: for, PemReader
