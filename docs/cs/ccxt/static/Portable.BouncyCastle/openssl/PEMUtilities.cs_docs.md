# Documentation: cs/ccxt/static/Portable.BouncyCastle/openssl/PEMUtilities.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/openssl/PEMUtilities.cs`
- **Size**: 3,132 bytes
- **Lines**: 84
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/openssl/PEMUtilities.cs`.

**Classes defined**: PemUtilities
