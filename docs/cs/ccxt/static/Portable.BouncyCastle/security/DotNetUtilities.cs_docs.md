# Documentation: cs/ccxt/static/Portable.BouncyCastle/security/DotNetUtilities.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/security/DotNetUtilities.cs`
- **Size**: 9,514 bytes
- **Lines**: 247
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/security/DotNetUtilities.cs`.

**Classes defined**: DotNetUtilities, containing
