# Documentation: cs/ccxt/static/Portable.BouncyCastle/security/MacUtilities.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/security/MacUtilities.cs`
- **Size**: 5,927 bytes
- **Lines**: 145
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/security/MacUtilities.cs`.

**Classes defined**: for, MacUtilities
