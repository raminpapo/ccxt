# Documentation: cs/ccxt/static/Portable.BouncyCastle/security/SecureRandom.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/security/SecureRandom.cs`
- **Size**: 6,758 bytes
- **Lines**: 224
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/security/SecureRandom.cs`.
