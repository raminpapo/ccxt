# Documentation: cs/ccxt/static/Portable.BouncyCastle/security/WrapperUtilities.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/security/WrapperUtilities.cs`
- **Size**: 3,748 bytes
- **Lines**: 116
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/security/WrapperUtilities.cs`.

**Classes defined**: for, WrapperUtilities, BufferedCipherWrapper
