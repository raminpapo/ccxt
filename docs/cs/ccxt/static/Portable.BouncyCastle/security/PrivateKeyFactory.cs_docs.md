# Documentation: cs/ccxt/static/Portable.BouncyCastle/security/PrivateKeyFactory.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/security/PrivateKeyFactory.cs`
- **Size**: 4,894 bytes
- **Lines**: 133
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/security/PrivateKeyFactory.cs`.

**Classes defined**: PrivateKeyFactory
