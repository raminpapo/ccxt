# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerUTCTime.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerUTCTime.cs`
- **Size**: 7,585 bytes
- **Lines**: 275
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerUTCTime.cs`.

**Classes defined**: Meta, DerUtcTime
