# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerVideotexString.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerVideotexString.cs`
- **Size**: 4,093 bytes
- **Lines**: 123
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerVideotexString.cs`.

**Classes defined**: Meta, DerVideotexString
