# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerGraphicString.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerGraphicString.cs`
- **Size**: 4,062 bytes
- **Lines**: 123
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerGraphicString.cs`.

**Classes defined**: Meta, DerGraphicString
