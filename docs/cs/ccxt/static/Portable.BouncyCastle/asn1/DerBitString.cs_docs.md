# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerBitString.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerBitString.cs`
- **Size**: 11,466 bytes
- **Lines**: 369
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerBitString.cs`.

**Classes defined**: DerBitString, Meta
