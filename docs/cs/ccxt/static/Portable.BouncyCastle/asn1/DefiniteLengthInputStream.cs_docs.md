# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DefiniteLengthInputStream.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DefiniteLengthInputStream.cs`
- **Size**: 3,444 bytes
- **Lines**: 118
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DefiniteLengthInputStream.cs`.

**Classes defined**: DefiniteLengthInputStream
