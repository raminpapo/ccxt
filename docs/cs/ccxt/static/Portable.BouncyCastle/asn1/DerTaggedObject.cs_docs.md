# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerTaggedObject.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerTaggedObject.cs`
- **Size**: 2,511 bytes
- **Lines**: 83
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerTaggedObject.cs`.

**Classes defined**: DerTaggedObject
