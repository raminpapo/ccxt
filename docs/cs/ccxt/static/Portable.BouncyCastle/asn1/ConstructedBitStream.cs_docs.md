# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/ConstructedBitStream.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/ConstructedBitStream.cs`
- **Size**: 3,785 bytes
- **Lines**: 137
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/ConstructedBitStream.cs`.

**Classes defined**: ConstructedBitStream
