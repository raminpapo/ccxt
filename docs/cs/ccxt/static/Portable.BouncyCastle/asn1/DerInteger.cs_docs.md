# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerInteger.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerInteger.cs`
- **Size**: 8,231 bytes
- **Lines**: 278
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerInteger.cs`.

**Classes defined**: DerInteger, Meta
