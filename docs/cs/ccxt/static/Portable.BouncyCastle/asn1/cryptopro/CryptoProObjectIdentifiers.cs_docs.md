# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/cryptopro/CryptoProObjectIdentifiers.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/cryptopro/CryptoProObjectIdentifiers.cs`
- **Size**: 3,410 bytes
- **Lines**: 52
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/cryptopro/CryptoProObjectIdentifiers.cs`.

**Classes defined**: CryptoProObjectIdentifiers
