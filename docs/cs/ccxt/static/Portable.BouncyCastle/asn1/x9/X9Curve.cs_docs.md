# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/x9/X9Curve.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/x9/X9Curve.cs`
- **Size**: 4,845 bytes
- **Lines**: 148
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/x9/X9Curve.cs`.

**Classes defined**: X9Curve
