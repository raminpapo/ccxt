# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/pkcs/PKCSObjectIdentifiers.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/pkcs/PKCSObjectIdentifiers.cs`
- **Size**: 18,491 bytes
- **Lines**: 302
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/pkcs/PKCSObjectIdentifiers.cs`.

**Classes defined**: PkcsObjectIdentifiers
