# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/BerOctetString.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/BerOctetString.cs`
- **Size**: 3,379 bytes
- **Lines**: 109
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/BerOctetString.cs`.

**Classes defined**: BerOctetString
