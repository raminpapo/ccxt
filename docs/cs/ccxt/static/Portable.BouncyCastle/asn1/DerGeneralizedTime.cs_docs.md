# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerGeneralizedTime.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerGeneralizedTime.cs`
- **Size**: 11,670 bytes
- **Lines**: 375
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerGeneralizedTime.cs`.

**Classes defined**: Meta, DerGeneralizedTime
