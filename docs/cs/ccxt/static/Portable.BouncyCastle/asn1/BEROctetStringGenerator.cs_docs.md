# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/BEROctetStringGenerator.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/BEROctetStringGenerator.cs`
- **Size**: 4,187 bytes
- **Lines**: 159
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/BEROctetStringGenerator.cs`.

**Classes defined**: BerOctetStringGenerator, BufferedBerOctetStream
