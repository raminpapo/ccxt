# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/BERBitString.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/BERBitString.cs`
- **Size**: 4,345 bytes
- **Lines**: 139
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/BERBitString.cs`.

**Classes defined**: BerBitString
