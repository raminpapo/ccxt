# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerPrintableString.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerPrintableString.cs`
- **Size**: 5,304 bytes
- **Lines**: 189
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerPrintableString.cs`.

**Classes defined**: Meta, DerPrintableString
