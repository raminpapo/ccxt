# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerBMPString.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerBMPString.cs`
- **Size**: 4,908 bytes
- **Lines**: 165
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerBMPString.cs`.

**Classes defined**: Meta, somehow, DerBmpString
