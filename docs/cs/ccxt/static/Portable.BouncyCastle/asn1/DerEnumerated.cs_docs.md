# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerEnumerated.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerEnumerated.cs`
- **Size**: 6,260 bytes
- **Lines**: 191
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerEnumerated.cs`.

**Classes defined**: Meta, DerEnumerated
