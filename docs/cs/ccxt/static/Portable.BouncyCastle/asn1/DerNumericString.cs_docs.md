# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerNumericString.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerNumericString.cs`
- **Size**: 5,816 bytes
- **Lines**: 192
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerNumericString.cs`.

**Classes defined**: Meta, DerNumericString
