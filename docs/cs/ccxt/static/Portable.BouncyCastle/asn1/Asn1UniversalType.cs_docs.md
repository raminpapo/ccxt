# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/Asn1UniversalType.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/Asn1UniversalType.cs`
- **Size**: 1,739 bytes
- **Lines**: 57
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/Asn1UniversalType.cs`.

**Classes defined**: Asn1UniversalType
