# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/nist/NISTNamedCurves.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/nist/NISTNamedCurves.cs`
- **Size**: 5,014 bytes
- **Lines**: 109
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/nist/NISTNamedCurves.cs`.

**Classes defined**: NistNamedCurves
