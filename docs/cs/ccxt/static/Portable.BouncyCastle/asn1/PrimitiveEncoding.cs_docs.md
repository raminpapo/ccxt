# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/PrimitiveEncoding.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/PrimitiveEncoding.cs`
- **Size**: 982 bytes
- **Lines**: 34
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/PrimitiveEncoding.cs`.

**Classes defined**: PrimitiveEncoding
