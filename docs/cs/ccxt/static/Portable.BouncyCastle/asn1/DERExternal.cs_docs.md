# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DERExternal.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DERExternal.cs`
- **Size**: 9,587 bytes
- **Lines**: 269
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DERExternal.cs`.

**Classes defined**: Meta, DerExternal
