# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/DerObjectIdentifier.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/DerObjectIdentifier.cs`
- **Size**: 10,067 bytes
- **Lines**: 309
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/DerObjectIdentifier.cs`.

**Classes defined**: Meta, DerObjectIdentifier
