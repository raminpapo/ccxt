# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/sec/SECObjectIdentifiers.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/sec/SECObjectIdentifiers.cs`
- **Size**: 3,824 bytes
- **Lines**: 52
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/sec/SECObjectIdentifiers.cs`.

**Classes defined**: SecObjectIdentifiers
