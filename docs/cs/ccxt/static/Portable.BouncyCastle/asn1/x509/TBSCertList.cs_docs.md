# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/x509/TBSCertList.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/x509/TBSCertList.cs`
- **Size**: 6,726 bytes
- **Lines**: 282
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/x509/TBSCertList.cs`.

**Classes defined**: RevokedCertificatesEnumeration, CrlEntry, RevokedCertificatesEnumerator, TbsCertificateList
...
**Classes** (4):
- `CrlEntry`
- `RevokedCertificatesEnumeration`
