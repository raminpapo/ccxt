# Documentation: cs/ccxt/static/Portable.BouncyCastle/asn1/x509/ExtendedKeyUsage.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/asn1/x509/ExtendedKeyUsage.cs`
- **Size**: 3,018 bytes
- **Lines**: 107
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/asn1/x509/ExtendedKeyUsage.cs`.

**Classes defined**: ExtendedKeyUsage
