# Documentation: cs/ccxt/static/Portable.BouncyCastle/BouncyCastle.Crypto.csproj

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/BouncyCastle.Crypto.csproj`
- **Size**: 3,268 bytes
- **Lines**: 74
- **Type**: Unknown
- **Extension**: .csproj
...
This is a Unknown file located at `cs/ccxt/static/Portable.BouncyCastle/BouncyCastle.Crypto.csproj`.
...
- `..\csharp_logo.png` (referenced)
- `..\License.md` (referenced)
