# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/prng/VMPCRandomGenerator.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/prng/VMPCRandomGenerator.cs`
- **Size**: 6,679 bytes
- **Lines**: 133
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/prng/VMPCRandomGenerator.cs`.

**Classes defined**: VmpcRandomGenerator
