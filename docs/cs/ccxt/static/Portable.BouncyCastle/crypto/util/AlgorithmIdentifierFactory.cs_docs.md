# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/util/AlgorithmIdentifierFactory.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/util/AlgorithmIdentifierFactory.cs`
- **Size**: 2,838 bytes
- **Lines**: 50
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/util/AlgorithmIdentifierFactory.cs`.

**Classes defined**: AlgorithmIdentifierFactory
