# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/util/BasicAlphabetMapper.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/util/BasicAlphabetMapper.cs`
- **Size**: 3,138 bytes
- **Lines**: 109
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/util/BasicAlphabetMapper.cs`.

**Classes defined**: BasicAlphabetMapper
