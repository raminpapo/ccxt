# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/util/Pack.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/util/Pack.cs`
- **Size**: 17,109 bytes
- **Lines**: 593
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/util/Pack.cs`.

**Classes defined**: Pack
