# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/IXof.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/IXof.cs`
- **Size**: 2,394 bytes
- **Lines**: 51
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/IXof.cs`.
