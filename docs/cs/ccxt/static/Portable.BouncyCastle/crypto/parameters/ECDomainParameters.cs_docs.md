# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/parameters/ECDomainParameters.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/parameters/ECDomainParameters.cs`
- **Size**: 4,369 bytes
- **Lines**: 172
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/parameters/ECDomainParameters.cs`.

**Classes defined**: ECDomainParameters
