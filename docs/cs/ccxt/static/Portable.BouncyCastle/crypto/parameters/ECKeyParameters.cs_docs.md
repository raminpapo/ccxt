# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/parameters/ECKeyParameters.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/parameters/ECKeyParameters.cs`
- **Size**: 4,105 bytes
- **Lines**: 135
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/parameters/ECKeyParameters.cs`.

**Classes defined**: ECKeyParameters
