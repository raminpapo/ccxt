# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/macs/GMac.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/macs/GMac.cs`
- **Size**: 4,559 bytes
- **Lines**: 130
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/macs/GMac.cs`.

**Classes defined**: GMac
