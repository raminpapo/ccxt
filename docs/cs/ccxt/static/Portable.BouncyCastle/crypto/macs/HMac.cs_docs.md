# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/macs/HMac.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/macs/HMac.cs`
- **Size**: 4,824 bytes
- **Lines**: 200
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/macs/HMac.cs`.
