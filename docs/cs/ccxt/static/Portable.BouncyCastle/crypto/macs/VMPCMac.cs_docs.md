# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/macs/VMPCMac.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/macs/VMPCMac.cs`
- **Size**: 5,774 bytes
- **Lines**: 239
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/macs/VMPCMac.cs`.

**Classes defined**: VmpcMac
