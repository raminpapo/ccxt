# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/IDSA.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/IDSA.cs`
- **Size**: 1,493 bytes
- **Lines**: 33
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/IDSA.cs`.
