# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/PbeParametersGenerator.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/PbeParametersGenerator.cs`
- **Size**: 4,289 bytes
- **Lines**: 142
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/PbeParametersGenerator.cs`.

**Classes defined**: for, PbeParametersGenerator
