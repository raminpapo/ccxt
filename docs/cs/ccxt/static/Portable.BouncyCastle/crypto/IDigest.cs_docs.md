# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/IDigest.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/IDigest.cs`
- **Size**: 2,472 bytes
- **Lines**: 54
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/IDigest.cs`.
