# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/signers/ECNRSigner.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/ECNRSigner.cs`
- **Size**: 6,485 bytes
- **Lines**: 194
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/ECNRSigner.cs`.

**Classes defined**: ECNRSigner
