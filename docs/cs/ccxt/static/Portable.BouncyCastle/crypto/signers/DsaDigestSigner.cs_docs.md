# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/signers/DsaDigestSigner.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/DsaDigestSigner.cs`
- **Size**: 3,042 bytes
- **Lines**: 127
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/DsaDigestSigner.cs`.

**Classes defined**: DsaDigestSigner
