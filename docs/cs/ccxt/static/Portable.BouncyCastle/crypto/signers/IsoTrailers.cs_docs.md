# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/signers/IsoTrailers.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/IsoTrailers.cs`
- **Size**: 1,921 bytes
- **Lines**: 54
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/IsoTrailers.cs`.

**Classes defined**: IsoTrailers
