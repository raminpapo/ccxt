# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/signers/ECDsaSigner.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/ECDsaSigner.cs`
- **Size**: 8,301 bytes
- **Lines**: 246
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/ECDsaSigner.cs`.

**Classes defined**: ECDsaSigner
