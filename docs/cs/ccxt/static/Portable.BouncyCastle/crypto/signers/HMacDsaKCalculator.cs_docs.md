# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/signers/HMacDsaKCalculator.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/HMacDsaKCalculator.cs`
- **Size**: 4,946 bytes
- **Lines**: 169
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/signers/HMacDsaKCalculator.cs`.

**Classes defined**: HMacDsaKCalculator
