# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/paddings/Pkcs7Padding.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/paddings/Pkcs7Padding.cs`
- **Size**: 2,536 bytes
- **Lines**: 95
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/paddings/Pkcs7Padding.cs`.

**Classes defined**: Pkcs7Padding
