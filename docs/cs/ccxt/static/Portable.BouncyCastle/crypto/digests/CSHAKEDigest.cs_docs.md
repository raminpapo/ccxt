# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/digests/CSHAKEDigest.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/digests/CSHAKEDigest.cs`
- **Size**: 3,327 bytes
- **Lines**: 128
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/digests/CSHAKEDigest.cs`.

**Classes defined**: CShakeDigest
