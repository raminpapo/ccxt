# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/digests/LongDigest.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/digests/LongDigest.cs`
- **Size**: 11,516 bytes
- **Lines**: 413
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/digests/LongDigest.cs`.

**Classes defined**: for, LongDigest
