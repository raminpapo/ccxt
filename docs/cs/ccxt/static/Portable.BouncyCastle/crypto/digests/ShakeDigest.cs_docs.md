# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/digests/ShakeDigest.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/digests/ShakeDigest.cs`
- **Size**: 3,897 bytes
- **Lines**: 153
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/digests/ShakeDigest.cs`.

**Classes defined**: ShakeDigest
