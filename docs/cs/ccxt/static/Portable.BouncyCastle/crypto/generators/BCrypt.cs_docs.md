# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/generators/BCrypt.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/generators/BCrypt.cs`
- **Size**: 28,930 bytes
- **Lines**: 629
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/generators/BCrypt.cs`.

**Classes defined**: BCrypt

**Functions defined**: as, grows
