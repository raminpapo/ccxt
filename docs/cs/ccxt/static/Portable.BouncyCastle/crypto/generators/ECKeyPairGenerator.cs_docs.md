# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/generators/ECKeyPairGenerator.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/generators/ECKeyPairGenerator.cs`
- **Size**: 5,989 bytes
- **Lines**: 187
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/generators/ECKeyPairGenerator.cs`.

**Classes defined**: ECKeyPairGenerator
