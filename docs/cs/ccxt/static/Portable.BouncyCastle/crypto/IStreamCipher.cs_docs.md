# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/IStreamCipher.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/IStreamCipher.cs`
- **Size**: 2,559 bytes
- **Lines**: 57
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/IStreamCipher.cs`.
