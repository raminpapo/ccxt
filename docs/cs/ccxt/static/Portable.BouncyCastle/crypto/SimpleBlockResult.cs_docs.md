# Documentation: cs/ccxt/static/Portable.BouncyCastle/crypto/SimpleBlockResult.cs

## File Metadata

- **Path**: `cs/ccxt/static/Portable.BouncyCastle/crypto/SimpleBlockResult.cs`
- **Size**: 1,881 bytes
- **Lines**: 63
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Portable.BouncyCastle/crypto/SimpleBlockResult.cs`.

**Classes defined**: SimpleBlockResult
