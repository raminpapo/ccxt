# Documentation: cs/ccxt/static/StarkSharp/StarkSharp.Signer/StarkCurveSigner/Signature.cs

## File Metadata

- **Path**: `cs/ccxt/static/StarkSharp/StarkSharp.Signer/StarkCurveSigner/Signature.cs`
- **Size**: 20,869 bytes
- **Lines**: 509
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/StarkSharp/StarkSharp.Signer/StarkCurveSigner/Signature.cs`.

**Classes defined**: StarkCurveParameters, ECSignature, ECDSA
...
- `StarkSharp/StarkSharp.Signer/StarkCurveSigner/pedersen_params.json` (referenced)
- `StarkSharp\\StarkSharp.Signer\\StarkCurveSigner\\pedersen_params.json` (referenced)
- `./pedersen_params.json` (referenced)
