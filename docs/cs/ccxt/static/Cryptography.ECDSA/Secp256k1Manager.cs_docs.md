# Documentation: cs/ccxt/static/Cryptography.ECDSA/Secp256k1Manager.cs

## File Metadata

- **Path**: `cs/ccxt/static/Cryptography.ECDSA/Secp256k1Manager.cs`
- **Size**: 14,608 bytes
- **Lines**: 387
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Cryptography.ECDSA/Secp256k1Manager.cs`.

**Classes defined**: Secp256K1Manager
