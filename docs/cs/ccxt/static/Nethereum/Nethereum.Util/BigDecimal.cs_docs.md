# Documentation: cs/ccxt/static/Nethereum/Nethereum.Util/BigDecimal.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.Util/BigDecimal.cs`
- **Size**: 15,807 bytes
- **Lines**: 464
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.Util/BigDecimal.cs`.
