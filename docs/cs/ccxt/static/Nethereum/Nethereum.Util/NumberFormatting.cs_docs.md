# Documentation: cs/ccxt/static/Nethereum/Nethereum.Util/NumberFormatting.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.Util/NumberFormatting.cs`
- **Size**: 9,186 bytes
- **Lines**: 233
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.Util/NumberFormatting.cs`.

**Classes defined**: NumberFormatting
