# Documentation: cs/ccxt/static/Nethereum/Nethereum.Util/ByteUtil.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.Util/ByteUtil.cs`
- **Size**: 6,725 bytes
- **Lines**: 205
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.Util/ByteUtil.cs`.

**Classes defined**: ByteListComparer, ByteArrayComparer, ByteUtil
