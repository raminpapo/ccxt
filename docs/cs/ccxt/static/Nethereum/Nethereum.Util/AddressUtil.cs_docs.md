# Documentation: cs/ccxt/static/Nethereum/Nethereum.Util/AddressUtil.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.Util/AddressUtil.cs`
- **Size**: 4,903 bytes
- **Lines**: 148
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.Util/AddressUtil.cs`.

**Classes defined**: UniqueAddressList, AddressUtil, AddressEqualityComparer
