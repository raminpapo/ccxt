# Documentation: cs/ccxt/static/Nethereum/Nethereum.Util/UnitConversion.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.Util/UnitConversion.cs`
- **Size**: 10,672 bytes
- **Lines**: 277
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.Util/UnitConversion.cs`.

**Classes defined**: UnitConversion
