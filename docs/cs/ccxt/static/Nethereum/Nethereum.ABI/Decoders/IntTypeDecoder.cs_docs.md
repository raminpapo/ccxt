# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/Decoders/IntTypeDecoder.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/Decoders/IntTypeDecoder.cs`
- **Size**: 4,128 bytes
- **Lines**: 146
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/Decoders/IntTypeDecoder.cs`.

**Classes defined**: IntTypeDecoder
