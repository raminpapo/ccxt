# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/ABIDeserialisation/ABIJsonDeserialiser.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/ABIDeserialisation/ABIJsonDeserialiser.cs`
- **Size**: 7,267 bytes
- **Lines**: 206
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/ABIDeserialisation/ABIJsonDeserialiser.cs`.

**Classes defined**: ABIJsonDeserialiser
