# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/Model/ModelExtensions.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/Model/ModelExtensions.cs`
- **Size**: 6,414 bytes
- **Lines**: 157
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/Model/ModelExtensions.cs`.

**Classes defined**: ModelExtensions
