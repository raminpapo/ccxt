# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/ABIType.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/ABIType.cs`
- **Size**: 3,083 bytes
- **Lines**: 107
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/ABIType.cs`.

**Classes defined**: ABIType
