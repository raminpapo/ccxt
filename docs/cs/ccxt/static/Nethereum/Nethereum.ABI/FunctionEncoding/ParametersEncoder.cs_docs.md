# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/FunctionEncoding/ParametersEncoder.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/FunctionEncoding/ParametersEncoder.cs`
- **Size**: 6,630 bytes
- **Lines**: 176
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/FunctionEncoding/ParametersEncoder.cs`.

**Classes defined**: ParametersEncoder
