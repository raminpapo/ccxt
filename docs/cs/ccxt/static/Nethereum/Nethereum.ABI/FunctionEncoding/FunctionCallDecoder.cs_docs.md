# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/FunctionEncoding/FunctionCallDecoder.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/FunctionEncoding/FunctionCallDecoder.cs`
- **Size**: 6,930 bytes
- **Lines**: 192
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/FunctionEncoding/FunctionCallDecoder.cs`.

**Classes defined**: FunctionCallDecoder
