# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/FunctionEncoding/EventTopicDecoder.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/FunctionEncoding/EventTopicDecoder.cs`
- **Size**: 5,407 bytes
- **Lines**: 126
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/FunctionEncoding/EventTopicDecoder.cs`.

**Classes defined**: EventTopicDecoder
