# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/ABIEncode.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/ABIEncode.cs`
- **Size**: 6,176 bytes
- **Lines**: 192
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/ABIEncode.cs`.

**Classes defined**: ABIEncode
