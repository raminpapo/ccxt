# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/Encoders/IntTypeEncoder.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/Encoders/IntTypeEncoder.cs`
- **Size**: 6,363 bytes
- **Lines**: 188
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/Encoders/IntTypeEncoder.cs`.

**Classes defined**: IntTypeEncoder
