# Documentation: cs/ccxt/static/Nethereum/Nethereum.ABI/ABIRepository/ABIInfoInMemoryStorage.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.ABI/ABIRepository/ABIInfoInMemoryStorage.cs`
- **Size**: 6,552 bytes
- **Lines**: 170
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.ABI/ABIRepository/ABIInfoInMemoryStorage.cs`.

**Classes defined**: ABIInfoInMemoryStorage
