# Documentation: cs/ccxt/static/Nethereum/Nethereum.Hex/HexTypes/HexType.cs

## File Metadata

- **Path**: `cs/ccxt/static/Nethereum/Nethereum.Hex/HexTypes/HexType.cs`
- **Size**: 3,633 bytes
- **Lines**: 138
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/static/Nethereum/Nethereum.Hex/HexTypes/HexType.cs`.

**Classes defined**: HexRPCType
