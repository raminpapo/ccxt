# Documentation: cs/ccxt/wrappers/coinbaseinternational.cs

## File Metadata

- **Path**: `cs/ccxt/wrappers/coinbaseinternational.cs`
- **Size**: 33,584 bytes
- **Lines**: 821
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/wrappers/coinbaseinternational.cs`.
