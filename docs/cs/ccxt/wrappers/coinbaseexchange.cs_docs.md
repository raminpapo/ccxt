# Documentation: cs/ccxt/wrappers/coinbaseexchange.cs

## File Metadata

- **Path**: `cs/ccxt/wrappers/coinbaseexchange.cs`
- **Size**: 30,851 bytes
- **Lines**: 751
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/wrappers/coinbaseexchange.cs`.
