# Documentation: cs/ccxt/wrappers/bigone.cs

## File Metadata

- **Path**: `cs/ccxt/wrappers/bigone.cs`
- **Size**: 24,737 bytes
- **Lines**: 619
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/wrappers/bigone.cs`.
...
- `https://open.big.one/docs/spot_asset_pair.html` (referenced)
- `https://open.big.one/docs/spot_ping.html` (referenced)
- `https://open.big.one/docs/fund_accounts.html` (referenced)
- `https://open.big.one/docs/spot_asset_pair_trade.html` (referenced)
- `https://open.big.one/docs/spot_asset_pair_candle.html` (referenced)
- `https://open.big.one/docs/spot_accounts.html` (referenced)
- `https://open.big.one/docs/spot_tickers.html` (referenced)
