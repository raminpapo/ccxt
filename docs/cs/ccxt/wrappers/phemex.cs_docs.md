# Documentation: cs/ccxt/wrappers/phemex.cs

## File Metadata

- **Path**: `cs/ccxt/wrappers/phemex.cs`
- **Size**: 44,536 bytes
- **Lines**: 1,069
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/wrappers/phemex.cs`.
...
- `https://github.com/phemex/phemex-api-docs/blob/master/Public-Contract-API-en.md` (referenced)
