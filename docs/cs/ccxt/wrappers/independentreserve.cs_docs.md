# Documentation: cs/ccxt/wrappers/independentreserve.cs

## File Metadata

- **Path**: `cs/ccxt/wrappers/independentreserve.cs`
- **Size**: 13,485 bytes
- **Lines**: 354
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/wrappers/independentreserve.cs`.
