# Documentation: cs/ccxt/base/Exchange.Wrappers.cs

## File Metadata

- **Path**: `cs/ccxt/base/Exchange.Wrappers.cs`
- **Size**: 84,930 bytes
- **Lines**: 1,390
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/base/Exchange.Wrappers.cs`.

**Classes defined**: wrappers, Bequant, Arkham, Alpaca, Apex, Exchange, Binance, Bigone, Ascendex, Backpack
