# Documentation: cs/ccxt/base/Polyfills.cs

## File Metadata

- **Path**: `cs/ccxt/base/Polyfills.cs`
- **Size**: 11,189 bytes
- **Lines**: 275
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/base/Polyfills.cs`.

**Classes defined**: RuntimeHelpers
