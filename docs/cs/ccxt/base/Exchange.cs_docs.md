# Documentation: cs/ccxt/base/Exchange.cs

## File Metadata

- **Path**: `cs/ccxt/base/Exchange.cs`
- **Size**: 43,176 bytes
- **Lines**: 1,262
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/base/Exchange.cs`.

**Classes defined**: for, Exchange, BoolExtensions, DynamicInvoker
