# Documentation: cs/ccxt/base/Exchange.Types.cs

## File Metadata

- **Path**: `cs/ccxt/base/Exchange.Types.cs`
- **Size**: 68,475 bytes
- **Lines**: 2,025
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/base/Exchange.Types.cs`.

**Classes defined**: Exchange, Helper
