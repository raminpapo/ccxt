# Documentation: cs/ccxt/base/Exchange.BaseMethods.cs

## File Metadata

- **Path**: `cs/ccxt/base/Exchange.BaseMethods.cs`
- **Size**: 396,665 bytes
- **Lines**: 8,337
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/base/Exchange.BaseMethods.cs`.

**Classes defined**: Exchange, needs

**Functions defined**: takes
