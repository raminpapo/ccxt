# Documentation: cs/ccxt/base/Exchange.SafeMethods.cs

## File Metadata

- **Path**: `cs/ccxt/base/Exchange.SafeMethods.cs`
- **Size**: 17,264 bytes
- **Lines**: 448
- **Type**: C#
- **Extension**: .cs
...
This is a C# file located at `cs/ccxt/base/Exchange.SafeMethods.cs`.
